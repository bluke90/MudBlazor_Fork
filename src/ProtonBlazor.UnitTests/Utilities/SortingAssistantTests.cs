...
namespace ProtonBlazor.UnitTests.Utilities
{
    public class SortingAssistantTests
    {
        ...
        public void UpdateOrder_MoveUp()
        {
            ...
            var dropInfo = new ProItemDropInfo<ItemsWithOrder>(items[4], "something", 0);
        ...
        public void UpdateOrder_MoveUp_Neighbor()
        {
            ...
            //move item item-5 to index 0
            var dropInfo = new ProItemDropInfo<ItemsWithOrder>(items[3], "something", 4);
            items.UpdateOrder(dropInfo, x => x.Prio);
        ...
        public void UpdateOrder_MoveUp_EdgeCase()
        {
            ...
            //move item item-5 to index 0
            var dropInfo = new ProItemDropInfo<ItemsWithOrder>(items[9], "something", 0);
            items.UpdateOrder(dropInfo, x => x.Prio);
        ...
        public void UpdateOrder_MoveDown()
        {
            ...
            //move item item-5 to index 0
            var dropInfo = new ProItemDropInfo<ItemsWithOrder>(items[2], "something", 5);
            items.UpdateOrder(dropInfo, x => x.Prio);
        ...
        public void UpdateOrder_MoveDown_Neighbor()
        {
            ...
            //move item item-5 to index 0
            var dropInfo = new ProItemDropInfo<ItemsWithOrder>(items[4], "something", 3);
            items.UpdateOrder(dropInfo, x => x.Prio);
        ...
        public void UpdateOrder_MoveDown_EdgeCase()
        {
            ...
            //move item item-5 to index 0
            var dropInfo = new ProItemDropInfo<ItemsWithOrder>(items[0], "something", 9);
            items.UpdateOrder(dropInfo, x => x.Prio);
        ...
        public void UpdateOrder_MoveDown_SameItem()
        {
            ...
            var dropInfo = new ProItemDropInfo<ItemsWithOrder>(items[3], "something", 3);
            items.UpdateOrder(dropInfo, x => x.Prio);
