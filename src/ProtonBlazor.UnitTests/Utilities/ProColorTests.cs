...
{
    [TestFixture]
    public class ProColorTests
    {
        [Test]
        public void ProColor_STJ_SourceGen_Serialization()
        {
            var originalMudColor = new ProColor("#f6f9fb");

            var mudColorType = typeof(ProColor);
            var context = ProColorSerializerContext.Default;
        ...
        [Test]
        public void ProColor_STJ_Serialization()
        {
            var originalMudColor = new ProColor("#f6f9fb");

            var jsonString = System.Text.Json.JsonSerializer.Serialize(originalMudColor);
            var deserializeMudColor = System.Text.Json.JsonSerializer.Deserialize<ProColor>(jsonString);
        ...
        [Test]
        public void ProColor_Newtonsoft_Serialization()
        {
            var originalMudColor = new ProColor("#f6f9fb");

            var jsonString = Newtonsoft.Json.JsonConvert.SerializeObject(originalMudColor);
            var deserializeMudColor = Newtonsoft.Json.JsonConvert.DeserializeObject<ProColor>(jsonString);
        ...
        [Test]
        public void ProColor_Default_Ctor()
        {
            var defaultMudColor = new ProColor();
            var blackMudColor = new ProColor("#000000ff");
        ...
        [Test]
        public void ProColor_XMLDataContract_Serialization()
        {
            var dataContractSerializer = new System.Runtime.Serialization.DataContractSerializer(typeof(ProColor));
            ...
            string SerializeXml(ProColor mudColorObject)
            {
            ...
            xmlString.Should().Be("<ProColor xmlns=\"http://schemas.datacontract.org/2004/07/ProtonBlazor.Utilities\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:x=\"http://www.w3.org/2001/XMLSchema\"><R i:type=\"x:unsignedByte\" xmlns=\"\">246</R><G i:type=\"x:unsignedByte\" xmlns=\"\">249</G><B i:type=\"x:unsignedByte\" xmlns=\"\">251</B><A i:type=\"x:unsignedByte\" xmlns=\"\">255</A></ProColor>");
            deserializeMudColor.Should().Be(originalMudColor);
        }
        ...
        public void FromString_RGBA_And_Darken(string input, byte r, byte g, byte b, byte alpha)
        {
            ...
            foreach (var item in cultures)
            {
                ...
                //use as reference
                var colorFromRgb = new ProColor(color.R, color.G, color.B, color.A);
        ...
        {
            ProColor color = new((byte)123, (byte)240, (byte)130, (byte)76);
        ...
        {
            ProColor color = new((byte)123, (byte)240, (byte)130, 0.8);
        ...
        {
            ProColor color = new((int)123, (int)240, (int)130, (int)76);
        ...
        {
            ProColor color = new((int)300, (int)2152525, (int)266, (int)25555);
        ...
        {
            ProColor color = new((int)123, (int)240, (int)130, 0.8);
        ...
        {
            ProColor color = new((int)300, (int)2152525, (int)266, 2.4);
        ...
        {
            ProColor color = new((int)-300, (int)-2152525, (int)-266, -0.8);
        ...
        {
            ProColor color = new(113.2424, 0.624, 0.2922525, 115);
        ...
        {
            ProColor color = new(450.0, 1.4, 1.2, 266);
        ...
        {
            ProColor color = new(450.0, 1.4, 1.2, 1.2);
        ...
        public void SetH()
        {
            ProColor color = new(120, 0.15, 0.25, 255);
        ...
        public void SetR()
        {
            ProColor color = new((byte)25, (byte)50, (byte)70, (byte)255);
        ...
        {
            ProColor color = new((byte)25, (byte)50, (byte)70, (byte)170);
        ...
        {
            ProColor color = new(140.0, 0.2, 0.4, (byte)170);
        ...
        {
            ProColor color = new(140.0, 0.2, 0.5, (byte)170);
        ...
        public void ValueAndExplicitCast(byte r, byte g, byte b, byte a, string expectedValue)
        {
            ...
            color.ToString(ProColorOutputFormats.HexA).ToLowerInvariant().Should().Be(expectedValue);
        ...
        public void ToRGB(byte r, byte g, byte b, byte a, string expectedValue)
        {
            ...
            foreach (var item in cultures)
            {
                ...
                color.ToString(ProColorOutputFormats.RGB).Should().Be(expectedValue);
            }
        }
        ...
        public void ToRGBA(byte r, byte g, byte b, byte a, string expectedValue)
        {
            ...
            foreach (var item in cultures)
            {
                ...
                color.ToString(ProColorOutputFormats.RGBA).Should().Be(expectedValue);
            }
        }
        ...
        public void ToColorRgbElements(byte r, byte g, byte b, byte a, string expectedValue)
        {
            ...
            foreach (var item in cultures)
            {
                ...
                color.ToString(ProColorOutputFormats.ColorElements).Should().Be(expectedValue);
            }
        }
        ...
        public void ToHex(byte r, byte g, byte b, byte a, string expectedValue)
        {
            ...
            foreach (var item in cultures)
            {
                ...
                color.ToString(ProColorOutputFormats.Hex).Should().Be(expectedValue);
            }
        }
        ...
        {
            // Arrange
            var color = new ProColor(130, 150, 240, 170);

            // Act
            var rgb = color.ToString(ProColorOutputFormats.RGB);
            var rgba = color.ToString(ProColorOutputFormats.RGBA);
            var hex = color.ToString(ProColorOutputFormats.Hex);
            var hexA = color.ToString(ProColorOutputFormats.HexA);
            var colorElements = color.ToString(ProColorOutputFormats.ColorElements);
            var unknown = color.ToString((ProColorOutputFormats)9999);
        ...
        {
            // Arrange
            IReadOnlyList<ProColor> colors = ["#FF0000"];

            // Act
            var act = () =>
            {
                _ = ProColor.GenerateMultiGradientPalette(colors).ToList();
            };
        ...
        public void GenerateMultiGradientPalette_ShouldGenerateCorrectGradient(ProColor[] colors, int numberOfColors, ProColor[] expectedColors)
        {
            // Arrange & Act
            var multiGradientPalette = ProColor.GenerateMultiGradientPalette(colors, numberOfColors).ToList();
        ...
        public void GenerateGradientPalette_ShouldGenerateCorrectGradient(ProColor startColor, ProColor endColor, int numberOfColors, ProColor[] expectedColors)
        {
            // Arrange & Act
            var gradientPalette = ProColor.GenerateGradientPalette(startColor, endColor, numberOfColors).ToList();
        ...
        {
            // Arrange
            var baseColor = new ProColor("#FF0000FF"); // Red
            IReadOnlyList<ProColor> expectedColors = ["#FF0000FF", "#FFFF00FF", "#00FF00FF", "#00FFFFFF", "#0000FFFF"];

            // Act
            var analogousPalette = ProColor.GenerateAnalogousPalette(baseColor, angle: 60).ToList();
        ...
        {
            // Arrange
            var baseColor = new ProColor("#808080FF"); // Gray

            // Only tints
            IReadOnlyList<ProColor> expectedTints = ["#808080FF", "#999999FF", "#B3B3B3FF", "#CCCCCCFF", "#E6E6E6FF"];

            // Only shades
            IReadOnlyList<ProColor> expectedShades = ["#808080FF", "#666666FF", "#4D4D4DFF", "#333333FF", "#1A1A1AFF"];

            // Both tints and shades (odd number of colors)
            IReadOnlyList<ProColor> expectedBothOdd = ["#CCCCCCFF", "#B3B3B3FF", "#999999FF", "#808080FF", "#666666FF", "#4D4D4DFF", "#333333FF"];

            // Both tints and shades (even number of colors)
            IReadOnlyList<ProColor> expectedBothEven = ["#CCCCCCFF", "#B3B3B3FF", "#999999FF", "#808080FF", "#666666FF", "#4D4D4DFF"];

            // Act
            var tintsPalette = ProColor.GenerateTintShadePalette(baseColor, tintStep: 0.1, shadeStep: 0).ToList();
            var shadesPalette = ProColor.GenerateTintShadePalette(baseColor, tintStep: 0, shadeStep: 0.1).ToList();
            var bothPaletteOdd = ProColor.GenerateTintShadePalette(baseColor, 7, tintStep: 0.1, shadeStep: 0.1).ToList();
            var bothPaletteEven = ProColor.GenerateTintShadePalette(baseColor, 6, tintStep: 0.1, shadeStep: 0.1).ToList();
        ...
        public void Lerp_ShouldInterpolateCorrectly(ProColor colorStart, ProColor colorEnd, float t, ProColor expectedColor)
        {
            // Arrange & Act
            var result = ProColor.Lerp(colorStart, colorEnd, t);
...
#pragma warning disable CS1718 // Comparison made to same variable
        ...
        {
            // Arrange & Act
            var generatedColors = ProColor.GenerateTintShadePalette("#E53935");
            var colors = new List<ProColor>
            {
                new("#ED7A78"),
                new("#E95653"),
                new("#E53935"),
        ...
        {
            // Arrange
            ProColor color1 = new(10, 20, 50, 255);
            ProColor color2 = new(10, 20, 50, 255);
            ProColor color3 = null;
            ProColor color4 = null;
        ...
        public void NotEquals_SameType()
        {
            // Arrange
            ProColor color1 = new(10, 20, 50, 255);
            ProColor color2 = new(10, 20, 50, 10);
            ProColor color3 = null;
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        public void Equals_Null()
        {
            ...
            color1.Equals(null as ProColor).Should().BeFalse();

            ProColor color2 = null;
        ...
        public void Equals_SameRgba_DifferentHsl()
        {
            ...
            var equals2 = color1.Equals(color2, ProColorComparison.Rgba);
            var equals3 = color1.Equals(color2, ProColorComparison.Hsl);
            var equals4 = color1.Equals(color2, ProColorComparison.RgbaAndHsl);
            var equals5 = color1.Equals(color2, (ProColorComparison)(-1));
        ...
        {
            // Arrange
            ProColor color = new(120, 0.5, 0.4, 1);
        ...
        {
            // Arrange
            ProColor first = new(h1, s1, l1, a1);
            ProColor second = new(h2, s2, l2, a2);
        ...
        {
            // Arrange
            ProColor color = new(10, 20, 30, 255);
        ...
        {
            // Arrange
            ProColor first = new(r1, g1, b1, a1);
            ProColor second = new(r2, g2, b2, a2);
        ...
        {
            // Arrange
            var color1 = new ProColor(130, 150, 240, 255);
            var color2 = new ProColor(130, 150, 240, 255);
        ...
        public void GetHasCode_DifferentRgba()
        {
            // Arrange
            var color1 = new ProColor(130, 150, 240, 255);
            var color2 = new ProColor(131, 150, 240, 255);
        ...
        public void UInt32_CheckAgainstBinaryPrimitive()
        {
            ...
            var mudColor = new ProColor(R, G, B, A);
        ...
        {
            // Arrange
            var expected = new ProColor(r, g, b, a);

            // Act
            var result = ProColor.Parse(value);
        ...
        public void TryParse(string value, byte r, byte g, byte b, byte a)
        {
            ...
            // Act
            var success = ProColor.TryParse(value, out var result);
        ...
        {
            // Arrange
            var mudColor = new ProColor(255, 128, 64, 192);
        ...
        {
            // Arrange
            var mudColor1 = new ProColor(71, 88, 99, 1);

            // Act
            var result1 = (string)mudColor1;
            var result2 = (string)(ProColor)null;
        ...
        [
            ...
            new object[] { new ProColor[] { "#FF4500FF", "#FFD700FF", "#32CD32FF", "#1E90FFFF", "#8A2BE2FF" }, 5, new ProColor[] { "#FF4500FF", "#FFD700FF", "#32CD32FF", "#1E90FFFF", "#8A2BE2FF" } },
            // Should act as "ProColor.GenerateGradientPalette" when there are only two colors (end and start), testing with odd number of colors
            new object[] { new ProColor[] { "#FF0000FF", "#0000FFFF" }, 5, new ProColor[] { "#FF0000FF", "#BF003FFF", "#7F007FFF", "#3F00BFFF", "#0000FFFF" } },
            // Should act as "ProColor.GenerateGradientPalette" when there are only two colors (end and start), testing with even number of colors
            new object[] { new ProColor[] { "#FF0000FF", "#0000FFFF" }, 6, new ProColor[] { "#FF0000FF", "#CC0033FF", "#990066FF", "#650099FF", "#3200CCFF", "#0000FFFF" } },
            ...
            new object[] { new ProColor[] { "#FF0000FF", "#7F007FFF", "#0000FFFF" }, 5, new ProColor[] { "#FF0000FF", "#BF003FFF", "#7F007FFF", "#3F00BFFF", "#0000FFFF" } },
            new object[] { new ProColor[] { "#FF4500FF", "#32CD32FF", "#8A2BE2FF" }, 5, new ProColor[] { "#FF4500FF", "#988919FF", "#32CD32FF", "#5E7C8AFF", "#8A2BE2FF" } },
            new object[] { new ProColor[] { "#FF4500FF", "#32CD32FF", "#8A2BE2FF" }, 6, new ProColor[] { "#FF4500FF", "BA7210FD", "769F21FF", "32CD32FF", "5E7C8AFF", "#8A2BE2FF" } }
        ];

        private static readonly object[] _gradientTestCases =
        [
            // Should just lerp between two colors when numbers of colors is 1
            new object[] { new ProColor("#FF0000FF"), new ProColor("#0000FFFF"), 1, new ProColor[] { "#7F007FFF" } },
            // Should return start and end colors when numbers of colors is 2
            new object[] { new ProColor("#FF0000FF"), new ProColor("#0000FFFF"), 2, new ProColor[] { "#FF0000FF", "#0000FFFF" }},
            ...
            new object[] { new ProColor("#FF0000FF"), new ProColor("#0000FFFF"), 5, new ProColor[] { "#FF0000FF", "#BF003FFF", "#7F007FFF", "#3F00BFFF", "#0000FFFF" }},
            // Should return start, then evenly lerped colors, testing with even number of colors
            new object[] { new ProColor("#FF0000FF"), new ProColor("#0000FFFF"), 6, new ProColor[] { "#FF0000FF", "#CC0033FF", "#990066FF", "#650099FF", "#3200CCFF", "#0000FFFF" }},
        ];

        private static readonly object[] _lerpTestCases =
        [
            // Tested expected also with https://www.colourblender.io/
            new object[] { new ProColor(255, 0, 0, 255), new ProColor(0, 0, 255, 255), 0.0f, new ProColor(255, 0, 0, 255) }, // t = 0, should return start color
            new object[] { new ProColor(255, 0, 0, 255), new ProColor(0, 0, 255, 255), 1.0f, new ProColor(0, 0, 255, 255) }, // t = 1, should return end color
            new object[] { new ProColor(255, 0, 0, 255), new ProColor(0, 0, 255, 255), 0.5f, new ProColor(127, 0, 127, 255) }, // t = 0.5, should interpolate between colors
            new object[] { new ProColor(255, 0, 0, 128), new ProColor(0, 0, 255, 64), 0.5f, new ProColor(127, 0, 127, 95) }, // t = 0.5, with alpha interpolation
            new object[] { new ProColor(0, 64, 128, 0), new ProColor(254, 0, 203, 0), 0.3f, new ProColor(76, 44, 150, 0) },
            new object[] { new ProColor(255, 255, 255, 0), new ProColor(254, 0, 203, 0), 0.15f, new ProColor(254, 216, 247, 0) }
        ];
    }
}
