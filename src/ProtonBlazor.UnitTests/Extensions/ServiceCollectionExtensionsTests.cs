...
{
    [Test]
    public void AddProtonBlazorDialog_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection();

        // Act
        services.AddProtonBlazorDialog();
    ...
    [Test]
    public void AddProtonBlazorSnackBar_ShouldRegisterServices()
    {
        // Arrange
    ...
    [Test]
    public void AddProtonBlazorSnackBar_ShouldRegisterServices_WithConfigurationAction()
    {
        // Arrange
        using var testContext = new BunitContext();
        var services = new ServiceCollection()
        ...
        // Act
        services.AddProtonBlazorSnackbar(options =>
        {
    ...
    [Test]
    public void AddProtonBlazorResizeListener_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddLogging()
    ...
    [Test]
    public void AddProtonBlazorResizeListener_ShouldRegisterServices_WithOptionsAction()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddLogging()
        ...
        // Act
        services.AddProtonBlazorResizeListener(options =>
        {
    ...
    [Test]
    public void AddProtonBlazorResizeObserver_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddSingleton<IJSRuntime, MockJsRuntime>();
    ...
    [Test]
    public void AddProtonBlazorResizeObserver_ShouldRegisterServices_WithOptionsAction()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddSingleton<IJSRuntime, MockJsRuntime>();
        ...
        // Act
        services.AddProtonBlazorResizeObserver(options =>
        {
            options.EnableLogging = true;
    ...
    [Test]
    public void AddProtonBlazorResizeObserverFactory_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Test]
    public void AddProtonBlazorResizeObserverFactory_ShouldRegisterServices_WithOptionsAction()
    {
        // Arrange
        var services = new ServiceCollection();
        ResizeObserverOptions? expectedOptions = null;
        ...
        // Act
        services.AddProtonBlazorResizeObserverFactory(options =>
        {
            options.EnableLogging = true;
            options.ReportRate = 500;
            expectedOptions = options;
    ...
    [Test]
    public void AddProtonBlazorKeyInterceptor_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddLogging()
        ...
        // Act
        services.AddProtonBlazorKeyInterceptor();
        var serviceProvider = services.BuildServiceProvider();
    ...
    [Test]
    public void AddProtonBlazorJsEvent_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddSingleton<IJSRuntime, MockJsRuntime>();
        ...
        // Act
        services.AddProtonBlazorJsEvent();
        var serviceProvider = services.BuildServiceProvider();
    ...
    [Test]
    public void AddProtonBlazorScrollManager_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddSingleton<IJSRuntime, MockJsRuntime>();
        ...
        // Act
        services.AddProtonBlazorScrollManager();
        var serviceProvider = services.BuildServiceProvider();
    ...
    [Test]
    public void AddProtonBlazorScrollListener_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddSingleton<IJSRuntime, MockJsRuntime>();
        ...
        // Act
        services.AddProtonBlazorScrollListener();
        var serviceProvider = services.BuildServiceProvider();
    ...
    [Test]
    public void AddProtonBlazorScrollSpy_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddSingleton<IJSRuntime, MockJsRuntime>();
        ...
        // Act
        services.AddProtonBlazorScrollSpy();
        var serviceProvider = services.BuildServiceProvider();
    ...
    [Test]
    public void AddProtonBlazorJsApi_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddSingleton<IJSRuntime, MockJsRuntime>();
    ...
    [Test]
    public void AddProtonBlazorPointerEventsNoneService_ShouldRegisterServices()
    {
        // Arrange
        var services = new ServiceCollection()
            .AddLogging()
        ...
        // Act
        services.AddProtonBlazorPointerEventsNoneService();
        var serviceProvider = services.BuildServiceProvider();
    ...
    public void AddMudServices_ShouldRegisterAllServices_WithOptionsAction()
    {
        ...
        var services = new ServiceCollection()
            ...
            .AddSingleton<NavigationManager>(new BunitNavigationManager(testContext))
            .AddSingleton<IJSRuntime, MockJsRuntime>();
        ProServicesConfiguration? expectedOptions = null;
