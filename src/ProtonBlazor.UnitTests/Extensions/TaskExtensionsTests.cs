...
namespace ProtonBlazor.UnitTests.Extensions
{
    ...
    public class TaskExtensionsTests
    {
        ...
        public void SetUp()
        {
            _originalExceptionHandler = ProGlobal.UnhandledExceptionHandler;
        }

        [TearDown]
        public void TearDown()
        {
            ProGlobal.UnhandledExceptionHandler = _originalExceptionHandler;
        }
        ...
        public async Task Task_AndForget_ShouldForwardExceptionToGlobalHandler()
        {
            ...
            ProGlobal.UnhandledExceptionHandler = ex => errorMessage = ex.Message;
        ...
        {
            ProGlobal.UnhandledExceptionHandler = null;
            var task = AsyncTaskExceptionGenerator("Something bad is about to happen ...");
            task.CatchAndLog();
            var t = Stopwatch.StartNew();
