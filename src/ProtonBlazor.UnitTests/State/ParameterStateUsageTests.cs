...
public class ParameterStateUsageTests : BunitTest
{
    ...
    public void GetStateTestFailureIntegration()
    {
        ...
        Action argumentNullException1 = () => StateComponent().Instance.GetState((Func<ProComponentBase, int>)null!);
    ...
    public async Task Parent_TwoWayBinding()
    {
        ...
        var alertChild1TextFunc = () => comp.Find("#childAlert1 div.pro-alert-message");
        var alertChild2TextFunc = () => comp.Find("#childAlert2 div.pro-alert-message");
        var alertChild3TextFunc = () => comp.Find("#childAlert3 div.pro-alert-message");
        var alertChild4TextFunc = () => comp.Find("#childAlert4 div.pro-alert-message");
    ...
    public async Task ParameterStateDependencyParameter()
    {
        ...
        child2.Instance.ValueChanges[0].Value!.ToString(ProColorOutputFormats.Hex).Should().Be("#fcefe5");
        ...
        child2.Instance.ValueChanges[2].Value!.ToString(ProColorOutputFormats.Hex).Should().Be("#5fa9e2");

        // ButtonAllSame
        child2.Instance.TextChanges[4].Value!.Should().Be("#9b3f33");
        child2.Instance.ValueChanges[3].Value!.ToString(ProColorOutputFormats.Hex).Should().Be("#9b3f33");

        // ButtonAllDiff
        child2.Instance.TextChanges[5].Value!.Should().Be("#662f18");
        child2.Instance.TextChanges[6].Value!.Should().Be("#30102a");
        child2.Instance.ValueChanges[4].Value!.ToString(ProColorOutputFormats.Hex).Should().Be("#30102a");
