...
public class DefaultConverterTests
{
    ...
    [Test]
    public void DefaultConverter_IParsableFormattable_ProColor_Convert_UsesConfiguredFormat()
    {
        var culture = new CultureInfo("tr-TR");
        var conv = new DefaultConverter<ProColor>
        {
            Culture = () => culture,
            Format = () => "hex"
        };
        var value = new ProColor("#12ab34ff");
    ...
    [Test]
    public void DefaultConverter_IParsableFormattableNullable_ProColor_Convert_UsesConfiguredFormat()
    {
        ...
        var value = new ProColor("#12ab34cd");
    ...
    [Test]
    public void DefaultConverter_IParsableFormattable_ProColor_ConvertBack_ParsesConfiguredFormatOutput()
    {
        var conv = new DefaultConverter<ProColor>
        {
            Culture = () => new CultureInfo("fr-FR"),
