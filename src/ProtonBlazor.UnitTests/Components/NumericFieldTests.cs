...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class NumericFieldTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProNumericField<double>>();
        ...
        {
            var comp = Context.Render<ProNumericField<T?>>(parameters => parameters.Add(x => x.Value, value));
            // print the generated html
        ...
        public async Task WithNoDebounceIntervalValueShouldChangeImmediately()
        {
            ...
            var comp = Context.Render<ProNumericField<int?>>(parameters => parameters
        ...
        public async Task NumericFieldFluentValidationTest1()
        {
            var validator = new FluentValueValidator<string>(x => x.Cascade(CascadeMode.Stop)
                .NotEmpty()
                .Length(1, 100));
            var comp = Context.Render<ProNumericField<decimal>>(parameters => parameters
        ...
        {
            var comp = Context.Render<ProNumericField<decimal>>();
            var numericField = comp.Instance;
        ...
        //{
        //    var comp = ctx.RenderComponent<ProNumericField<int?>>(parameters => parameters.Add(p => p.Required, true));
        //    var numericField = comp.Instance;
        ...
        public void NumericField_ShouldNot_ShowRequiredErrorWhenInitialTextIsEmpty()
        {
            ...
            var numericField = comp.FindComponent<ProNumericField<int?>>().Instance;
        ...
        {
            Assert.DoesNotThrow(() => Context.Render<ProNumericField<T>>(), $"{typeof(ProNumericField<>)}<{typeof(T)}> render failed.");
        }
        ...
        {
            var comp = Context.Render<ProNumericField<double?>>(parameters => parameters
                .Add(x => x.Immediate, true)
        ...
        {
            var comp = Context.Render<ProNumericField<T>>();
            await comp.SetParametersAndRenderAsync(parameters => parameters
                .Add(x => x.Max, value)
                .Add(x => x.Min, value)
                .Add(x => x.Value, value));
        ...
        public async Task NumericField_SpinButtonsShouldFocusInput()
        {
            ...
            await comp.FindAll(".pro-input-numeric-spin .pro-button-root")[0].TriggerEventAsync("onpointerdown", new PointerEventArgs());
            await comp.FindAll(".pro-input-numeric-spin .pro-button-root")[1].TriggerEventAsync("onpointerdown", new PointerEventArgs());
        ...
        {
            var comp = Context.Render<ProNumericField<int?>>();
            await comp.SetParametersAndRenderAsync(parameters => parameters
                .Add(x => x.Min, min)
                .Add(x => x.Max, max)
                .Add(x => x.Value, value));
        ...
        public void DebouncedNumericField_Should_RenderDefaultValueTextOnFirstRender()
        {
            ...
            var textfield = comp.FindComponent<ProNumericField<int>>().Instance;
        ...
        public async Task DebouncedNumericFieldCultureChangeRerender()
        {
            ...
            var numericField = comp.FindComponent<ProNumericField<double>>().Instance;
        ...
        {
            var comp = Context.Render<ProNumericField<int>>(parameters
        ...
        {
            var comp = Context.Render<NumericFieldRenderTest>();
            var numericField = comp.FindComponent<ProNumericField<decimal>>();
...
#nullable enable
            ...
            bool withHelperText)
        {
            ...
            var comp = Context.Render<ProNumericField<string>>(parameters => parameters
