...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class ImageTests : BunitTest
    {
        ...
        public void Image_GeneralStructure()
        {
            ...
            var comp = Context.Render<ProImage>(p =>
            {
            ...
            img.ClassList.Should().BeEquivalentTo("my-custom-class", "pro-elevation-25", "object-bottom", "object-cover", "pro-image", "fluid");
        }
        ...
        public void Image_ObjectFitToClassMapping(ObjectFit fit, string expectedClass)
        {
            ...
            var img = comp.Find("img");
            img.ClassList.Should().Contain(new[] { "pro-image", $"object-{expectedClass}" });
        }
        ...
        public void Image_ObjectPositionToClassMapping(ObjectPosition position, string expectedClass)
        {
            ...
            var img = comp.Find("img");
            img.ClassList.Should().Contain(["pro-image", $"object-{expectedClass}"]);
        }
        ...
        public async Task SwitchesToFallbackSrcOnError()
        {
            ...
            var comp = Context.Render<ProImage>(parameters => parameters
