...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class DynamicTabsTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProDynamicTabs>();
...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            ((IHtmlDivElement)comp.Nodes[0]).ClassList.Should().BeEquivalentTo("pro-tabs", "pro-dynamic-tabs");
        }
        ...
        public void BasicParameters()
        {
            ...
            {
                item.ClassList.Should().StartWith(new string[] { "pro-button-root" });
        ...
        public async Task BasicParameters_WithToolTips()
        {
            ...
            foreach (var item in closeButtons)
            {
                item.ClassList.Should().StartWith(["pro-button-root"]);
                ...
                toolTip.ClassList.Should().Contain(["pro-tooltip"]);
