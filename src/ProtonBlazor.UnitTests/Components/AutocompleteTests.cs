...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class AutocompleteTests : BunitTest
    {
        ...
        public async Task Autocomplete_Should_Handle_Converter_WithStrict()
        {
            ...
            var autocompleteComponent = comp.FindComponent<ProAutocomplete<AutocompleteConverterStrictTest.ConverterElement>>();
            ...
            {
                var button = await autocompleteComponent.WaitForElementAsync(".pro-button-root.pro-no-activator");
                await autocompleteComponent.InvokeAsync(() => button.Click());
            };

            await ButtonClicker(); // open popover
            var pop = await comp.WaitForElementAsync("div.pro-popover"); // doesn't return until popover exists
            await comp.WaitForAssertionAsync(() => pop.ClassList.Should().Contain("pro-popover-open")); // wait for popover to open
            var items = comp.FindComponents<ProListItem<AutocompleteConverterStrictTest.ConverterElement>>();
            items.Count.Should().Be(10, "The popover should contain 10 items."); // default maxitems is 10
            await ButtonClicker(); // close popover
            await comp.WaitForAssertionAsync(() => pop.ClassList.Should().NotContain("pro-popover-open"));

            // set search
            await autocompleteComponent.Find("input").InputAsync("he");
            await comp.WaitForAssertionAsync(() => pop.ClassList.Should().Contain("pro-popover-open"));
            var filteredItems = comp.FindComponents<ProListItem<AutocompleteConverterStrictTest.ConverterElement>>();
        ...
        public async Task AutocompleteTest1()
        {
            ...
            var autocompleteComponent = comp.FindComponent<ProAutocomplete<string>>();
            ...
            var items = comp.FindComponents<ProListItem<string>>().ToArray();
            items.Length.Should().Be(1);
            items.First().Markup.Should().Contain("California");
            // click on California!
            await comp.Find("div.pro-list-item").ClickAsync();
            // check popover class
            comp.Find("div.pro-popover").ClassList.Should().Contain("autocomplete-popover-class");
            // check state
        ...
        public async Task Autocomplete_ModelessOverlay_IgnoresActivatorRootForAutoCloseHitTesting()
        {
            ...
            var overlay = comp.Find("div.pro-overlay");
            overlay.GetAttribute("data-modeless-ignore-element-id").Should().Be(comp.Find("div.pro-autocomplete").Id);
        }
        ...
        public async Task AutocompleteTest2()
        {
            ...
            // select elements needed for the test
            var select = comp.FindComponent<ProAutocomplete<string>>();

            // check initial state
            comp.Markup.Should().NotContain("pro-popover-open");

            // focus and check if it has toggled the menu
            await select.Find("div.pro-input-control").FocusAsync();
        ...
        public void AutocompleteTest3()
        {
            ...
            var autocomplete = comp.FindComponent<ProAutocomplete<AutocompleteTest3.State>>().Instance;
        ...
        public async Task AutocompleteCancelDispose()
        {
            ...
            var autocompleteComp = autocompleteContainerComp.FindComponent<ProAutocomplete<string>>();
        ...
        {
            var comp = Context.Render<AutocompleteTest1>();
            var label = comp.FindAll(".pro-input-label");
        ...
        public void AutocompleteTest4()
        {
            ...
            var autocomplete = comp.FindComponent<ProAutocomplete<AutocompleteTest4.State>>().Instance;
            autocomplete.ReadText.Should().Be("Assam");
        }
        ...
        {
            var comp = Context.Render<ProAutocomplete<CoerceValueElement>>(parameters =>
            {
        ...
        public async Task OnTextChanged_WithCoerceValueAndNotCoerceTextAndImmediateNotDebounce_SetValueAndOpenMenuImmediately()
        {
            ...
            var autocompletecomp = comp.FindComponent<ProAutocomplete<string>>();
        ...
        public async Task OnTextChanged_CoerceValueAndNotCoerceTextAndImmediateAndDebounce_SetValueImmediatelyButDelaysMenuOpening()
        {
            ...
            await autocompletecomp.WaitForAssertionAsync(() => comp.Markup.Should().Contain("pro-popover-open"));
        ...
        public async Task CoerceValueAndNotCoerceTextAndNotImmediate_ValueSetOnBlur()
        {
            ...
            var comp = Context.Render<ProAutocomplete<string>>(parameters =>
            {
                parameters.Add(a => a.CoerceValue, true);
                parameters.Add(a => a.CoerceText, false);
            ...
            var ccc = comp.FindComponent<ProInput<string>>();
        ...
        public async Task AutocompleteTextCoercionOnTabKey()
        {
            ...
            // now trigger the coercion by call ProInput.BlurAsync
        ...
        {
            var comp = Context.Render<ProAutocomplete<string>>((a) =>
            {
        ...
        public async Task Autocomplete_ReadOnly_Should_Not_Open()
        {
            ...
            await comp.FindAll(".pro-input-control")[0].MouseDownAsync(new MouseEventArgs());
        ...
        {
            var comp = Context.Render<ProAutocomplete<string>>(p => p
        ...
        public async Task AutocompleteReadOnlyShouldHaveMudReadonlyClass()
        {
            ...
            comp.Find(".pro-select-input").ClassList.Should().NotContain("pro-readonly");

            await comp.SetParametersAndRenderAsync(p => p.Add(x => x.ReadOnly, true));
            comp.Find(".pro-select-input").ClassList.Should().Contain("pro-readonly");
        }
        ...
        public async Task AutocompleteTest6()
        {
            ...
            await comp.Find("div.pro-input-control").FocusAsync();
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ClassList.Should().Contain("pro-popover-open"));

            var mudText = comp.FindAll("p.pro-typography");
            mudText[^1].InnerHtml.Should().Contain("Not all items are shown"); //ensure the text is shown

            comp.FindAll("div.pro-popover .pro-autocomplete-more-items").Count.Should().Be(1);
        }
        ...
        public async Task AutocompleteTest7()
        {
            ...
            comp.FindAll("div.pro-popover .pro-autocomplete-no-items").Count.Should().Be(1);
        }
        ...
        /// <summary>
        /// Based on this try https://try.protonblazor.com/snippet/GacPunvDUyjdUJAh
        /// and this issue https://github.com/ProtonBlazor/ProtonBlazor/issues/1235
        /// </summary>
        [Test]
        ...
        /// </summary>
        [Test(Description = "https://github.com/ProtonBlazor/ProtonBlazor/issues/12900")]
        ...
        /// <summary>
        /// Test for <seealso cref="https://github.com/ProtonBlazor/ProtonBlazor/issues/1415"/>
        /// </summary>
        [Test]
        ...
        public async Task AutoCompleteClearable()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll(".pro-input-clear-button").Should().BeEmpty());

            // Button shows after entering text
            await comp.Find("input").InputAsync("text");
            await comp.WaitForAssertionAsync(() => comp.Find(".pro-input-clear-button").Should().NotBeNull());
            // Text cleared and button removed after clicking clear button
            await comp.Find(".pro-input-clear-button").ClickAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll(".pro-input-clear-button").Should().BeEmpty());
        ...
        public async Task Autocomplete_Should_SetRequiredTrue()
        {
            ...
            var autocomplete = comp.FindComponent<ProAutocomplete<string>>().Instance;
        ...
        /// <summary>
        /// Test for <seealso cref="https://github.com/ProtonBlazor/ProtonBlazor/issues/1761"/>
        /// </summary>
        [Test]
        ...
        public async Task Autocomplete_CheckTextValueandOpenState_OnClear()
        {
            ...
            await comp.InvokeAsync(() => autocomplete.ClearAsync());
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ClassList.Should().NotContain("pro-popover-open"));
            autocomplete.ReadValue.Should().Be(null);
            autocomplete.ReadText.Should().Be("");
        }
        ...
        public async Task Autocomplete_CheckTextValueCleared_OnClear()
        {
            ...
            var listItemQuerySelector = "div.pro-list-item";

            var selectedItemIndexPropertyInfo = typeof(ProAutocomplete<string>).GetField("_selectedListItemIndex", BindingFlags.NonPublic | BindingFlags.Instance) ?? throw new ArgumentException("Cannot find field named '_selectedListItemIndex' on type 'ProAutocomplete<T>'");

            // create the component
            var component = Context.Render<AutocompleteDisabledItemsTest>();

            // get the elements needed for the test
            var autocompleteComponent = component.FindComponent<ProAutocomplete<string>>();
            ...
            await autocompleteComponent.Find("div.pro-input-control").FocusAsync();
            ...
            var matchingStates = component.FindComponents<ProListItem<string>>().ToArray();
        ...
        public async Task Autocomplete_Should_Not_Select_Disabled_Item()
        {
            ...
            var listItemQuerySelector = "div.pro-list-item";
            var selectedItemClassName = "pro-selected-item";
            ...
            matchingStates = component.FindComponents<ProListItem<string>>().ToArray();
        ...
        public async Task Autocomplete_Should_Support_Sync_Search()
        {
            ...
            var popoverProvider = root.FindComponent<ProPopoverProvider>();
            var autocomplete = root.FindComponent<ProAutocomplete<string>>();
            var popover = autocomplete.FindComponent<ProPopover>();

            popover.Instance.Open.Should().BeFalse("Should start as closed");

            await autocomplete.Find("div.pro-input-control").FocusAsync();
            ...
            await popoverProvider.WaitForAssertionAsync(() =>
            {
                ...
                popoverProvider
                    .FindComponents<ProListItem<string>>().Count
        ...
        public async Task Autocomplete_Should_FocusInputOnAdornmentClick()
        {
            ...
            var adornment = comp.Find(".pro-input-adornment-icon-button");
        ...
        public async Task Autocomplete_Should_ChangeAdornmentIcon()
        {
            ...
            var markupBefore = comp.Find("svg.pro-icon-root").Children.ToMarkup().Trim();
            ...
            var markupAfter = comp.Find("svg.pro-icon-root").Children.ToMarkup().Trim();
        ...
        public async Task Autocomplete_Should_NotIndicateLoadingByDefault()
        {
            ...
            // Test
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").ClassList.Should().NotContain("pro-autocomplete--with-progress"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").Children.ToMarkup().Should().NotContain("progress-indicator-circular"));
        }
        ...
        public async Task Autocomplete_Should_IndicateLoadingWithCircularProgressIndicator()
        {
            ...
            // Test show
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").ClassList.Should().Contain("pro-autocomplete--with-progress"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").Children.ToMarkup().Should().Contain("progress-indicator-circular"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ClassList.Should().Contain("pro-popover-open"));
        ...
        public async Task Autocomplete_Should_IndicateLoadingWithCircularProgressIndicatorAndAdornmentAdjustment()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").ClassList.Should().NotContain("pro-autocomplete--with-progress"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").Children.ToMarkup().Should().NotContain("progress-indicator-circular"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").Children.ToMarkup().Should().NotContain("progress-indicator-circular--with-adornment"));
        }
        ...
        public async Task Autocomplete_Should_IndicateLoadingWithCustomProgressIndicator()
        {
            ...
            // Test show
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").ClassList.Should().Contain("pro-autocomplete--with-progress"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").Children.ToMarkup().Should().Contain("Loading..."));

            // Test hide
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").ClassList.Should().NotContain("pro-autocomplete--with-progress"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").Children.ToMarkup().Should().NotContain("Loading..."));
        }
        ...
        public async Task Autocomplete_Should_IndicateLoadingWithProgressIndicatorInsidePopover()
        {
            ...
            // Test show
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").ClassList.Should().Contain("pro-autocomplete--with-progress"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ToMarkup().Should().Contain("Loading..."));

            // Test hide
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-autocomplete").ClassList.Should().NotContain("pro-autocomplete--with-progress"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ToMarkup().Should().NotContain("Loading..."));
        }
        ...
        public async Task Autocomplete_Should_Cancel_Search()
        {
            ...
            first.SetCanceled();
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ToMarkup().Should().NotContain("Foo"));

            second.SetResult(["Bar"]);
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ToMarkup().Should().Contain("Bar"));
        }
        ...
        public async Task Autocomplete_FullWidth()
        {
            ...
            autocompleteComp.Find("div.pro-select").ClassList.Should().Contain("pro-autocomplete");
            autocompleteComp.Find("div.pro-select").ClassList.Should().NotContain("pro-width-full");

            await autocompleteComp.SetParametersAndRenderAsync(parameters => parameters.Add(p => p.FullWidth, true));

            autocompleteComp.Find("div.pro-select").ClassList.Should().Contain("pro-autocomplete");
            autocompleteComp.Find("div.pro-select").ClassList.Should().Contain("pro-width-full");
        }
        ...
        public async Task AutocompleteStrictFalse(int index)
        {
            ...
            var autocompleteComponent = comp.FindComponents<ProAutocomplete<AutocompleteStrictFalseTest.State>>()[index];
            var autocomplete = autocompleteComponent.Instance;

            //search for and select California
            await autocompleteComponent.Find("input").InputAsync("Calif");
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-popover")[index].ClassList.Should().Contain("pro-popover-open"));
            await autocompleteComponent.Find("input").KeyUpAsync(new KeyboardEventArgs() { Key = "Enter" });
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-popover")[index].ClassList.Should().Contain("pro-popover-open"));
            var items = comp.FindComponents<ProListItem<AutocompleteStrictFalseTest.State>>().ToArray();
            ...
            await autocompleteComponent.Find("input").KeyUpAsync(new KeyboardEventArgs() { Key = "Escape" }); // Close autocomplete.
            ...
            await comp.InvokeAsync(autocompleteComponent.Instance.OpenMenuAsync); // reopen menu because Enter closes it.
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-popover")[index].ClassList.Should().Contain("pro-popover-open"));
            var items2 = comp.FindComponents<ProListItem<AutocompleteStrictFalseTest.State>>().ToArray();
        ...
        public async Task Autocomplete_Should_PreserveText_OnKeyRerender_WhenValueIsUnchanged()
        {
            ...
            var autocompleteComponent = comp.FindComponent<ProAutocomplete<AutocompleteKeyDownRerenderTextTest.User>>();
        ...
        /// <summary>
        /// Test case for <seealso cref="https://github.com/ProtonBlazor/ProtonBlazor/issues/6412"/>
        /// </summary>
        [Test]
        public async Task Autocomplete_Should_Highlight_Selected_Item_After_Disabled()
        {
            var disabledItemSelector = "pro-list-item-disabled";
            var selectedItemSelector = "pro-selected-item";
            var popoverSelector = "div.pro-popover";
            ...
            await comp.WaitForAssertionAsync(() => comp.Find(popoverSelector).ClassList.Should().Contain("pro-popover-open"));
            await autocompleteComponent.Find("input").KeyUpAsync(new KeyboardEventArgs() { Key = "Enter" });
            ...
            await comp.WaitForAssertionAsync(() => comp.Find(popoverSelector).ClassList.Should().Contain("pro-popover-open"));
            var listItems = comp.FindComponents<ProListItem<string>>().ToArray();
        ...
        /// <summary>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/6475
        /// </summary>
        [Test]
        public async Task Autocomplete_Reset_Value_ShouldBe_Empty()
        {
            ...
            // try clicking 'Test'
            await matchingStates.Single(s => s.Markup.Contains("Test")).Find("div.pro-list-item").ClickAsync();
            await component.WaitForAssertionAsync(() => autocompleteInstance.ReadText.Should().Be(string.Empty));
        }
        ...
        public async Task Autocomplete_Should_LoadListStartWhenSetAndThereAreItems()
        {
            ...
            comp.FindAll("div.pro-popover .pro-autocomplete-before-items").Count.Should().Be(1);
        }
        ...
        public async Task Autocomplete_Should_LoadListEndWhenSetAndThereAreItems()
        {
            ...
            comp.FindAll("div.pro-popover .pro-autocomplete-after-items").Count.Should().Be(1);
        }
        ...
        public async Task Autocomplete_Should_Not_LoadListStartWhenSet()
        {
            ...
            comp.Find("div.pro-popover").InnerHtml.Should().BeEmpty();
        }
        ...
        public async Task Autocomplete_Should_ApplyListItemClass()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-list-item").ClassList.Should().Contain(listItemClassTest));
        }
        ...
        public async Task Autocomplete_Should_OpenMenuOnFocus_AlwaysOnClick()
        {
            ...
            await comp.Find("div.pro-input-control").FocusAsync(); // Browser would focus first.
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ClassList.Should().NotContain("pro-popover-open"));

            await comp.Find("input.pro-input-root").MouseDownAsync(new MouseEventArgs());
        ...
        public async Task Autocomplete_ReturnedItemsCount_Should_Be_Accurate()
        {
            ...
            var comp = Context.Render<ProAutocomplete<string>>();
        ...
        {
            var comp = Context.Render<ProAutocomplete<string>>(parameters => parameters
        ...
        public async Task Autocomplete_User_ShouldNot_OpenMenu_InReadOnlyMode()
        {
            ...
            await comp.Find("div.pro-input-control").MouseDownAsync(new MouseEventArgs());
        ...
        {
            var comp = Context.Render<ProAutocomplete<int>>(parameters => parameters
        ...
        public void Should_render_aria_label_for_adornment_if_provided(Adornment adornment)
        {
            ...
            comp.Find(".pro-input-adornment-icon-button").Attributes.GetNamedItem("aria-label")!.Value.Should().Be(ariaLabel);
        }
...
#nullable disable
        ...
        public void Autocomplete_Attribute_Should_Exist()
        {
            ...
            comp.Find("input.pro-input-root").GetAttribute("autocomplete").Should().Be("off");
        }
        ...
        public void Should_Override_Autocomplete_Attribute_With_UserAttributes()
        {
            ...
            comp.Find("input.pro-input-root").GetAttribute("autocomplete").Should().Be("on");
        }

        /// <summary>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/9495
        ...
        public void Should_Render_Classes_Correctly()
        {
            ...
            // Assert
            comp.Find(".pro-select-input").ClassList.Should().Contain(inputClass);
        }
        ...
        public async Task Autocomplete_OpenTwiceInMenu()
        {
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Menu should be open");
                // comp.Find(".pro-overlay").Attributes["style"]?.Value.Should().Contain("1302", "Overlay should be present with 1302 as z-index");
            });
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                comp.FindAll("div.pro-popover-open").Count.Should().Be(2, "Both menu & autocomplete should be open");
                // comp.Find(".pro-overlay").Attributes["style"]?.Value.Should().Contain("z-index:1303");
            });

            // Click on the backdrop, closes the autocomplete
            await comp.Find(".pro-overlay").ClickAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Only menu should be open"));
            // comp.Find(".pro-overlay").Attributes["style"]?.Value.Should().Contain("z-index:1302");
            ...
            await comp.Find(".autocomplete input").FocusAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-popover-open").Count.Should().Be(2, "Both menu & autocomplete should be opened again"));
            // comp.Find(".pro-overlay").Attributes["style"]?.Value.Should().Contain("z-index:1303");
        }
        ...
        {
            var auto = Context.Render<ProAutocomplete<string>>();
        ...
        {
            var auto = Context.Render<ProAutocomplete<string>>(p =>
            {
