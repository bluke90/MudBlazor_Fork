...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class DrawerTest : BunitTest
    {
        ...
        public async Task TemporaryClosed_Open_CheckOpened_Close_CheckClosedAsync()
        {
            ...
            comp.FindAll("aside.pro-drawer--open.pro-drawer-temporary").Count.Should().Be(1);
            comp.FindAll(".pro-overlay-drawer").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-temporary").Count.Should().Be(1);
        ...
        public async Task Temporary_OverlayAutoClose(bool overlayAutoClose)
        {
            ...
            await comp.Find("div.pro-overlay").ClickAsync(new MouseEventArgs());

            if (overlayAutoClose)
            {
                // Drawer should close
                comp.FindAll("aside.pro-drawer--open.pro-drawer-temporary").Count.Should().Be(0);
                comp.FindAll("aside.pro-drawer--closed.pro-drawer-temporary").Count.Should().Be(1);
                comp.FindAll(".pro-overlay-drawer").Count.Should().Be(0);
                comp.Instance.Drawer.Open.Should().BeFalse();
            }
            else
            {
                ...
                comp.FindAll("aside.pro-drawer--open.pro-drawer-temporary").Count.Should().Be(1);
                comp.FindAll("aside.pro-drawer--closed.pro-drawer-temporary").Count.Should().Be(0);
                comp.FindAll(".pro-overlay-drawer").Count.Should().Be(1);
                comp.Instance.Drawer.Open.Should().BeTrue();
            }
        }
        ...
        public async Task TemporaryClosedWithoutOverlay_Open_CheckOverlayAsync()
        {
            ...
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside+pro-overlay-drawer").Count.Should().Be(0);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside+pro-overlay-drawer").Count.Should().Be(0);
            comp.Instance.Drawer.Open.Should().BeFalse();
        ...
        public async Task TemporaryClosedClipped_Open_CheckStateAsync()
        {
            ...
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer-clipped-always").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-temporary").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeFalse();
        ...
        public async Task PersistentClosed_Open_CheckOpened_Close_CheckClosedAsync()
        {
            ...
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--open.pro-drawer-persistent").Count.Should().Be(1);
            comp.FindAll("aside+pro-overlay-drawer").Count.Should().Be(0);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-persistent").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeFalse();
        }
        ...
        public async Task MiniClosed_Open_CheckOpened_Close_CheckClosedAsync()
        {
            ...
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--open.pro-drawer-mini").Count.Should().Be(1);
            comp.FindAll("aside+pro-overlay-drawer").Count.Should().Be(0);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-mini").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeFalse();
        }
        ...
        public async Task ResponsiveClosed_Open_CheckOpened_Close_CheckClosedAsync()
        {
            ...
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--open.pro-drawer-responsive").Count.Should().Be(1);
            comp.FindAll("aside+pro-overlay-drawer").Count.Should().Be(0);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-responsive").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeFalse();
        }
        ...
        public async Task ResponsiveSmallClosed_Open_CheckOpenedAndOverlayAsync(Breakpoint point)
        {
            ...
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--open.pro-drawer-responsive").Count.Should().Be(1);
            comp.FindAll(".pro-drawer-overlay").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-responsive").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeFalse();
        ...
        public async Task ResponsiveClosed_StartLargeScreen_SetBreakpoint_Open_CheckStateAsync(Breakpoint breakpoint)
        {
            ...
            var providerComp = Context.Render<ProPopoverProvider>();
            var comp = Context.Render<DrawerResponsiveTest>(parameters => parameters
                .Add(x => x.Breakpoint, breakpoint));

            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--open.pro-drawer-responsive").Count.Should().Be(1);
            comp.FindAll(".pro-drawer-overlay").Count.Should().Be(0);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-responsive").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeFalse();
        ...
        public async Task ResponsiveClosed_StartSmallScreen_SetBreakpoint_Open_CheckStateAsync(Breakpoint breakpoint)
        {
            ...
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--open.pro-drawer-responsive").Count.Should().Be(1);
            comp.FindAll(".pro-drawer-overlay").Count.Should().Be(breakpoint == Breakpoint.Xs ? 0 : 1);
            comp.Instance.Drawer.Open.Should().BeTrue();
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--closed.pro-drawer-responsive").Count.Should().Be(1);
            comp.Instance.Drawer.Open.Should().BeFalse();
        ...
        public async Task ResponsiveClosed_ResizeMultiple_CheckStates()
        {
            ...
            var comp = Context.Render<DrawerResponsiveTest>();
            var mudDrawerComponent = comp.FindComponent<ProDrawer>();
        ...
        public async Task DrawerContainer_RemoveDrawer_CheckStatesAsync()
        {
            ...
            comp.FindAll("div.pro-drawer-open-responsive-md-right").Count.Should().Be(1);

            // Remove drawer
            await comp.Find("#hide-drawer-button").ClickAsync();

            comp.FindAll("div.pro-drawer-open-responsive-md-right").Count.Should().Be(0);
        }
            ...
            )] bool initialState)
        {
            ...
            comp.FindAll("aside.pro-drawer--open.pro-drawer-temporary").Count.Should().Be(expectedDrawerCount);
            comp.FindAll(".pro-drawer-overlay").Count.Should().Be(expectedDrawerCount);
            ...
            comp.FindAll("aside.pro-drawer--open.pro-drawer-temporary").Count.Should().Be(expectedToggledDrawerCount);
            comp.FindAll(".pro-drawer-overlay").Count.Should().Be(expectedToggledDrawerCount);
            comp.Instance.Drawer.Open.Should().Be(!initialState);
        }
        ...
        public void DrawerPersistentTop_HeightTest()
        {
            ...
            var asideDrawer = comp.Find("aside.pro-drawer");
            var styles = asideDrawer.GetStyle().ToList();
            styles.Single(a => a.Name == "--pro-drawer-height").Value.Should().Be(drawerHeight);
        }

        /// <summary>
        /// Test for issue #3378: Verifies that the pro-drawer--initial class is removed after first interaction.
        ...
        public async Task DrawerInTabs_ShouldRemoveInitialClassAfterFirstInteractionAsync()
        {
            ...
            comp.FindAll("aside.pro-drawer--closed").Count.Should().Be(1);

            // Open the drawer
            await comp.Find("#toggle-drawer-button").ClickAsync();
            comp.FindAll("aside.pro-drawer--open").Count.Should().Be(1);
            ...
            comp.FindAll("aside.pro-drawer--initial").Count.Should().Be(0);
        }
    }
}
