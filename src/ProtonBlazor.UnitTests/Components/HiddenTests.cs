...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class HiddenTests : BunitTest
    {
        ...
        public void Content_Visible(bool mediaResult, bool invert, bool isHidden)
        {
            ...
            {
                comp.Find("p").TextContent.Should().Be("ProHidden content");
            }
        ...
        public async Task SizeChanged()
        {
            ...
            var mudHiddenComponent = component.FindComponent<ProHidden>();

            component.Find("p").TextContent.Should().Be("ProHidden content");
        ...
        public void WithinMudBreakpointProvider()
        {
            ...
            {
                var item = items[i];
                item.TextContent.Should().Be($"ProHidden content {i + 1}");
            }
        ...
        public async Task WithinMudBreakpointProvider_UpdateBreakpointValue()
        {
            ...
            var mudBreakpointProviderComponent = component.FindComponent<ProBreakpointProvider>();
