...
using ProtonBlazor.UnitTests.TestComponents.TimePicker;
...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class TimePickerTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProTimePicker>();
        ...
        public async Task Change_24hrsTo12Hours_CheckHours()
        {
            var comp = await OpenPicker();
            var picker = comp.Instance;
            var underlyingPicker = comp.FindComponent<ProTimePicker>();
            // count hours
            underlyingPicker.Instance.AmPm.Should().Be(false);
            comp.FindAll("div.pro-hour").Count.Should().Be(24);
            // change to 12 hour
            ...
            comp.FindAll("div.pro-hour").Count.Should().Be(12);
        }

        [Test]
        public void TimePicker_WithAmPmTrue_Displays12HourText()
        {
            var comp = Context.Render<ProTimePicker>(parameters => parameters
        ...
        public async Task OpenToHours_CheckMinutesHidden()
        {
            ...
            // Are hours displayed
            comp.FindAll("div.pro-time-picker-minute.pro-time-picker-dial-hidden").Count.Should().Be(1);
        }
        ...
        public async Task OpenToHours_ChangeTo_Minutes_ReOpen_CheckStillHours()
        {
            ...
            await comp.FindAll("button.pro-timepicker-button")[1].ClickAsync();
            // clicking outside to close
            await comp.Find("div.pro-overlay").ClickAsync();
            // should not be open
            comp.FindAll("div.pro-picker-open").Count.Should().Be(0);
        ...
        public async Task OpenToMinutes_CheckHoursHidden()
        {
            ...
            // Are Hours hidden
            comp.FindAll("div.pro-time-picker-hour.pro-time-picker-dial-hidden").Count.Should().Be(1);
        }
        ...
        public async Task TimePicker_KeyboardNavigation()
        {
            ...
            var comp = Context.Render<SimpleTimePickerTest>();
            var timePickerComponent = comp.FindComponent<ProTimePicker>();
        ...
        {
            var comp = Context.Render<ProTimePicker>(parameters
