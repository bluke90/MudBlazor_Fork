...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class HighlighterTests : BunitTest
    {
        ...
        /// </summary>
        [Test]
        public void ProHighlighterMarkupUsingHighlightedTextParameter()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, TEXT)
        ...
        /// </summary>
        [Test]
        public void ProHighlighterMarkupUsingHighlightedTextsParameterWithOneElement()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, TEXT)
        ...
        /// </summary>
        [Test]
        public void ProHighlighterMarkupUsingHighlightedTextsParameterWithMultipleElements()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, TEXT)
        ...
        /// </summary>
        [Test]
        public void ProHighlighterMarkupUsingHighlightedTextParameterAndHighlightedTextsParameterWithOneElement()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, TEXT)
        ...
        /// </summary>
        [Test]
        public void ProHighlighterMarkupUsingHighlightedTextParameterAndHighlightedTextsParameterWithMultipleElements()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, TEXT)
                .Add(x => x.HighlightedText, "This")
        ...
        /// </summary>
        [Test]
        public void ProHighlighter_Nulls()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, null)
        ...
        /// </summary>
        [Test]
        public void ProHighlighterMarkupWithRegexText()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, TEXT)
        ...
        /// </summary>
        [Test]
        public void ProHighlighterMarkupUntilNextBoundary()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(x => x.Text, TEXT)
        ...
        /// </summary>
        [Test]
        public async Task ProHighlighterMarkupCaseSensitive()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_HtmlInText_ShouldHighlightCorrectly()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_HtmlSensitiveCharInHighlightedText_ShouldEncodeAndHighlight()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_HtmlInText_ShouldNotHighlightInTags()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_HtmlTag_ShouldNotHighlight()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_TextWithHtmlEntities_HighlightedTextIsEntityText()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
                .Add(p => p.Text, "Hello &amp; World")
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_HighlightedTextWithSingleQuotes_ShouldHighlight()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_HighlightedTextWithDoubleQuotes_ShouldHighlight()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
                .Add(p => p.Text, "This is a 'quoted' text and a \"double quoted\" text.")
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_HighlightedTextAsAttributeValue_ShouldNotHighlightInAttribute()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
                .Add(p => p.Text, "<i>ProtonBlazor</i> is <span style='color:red'>important</span>")
                .Add(p => p.HighlightedText, "nothing")
                .Add(p => p.Markup, true)
            );

            comp.Markup.Should().Contain("<i>ProtonBlazor</i> is <span style='color:red'>important</span>");
        }

        [Test]
        public void ProHighlighter_MarkupTrue_FormattingPreservation_ItalicsAndColor()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
                .Add(p => p.Text, "<i>ProtonBlazor</i> is <span style='color:red'>important</span>")
                .Add(p => p.HighlightedText, "ProtonBlazor")
                .Add(p => p.Markup, true)
            );

            comp.Markup.Should().Contain("<i><mark>ProtonBlazor</mark></i> is <span style='color:red'>important</span>");
        }

        [Test]
        public void ProHighlighter_MarkupTrue_FormattingPreservation_Bold()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_NonStandardTag_NoHighlight()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_NonStandardTag_WithHighlightAfterTag()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
                .Add(p => p.Text, "Hello <ambitious> world")
                .Add(p => p.HighlightedText, "world")
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_NonStandardTag_WithHighlightInsideTag()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
                .Add(p => p.Text, "Hello <ambitious> world")
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_NoFragments_RendersTextAsMarkupString()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_WithClass_RendersMarkWithClass()
        {
            var comp = Context.Render<BasicHighlighterTest>(parameters => parameters
        ...
        [Test]
        public void ProHighlighter_MarkupTrue_WithStyleAndUserAttributes_RendersEncodedAttributes()
        {
            var comp = Context.Render<ProHighlighter>(parameters => parameters
                .Add(p => p.Text, "Hello world")
                .Add(p => p.HighlightedText, "Hello")
        ...
        [Test]
        public async Task ProHighlighter_MarkupFalse_AfterMarkupTrue_ClearsHtmlAwareFragmentsAndRendersCorrectly()
        {
