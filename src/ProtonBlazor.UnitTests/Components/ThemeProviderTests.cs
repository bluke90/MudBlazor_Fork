    ...
    public class ThemeProviderTests : BunitTest
    {
        ...
        public void DifferentCultures(string cultureString)
        {
            ...
            var expectedLines = new[] {
                ...
                "--pro-palette-primary: rgba(79,70,229,1);",
                "--pro-palette-primary-rgb: 79,70,229;",
                "--pro-palette-primary-text: rgba(255,255,255,1);",
                "--pro-palette-primary-darken: rgb(46,36,224);",
                "--pro-palette-primary-lighten: rgb(110,103,233);",
                "--pro-palette-primary-hover: rgba(79,70,229,0.058823529411764705);",
                "--pro-palette-secondary: rgba(14,165,233,1);",
                "--pro-palette-secondary-rgb: 14,165,233;",
                "--pro-palette-secondary-text: rgba(255,255,255,1);",
                "--pro-palette-secondary-darken: rgb(12,139,198);",
                "--pro-palette-secondary-lighten: rgb(43,179,243);",
                "--pro-palette-secondary-hover: rgba(14,165,233,0.058823529411764705);",
                "--pro-palette-tertiary: rgba(16,185,129,1);",
                "--pro-palette-tertiary-rgb: 16,185,129;",
                "--pro-palette-tertiary-text: rgba(255,255,255,1);",
                "--pro-palette-tertiary-darken: rgb(13,150,104);",
                "--pro-palette-tertiary-lighten: rgb(19,221,153);",
                "--pro-palette-tertiary-hover: rgba(16,185,129,0.058823529411764705);",
                ...
                "--pro-palette-appbar-background: rgba(79,70,229,1);",
                ...
                "--pro-typography-default-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                "--pro-typography-default-size: .875rem;",
                "--pro-typography-default-weight: 400;",
                "--pro-typography-default-lineheight: 1.5;",
                "--pro-typography-default-letterspacing: 0;",
                "--pro-typography-default-text-transform: none;",
                "--pro-typography-h1-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-h2-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-h3-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-h4-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-h5-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-h6-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-subtitle1-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-subtitle2-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-body1-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-body2-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-button-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                "--pro-typography-button-size: .875rem;",
                "--pro-typography-button-weight: 500;",
                "--pro-typography-button-lineheight: 1.75;",
                "--pro-typography-button-letterspacing: 0.025em;",
                "--pro-typography-button-text-transform: none;",
                "--pro-typography-caption-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
                ...
                "--pro-typography-overline-family: Inter, system-ui, -apple-system, BlinkMacSystemFont, sans-serif;",
        ...
        public void CustomThemeDefault()
        {
            ...
            defaultTheme.PaletteDark.Primary.Should().Be(new ProColor("#818CF8"));
            ...
            defaultTheme.PaletteLight.Primary.Should().Be(new ProColor("#4F46E5"));
