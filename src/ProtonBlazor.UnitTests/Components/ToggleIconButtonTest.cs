...
using ProtonBlazor.UnitTests.TestComponents.ToggleIconButton;
...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class ToggleIconButtonTest : BunitTest
    {
        ...
        public async Task ShouldToggleOnClickAsync()
        {
            ...
            var comp = Context.Render<ProToggleIconButton>(parameters => parameters
        ...
        public async Task ShouldSynchronizeStateWithOtherComponentAsync()
        {
            ...
            var group = comp.FindComponents<ProToggleIconButton>();
            var comp1 = group[0];
            var comp2 = group[1];
            // check initial state
