...
public class ScrollToTopTests : BunitTest
{
    ...
    public async Task Click_ScrollsToTopUsingListenerSelectorAndRaisesOnClick()
    {
        ...
        await component.Find("span.pro-scroll-to-top").ClickAsync();
    ...
    private IRenderedComponent<ProScrollToTop> RenderScrollToTop(
        TestScrollListenerFactory scrollListenerFactory,
        Action<ComponentParameterCollectionBuilder<ProScrollToTop>> configure = null,
        TestScrollManager scrollManager = null)
    {
        ...
        return Context.Render<ProScrollToTop>(parameters =>
        {
