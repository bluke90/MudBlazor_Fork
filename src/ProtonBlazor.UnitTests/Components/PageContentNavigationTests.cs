...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class PageContentNavigationTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProPageContentNavigation>();
        ...
        public async Task AddSection(bool withUpdate)
        {
            ...
            var section1 = new ProPageContentSection("my section", "my-id");
            var section2 = new ProPageContentSection("my section 2", "my-id-2");
        ...
        public async Task AddSection_WhichIsActiveByScrollSpy()
        {
            ...
            var section1 = new ProPageContentSection("my section", "my-id");
            var section2 = new ProPageContentSection("different section", "my-id-2");
            ...
            var linkText = navLinks[0].Find(".pro-nav-link-text");
        ...
        public async Task AddSection_ActivateDefault()
        {
            ...
            var comp = Context.Render<ProPageContentNavigation>(p => p.Add(x => x.ActivateFirstSectionAsDefault, true));
        ...
        public async Task NavigateBySections()
        {
            ...
            var section1 = new ProPageContentSection("my first section", "my-id1");
            var section2 = new ProPageContentSection("my second section", "my-id2");
            var section3 = new ProPageContentSection("my third section", "my-id3");
            ...
            {
                var navLinks = comp.FindComponents<ProNavLink>();
                await navLinks[i].Find(".pro-nav-link").ClickAsync();

                comp.Instance.ActiveSection.Should().Be(sections[i]);
                navLinks = comp.FindComponents<ProNavLink>();
        ...
        public async Task ObserverScrollAndHandlingEvent()
        {
            ...
            var comp = Context.Render<ProPageContentNavigation>(x => x.Add(y => y.SectionClassSelector, "my-section-class"));
        ...
        public async Task HideContentIfOnlyOneSectionIsAdded()
        {
            ...
            var section = new ProPageContentSection("my section", "my-id");
