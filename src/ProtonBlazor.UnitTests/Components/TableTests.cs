...
using ProtonBlazor.UnitTests.TestComponents.Table;
...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class TableTests : BunitTest
    {
        ...
        public async Task CustomTableClass()
        {
            ...
            var table = comp.FindComponent<ProTable<int>>();
            await table.SetParametersAndRenderAsync(parameters => parameters.Add(x => x.TableClass, "table-custom-class"));
            table.Markup.Should().Contain("class=\"pro-table-root table-custom-class\"");
        }
        ...
        public async Task TableDisabledSort()
        {
            ...
            // Access to the table
            var table = comp.FindComponent<ProTable<string>>();
...
#pragma warning restore BL0005
        ...
        public async Task TableSortLabelInitialSortDirection()
        {
            ...
            await comp.Find("span.pro-clickable.pro-table-sort-label").ClickAsync();
            comp.FindAll("td")[0].TextContent.Trim().Should().Be("C");
            comp.FindAll("td")[1].TextContent.Trim().Should().Be("B");
            comp.FindAll("td")[2].TextContent.Trim().Should().Be("A");
        ...
        public async Task TableLoadingProgressHasAriaLabel()
        {
            ...
            var progress = comp.Find(".pro-table-loading-progress");
        ...
        public async Task DynamicColumnsDoNotAffectLoadingRow()
        {
            ...
            var loaderCell = loaderRow.QuerySelector(".pro-table-loading");
            ...
            loaderCell = loaderRow.QuerySelector(".pro-table-loading");
            loaderCell.IsOnlyChild();
        }
        ...
        public async Task TableHeadContentBody()
        {
            ...
            comp.FindAll(".pro-skeleton").Count.Should().Be(0);
            ...
            comp.FindAll(".pro-skeleton").Count.Should().Be(20);
        }
        ...
        public async Task TableSingleSelection(TableEditTrigger trigger)
        {
            ...
            var table = comp.FindComponent<ProTable<int?>>().Instance;
        ...
        public async Task TableFilter()
        {
            ...
            // print the generated html
            var table = comp.FindComponent<ProTable<string>>().Instance;
            var searchString = comp.Find("#searchString");
        ...
        public async Task TablePagingNavigationButtons()
        {
            ...
            // print the generated html
            // after initial load
            comp.FindAll("tr.pro-table-row").Count.Should().Be(10);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-10 of 59");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(false);
            IReadOnlyList<IElement> PagingButtons() => comp.FindAll(".pro-table-pagination-actions button");
            // click next page
            await PagingButtons()[2].ClickAsync();
            comp.FindAll("tr.pro-table-row").Count.Should().Be(10);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("11-20 of 59");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(false);
            // last page
            await PagingButtons()[3].ClickAsync();
            comp.FindAll("tr.pro-table-row").Count.Should().Be(9);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("51-59 of 59");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(true);
            // previous page
            await PagingButtons()[1].ClickAsync();
            comp.FindAll("tr.pro-table-row").Count.Should().Be(10);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("41-50 of 59");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(false);
        ...
        public async Task TableNavigateToPage(int pageIndex, string expectedFirstItem)
        {
            ...
            comp.FindAll("tr.pro-table-row")[0].TextContent.Should().Be(expectedFirstItem);
        }
        ...
        public async Task TablePagingChangePageSize()
        {
            ...
            comp.FindAll("tr.pro-table-row").Count.Should().Be(20);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-20 of 59");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(false);
            ...
            comp.FindAll("tr.pro-table-row").Count.Should().Be(59);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-59 of 59");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(true);
        ...
        public async Task TablePagingAll()
        {
            ...
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-10 of 59"); //check initial value
            // change page size
            await table.InvokeAsync(() => table.Instance.SetRowsPerPage(int.MaxValue));
            pager.Value.Should().Be(int.MaxValue);
            comp.FindAll("tr.pro-table-row").Count.Should().Be(59);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-59 of 59");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(true); //buttons are disabled
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(true);
            pager.Value.Should().Be(int.MaxValue);
        ...
        public async Task TablePagingChangePageSizeAfterPaging()
        {
            ...
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-10 of 99");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(false);
            // last page
            await comp.FindAll("div.pro-table-pagination-actions button")[3].ClickAsync(); // last >
            ...
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("91-99 of 99");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(false);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(true);
            ...
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-99 of 99");
            comp.Find(".pro-table-pagination-first-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-before-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-next-button").IsDisabled().Should().Be(true);
            comp.Find(".pro-table-pagination-last-button").IsDisabled().Should().Be(true);
        ...
        public async Task TablePagingFilter()
        {
            ...
            await searchString.ChangeAsync("Ala");
            comp.FindAll("tr").Count.Should().Be(3);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-3 of 3");
            // clear search
            await searchString.ChangeAsync(string.Empty);
        ...
        public async Task TablePagingFilterAdjustCurrentPage()
        {
            ...
            await PagingButtons()[2].ClickAsync();
            comp.FindAll("tr.pro-table-row").Count.Should().Be(10);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("21-30 of 59");
            // should return 3 items and
            var table = comp.FindComponent<ProTable<string>>().Instance;
            var searchString = comp.Find("#searchString");
            await searchString.ChangeAsync("Ala");
            table.GetFilteredItemsCount().Should().Be(3);
            comp.FindAll("tr.pro-table-row").Count.Should().Be(3);
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-3 of 3");
            await searchString.ChangeAsync(string.Empty);
            table.GetFilteredItemsCount().Should().Be(59);
            comp.FindAll("tr.pro-table-row").Count.Should().Be(10);
        ...
        public async Task TableMultiSelectionSelectedItemsEqualsNull()
        {
            ...
            // print the generated html
            // select elements needed for the test
            var tableComponent = comp.FindComponent<ProTable<int>>();
            //var table = comp.FindComponent<ProTable<int>>().Instance;
        ...
        public async Task TableMultiSelection_CheckboxAndRowClick()
        {
            ...
            var checkboxes = comp.FindComponent<ProTable<int>>().FindAll("input").ToArray();
            var table = comp.FindComponent<ProTable<int>>().Instance;
        ...
        public async Task TableMultiSelection_IgnoreCheckbox_RowClick()
        {
            ...
            var rows = comp.FindComponent<ProTable<int>>().FindAll("tr").ToArray();
            var table = comp.FindComponent<ProTable<int>>().Instance;
        ...
        public void TableMultiSelection_MultiGrouping_DefaultCheckboxStates()
        {
            ...
            var mudTable = comp.Instance.ProTable;
        ...
        public async Task TableMultiSelectionTest2()
        {
            ...
            // select elements needed for the test
            var table = comp.FindComponent<ProTable<int>>().Instance;
            var text = comp.FindComponent<ProText>();
            var checkboxes = comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).ToArray();
        ...
        public async Task TableMultiSelectionTest3()
        {
            ...
            var table = comp.FindComponent<ProTable<int>>().Instance;
            var text = comp.FindComponent<ProText>();
            var checkboxRendered = comp.FindComponents<ProCheckBox<bool>>().ToArray();
        ...
        public async Task TableMultiSelectionTest5()
        {
            ...
            checkboxes = comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).ToArray();
            checkboxes.Sum(x => x.ReadValue ? 1 : 0).Should().Be(2);
        }
        ...
        public async Task TableMultiSelectionTest7()
        {
            ...
            var checkboxes = comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance);
            ...
            checkboxes = comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance);
        ...
        public async Task TableMultiSelectionTest9()
        {
            ...
            // select elements needed for the test
            var tableComponent = comp.FindComponent<ProTable<TableGroupingTest.RacingCar>>();
            var table = tableComponent.Instance;
            var rows = tableComponent.FindAll("tr").ToArray();
            var headerAndFooterCheckboxes = comp.FindComponents<ProCheckBox<bool?>>().Select(x => x.Instance).ToArray();
            var dataCheckboxes = comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).ToArray();
        ...
        public async Task TableMultiSelectionServerData()
        {
            ...
            // select elements needed for the test
            var table = comp.FindComponent<ProTable<TableMultiSelectionServerDataTest.ComplexObject>>().Instance;
            var checkboxes = comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).ToArray();
        ...
        public async Task TableMultiSelectionItemsTest1_PageChange()
        {
            ...
            // select elements needed for the test
            var table = comp.FindComponent<ProTable<TableMultiSelectionItemsTest1.ComplexObject>>().Instance;
            var checkboxes = comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).ToArray();
        ...
        public async Task TablePaginationTest1()
        {
            ...
            comp.FindAll("tr.pro-table-row").Count.Should().Be(11); // ten rows + header row
            comp.FindAll("div.pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-10 of 20");
        }

        /// <summary>
        /// Even without a ProTablePager the table should call ServerReload to get the items on start.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// The table should call ServerReload to get the items for the current page according to ProTablePager
        /// </summary>
        [Test]
        public async Task TableServerSideDataTest2()
        {
            ...
            comp.FindAll("td")[1].TextContent.Trim().Should().Be("2");
            comp.FindAll("td")[2].TextContent.Trim().Should().Be("3");
            await comp.FindAll("div.pro-table-pagination-actions button")[2].ClickAsync(); // next >
            ...
            await comp.FindAll("div.pro-table-pagination-actions button")[0].ClickAsync(); // |<
            comp.FindAll("td")[0].TextContent.Trim().Should().Be("1");
            comp.FindAll("td")[1].TextContent.Trim().Should().Be("2");
            comp.FindAll("td")[2].TextContent.Trim().Should().Be("3");
        }
        ...
        public async Task TableServerSideDataTest4()
        {
            ...
            await comp.FindAll("div.pro-select-input")[0].MouseDownAsync(new MouseEventArgs()); // mobile sort drop down
            await comp.FindAll("div.pro-list-item-clickable")[1].ClickAsync(); // sort b column
        ...
        public async Task TableServerSideDataTest5()
        {
            ...
            await comp.FindAll("div.pro-table-pagination-actions button")[1].ClickAsync(); // < previous
        ...
        public async Task TableServerSideDataTest6()
        {
            ...
            await comp.Find("span.pro-clickable.pro-table-sort-label").ClickAsync(); // sort
            comp.Find("#counter").TextContent.Should().Be("2");
        ...
        public async Task TableServerDataLoadingTestWithCancel()
        {
            ...
            // Get the ProTable<int> component
            var table = comp.FindComponent<ProTable<int>>();
        ...
        public async Task TableInlineEditSort()
        {
            ...
            // Access to the table
            var table = comp.FindComponent<ProTable<TableInlineEditSortTest.Element>>();
        ...
        {
            var comp = Context.Render<TableInlineEditCancelTest>();
            var tableComponent = comp.FindComponent<ProTable<TableInlineEditCancelTest.Element>>();
        ...
        public async Task TableGrouping()
        {
            ...
            tableComponent = comp.FindComponent<ProTable<TableGroupingTest.RacingCar>>();
            ...
            comp.Render();
            tr = comp.FindAll("tr.pro-table-row-group-indented-1").ToArray();
            tr.Length.Should().Be(27); // (4 LMP1 group (h / f) + 6 GTE + 4 GTE + 4 Formula 1) brands groups per category + 9 data rows
            tr = comp.FindAll("tr.pro-table-row-group-indented-2").ToArray();
        ...
        /// </summary>
        /// <remarks>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/10250
        /// </remarks>
        [Test]
        ...
        public async Task TablePagerInfoTextTest1()
        {
            ...
            tableComponent.Find("div.pro-table-page-number-information").Text().Should().Be("1-10 of 59", "No filter applied yet.");

            // get the instance
            var tableInstance = tableComponent.FindComponent<ProTable<string>>().Instance;
            ...
            tableComponent.Find("div.pro-table-page-number-information").Text().Should().Be("1-3 of 3", "'Ala' filter applied.");
            ...
            tableComponent.Find("div.pro-table-page-number-information").Text().Should().Be("0-0 of 0", "'ZZZ' filter applied.");
        }
        ...
        public void TablePagerInfoTextTest2(string infoFormat, string expectedInfoText)
        {
            ...
            // assert correct info-text
            tableComponent.Find("div.pro-table-page-number-information").Text().Should().Be(expectedInfoText);
        }
        ...
        public void TablePagerControlButtonAriaLabel(Page controlButton, string expectedButtonAriaLabel)
        {
            ...
            //get control button
            var buttons = tableComponent.FindAll("div.pro-table-pagination-actions button");
        ...
        public async Task RowsPerPageParameterTwoWayBinding()
        {
            ...
            var t = comp.Find("input.pro-select-input").GetAttribute("Value");
            int.Parse(t).Should().Be(rowsPerPage, "The component rendered correctly");
            //open the menu
            var menuItem = comp.Find("div.pro-input-control");
        ...
        public async Task TableRowClickNotEditable()
        {
            ...
            // Get table instance
            var tableInstance = comp.FindComponent<ProTable<string>>().Instance;
        ...
        public async Task AllowEditRowPreventsEdit(TableEditTrigger trigger)
        {
            ...
            // Get table instance
            var tableInstance = comp.FindComponent<ProTable<int>>().Instance;
        ...
        public async Task RowsPerPageChangeValueFromCode()
        {
            ...
            var table = testComponent.FindComponent<ProTable<string>>().Instance;
            var buttonComponent = testComponent.FindComponent<ProButton>();
        ...
        public async Task TableRecordEditingMultiSelect()
        {
            ...
            var table = comp.FindComponent<ProTable<TableRecordComparerTest.Element>>().Instance;
        ...
        public async Task TableComparerContext()
        {
            ...
            var table = comp.FindComponent<ProTable<TableComparerContextTest.Element>>().Instance;
        ...
        public async Task TestVirtualizedTableWithMultiSelection()
        {
            ...
            var table = comp.FindComponent<ProTable<TableMultiSelectionVirtualizedTest.TestItem>>();
            ...
            comp.FindAll(".pro-table-body .pro-table-row .pro-table-cell .pro-checkbox-input")[0].IsChecked().Should().Be(false);
            comp.FindAll(".pro-table-body .pro-table-row .pro-table-cell")[1].TextContent.Should().Be("Value_0");
            await comp.FindAll(".pro-table-body .pro-table-row .pro-table-cell .pro-checkbox-input")[0].ChangeAsync(true);
            comp.FindAll(".pro-table-body .pro-table-row .pro-table-cell .pro-checkbox-input")[0].IsChecked().Should().Be(true);

            // scroll down
            await virtualized.SetParametersAndRenderAsync(parameters => parameters.Add(
                v => v.Items,
                table.Instance.Items.ToList().GetRange(1000, 100)));
            comp.FindAll(".pro-table-body .pro-table-row .pro-table-cell")[1].TextContent.Should().Be("Value_1000");
            comp.FindAll(".pro-table-body .pro-table-row .pro-table-cell .pro-checkbox-input")[0].IsChecked().Should().Be(false);
        ...
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/11727
        /// </remarks>
        [Test]
        public void Table_WithCurrentPage_ShouldFirstRenderThisPage()
        {
            ...
            comp.Find(".pro-table-body .pro-table-row .pro-table-cell").TextContent.Should().Be("20");
        }
        ...
        {
            var comp = Context.Render<ProTableSortLabel<string>>(parameters => parameters
                .Add(p => p.SortDirection, direction)
            );

            var icon = comp.Find(".pro-table-sort-label-icon");

            icon.ClassList.Should().Contain("pro-table-sort-label-icon");
            icon.ClassList.Contains("pro-direction-asc").Should().Be(direction == SortDirection.Ascending);
            icon.ClassList.Contains("pro-direction-desc").Should().Be(direction == SortDirection.Descending);
        }
        ...
        public async Task ScrollToItemAsync_NonVirtualized_ItemExists_CallsScrollIntoView()
        {
            ...
            var comp = Context.Render<ProTable<TestItem>>(parameters => parameters
                .Add(p => p.Items, items)
                .Add(p => p.Virtualize, false) // Ensure non-virtualized
                .Add(p => p.RowTemplate, (context) => builder =>
                {
                    builder.OpenComponent<ProTd>(0);
        ...
        public async Task ScrollToItemAsync_Virtualized_ItemExists_CallsScrollToVirtualizedItem()
        {
            ...
            var comp = Context.Render<ProTable<TestItem>>(parameters => parameters
                ...
                {
                    builder.OpenComponent<ProTh>(0); builder.AddAttribute(1, "ChildContent", (RenderFragment)(b => b.AddContent(2, "Name"))); builder.CloseComponent();
                })
                .Add(p => p.RowTemplate, (context) => builder =>
                {
                    builder.OpenComponent<ProTd>(0);
        ...
        public async Task ScrollToItemAsync_ItemNotFound_NonVirtualized_DoesNotCallScrollManager()
        {
            ...
            var comp = Context.Render<ProTable<TestItem>>(parameters => parameters
                ...
                .Add(p => p.RowTemplate, (context) => builder =>
                {
                    builder.OpenComponent<ProTd>(0); builder.AddAttribute(1, "ChildContent", (RenderFragment)(b => b.AddContent(2, context.Name))); builder.CloseComponent();
                }));
            var tableInstance = comp.Instance;
        ...
        {
            var comp = Context.Render<ProTable<int>>(parameters => parameters
                .Add(p => p.Items, new[] { 1 })
            ...
            var row = comp.Find("tr.pro-table-row");

            row.ClassList.Should().Contain("pro-table-row-clickable");
        }
        [Test]
        public void RowDoesNotGetClickableClass_WhenOnRowClickNotProvided()
        {
            ...
            row.ClassList.Should().NotContain("pro-table-row-clickable");
        }
        ...
        public void RowDoesNotGetClickableClass_WhenDisabled()
        {
            ...
            row.ClassList.Should().NotContain("pro-table-row-clickable");
            row.ClassList.Should().Contain("pro-table-row-disabled");
        }
    }
}
