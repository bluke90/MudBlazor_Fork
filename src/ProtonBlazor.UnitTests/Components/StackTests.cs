...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class StackTests : BunitTest
    {
        ...
        {
            var stack = Context.Render<ProStack>();
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.Row, true));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.Reverse, true));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.Spacing, spacing));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.Breakpoint, breakpoint).Add(c => c.Row, row).Add(c => c.Reverse, reverse));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.Justify, justify));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.AlignItems, align));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.StretchItems, stretch));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.StretchItems, StretchItems.None));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.Wrap, wrap));
        ...
        {
            var stack = Context.Render<ProStack>(x => x.Add(c => c.HtmlTag, "ul"));
        ...
        {
            var divStack = Context.Render<ProStack>(parameters => parameters
        ...
        {
            var semanticStack = Context.Render<ProStack>(parameters => parameters
                .Add(c => c.HtmlTag, "ul"));
