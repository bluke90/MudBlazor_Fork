...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    {
        private IRenderedComponent<ProSnackbarProvider> _provider;
        ...
        public void SnackbarSetUp()
        {
            ...
            _provider = Context.Render<ProSnackbarProvider>();
            _provider.Find("#pro-snackbar-container").InnerHtml.Trimmed().Should().BeEmpty();
        }
        ...
        public async Task Simple()
        {
            ...
            _provider.Find("#pro-snackbar-container").InnerHtml.Trim().Should().NotBeEmpty();
            _provider.Find("div.pro-snackbar-content-message").TrimmedText().Should().Be("Boom, big reveal. Im a pickle!");
        }
        ...
        public async Task SimpleTestWithRenderFragment()
        {
            ...
            _provider.Find("#pro-snackbar-container").InnerHtml.Trim().Should().NotBeEmpty();
            _provider.Find("div.pro-snackbar-content-message").TrimmedText().Should().Be(testText);
        }
        ...
        public async Task SimpleTestWithHtmlInMessageMarkupString()
        {
            ...
            var messageText = _provider.Find("div.pro-snackbar-content-message").InnerHtml.Trim();
        ...
        public async Task TestWithHierarchicalRenderFragment()
        {
            ...
            await _provider.InvokeAsync(() => _service.Add(renderFragment));
            _provider.Find("#pro-snackbar-container").InnerHtml.Trim().Should().NotBeEmpty();
            _provider.Find("div.pro-snackbar-content-message").InnerHtml.Should().Be($"<ul><li>{testText}</li></ul>");
        }
        ...
        public async Task TestWithRenderFragmentLiteral()
        {
            ...
            await _provider.WaitForAssertionAsync(() =>
                _provider.Find("div.pro-snackbar-content-message").Should().NotBe(null)
            );
            _provider.Find("div.pro-snackbar-content-message").TrimmedText().Replace(" ", "").Should().Be("Here'saregularitem\nHere'sabolditem\nHere'sanitalicizeditem");
        }
        ...
        public async Task TestWithCustomComponent()
        {
            ...
            _provider.Find("div.pro-snackbar-content-message .pro-chip").Should().NotBe(null);
        }
        ...
        public async Task SnackbarIconConfiguration()
        {
            ...
            var svg = _provider.Find("#pro-snackbar-container .pro-snackbar").FirstElementChild.FirstElementChild;
            svg.ClassName.Should().Contain("pro-icon-size-large");
        ...
        {
            await _provider.InvokeAsync(() => _service.Add("Boom, big reveal. Im a pickle!"));
            _provider.Find("#pro-snackbar-container .pro-snackbar .pro-snackbar-icon").InnerHtml.Trim().Should().NotBeEmpty();
        }
        ...
        public async Task HideIcon()
        {
            ...
            var hasIcon = _provider.Find("#pro-snackbar-container .pro-snackbar").FirstElementChild.ClassName.Contains("pro-snackbar-icon");
        ...
        public async Task CustomIcon()
        {
            ...
            var svgClassNames = _provider.Find("#pro-snackbar-container .pro-snackbar").FirstElementChild.FirstElementChild.ClassName;
            svgClassNames.Should().Contain("pro-icon-size-large");
            svgClassNames.Should().Contain("pro-tertiary-text");
        }
        ...
        public async Task CustomIconDefaultValues()
        {
            ...
            var svgClassNames = _provider.Find("#pro-snackbar-container .pro-snackbar").FirstElementChild.FirstElementChild.ClassName;
            svgClassNames.Should().Contain("pro-icon-size-medium");

            // Ensure no color classes are present, like "pro-primary-text", "pro-error-text", etc.
            var classNames = svgClassNames.Split(' ', StringSplitOptions.RemoveEmptyEntries);
            foreach (var className in classNames)
            {
                Regex.IsMatch(className, "^pro-[a-z]+-text$", RegexOptions.IgnoreCase).Should().BeFalse();
            }
        }
        ...
        {
            // https://github.com/ProtonBlazor/ProtonBlazor/issues/5027.
            ...
            var snackbarClassList = _provider.Find(".pro-snackbar").ClassList;
            snackbarClassList.Should().Contain("pro-snackbar-blurred");
            snackbarClassList.Should().Contain("pro-alert-outlined-success");
        }
        ...
        public async Task ForceCloseSkipsTransition()
        {
            ...
            _provider.FindAll(".pro-snackbar").Count.Should().Be(1);

            await _provider.Find(".pro-snackbar-close-button").ClickAsync();

            // Test that the hide transition from clicking the close button will be forcibly ended, skipping the max value duration.
            primary.ForceClose();

            _provider.FindAll(".pro-snackbar").Count.Should().Be(0);
        }
        ...
        public async Task PauseTransitionsManually()
        {
            ...
            await _provider.WaitForAssertionAsync(() => _provider.FindAll(".pro-snackbar").Count.Should().Be(0));
        }
        ...
        public async Task OnClickClosesWithPointerOver()
        {
            ...
            _provider.Find(".pro-snackbar").TouchStart();
            await _provider.Find(".pro-snackbar").PointerEnterAsync(new PointerEventArgs());
            await _provider.Find(".pro-snackbar").ClickAsync();
        ...
        public async Task CloseButtonClosesWithPointerOver()
        {
            ...
            await _provider.Find(".pro-snackbar").PointerEnterAsync(new PointerEventArgs());
            await _provider.FindAll(".pro-snackbar-close-button").Single().ClickAsync();
        ...
        public async Task ActionButtonClosesWithPointerOver()
        {
            ...
            await _provider.Find(".pro-snackbar").PointerEnterAsync(new PointerEventArgs());
            await _provider.Find(".pro-snackbar-action-button").ClickAsync();
        ...
        public async Task StayVisibleWithPointer()
        {
            ...
            await _provider.Find(".pro-snackbar").PointerLeaveAsync(new PointerEventArgs());
            await AdvanceTimeAsync(primary.State.Options.HideTransitionDuration);
        ...
        public async Task StayVisibleWithTouch()
        {
            ...
            _provider.Find(".pro-snackbar").TouchEnd();
            await AdvanceTimeAsync(primary.State.Options.HideTransitionDuration);
        ...
        public async Task PointerOverDoesNotTriggerHideTransition()
        {
            ...
            primary.State.SnackbarState.Should().Be(SnackbarState.Showing);
            _provider.Find(".pro-snackbar").PointerEnter(new PointerEventArgs());
            primary.State.SnackbarState.Should().Be(SnackbarState.Visible);
            ...
            _provider.Find(".pro-snackbar").PointerLeave(new PointerEventArgs());
            await AdvanceTimeAsync(primary.State.Options.VisibleStateDuration / 2);
            primary.State.SnackbarState.Should().Be(SnackbarState.Visible);
            _provider.FindAll(".pro-snackbar").Count.Should().Be(1);
        ...
        public async Task SnackbarShouldNotRenderIconWhenGlobalHideIconIsTrue()
        {
            ...
            _provider.FindAll(".pro-snackbar-icon").Count.Should().Be(0);
        }
        ...
        public async Task SnackbarShouldRenderIconWhenPerSnackbarOverrideIsFalse()
        {
            ...
            _provider.FindAll(".pro-snackbar-icon").Count.Should().Be(1);
        }
