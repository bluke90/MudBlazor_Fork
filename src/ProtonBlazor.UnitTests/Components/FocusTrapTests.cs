...
public class FocusTrapTests : BunitTest
{
    ...
    {
        Context.Render<ProFocusTrap>(parameters => parameters.Add(x => x.DefaultFocus, DefaultFocus.Element));
    ...
    {
        Context.Render<ProFocusTrap>(parameters => parameters.Add(x => x.DefaultFocus, DefaultFocus.LastChild));
    ...
    {
        Context.Render<ProFocusTrap>(parameters => parameters.Add(x => x.DefaultFocus, DefaultFocus.None));
    ...
    {
        var comp = Context.Render<ProFocusTrap>(parameters => parameters.Add(x => x.DefaultFocus, DefaultFocus.None));
        var root = comp.Find("div.pro-focus-trap");
    ...
    {
        var comp = Context.Render<ProFocusTrap>(parameters => parameters.Add(x => x.Disabled, true));
        var trapChildren = comp.Find("div.pro-focus-trap").Children;
        ...
        trapChildren = comp.Find("div.pro-focus-trap").Children;
