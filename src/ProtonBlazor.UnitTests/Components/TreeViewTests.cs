...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class TreeViewTests : BunitTest
    {
        ...
        public async Task TreeView_ClickWhileDisabled_DoesNotChangeSelection()
        {
            ...
            await comp.Find("div.pro-treeview-item-content").ClickAsync();
            var GetSelectedValue = () => comp.Find("p.selected-value").TrimmedText();
            GetSelectedValue().Should().BeNullOrWhiteSpace();

            await comp.Find("div.pro-treeview-item-content").DoubleClickAsync();
            GetSelectedValue().Should().BeNullOrWhiteSpace();
        }
        ...
        public async Task TreeView_MultiSelectionClickCheckboxWhenDisabled_DoesNotChangeSelection()
        {
            ...
            await comp.Find("div.pro-treeview-item-checkbox").ClickAsync();
            var GetSelectedValue = () => comp.Find("ul.selected-values").ChildElementCount;
            GetSelectedValue().Should().Be(0);

            await comp.Find("div.pro-treeview-item-checkbox").DoubleClickAsync();
            GetSelectedValue().Should().Be(0);
        }
        ...
        public void TreeViewWithSingleSelection_Should_RespectInitialSelectedValue(string value)
        {
            ...
            comp.Find("div.pro-treeview-item-selected").QuerySelector(".pro-treeview-item-label").TrimmedText().Should().Be(value);
        }
        ...
        public async Task TreeViewWith_SingleSelection_TwoWayBinding()
        {
            ...
            comp.Find(".tree1 .item-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree1 .item-1-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree1 .item-1-2 .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1-2 .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");

            // select another value on tree1 and check selection has changed on both trees
            await comp.Find(".tree1 .item-1 .pro-treeview-item-content").ClickAsync();
            comp.Find("p.selected-value").TrimmedText().Should().Be("item1");
            comp.Find(".tree1 .item-1 .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1 .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            comp.Find(".tree1 .item-1-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree1 .item-1-2 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1-2 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");

            // select another value on tree2 and check selection has changed on both trees
            await comp.Find(".tree1 .item-1-1 .pro-treeview-item-content").ClickAsync();
            comp.Find("p.selected-value").TrimmedText().Should().Be("item1.1");
            comp.Find(".tree1 .item-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree1 .item-1-1 .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1-1 .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            comp.Find(".tree1 .item-1-2 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1-2 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            ...
            await comp.Find(".tree2 .item-1-1 .pro-treeview-item-content").ClickAsync();
            comp.Find("p.selected-value").TrimmedText().Should().Be("item1.1");
            comp.Find(".tree1 .item-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree2 .item-1 .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".tree1 .item-1-1 .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
        ...
        public async Task TreeViewWith_MultiSelection_TwoWayBinding()
        {
            ...
            // check initial selection
            comp.Find(".tree1 .item-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-null");
            comp.Find(".tree2 .item-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-null");
            ...
            foreach (var item in comp.FindComponents<ProTreeViewItem<string>>().Where(x => x.Instance.Value == "item1"))
            {
                item.Instance.GetState<bool>(nameof(ProTreeViewItem<string>.Selected)).Should().Be(true);
            }
            comp.Find(".tree1 .item-1-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
            comp.Find(".tree2 .item-1-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
            comp.Find(".tree1 .item-1-2 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            comp.Find(".tree2 .item-1-2 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            comp.Find("p.selected-values").TrimmedText().Should().Be("item1, item1.2");

            // select another value on tree1 and check selection has changed on both trees
            await comp.Find(".tree1 .item-1-1 .pro-treeview-item-content").ClickAsync();
            comp.Find(".tree1 .item-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            comp.Find(".tree2 .item-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            comp.Find(".tree1 .item-1-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            comp.Find(".tree2 .item-1-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            comp.Find(".tree1 .item-1-2 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            comp.Find(".tree2 .item-1-2 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-true");
            ...
            await comp.Find(".tree2 .item-1 .pro-treeview-item-content").ClickAsync();
            comp.Find(".tree1 .item-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
            comp.Find(".tree2 .item-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
            comp.Find(".tree1 .item-1-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
            comp.Find(".tree2 .item-1-1 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
            comp.Find(".tree1 .item-1-2 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
            comp.Find(".tree2 .item-1-2 .pro-checkbox span").ClassList.Should().Contain("pro-checkbox-false");
        ...
        public async Task Collapsed_ClickOnArrowButton_CheckClose()
        {
            ...
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(10);
            await comp.Find("button.pro-treeview-item-expand-button").ClickAsync();
            comp.FindAll("li.pro-treeview-item .pro-collapse-container.pro-collapse-entering").Count.Should().Be(1);
            await comp.Find("button.pro-treeview-item-expand-button").ClickAsync();
            comp.FindAll("li.pro-treeview-item .pro-collapse-container.pro-collapse-entering").Count.Should().Be(0);
            await comp.Find("div.pro-treeview-item-content").ClickAsync();
            comp.FindAll("li.pro-treeview-item .pro-collapse-container.pro-collapse-entering").Count.Should().Be(0);
        }
        ...
        public async Task DoubleClickOnArrowButton_ShouldNotSelectItem()
        {
            ...
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(10);
            await comp.Find("button.pro-treeview-item-expand-button").ClickAsync();
            comp.FindAll("input.pro-checkbox-input").Count.Should().Be(10);
            ...
            await comp.Find("button.pro-treeview-item-expand-button").DoubleClickAsync();
            comp.Instance.SubItemSelected.Should().BeFalse();
            comp.Instance.Item1Selected.Should().BeFalse();
            await comp.Find("input.pro-checkbox-input").ChangeAsync(true);
        ...
        public async Task Unselected_Select_CheckSelected_Deselect_CheckDeselected()
        {
            ...
            comp.Instance.SubItemSelected.Should().BeTrue();
            comp.Instance.Item1Selected.Should().BeTrue();
            await comp.FindAll("input.pro-checkbox-input")[2].ChangeAsync(false);
            comp.Instance.SubItemSelected.Should().BeFalse();
        ...
        {
            var comp = Context.Render<TreeViewTest1>(self => self.Add(x => x.SelectionMode, SelectionMode.MultiSelection));
            comp.FindAll(".pro-checkbox-true").Count.Should().Be(0);
            await comp.Find("div.pro-treeview-item-content").ClickAsync();
            comp.Instance.Item1Selected.Should().BeTrue();
            comp.Instance.Item2Selected.Should().BeFalse();
            comp.FindAll(".pro-checkbox-true").Count.Should().Be(4); // item1 + entire sub-tree checked
            await comp.FindAll("div.pro-treeview-item-content")[4].ClickAsync();
            comp.Instance.Item1Selected.Should().BeTrue();
            comp.Instance.Item2Selected.Should().BeTrue();
            comp.FindAll(".pro-checkbox-true").Count.Should().Be(10);  // + item2 + entire sub-tree checked
        }
        ...
        public async Task TreeView_WillUnselectItems_WhenNotMultiSelect()
        {
            ...
            comp.FindAll("div.pro-treeview-item-content.pro-treeview-item-selected").Count.Should().Be(0);
            await comp.Find("div.pro-treeview-item-content").ClickAsync();
            comp.Instance.Item1Selected.Should().BeTrue();
            comp.Instance.Item2Selected.Should().BeFalse();
            comp.FindAll("div.pro-treeview-item-content.pro-treeview-item-selected").Count.Should().Be(1);
            await comp.FindAll("div.pro-treeview-item-content")[4].ClickAsync();
            comp.Instance.Item1Selected.Should().BeFalse();
            comp.Instance.Item2Selected.Should().BeTrue();
            comp.FindAll("div.pro-treeview-item-content.pro-treeview-item-selected").Count.Should().Be(1);
        ...
        public void RenderWithTemplate_CheckResult()
        {
            ...
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(8);
        }
        ...
        public async Task TreeViewServer()
        {
            ...
            string.Join('|', comp.FindAll("div.pro-treeview-item-content").Select(x => x.TextContent)).Should()
                .Be("All Mail|Categories|Social|Updates|Trash");
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(5);
            await comp.FindAll("div.pro-treeview-item-content")[4].ClickAsync();
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(5); // <-- nothing loaded as it's not expandable
            await comp.FindAll("div.pro-treeview-item-content")[0].ClickAsync();
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(6); // <- loaded one more from server
            await comp.FindAll("div.pro-treeview-item-content")[3].ClickAsync();
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(7); // <- loaded another one from server
            // now loading a child of a server loaded item
            await comp.FindAll("div.pro-treeview-item-content")[1].ClickAsync();
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(8); // <- loaded another one from server
            string.Join('|', comp.FindAll("div.pro-treeview-item-content").Select(x => x.TextContent)).Should()
...
#nullable enable
        ...
        {
            var comp = Context.Render<TreeViewServerTest>();
            var target = comp.FindComponents<ProTreeViewItem<string?>>()
...
#nullable disable
        ...
        public async Task TreeViewItem_ShouldBeAbleTo_ReloadInCollapsedState()
        {
            ...
            var treeviewItem = comp.FindComponents<ProTreeViewItem<string>>().FirstOrDefault();
            treeviewItem!.Instance.GetState<bool>(nameof(ProTreeViewItem<string>.Expanded)).Should().Be(false);
            comp.FindAll("div.pro-treeview-item-arrow button").Count.Should().Be(2);
            // expand first tree
            await comp.Find("div.pro-treeview-item-arrow button").ClickAsync();
            comp.FindAll("div.pro-treeview-item-arrow button").Count.Should().Be(3);
        ...
        public async Task TreeViewItem_DoubleClick_CheckExpanded()
        {
            ...
            var item = comp.FindComponent<ProTreeViewItem<string>>();
        ...
        public async Task TreeViewItem_DoubleClick_CheckSelected()
        {
            ...
            var tree = comp.FindComponent<ProTreeView<string>>();
        ...
        public async Task TreeViewItem_ProgrammaticallySelect()
        {
            ...
            var treeView = comp.FindComponent<ProTreeView<string>>();
        ...
        public async Task TreeViewItem_BodyContent()
        {
            ...
            var treeView = comp.FindComponent<ProTreeView<string>>();
            var treeViewItem = comp.FindComponents<ProTreeViewItem<string>>()[2];

            comp.FindAll("ul.pro-treeview").Count.Should().Be(5);
            comp.FindAll("li.pro-treeview-item").Count.Should().Be(4);
            comp.FindAll("div.pro-treeview-item-content").Count.Should().Be(4);
            comp.FindAll("div.pro-treeview-item-arrow").Count.Should().Be(4);
            comp.FindAll("div.pro-treeview-item-icon").Count.Should().Be(4);
            comp.FindAll("div.pro-treeview-item-bodycontent").Count.Should().Be(4);
            comp.FindAll("button.pro-treeview-item-arrow-expand").Count.Should().Be(4);
            comp.FindAll("p.pro-typography")[0].InnerHtml.MarkupMatches("This is item one");
            comp.FindAll("p.pro-typography")[1].InnerHtml.MarkupMatches("This is item two");
            comp.FindAll("p.pro-typography")[2].InnerHtml.MarkupMatches("This is item three");
            comp.FindAll("p.pro-typography")[3].InnerHtml.MarkupMatches("This is item six");
            ...
            comp.FindAll("p.pro-typography")[1].InnerHtml.MarkupMatches("This is item 2");

            // Test reloading the treeview item.
            await comp.FindAll("button.pro-treeview-item-arrow-expand")[2].ClickAsync();
            comp.FindAll("p.pro-typography")[3].InnerHtml.MarkupMatches("This is item four");
            comp.FindAll("p.pro-typography")[4].InnerHtml.MarkupMatches("This is item five");

            comp.Instance.SimulateUpdate3 = true;
            await treeViewItem.InvokeAsync(treeViewItem.Instance.ReloadAsync);
            comp.FindAll("p.pro-typography")[3].InnerHtml.MarkupMatches("This is item 4");
            comp.FindAll("p.pro-typography")[4].InnerHtml.MarkupMatches("This is item 5");
        }
        ...
        public async Task TreeViewItem_TwoWayBinding()
        {
            ...
            // check initial selection
            comp.Find(".item-config .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-launch .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            comp.Find(".item-tasks .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-images .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-logo .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            // expanded
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "config").Expanded.Should().Be(false);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "images").Expanded.Should().Be(false);
            // selected
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "launch.json").Selected.Should().Be(true);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "tasks.json").Selected.Should().Be(false);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "logo.png").Selected.Should().Be(false);
            // switches
            comp.FindComponents<ProSwitch<bool>>().Select(x => x.Instance).First(x => x.Class == "switch-config").ReadValue.Should().Be(false);
            comp.FindComponents<ProSwitch<bool>>().Select(x => x.Instance).First(x => x.Class == "switch-images").ReadValue.Should().Be(false);
            // checkboxes
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-launch").ReadValue.Should().Be(true);
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-tasks").ReadValue.Should().Be(false);
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-logo").ReadValue.Should().Be(false);

            // select logo.png via tree item
            await comp.Find(".item-logo .pro-treeview-item-content").ClickAsync();
            // selection visualization
            comp.Find(".item-config .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-launch .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-tasks .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-images .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-logo .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            // expanded
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "config").Expanded.Should().Be(false);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "images").Expanded.Should().Be(false);
            // selected
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "launch.json").Selected.Should().Be(false);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "tasks.json").Selected.Should().Be(false);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "logo.png").Selected.Should().Be(true);
            // switches
            comp.FindComponents<ProSwitch<bool>>().Select(x => x.Instance).First(x => x.Class == "switch-config").ReadValue.Should().Be(false);
            comp.FindComponents<ProSwitch<bool>>().Select(x => x.Instance).First(x => x.Class == "switch-images").ReadValue.Should().Be(false);
            // checkboxes
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-launch").ReadValue.Should().Be(false);
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-tasks").ReadValue.Should().Be(false);
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-logo").ReadValue.Should().Be(true);

            // expand config via tree item
            await comp.Find(".item-config .pro-treeview-item-arrow button").ClickAsync();
            // selection visualization
            comp.Find(".item-config .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-launch .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            comp.Find(".item-tasks .pro-treeview-item-content").ClassList.Should().NotContain("pro-treeview-item-selected");
            ...
            comp.Find(".item-logo .pro-treeview-item-content").ClassList.Should().Contain("pro-treeview-item-selected");
            // expanded
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "config").Expanded.Should().Be(true);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "images").Expanded.Should().Be(false);
            // selected
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "launch.json").Selected.Should().Be(false);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "tasks.json").Selected.Should().Be(false);
            comp.FindComponents<ProTreeViewItem<string>>().Select(x => x.Instance).First(x => x.Text == "logo.png").Selected.Should().Be(true);
            // switches
            comp.FindComponents<ProSwitch<bool>>().Select(x => x.Instance).First(x => x.Class == "switch-config").ReadValue.Should().Be(true);
            comp.FindComponents<ProSwitch<bool>>().Select(x => x.Instance).First(x => x.Class == "switch-images").ReadValue.Should().Be(false);
            // checkboxes
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-launch").ReadValue.Should().Be(false);
            comp.FindComponents<ProCheckBox<bool>>().Select(x => x.Instance).First(x => x.Class == "checkbox-tasks").ReadValue.Should().Be(false);
        ...
        public async Task TreeViewAutoExpansion()
        {
            ...
            var isExpanded = (string value) => comp.FindComponents<ProTreeViewItem<string>>()
                .FirstOrDefault(x => x.Instance.Value == value)?.Instance.GetState<bool>(nameof(ProTreeViewItem<string>.Expanded));
            var select = (string value) => comp.FindComponents<ProChip<string>>().FirstOrDefault(x => x.Instance.Text == value)?.Find("button.pro-chip").ClickAsync();
...
#nullable enable
            ProTreeView<string>? nullInstanceTree = null;
            ProTreeViewItem<string>? nullInstanceItem = null;
#nullable disable

            exception.Message.Should().Be($"'{nameof(ProTreeView<string>)}.{nameof(nullInstanceTree.ServerData)}' requires '{nameof(nullInstanceTree.ItemTemplate)}.{nameof(ProTreeViewItem<string>)}.{nameof(nullInstanceItem.Value)}' to be supplied.");
        }
        ...
        public async Task TreeView_ClickItemWhileActive_DoesChangeSelection()
        {
            ...
            var parentItemButton = comp.Find(".parent-item button.pro-treeview-item-expand-button");
            var parentItemContent = comp.Find(".parent-item > div.pro-treeview-item-content");

            var GetSelectedValue = () => comp.Find("p.selected-value").TrimmedText();
            var GetItemExpandedValue = () => comp
                .FindComponent<ProTreeViewItem<string>>()
                .Instance
                .GetState<bool>(nameof(ProTreeViewItem<string>.Expanded));
        ...
        public async Task TreeView_ClickHeterogeneousTreeElement_ShouldNotThrow()
        {
            ...
            var l2 = comp.Find(".L2 > div.pro-treeview-item-content");
            var act = () => l2.ClickAsync();
            await act.Should().NotThrowAsync();
        }

        [Test(Description = "https://github.com/ProtonBlazor/ProtonBlazor/issues/12833")]
        ...
        [Test(Description = "https://github.com/ProtonBlazor/ProtonBlazor/issues/12849")]
        public async Task TreeView_ServerData_Reset()
        {
            var comp = Context.Render<TreeViewServerDataResetTest>();
            var arrows = () => comp.FindAll("button.pro-treeview-item-expand-button");
            var itemContents = () => comp.FindAll("div.pro-treeview-item-content").Select(x => x.TextContent);
