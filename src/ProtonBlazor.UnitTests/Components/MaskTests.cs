...
using ProtonBlazor.UnitTests.TestComponents.Mask;
...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class MaskTests : BunitTest
    {
        ...
        public async Task TextFieldWithMask_SetValueParameterUpdateText(string testName, IMask mask, string initialValue, string setValue)
        {
            ...
            var maskField = comp.FindComponent<ProMask>().Instance;
        ...
        public async Task Mask_Fundamentals1()
        {
            ...
            var comp = Context.Render<ProMask>();
        ...
        public async Task Mask_Int()
        {
            ...
            var maskField = comp.FindComponent<ProMask>();
        ...
        public async Task Mask_TwoWayBinding()
        {
            ...
            var maskField1 = comp.FindComponents<ProMask>().First();
            var maskField2 = comp.FindComponents<ProMask>().Last();
        ...
        {
            var keyInterceptorService = Context.AddKeyInterceptorService();
            var comp = Context.Render<ProTextField<TimeSpan?>>();
        ...
        public async Task Mask_MultipleTFsLinkedViaTwoWayBinding()
        {
            ...
            var tfs = comp.FindComponents<ProTextField<string>>().Select(x => x.Instance).ToArray();
            var masks = comp.FindComponents<ProMask>().Select(x => x.Instance).ToArray();
        ...
        public async Task FormReset_Should_ClearMaskedField()
        {
            ...
            var mask = comp.FindComponent<ProMask>().Instance;
        ...
        public void DifferentMaskImplementationTests()
        {
            ...
            var masks = comp.FindComponents<ProMask>();
        ...
        {
            var comp = Context.Render<ProMask>(parameters => parameters
