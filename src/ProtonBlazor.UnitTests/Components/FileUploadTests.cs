...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class FileUploadTests : BunitTest
    {
        ...
        public void InvalidTLogWarning()
        {
            ...
            var comp = Context.Render<ProFileUpload<ProTextField<string>>>();
        ...
        {
            var comp = Context.Render<ProFileUpload<IBrowserFile>>(parameters => parameters
                .Add(x => x.Class, "outer-test")
                .Add(x => x.InputClass, "inner-test"));

            comp.Find(".pro-input-control.pro-file-upload.outer-test"); //find outer div
        ...
        {
            var comp = Context.Render<ProFileUpload<IReadOnlyList<IBrowserFile>>>();
        ...
        {
            var comp = Context.Render<ProFileUpload<IReadOnlyList<IBrowserFile>>>(parameters =>
        ...
        public async Task FileUpload_Validation()
        {
            ...
            var single = comp.FindComponent<ProFileUpload<IBrowserFile>>();
            ...
            var multiple = comp.FindComponent<ProFileUpload<IReadOnlyList<IBrowserFile>>>();
        ...
        public async Task FileUploadDisabled()
        {
            ...
            comp.FindComponent<ProFileUpload<IBrowserFile>>().Find("input").HasAttribute("disabled").Should().BeFalse();
            comp.FindComponent<ProFileUpload<IBrowserFile>>().Find("button").HasAttribute("disabled").Should().BeFalse();
            ...
            comp.FindComponent<ProFileUpload<IBrowserFile>>().Find("input").HasAttribute("disabled").Should().BeTrue();
            comp.FindComponent<ProFileUpload<IBrowserFile>>().Find("button").HasAttribute("disabled").Should()
                .BeTrue(); //we need to test for a button as the ProButton replaces disabled labels with buttons
        }
        ...
        {
            var comp = Context.Render<ProFileUpload<IBrowserFile>>();
        ...
        public async Task FileUpload_DragAndDrop_Test()
        {
            ...
            comp.Find(".pro-file-upload-dragarea").Should().NotBeNull();

            // Test drag enter
            await comp.Find(".pro-file-upload-dragarea").DragEnterAsync();
            comp.Find(".pro-file-upload-dragarea").ClassList.Should().Contain("pro-border-primary");

            // Test drag leave
            await comp.Find("input").DragLeaveAsync();
            comp.Find(".pro-file-upload-dragarea").ClassList.Should().NotContain("pro-border-primary");
        ...
        public void FileUpload_DragAndDrop_DefaultActivator_Should_Render_Button()
        {
            ...
            var dragAreaButton = comp.Find("button.pro-file-upload-dragarea");
        ...
        public async Task FileUpload_DragAndDrop_DefaultActivator_Click_Should_OpenFilePicker()
        {
            ...
            await comp.Find("button.pro-file-upload-dragarea").ClickAsync();
        ...
        public void FileUpload_DragAndDrop_DefaultActivator_Should_Respect_Disabled_State()
        {
            ...
            dragAreaButton.ClassList.Should().NotContain("pro-file-upload-dragarea-clickable");
        }
        ...
        public async Task FileUpload_RemoveFileAsync_MultipleFiles_Test()
        {
            ...
            var comp = Context.Render<ProFileUpload<IReadOnlyList<IBrowserFile>>>(parameters => parameters
                .Add(x => x.Files, files));
        ...
        public void GetFilenames_ShouldNotThrow_ForDifferentTypes(Type type)
        {
            ...
            {
                not null when type == typeof(IBrowserFile) => () => Context.Render<ProFileUpload<IBrowserFile>>().Instance.GetFilenames(),
                not null when type == typeof(IReadOnlyList<IBrowserFile>) => () => Context.Render<ProFileUpload<IReadOnlyList<IBrowserFile>>>().Instance.GetFilenames(),
                _ => () => Context.Render<ProFileUpload<object>>().Instance.GetFilenames()
            };
        ...
        public void MaxFileSize_SingleFile_ExceedsLimit()
        {
            ...
            var input = comp.FindComponent<InputFile>();
            var fileUpload = comp.FindComponent<ProFileUpload<IBrowserFile>>().Instance;
        ...
        public void MaxFileSize_MultipleFiles_AllWithinLimit()
        {
            ...
            var input = comp.FindComponent<InputFile>();
            var fileUpload = comp.FindComponent<ProFileUpload<IReadOnlyList<IBrowserFile>>>().Instance;
