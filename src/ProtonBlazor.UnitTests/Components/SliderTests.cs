...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class SliderTests : BunitTest
    {
        ...
        {
            var slider = new ProSlider<double>();
        ...
        {
            var comp = Context.Render<ProSlider<int>>(x => x.Add(p => p.Size, size));

            IElement Slider() => comp.Find(".pro-slider");
            Slider().ClassList.Should().ContainInOrder(new[] { "pro-slider", $"pro-slider-{expectedSizeClass}" });
        }

        [Test]
        public void CheckVerticalClass()
        {
            var verticalSliderComponent = Context.Render<ProSlider<int>>(x => x.Add(p => p.Vertical, true));

            IElement VerticalSlider() => verticalSliderComponent.Find(".pro-slider");
            VerticalSlider().ClassList.Should().ContainInOrder(new[] { "pro-slider", "pro-slider-small", "pro-slider-vertical" });

            var horizontalSliderComponent = Context.Render<ProSlider<int>>(x => x.Add(p => p.Vertical, true));

            IElement HorizontalSlider() => horizontalSliderComponent.Find(".pro-slider");
            HorizontalSlider().ClassList.Should().ContainInOrder(new[] { "pro-slider", "pro-slider-small" });
        }
        ...
        public void CheckInputSizeCssClass(Size size, string expectedSizeClass)
        {
            ...
            IElement Slider() => comp.Find(".pro-slider");
            Slider().ClassList.Should().ContainInOrder(new[] { "pro-slider", $"pro-slider-{expectedSizeClass}", "pro-slider-primary" });
        }
        ...
        {
            var comp = Context.Render<ProSlider<int>>(x => x.Add(p => p.Color, color));

            IElement Slider() => comp.Find(".pro-slider");
            Slider().ClassList.Should().ContainInOrder(new[] { "pro-slider", "pro-slider-small", $"pro-slider-{expectedColorClass}" });
        }

        [Test]
        public void GeneralStructure()
        {
            var comp = Context.Render<ProSlider<double>>(x =>
            {
                x.Add(p => p.Min, 100.0);
                x.Add(p => p.Max, 200.0);
                x.Add(p => p.Step, 10.0);
            ...
            IElement RootElement() => comp.Find(".pro-slider");
            ...
            container.ClassList.Should().Contain("pro-slider-container");

            container.Children.Should().HaveCount(1);

            var input = container.Children.ElementAt(0);

            input.ClassList.Should().Contain("pro-slider-input");
        ...
        public void Structure_WithChildContent()
        {
            ...
            container.Children.ElementAt(0).ClassList.Should().Contain("pro-slider-input");
        }
        ...
        public void Structure_WithFilled()
        {
            ...
            containerInner.ClassList.Should().Contain("pro-slider-inner-container");

            var filling = containerInner.Children.ElementAt(0);
            filling.ClassList.Should().Contain("pro-slider-filled");

            container.Children.ElementAt(1).ClassList.Should().Contain("pro-slider-input");
        }
        ...
        public void TickMarksEnabled_ButNoLabels()
        {
            ...
            filling.ClassList.Should().Contain("pro-slider-inner-container");
            filling.Children.Should().ContainSingle();

            var tickMarks = filling.Children.First();
            tickMarks.ClassList.Should().Contain("pro-slider-tickmarks");
            ...
            foreach (var item in tickMarks.Children)
            {
                ...
                item.Children.First().ClassList.Should().Contain("pro-slider-track-tick");
            }
        ...
        public void TickMarksEnabled_ButLabels()
        {
            ...
            foreach (var item in tickMarks.Children)
            {
                ...
                content.ClassList.Should().Contain("pro-slider-track-tick-label");
        ...
        public void TickMarksEnabled_CheckAmount(double min, double max, double step, int expectedAmount)
        {
            ...
            IElement TickMarks() => comp.Find(".pro-slider-tickmarks");
        ...
        public void Percentage(double min, double max, double value, string expectedPercentage)
        {
            ...
            foreach (var culture in cultures)
            {
                ...
                IElement Thumb() => comp.Find(".pro-slider-value-label");
                Thumb().GetAttribute("style").Should().Be($"left:{expectedPercentage}%;");

                IElement Filling() => comp.Find(".pro-slider-filled");
        ...
        public void ValueLabelPosition_Rtl(double min, double max, double value, string expectedPercentage)
        {
            ...
            IElement ValueLabel() => comp.Find(".pro-slider-value-label");
        ...
        public async Task CheckInput(bool immediate)
        {
            ...
            IElement Input() => comp.Find(".pro-slider-input");
            IElement Filling() => comp.Find(".pro-slider-filled");
            var value = "180";
        ...
        public void CustomCultureAndFormatting(decimal value, string expectedValueLabel)
        {
            ...
            var comp = Context.Render<ProSlider<decimal>>(x =>
            {
                x.Add(p => p.Value, value);
                x.Add(p => p.Step, 0.5m);
                x.Add(p => p.ValueLabel, true);
