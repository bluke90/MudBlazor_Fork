...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class TextFieldTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProTextField<double>>();
            ...
            comp.FindAll("div.pro-input-error").Count.Should().Be(0);
        }
        ...
        {
            var comp = Context.Render<ProTextField<int?>>(parameters => parameters.Add(p => p.Value, 17));
        ...
        {
            var comp = Context.Render<ProTextField<int?>>();

            // print the generated html
            await comp.Find("input").ChangeAsync("seventeen");
            await comp.Find("input").BlurAsync();
            comp.FindAll("div.pro-input-error").Count.Should().Be(3);
            comp.Find("div.pro-input-error").TextContent.Trim().Should().Be("Not a valid number");
        }
        ...
        public async Task TextField_Should_PreserveInvalidTextOnKeyRerender()
        {
            ...
            var textField = comp.FindComponent<ProTextField<TextFieldConversionErrorKeyRerenderTest.Pod>>().Instance;
            ...
            textField = comp.FindComponent<ProTextField<TextFieldConversionErrorKeyRerenderTest.Pod>>().Instance;
            textField.ReadValue.Should().BeNull();
            textField.ReadText.Should().Be("123456");
            textField.ConversionError.Should().BeTrue();
        ...
        public async Task WithNoDebounceIntervalValueShouldChangeImmediately()
        {
            ...
            var comp = Context.Render<ProTextField<string>>(parameters => parameters.Add(p => p.Immediate, true));
            var textField = comp.Instance;
        ...
        public async Task ShouldRespectDebounceIntervalPropertyInTextField()
        {
            ...
            var comp = Context.Render<ProTextField<string>>(parameters => parameters.Add(p => p.DebounceInterval, 200d));
            var textField = comp.Instance;
            var input = comp.Find("input");
        ...
        {
            // Arrange
            var comp = Context.Render<ProTextField<string>>(parameters => parameters.Add(p => p.DebounceInterval, 200.0));
            var textField = comp.Instance;
            var input = comp.Find("input");
        ...
        public async Task DebouncedTextField_Should_ValidatePendingValueImmediatelyWhenFormIsValidated()
        {
            ...
            var textField = comp.FindComponents<ProTextField<string>>();
        ...
        public async Task LabelShouldShrinkWhenPlaceholderIsSet()
        {
            ...
            var comp = Context.Render<ProTextField<string>>(parameters => parameters.Add(p => p.Label, "label"));
        ...
        /// <summary>
        /// Setting ShrinkLabel should apply pro-shrink class.
        /// </summary>
        [Test]
        public void LabelShouldShrinkWhenShrinkLabelIsSet()
        {
            var comp = Context.Render<TextFieldShrinkLabelTest>();
            var noMask = comp.FindComponents<ProTextField<string>>()[0];
            var masked = comp.FindComponents<ProTextField<string>>()[1];

            noMask.Markup.Should().Contain("pro-shrink");
            masked.Markup.Should().Contain("pro-shrink");
        }
        ...
        public async Task TextFieldFluentValidationTest1()
        {
            var validator = new FluentValueValidator<string>(x => x.Cascade(CascadeMode.Stop)
                ...
                .Length(1, 100)
                .CreditCard());
            var comp = Context.Render<ProTextField<string>>(parameters => parameters.Add(p => p.Validation, validator.Validation));
            var textfield = comp.Instance;
        ...
        {
            var comp = Context.Render<ProTextField<string>>(parameters => parameters
        ...
        public void TextField_Should_FireValueChangedOnTextParameterChange()
        {
            ...
            _ = Context.Render<ProTextField<string>>(parameters => parameters
        ...
        {
            var comp = Context.Render<ProTextField<int?>>(parameters => parameters.Add(p => p.Required, true));
            var textfield = comp.Instance;
        ...
        {
            var comp = Context.Render<ProTextField<string>>(parameters => parameters.Add(p => p.Required, true));
        ...
        {
            var comp = Context.Render<ProTextField<string>>();
            var textfield = comp.Instance;
            await comp.Find("input").ChangeAsync("A");
            await comp.Find("input").BlurAsync();
            textfield.ReadText.Should().Be("A");
        ...
        public async Task MultiLineTextField_ShouldBe_TwoWayBindable()
        {
            ...
            // print the generated html
            var tf1 = comp.FindComponents<ProTextField<string>>()[0].Instance;
            var tf2 = comp.FindComponents<ProTextField<string>>()[1].Instance;
        ...
        public async Task TextFieldClearable()
        {
            ...
            comp.Find(".pro-input-clear-button").Should().NotBeNull();
        ...
        public void TextField_ClearButton_TabIndex()
        {
            ...
            comp.Find(".pro-input-clear-button").GetAttribute("tabindex").Should().Be("-1");
        }
        ...
        public async Task TextField_Should_HaveCorrectMessageWithCustomAttr_Failing()
        {
            ...
            var comp = Context.Render<ProTextField<string>>(parameters =>
        ...
        {
            var comp = Context.Render<ProTextField<string>>();
            var input = comp.FindComponent<ProInput<string>>();
            var textfield = comp.Instance;
        ...
        public void InputMode_DefaultValueWithMask_IsText()
        {
            ...
            var comp = Context.Render<ProTextField<string>>(x =>
                x.Add(f => f.Mask, mask));
        ...
        {
            var mask = new PatternMask("0000");
            var comp = Context.Render<ProTextField<string>>(x => x
        ...
        {
            var comp = Context.Render<ProTextField<int?>>(parameters => parameters
                .Add(p => p.Required, true)
        ...
        public async Task TextField_OnlyValidateIfDirty_WithNonDefaultInitialValue_ShouldNotValidateOnBlur()
        {
            ...
            await comp.Find("input").ChangeAsync("");
            await comp.Find("input").BlurAsync();
            comp.FindAll("div.pro-input-error").Count.Should().BeGreaterThan(0);
            comp.Find("div.pro-input-error").TextContent.Trim().Should().Be("Required");
        }
        ...
        public void TextFieldLabel()
        {
            ...
            var comp = Context.Render<ProTextField<string>>(x => x.Add(f => f.For, () => value.String));
            comp.Instance.Label.Should().Be("String LabelAttribute"); //label should be set by the attribute

            var comp2 = Context.Render<ProTextField<string>>(x => x.Add(f => f.For, () => value.String).Add(l => l.Label, "Label Parameter"));
        ...
        /// <summary>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/6322
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Reproduce https://github.com/ProtonBlazor/ProtonBlazor/issues/7034
        /// </summary>
        [Test]
        ...
        public async Task DebouncedTextFieldFormatChangeRerender()
        {
            ...
            var textField = comp.FindComponent<ProTextField<DateTime>>().Instance;
        ...
        /// <summary>
        /// Bug : https://github.com/ProtonBlazor/ProtonBlazor/issues/10606
        ...
        {
            var comp = Context.Render<ProTextField<string>>(p => p
        ...
        public void OutlineLegendRender()
        {
            ...
            comp = Context.Render<ProTextField<string>>(parameters => parameters
                .Add(p => p.Variant, Variant.Outlined)
                .Add(p => p.Label, ""));
        ...
        public async Task GetCurrentCaretPositionAsyncCallsJsCorrectly()
        {
            ...
            var textField = Context.Render<ProTextField<string>>().Instance;
