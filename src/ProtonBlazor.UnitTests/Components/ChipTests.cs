...
using ProtonBlazor.UnitTests.TestComponents.Chip;
...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class ChipTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProChip<string>>();

            var chip = comp.Find(".pro-chip");
            ...
            [Values(null, "noopener", "nofollow")] string rel)
        {
            ...
            var comp = Context.Render<ProChip<string>>(parameters => parameters
        ...
        public void Chip_ShouldRenderAvatar()
        {
            ...
            comp.Find("div.pro-chip").InnerHtml.Should().Contain("pro-avatar");
        }
        ...
        public async Task Chip_OnClick()
        {
            ...
            // chip should have pro-clickable and pro-ripple classes
            var chip = comp.Find("button.pro-chip");
            chip.ClassName.Should().Contain("pro-clickable");
            chip.ClassName.Should().Contain("pro-ripple");
        ...
        public async Task Chip_OnClose()
        {
            ...
            await comp.Find("button.pro-chip-close-button").ClickAsync();
