...
public class ExitPromptTests : BunitTest
{
    ...
    public async Task DialogPrompt_UsesLocalizedDefaultsWhenTitleAndTextAreNotProvided()
    {
        ...
        VerifyDialogMessage(
            dialogServiceMock,
            localizer[LanguageResource.ProExitPrompt_Title],
            localizer[LanguageResource.ProExitPrompt_Text],
    ...
    /// </summary>
    private IRenderedComponent<ProExitPrompt> RenderExitPrompt(
        bool disabled = false,
        bool useNativePrompt = false,
        string? title = null,
        string? text = null)
    {
        return Context.Render<ProExitPrompt>(parameters =>
        {
