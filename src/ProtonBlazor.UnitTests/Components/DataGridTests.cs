...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class DataGridTests : BunitTest
    {
        ...
        public async Task DataGridSortable()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSortableTest.Item>>();
        ...
        public void DataGridVirtualizeSpacerElementsAreTableRows()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerDataWithVirtualizeTest.Item>>();
            ...
            // Virtualize renders one before-spacer and one after-spacer <tr>; neither has the pro-table-row class.
            var spacerTrs = tbody.QuerySelectorAll("tr:not(.pro-table-row)").ToList();
        ...
        public void DataGridWithServerDataAndVirtualize()
        {
            ...
            // Count data rows using the pro-table-row class; avoids counting Virtualize spacer <tr> elements.
            var dataRows = dataGrid.FindAll("tbody tr.pro-table-row");
        ...
        public async Task DataGridSortableVirtualizeServerData()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSortableVirtualizeServerDataTest.Item>>();
        ...
        public async Task DataGridSortableHeaderRow()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSortableHeaderRowTest.Item>>();
        ...
        public async Task DataGridSortableTemplateColumn()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSortableTemplateColumnTest.Item>>();
        ...
        public async Task DataGridFilterableVirtualizeServerData()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterableVirtualizeServerDataTest.Item>>();

            // Count data rows using the pro-table-row class; avoids counting Virtualize spacer <tr> elements.
            dataGrid.FindAll("tbody tr.pro-table-row").Count.Should().Be(4, because: "four data rows");
        ...
        public async Task DataGridFilterable()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterableTest.Item>>();
        ...
        public void DataGrid_SetParameters_ServerData_Items_Throw()
        {
            ...
            var exception = Assert.Throws<InvalidOperationException>(() =>
                Context.Render<ProDataGrid<TestModel1>>(parameters => parameters
            ...
            exception.Message.Should().Be(
                """
                ProtonBlazor.ProDataGrid`1[ProtonBlazor.UnitTests.Components.TestModel1] can only accept one item source from its parameters. Do not supply both 'Items' and 'ServerData'.
                """
            );
        }
        ...
        public void DataGrid_SetParameters_ServerData_VirtualizeServerData_Throw()
        {
            ...
            exception.Message.Should().Be(
                """
                ProtonBlazor.ProDataGrid`1[ProtonBlazor.UnitTests.Components.TestModel1] can only accept one item source from its parameters. Do not supply both 'VirtualizeServerData' and 'ServerData'.
                """
            );
        }
        ...
        public void DataGrid_SetParameters_Items_VirtualizeServerData_Throw()
        {
            ...
            exception.Message.Should().Be(
                """
                ProtonBlazor.ProDataGrid`1[ProtonBlazor.UnitTests.Components.TestModel1] can only accept one item source from its parameters. Do not supply both 'Items' and 'VirtualizeServerData'.
                """
            );
        }
        ...
        public async Task DataGridFilterableServerData()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterableServerDataTest.Item>>();
        ...
        public async Task DataGridCustomComparer()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSelectionComparerTest.Person>>();
            ...
            //select a chip
            var chipSet = comp.FindComponent<ProChipSet<string>>();

            await chipSet.FindAll(".pro-chip")[2].ClickAsync();
        ...
        public async Task DataGridSingleSelection()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSingleSelectionTest.Item>>();
        ...
        public async Task DataGridMultiSelection()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridMultiSelectionTest.Item>>();
        ...
        public async Task DataGridServerMultiSelection()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerMultiSelectionTest.Item>>();
        ...
        public async Task DataGridEditableSelection()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridEditableWithSelectColumnTest.Item>>();

            // test that all rows, header and footer have cell with a checkbox
            dataGrid.FindAll("input.pro-checkbox-input").Count.Should().Be(dataGrid.Instance.Items.Count() + 2);

            //test that changing header sets all items selected
            dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(0);
            await dataGrid.FindAll("input.pro-checkbox-input")[0].ChangeAsync(true);
            comp.Render();
            ...
            await dataGrid.FindAll("input.pro-checkbox-input")[^1].ChangeAsync(false);
            dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(0);
            //test that changing value in each row selects an item in grid
            for (var i = 1; i < dataGrid.Instance.Items.Count(); i++)
            {
                await dataGrid.FindAll("input.pro-checkbox-input")[i].ChangeAsync(true);
        ...
        public async Task DataGridInlineEditVirtualizeServerData()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCellEditVirtualizeServerDataTest.Item>>();
            ...
            await dataGrid.FindAll(".pro-table-body tr td input")[0].ChangeAsync("Jonathan");
            await dataGrid.FindAll(".pro-table-body tr td input")[1].ChangeAsync(52d);
            dataGrid.FindAll(".pro-table-body tr td input")[0].GetAttribute("value").Trim().Should().Be("Jonathan");
            dataGrid.FindAll(".pro-table-body tr td input")[1].GetAttribute("value").Trim().Should().Be("52");
        }
        ...
        public async Task DataGridVirtualizeServerDataLoadingWithCancel()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<int>>();
        ...
        public async Task DataGridPagination()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridPaginationTest.Item>>();
            // check that the page size dropdown is shown
            comp.FindComponents<ProSelect<int>>().Count.Should().Be(1);

            dataGrid.FindAll(".pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-10 of 20");

            // test that we are on the first page of results
            dataGrid.Find(".pro-table-body td").TextContent.Trim().Should().Be("0");

            // click to go to the next page
            await dataGrid.FindAll(".pro-table-pagination-actions button")[2].ClickAsync();

            // test that we are on the second page of results
            dataGrid.Find(".pro-table-body td").TextContent.Trim().Should().Be("10");
        ...
        public void DataGridPaginationShouldFormatNumbersWithCommas()
        {
            ...
            comp.FindAll(".pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-10 of 1,000");
        }
        ...
        public void DataGridPaginationShouldRespectCustomFormatWithSingleTag()
        {
            ...
            comp.FindAll(".pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("Total: 1,000");
        }
        ...
        public void DataGridPaginationPageSizeDropDown()
        {
            ...
            comp.FindComponents<ProSelect<string>>().Should().BeEmpty();
        }
        ...
        public async Task DataGridPagingAll()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridPaginationAllItemsTest.Item>>();
            var pager = comp.FindComponent<ProSelect<int>>().Instance;

            dataGrid.FindAll(".pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-10 of 20"); //check initial value
            // change page size
            ...
            comp.FindAll(".pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("1-20 of 20");

            comp.FindAll(".pro-table-pagination-actions button")[0].IsDisabled().Should().Be(true); //buttons are disabled
            comp.FindAll(".pro-table-pagination-actions button")[1].IsDisabled().Should().Be(true);
            comp.FindAll(".pro-table-pagination-actions button")[2].IsDisabled().Should().Be(true);
            comp.FindAll(".pro-table-pagination-actions button")[3].IsDisabled().Should().Be(true);

            comp.FindAll(".pro-table-pagination-select")[^1].TextContent.Trim().Should().Be("All");
        }
        ...
        public void DataGridPaginationNoItems()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridPaginationNoItemsTest.Item>>();
            // check that the page size dropdown is shown
            comp.FindComponents<ProSelect<int>>().Count.Should().Be(1);

            dataGrid.FindAll(".pro-table-pagination-caption")[^1].TextContent.Trim().Should().Be("0-0 of 0");
        }
        ...
        public async Task DataGridHideNavigation()
        {
            var comp = Context.Render<DataGridPaginationTest>();
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridPaginationTest.Item>>();
            var pagerContent = comp.FindComponent<ProDataGridPager<DataGridPaginationTest.Item>>();

            comp.Markup.Should().Contain("pro-table-pagination-actions");
            ...
            comp.Markup.Should().NotContain("pro-table-pagination-actions");
        ...
        public async Task DataGridRowsPerPageTwoWayBinding()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridRowsPerPageBindingTest.Item>>();
        ...
        public async Task DataGridInlineEdit()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCellEditTest.Model>>();
        ...
        public async Task DataGridInlineEditWithNullableChange()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCellEditWithNullableTest.Model>>();
        ...
        public async Task DataGridInlineEditWithNullable()
        {
            ...
            await dataGrid.FindAll(".pro-table-body tr td input")[0].ChangeAsync("Jonathan");
            await dataGrid.FindAll(".pro-table-body tr td input")[1].ChangeAsync(52);
            dataGrid.FindAll(".pro-table-body tr td input")[0].GetAttribute("value").Trim().Should().Be("Jonathan");
            dataGrid.FindAll(".pro-table-body tr td input")[1].GetAttribute("value").Trim().Should().Be("52");
        ...
        public async Task DataGridInlineEditWithTemplate()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCellEditWithTemplateTest.Model>>();
        ...
        public async Task DataGridDialogEdit()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFormEditTest.Model>>();
            ...
            await comp.Find(".pro-dialog-actions .pro-button-filled-primary").ClickAsync();
        ...
        public async Task DataGridChangesBehaviorTest(int age, bool shouldClose)
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridEditFormActionTest.Model>>();
            ...
            comp.FindAll("div.pro-dialog").Count.Should().Be(0);

            //open edit dialog
            dataGrid.FindAll("tbody tr")[1].Click();

            //verify dialog open
            comp.Find("div.pro-dialog").Should().NotBeNull();

            //edit data
            comp.FindAll("div input")[0].Change("Galadriel");
            comp.FindAll("div input")[1].Change(age);

            comp.Find(".pro-dialog-actions .pro-button-filled-primary").Click();
        ...
        public void DataGridNoNullExceptionWhenNestedPropertyNullValue()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridNestedNullPropertyTest.Model>>();
        ...
        public async Task DataGridDialogEditCloneStrategyTest1()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFormEditCloneStrategyTest.Movement>>();
        ...
        public async Task DataGridFormFieldChanged()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFormFieldChangedTest.Item>>();
            //open edit dialog
            ...
            var textfield = comp.FindComponent<ProTextField<string>>();
        ...
        public async Task DataGridFormValidationErrorsPreventUpdate()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFormValidationTest.Model>>();

            // open form dialog
            await dataGrid.Find("tbody tr button").ClickAsync();
            dataGrid.Instance._isEditFormOpen.Should().BeTrue();

            var field = comp.FindComponents<ProTextField<string>>()[2];
            ...
            var button = comp.FindComponents<ProButton>().Single(b => b.Markup.Contains("Save"));
        ...
        public void DataGridVisualStyling()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridVisualStylingTest.Item>>();
        ...
        public async Task DataGridEventCallbacks()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridEventCallbacksTest.Item>>();
...
#pragma warning restore BL0005
            ...
            await dataGrid.FindAll(".pro-table-body tr")[0].ClickAsync();

            // Fire RowContextMenuClick
            dataGrid.FindAll(".pro-table-body tr")[0].ContextMenu();

            // Edit an item.
            await dataGrid.FindAll(".pro-table-body tr td input")[0].ChangeAsync("A test");
        ...
        public async Task DataGridFilterChangedColumnFilterRowApplyAndClear()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterChangedCallbacksTest.Item>>();
            var popoverProvider = comp.FindComponent<ProPopoverProvider>();

            var filterInput = dataGrid.FindComponents<ProTextField<string>>().Single();
            ...
            var operators = popoverProvider.FindComponents<ProMenuItem>();
            await operators[1].Find(".pro-menu-item").ClickAsync();
            comp.Instance.FilterChangedCallCount.Should().Be(2);
        ...
        public async Task DataGridFilterChangedColumnFilterMenuApplyAndClear()
        {
            ...
            var filterInput = comp.FindComponents<ProTextField<string>>().Single();
            await comp.InvokeAsync(async () => await filterInput.Instance.ValueChanged.InvokeAsync("second"));
        ...
        public async Task DataGridCommittedItemChangedOccursAfterSourceItemUpdateInFormEdit()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCommittedItemChangedTest.Model>>();
        ...
        public async Task DataGridEditComplexPropertyExpression()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridEditComplexPropertyExpressionTest.Item>>();
            ...
            await dataGrid.FindAll(".pro-table-body tr td input")[0].ChangeAsync("Test 1");
            comp.Instance.Items[0].Name.Should().Be("Test 1");

            // Edit an item that has a sub property like x.Something.SomethingElse
            await dataGrid.FindAll(".pro-table-body tr td input")[1].ChangeAsync("Test 2");
            ...
            await dataGrid.FindAll(".pro-table-body tr td input")[2].ChangeAsync("Test 3");
        ...
        public void DataGridOnContextMenuClickWhenIsGrouped()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridGroupExpandedTest.Fruit>>();
            ...
            // Fire RowContextMenuClick
            dataGrid.FindAll(".pro-table-body tr")[1].ContextMenu();
        ...
        public async Task DataGridServerSideSortable()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerSideSortableTest.Item>>();
        ...
        public async Task FilterDefinitionString()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFiltersTest.Model>>();
        ...
        public void FilterDefinitionDateOnly()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridDateOnlyFilterTest.Model>>();
            var dateColumn = dataGrid.Instance.GetColumnByPropertyName("HiredOn");
        ...
        public async Task FilterDefinitionReplaceWithCustom()
        {
            ...
            comp.FindAll(".filters-panel .pro-grid-item.d-flex").Count.Should().Be(1);
        ...
        public async Task DataGridCloseFilters()
        {
            ...
            async Task SelectFilterOperator(int operatorIndex, int expectedFilterCount)
            {
                ...
                if (comp.FindAll(".filters-panel .pro-grid-item.d-flex").Count == 0)
                {
                    await FilterButton().ClickAsync();
                ...
                var listItems = await comp.WaitForElementsAsync(".pro-list .pro-list-item");
            ...
            await FilterButton().ClickAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll(".filters-panel .pro-grid-item.d-flex").Count.Should().Be(1));
        ...
        public async Task DataGridFilters()
        {
            ...
            // check the number of filters displayed in the filters panel
            comp.FindAll(".filters-panel .pro-grid-item.d-flex").Count.Should().Be(7);
            ...
            comp.FindAll(".filters-panel .pro-grid-item.d-flex").Count.Should().Be(8);

            // add a filter via the AddFilter method
            await comp.InvokeAsync(() => dataGrid.Instance.AddFilter());

            // check the number of filters displayed in the filters panel is 1 more because we added a filter
            comp.FindAll(".filters-panel .pro-grid-item.d-flex").Count.Should().Be(9);
            ...
            // check the number of filters displayed in the filters panel is 1 more because we added a filter
            comp.FindAll(".filters-panel .pro-grid-item.d-flex").Count.Should().Be(10);
        ...
        public async Task DataGridFilterPerColumn()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterPerColumnTest.Model>>();
            ...
            // get select menus
            var selects = comp.FindAll(".filters-panel .pro-grid-item .pro-input-control.pro-select");
            ...
            var items = comp.FindAll("div.pro-list-item");
        ...
        public async Task DataGridIDictionaryFilters()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<IDictionary<string, object>>>();
        ...
        public void DataGridColGroup()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColGroupTest.Model>>();
        ...
        public async Task DataGridColReorderRowFilters()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColReorderRowFiltersTest.Model>>();
        ...
        public void DataGridHeaderTemplate()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHeaderTemplateTest.Model>>();
        ...
        public async Task DataGridRowDetailOpen()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHierarchyColumnTest.Model>>();
        ...
        public async Task DataGrid_RowDetail_ExpandCollapseAllWithOne()
        {
            ...
            await dataGrid.WaitForAssertionAsync(() => dataGrid.Instance._openHierarchies.Count.Should().Be(0));
            var headerToggle = dataGrid.Find("th button.pro-hierarchy-toggle-button");
        ...
        public void DataGrid_RowDetail_RTL_GroupIcon(bool rightToLeft)
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHierarchyColumnTest.Model>>();
            var svg = dataGrid.Find(".pro-table-body .pro-table-row .pro-table-cell .pro-icon-root");
        ...
        public async Task DataGridRowDetailButtonDisabledClick()
        {
            ...
            await comp.InvokeAsync(async () =>
            {
                var buttons = dataGrid.FindAll("button.pro-button-root.pro-icon-button.pro-ripple.pro-ripple-icon");
        ...
        {
            var comp = Context.Render<DataGridHierarchyColumnTest>();
            var button = comp.Find("tbody tr button.pro-icon-button");
        ...
        public void DataGridChildRowContent()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridChildRowContentTest.Model>>();
        ...
        public void DataGridLoadingContent()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridLoadingContentTest.Model>>();

            dataGrid.Find("th.pro-table-empty-row div").TextContent.Trim().Should().Be("Data loading, please wait...");
        }
        ...
        public void DataGridNoRecordsContent()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridNoRecordsContentTest.Model>>();

            dataGrid.Find("th.pro-table-empty-row div").TextContent.Trim().Should().Be("There are no records to view.");
        }
        ...
        public void DataGridNoRecordsContentVirtualize()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridNoRecordsContentVirtualizeTest.Model>>();
        ...
        public void DataGridFooterTemplate()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFooterTemplateTest.Model>>();
        ...
        public async Task DataGridServerPagination()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerPaginationTest.Model>>();

            // test that we are on the first page of results
            dataGrid.Find(".pro-table-body td").TextContent.Trim().Should().Be("Name 0");

            // click to go to the next page
            await dataGrid.FindAll(".pro-table-pagination-actions button")[2].ClickAsync();

            // test that we are on the second page of results
            dataGrid.Find(".pro-table-body td").TextContent.Trim().Should().Be("Name 10");
        ...
        /// <summary>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/8298
        /// </summary>
        [Test]
        ...
        public void DataGridCellTemplate()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCellTemplateTest.Model>>();
        ...
        public async Task DataGridColumnChooser()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColumnChooserTest.Model>>();
            var popoverProvider = comp.FindComponent<ProPopoverProvider>();

            dataGrid.FindAll(".pro-table-head th").Count.Should().Be(6);
            await comp.InvokeAsync(async () =>
            {
                var columnHamburger = dataGrid.FindAll("button.pro-button-root.pro-icon-button.pro-ripple.pro-ripple-icon.pro-icon-button-size-small");
                await columnHamburger[2].ClickAsync();
                var listItems = popoverProvider.FindComponents<ProMenuItem>();
            ...
            {
                dataGrid.FindAll(".pro-table-head th").Count.Should().Be(5);
            });

            await comp.InvokeAsync(async () =>
            {
                var columnsButton = dataGrid.Find("button.pro-button-root.pro-icon-button.pro-ripple.pro-ripple-icon.pro-icon-button-size-small");
                await columnsButton.ClickAsync();
                var popover = dataGrid.FindComponent<ProPopover>();
                popover.Instance.Open.Should().BeTrue("Should be open once clicked");
                var listItems = popoverProvider.FindComponents<ProMenuItem>();
                listItems.Count.Should().Be(1);
                var clickablePopover = listItems[0].Find(".pro-menu-item");
                await clickablePopover.ClickAsync();
            });
            ...
            {
                var switches = comp.FindComponents<ProSwitch<bool>>();
                switches.Count.Should().Be(6);
                var iconbuttons = comp.FindComponents<ProIconButton>();
                iconbuttons.Count.Should().Be(29);
                var buttons = comp.FindComponents<ProButton>();
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                comp.FindAll(".pro-table-head th").Count.Should().Be(7);
            });

            await comp.InvokeAsync(() => dataGrid.Instance.ShowColumnsPanel());
            comp.FindAll(".pro-data-grid-columns-panel").Count.Should().Be(1);
            comp.Find(".pro-data-grid-columns-panel").ClassList.Should().Contain("pro-popover-overflow-flip-onopen");

            await comp.InvokeAsync(() => dataGrid.Instance.HideColumnsPanel());
            comp.FindAll(".pro-data-grid-columns-panel").Count.Should().Be(0);

            await comp.InvokeAsync(() => dataGrid.Instance.HideAllColumnsAsync());
            await dataGrid.WaitForAssertionAsync(() =>
            {
                dataGrid.FindAll(".pro-table-head th").Count.Should().Be(3);
            });
        ...
        public async Task DataGridShowMenuIconOpeningFilterDoesNotRepositionColumnsPanel()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridShowMenuIconFilterPositionTest.Item>>();
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                columnsPanel = comp.Find(".pro-data-grid-columns-panel");
            });
            columnsPanel.GetAttribute("data-pc-x").Should().Be("11");
            columnsPanel.GetAttribute("data-pc-y").Should().Be("22");
            columnsPanel.ClassList.Should().Contain("pro-popover-overflow-flip-onopen");

            await comp.Find(".pro-data-grid-columns-panel .filter-button").ClickAsync(new MouseEventArgs { PageX = 101, PageY = 202 });

            comp.Find(".filters-panel").ClassList.Should().Contain("pro-popover-overflow-flip-onopen");
            comp.Find(".pro-data-grid-columns-panel").GetAttribute("data-pc-x").Should().Be("11");
            comp.Find(".pro-data-grid-columns-panel").GetAttribute("data-pc-y").Should().Be("22");
        }
        ...
        public async Task DataGridColumnHidden()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColumnHiddenTest.Model>>();

            var popoverProvider = comp.FindComponent<ProPopoverProvider>();

            comp.Markup.Should().NotContain("pro-popover-open");
            var columnsButton = dataGrid.Find("button.pro-button-root.pro-icon-button.pro-ripple.pro-ripple-icon.pro-icon-button-size-small");
            await columnsButton.ClickAsync();

            comp.Markup.Should().Contain("pro-popover-open");
            var listItems = popoverProvider.FindComponents<ProMenuItem>();
            listItems.Count.Should().Be(1);
            var clickablePopover = listItems[0].Find(".pro-menu-item");
            await clickablePopover.ClickAsync();
            ...
            dataGrid.FindAll(".pro-table-head th").Count.Should().Be(4);
            ...
            dataGrid.FindAll(".pro-table-head th").Count.Should().Be(7);
            ...
            dataGrid.FindAll(".pro-table-head th").Count.Should().Be(1);
        ...
        //    var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterRowHiddenTest.Model>>();

        //    //there should be only one filter cell visible
        //    dataGrid.FindAll(".pro-input-control-input-container").Count.Should().Be(1);
        ...
        //    popover.Instance.Open.Should().BeTrue("Should be open once clicked");
        //    var listItems = popoverProvider.FindComponents<ProListItem>();
        //    listItems.Count.Should().Be(1);
        //    var clickablePopover = listItems[0].Find(".pro-menu-item");
        //    await clickablePopover.ClickAsync();

        //    // at this point, the column picker should be open
        //    var switches = dataGrid.FindComponents<ProSwitch<bool>>();
        //    switches.Count.Should().Be(2);

        //    switches[0].Instance.Checked.Should().BeFalse();
        //    switches[1].Instance.Checked.Should().BeTrue();

        //    var buttons = dataGrid.FindComponents<ProButton>();
        //    // this is the hide all button
        //    await buttons[0].Find("button").ClickAsync();
        //    switches[0].Instance.Checked.Should().BeTrue();
        //    switches[1].Instance.Checked.Should().BeTrue();
        //    // 2 columns, 2 hidden
        //    dataGrid.FindAll(".pro-input-control-input-container").Count.Should().Be(0);
        ...
        //    // 2 columns, 0 hidden
        //    dataGrid.FindAll(".pro-input-control-input-container").Count.Should().Be(2);
        ...
        //    //without the input
        //    dataGrid.FindAll(".pro-table-cell.filter-header-cell").Count.Should().Be(2);
        //    dataGrid.FindAll(".pro-input-control-input-container").Count.Should().Be(1);
        //}
        ...
        public async Task DataGridShowMenuIcon()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridShowMenuIconTest.Item>>();
            dataGrid.FindAll(".pro-table-toolbar .pro-menu").Should().BeEmpty();
            await dataGrid.SetParametersAndRenderAsync(parameters => parameters.Add(x => x.ShowMenuIcon, true));
            dataGrid.FindAll(".pro-table-toolbar .pro-menu").Should().NotBeEmpty();
        }
        ...
        public async Task DataGridColumnPopupFiltering()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColumnPopupFilteringTest.Model>>();

            dataGrid.FindAll("tbody tr").Count.Should().Be(4);

            await comp.Find(".filter-button").ClickAsync();
            var input = comp.FindComponent<ProTextField<string>>();
        ...
        public async Task DataGridColumnPopupFilteringEscapeClearsFilter()
        {
            ...
            {
                dataGrid.Instance.FilterDefinitions.Should().BeEmpty();
                comp.FindAll(".column-filter-popup.pro-popover-open").Should().BeEmpty();
                dataGrid.FindAll("tbody tr").Count.Should().Be(4);
            });
        }
        ...
        public void DataGridColumnShowFilterIcons()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColumnShowFilterIconsTest.Model>>();
        ...
        public async Task DataGridFilterableFalse()
        {
            ...
            await comp.FindAll("div.pro-input-control")[0].MouseDownAsync(new MouseEventArgs());
            comp.FindAll("div.pro-list-item").Count.Should().Be(3);
        }
        ...
        public async Task DataGridColumnPopupCustomFiltering()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColumnPopupCustomFilteringTest.Model>>();
        ...
        public async Task DataGridCustomFiltering()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCustomFilteringTest.Model>>();
        ...
        public async Task DataGridCustomPropertyFilterTemplate()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCustomPropertyFilterTemplateTest.Model>>();
        ...
        public async Task DataGridFilterTemplateRendersInSimpleMode()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterTemplateSimpleModeTest.Model>>();
            ...
            await comp.Find(".pro-button-root.filter-button").ClickAsync();
        ...
        public async Task DataGridFilterTemplateInSimpleMode_ChangingColumnShouldClearCustomFilterFunction()
        {
            ...
            var columnSelect = comp.FindComponents<ProSelect<Column<DataGridFilterTemplateSimpleModeTest.Model>>>()
        ...
        public async Task DataGridServerDataColumnFilterMenu()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerDataColumnFilterMenuTest.Model>>();
            var callCountText = comp.FindComponent<ProText>();
            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(4);
            ...
            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(1);
        ...
        public async Task DataGridFilterTemplateApplyActionInSimpleMode_ShouldKeepSimplePanelOpen()
        {
            ...
            var departmentFilter = comp.FindComponents<ProSelect<string>>()
        ...
        {
            // https://github.com/ProtonBlazor/ProtonBlazor/issues/11518
            var comp = Context.Render<DataGridServerDataColumnFilterMenuTest>();
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerDataColumnFilterMenuTest.Model>>();
        ...
        public async Task DataGridServerDataColumnFilterRow()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerDataColumnFilterRowTest.Model>>();
            var callCountText = comp.FindComponent<ProText>();
            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(4);
            callCountText.Markup.Should().Contain("Server call count: 1");
            ...
            await comp.Find("th > div > button.pro-button-root").ClickAsync(); // Clear filter button
            callCountText.Markup.Should().Contain("Server call count: 3");
            dataGrid.Render();
            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(4);
        }
        ...
        public void DataGridColumnFilterRowProperty()
        {
            ...
            Assert.DoesNotThrow(() => comp.FindComponent<ProTextField<string>>());
            Assert.DoesNotThrow(() => comp.FindComponent<ProNumericField<double?>>());
            Assert.DoesNotThrow(() => comp.FindComponent<ProSelect<Enum>>());
            Assert.DoesNotThrow(() => comp.FindComponent<ProSelect<bool?>>());
            Assert.DoesNotThrow(() => comp.FindComponent<ProDatePicker>());
        }
        ...
        {
            var comp = Context.Render<DataGridColumnFilterRowPropertyTest>();
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridColumnFilterRowPropertyTest.Model>>();
            ...
            // We had regressions here before https://github.com/ProtonBlazor/ProtonBlazor/issues/10034
        ...
        public void DataGridStickyColumns()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridStickyColumnsTest.Model>>();
        ...
        public void DataGridStickyColumnsResizer()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridStickyColumnsResizerTest.Model>>();

            var header = dataGrid.Find(".pro-table-toolbar");
            header.GetAttribute("style").Should().Contain("position:sticky");
            header.GetAttribute("style").Should().Contain("left:0px");

            var footer = dataGrid.Find(".pro-table-pagination");
            footer.GetAttribute("style").Should().Contain("position:sticky");
            footer.GetAttribute("style").Should().Contain("left:0px");

            var body = dataGrid.Find(".pro-table-container");
        ...
        public async Task DataGridCellContext()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCellContextTest.Model>>();
        ...
        public void DataGridAggregation()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridAggregationTest.Model>>();
        ...
        public void DataGridSequenceContainsNoElements()
        {
            ...
            var dataGridComponent = () => component.FindComponent<ProDataGrid<DataGridSequenceContainsNoElementsTest.Model>>();
        ...
        public async Task DataGridObservability()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridObservabilityTest.Model>>();

            var addButton = comp.Find(".add-item-btn");
            var removeButton = comp.Find(".remove-item-btn");

            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(8);

            await addButton.ClickAsync();

            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(9);
        ...
        /// </summary>
        /// <remarks>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/11758
        /// </remarks>
        [Test]
        public void DataGridObservabilityTest2()
        {
            ...
            var dataGrid = sup.FindComponent<ProDataGrid<DataGridObservabilityTest.Model>>();
            ...
            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(10);
            ...
            dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(7);
        }

        public void TableFilterGuid()
        {
            var comp = Context.Render<DataGridFilterGuid<Guid>>();
            var grid = comp.Instance.ProGridRef;
        ...
        public void DataGridCultureColumnSimple()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCultureSimpleTest.Model>>();
        ...
        public void DataGridCultureColumnEditable()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCultureEditableTest.Model>>();
        ...
        public async Task DataGridCultureColumnFilter()
        {
            ...
            var amountHeader = dataGrid.FindAll("th .pro-menu button")[2];
            await amountHeader.ClickAsync();

            var filterAmount = comp.FindAll(".pro-menu-item")[1];
            await filterAmount.ClickAsync();

            var filterField = comp.Find(".filters-panel .filter-field .pro-select-input");
            ...
            var totalHeader = dataGrid.FindAll("th .pro-menu button")[3];
            await totalHeader.ClickAsync();
            var filterTotal = comp.FindAll(".pro-menu-item")[1];
            await filterTotal.ClickAsync();

            var filterTotalField = comp.Find(".filters-panel .filter-field .pro-select-input");
        ...
        public async Task DataGridCultureColumnFilterHeader()
        {
            ...
            var cells = dataGrid.FindAll(".pro-table-body td input[value]");

            // We want to check the cell values since there are cases when something is broken with ProNumericField's culture, and you won't know without checking values
        ...
        public void DataGridCultureColumnOverrides()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCulturesTest.Model>>();
        ...
        public async Task DataGridSortIndicator()
        {
            ...
            dataGrid.FindAll("th .sort-direction-icon")[0].ClassList.Contains("pro-direction-asc").Should().Be(false);
            dataGrid.FindAll("th .sort-direction-icon")[1].ClassList.Contains("pro-direction-asc").Should().Be(true);
            ...
            dataGrid.FindAll("th .sort-direction-icon")[0].ClassList.Contains("pro-direction-asc").Should().Be(false);
            dataGrid.FindAll("th .sort-direction-icon")[1].ClassList.Contains("pro-direction-desc").Should().Be(true);
            ...
            dataGrid.FindAll("th .sort-direction-icon")[0].ClassList.Contains("pro-direction-asc").Should().Be(true);
            dataGrid.FindAll("th .sort-direction-icon")[1].ClassList.Contains("pro-direction-asc").Should().Be(false);
        }
        ...
        public async Task DataGridParentAndChildSamePropertyNameSort()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridChildPropertiesWithSameNameSortTest.Employee>>();
        ...
        public async Task DataGridCustomSort()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridCustomSortableTest.Item>>();
            ...
            await comp.InvokeAsync(() => dataGrid.Instance.SetSortAsync("Value", SortDirection.Ascending, x => x.Value, new ProtonBlazor.Utilities.NaturalComparer()));
            dataGrid.Instance.DropContainerHasChanged();
            dataGrid.FindAll("th .sortable-column-header")[1].TextContent.Trim().Should().Be("Value");
            dataGrid.FindAll("th .sort-direction-icon")[0].ClassList.Contains("pro-direction-asc").Should().Be(false);
            dataGrid.FindAll("th .sort-direction-icon")[1].ClassList.Contains("pro-direction-asc").Should().Be(true);
            ...
            await comp.InvokeAsync(() => dataGrid.Instance.SetSortAsync("Value", SortDirection.Descending, x => x.Value, new ProtonBlazor.Utilities.NaturalComparer()));
            dataGrid.Instance.DropContainerHasChanged();
            dataGrid.Instance.GetColumnSortDirection("Name").Should().Be(SortDirection.None);
            dataGrid.Instance.GetColumnSortDirection("Value").Should().Be(SortDirection.Descending);
            dataGrid.FindAll("th .sort-direction-icon")[0].ClassList.Contains("pro-direction-asc").Should().Be(false);
            ...
            await comp.InvokeAsync(() => dataGrid.Instance.SetSortAsync("Name", SortDirection.Ascending, x => x.Name, new ProtonBlazor.Utilities.NaturalComparer()));
            dataGrid.Instance.DropContainerHasChanged();
            dataGrid.Instance.GetColumnSortDirection("Name").Should().Be(SortDirection.Ascending);
            dataGrid.Instance.GetColumnSortDirection("Value").Should().Be(SortDirection.None);
            dataGrid.FindAll("th .sort-direction-icon")[0].ClassList.Contains("pro-direction-asc").Should().Be(true);
            ...
            await comp.InvokeAsync(() => dataGrid.Instance.SetSortAsync("Name", SortDirection.Descending, x => x.Name, new ProtonBlazor.Utilities.NaturalComparer()));
            dataGrid.Instance.DropContainerHasChanged();
            dataGrid.Instance.GetColumnSortDirection("Name").Should().Be(SortDirection.Descending);
            dataGrid.Instance.GetColumnSortDirection("Value").Should().Be(SortDirection.None);
            dataGrid.FindAll("th .sort-direction-icon")[0].ClassList.Contains("pro-direction-desc").Should().Be(true);
            dataGrid.FindAll("th .sort-direction-icon")[1].ClassList.Contains("pro-direction-asc").Should().Be(false);
            ...
            await column.SetParametersAndRenderAsync(parameters => parameters.Add(x => x.Comparer, new ProtonBlazor.Utilities.NaturalComparer()));
            //Clear sorting
            await comp.InvokeAsync(() => dataGrid.Instance.RemoveSortAsync("Name"));
            dataGrid.Instance.GetColumnSortDirection("Name").Should().Be(SortDirection.None);
        ...
        public async Task DataGridPropertyColumnFormat()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFormatTest.Employee>>();

            comp.FindAll("tbody.pro-table-body td")[3].TextContent.Should().Be("$87,000.00");
...
#pragma warning restore BL0005
            await comp.Find(".pro-switch-input").ChangeAsync(new ChangeEventArgs { Value = true });
            comp.FindAll("tbody.pro-table-body td")[3].TextContent.Should().Be("$87,000");
        }
        ...
        public async Task DataGridMultiSelectOnRowClick()
        {
            ...
            dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(0);
            await dataGrid.FindAll("tbody.pro-table-body td")[1].ClickAsync();
            dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(1);
            dataGrid.FindAll(".pro-checkbox-true").Count.Should().Be(1); //ensure selection is rendered

            // click on the second row
            await dataGrid.FindAll("tbody.pro-table-body td")[2].ClickAsync();
            dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(2);
            dataGrid.FindAll(".pro-checkbox-true").Count.Should().Be(2);
            ...
            await comp.InvokeAsync(async () => await dataGrid.Instance.SetSelectAllAsync(false));
            dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(0);
            dataGrid.FindAll(".pro-checkbox-true").Count.Should().Be(0);
        ...
        public async Task DataGridSingleSelectOnRowClick()
        {
            ...
            await dataGrid.FindAll("tbody.pro-table-body td")[2].ClickAsync();
            dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(1);
            dataGrid.FindAll(".pro-checkbox-true").Count.Should().Be(1);
        ...
        public async Task DataGridDragAndDrop()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridDragAndDropTest.Model>>();
            dataGrid.Instance.DropContainerHasChanged();
            ...
            var container = dataGrid.Find(".pro-drop-container");
            container.Children.Should().HaveCount(1);

            var zone = dataGrid.FindAll(".pro-drop-zone");
        ...
        public async Task DataGridEditFormDialogIsCustomizable()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridEditFormCustomizedDialogTest.Model>>();

            //open edit dialog
            await dataGrid.FindAll("tbody tr")[1].ClickAsync();
            //check if dialog is open
            comp.FindAll("div.pro-dialog-container").Should().NotBeEmpty();
            ...
            comp.FindAll("div.pro-dialog-container").Should().BeEmpty();
        }
        ...
        public async Task DataGridDragAndDropWithDynamicColumns()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridDragAndDropWithDynamicColumnsTest.Model>>();
            dataGrid.Instance.DropContainerHasChanged();
        ...
        public async Task DataGridRedundantMenu()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridRedundantMenuTest.Model>>();
        ...
        public async Task DataGridSelectColumn()
        {
            ...
            var selectAllCheckboxes = dataGrid.FindComponents<ProCheckBox<bool?>>();
        ...
        public void SelectColumn_DefaultAriaLabels_AreApplied()
        {
            ...
            var comp = Context.Render<ProDataGrid<TestDataItem>>(parameters => parameters
                .Add(p => p.Items, items)
            ...
            var headerCheckbox = comp.Find("thead .pro-checkbox input");
            headerCheckbox.GetAttribute("aria-label").Should().Be("Select all rows");

            var footerCheckbox = comp.Find("tfoot .pro-checkbox input");
            footerCheckbox.GetAttribute("aria-label").Should().Be("Select all rows");

            var rowCheckboxes = comp.FindAll("tbody .pro-checkbox input");
        ...
        public void DataGrid_WithoutSelectColumn_DoesNotRenderAriaSelected()
        {
            ...
            var comp = Context.Render<ProDataGrid<int>>(parameters => parameters
                .Add(p => p.Items, items)
                .Add(p => p.MultiSelection, true)
                .Add(p => p.Columns, builder =>
                {
        ...
        public async Task SelectColumn_SetsAriaSelectedOnRows()
        {
            ...
            List<IElement> RowCheckboxes() => comp.FindAll("tbody .pro-checkbox input").ToList();
            IElement HeaderCheckbox() => comp.Find("thead .pro-checkbox input");
        ...
        public void SelectColumn_AriaLabelFunc_FallsBackToDefaultRowLabeling()
        {
            ...
            var rowCheckbox = comp.Find("tbody .pro-checkbox input");
        ...
        /// <summary>
        /// Reproduce the bug from https://github.com/ProtonBlazor/ProtonBlazor/issues/9585
        ...
        public async Task DataGrid_ResizeColumn_WhenNeighboringColumnIsHidden()
        {
            ...
            var dgComp = comp.FindComponent<ProDataGrid<DataGridHideAndResizeTest.Model>>();

            // Act : Hide the middle column and resize the first column

            // Open column the second column header menu
            var columnMenu = comp.FindAll("th .pro-menu button").ElementAt(1);
            await columnMenu.ClickAsync();

            // Click on the menu item 'Hide'
            await comp.WaitForAssertionAsync(() => comp.FindAll(".pro-menu-item").ElementAt(1));
            var hideMenuItem = comp.FindAll(".pro-menu-item").ElementAt(1);
            ...
            // Mouse click down
            var resizer = () => comp.FindAll(".pro-resizer").ElementAt(0);
        ...
        public void QuerySortExtension()
        {
            ...
            query.ToString().Should().Be("ProtonBlazor.UnitTests.TestComponents.DataGrid.DataGridFiltersTest+Model[].OrderByDescending(x => x.Name).ThenBy(x => x.Age)");
        }
        ...
        public void QuerySortExtensionTestAscendingThenDescending()
        {
            ...
            var query = Array.Empty<DataGridFiltersTest.Model>().AsQueryable().OrderBy([nameSort, ageSort]);
            query.ToString().Should().Be("ProtonBlazor.UnitTests.TestComponents.DataGrid.DataGridFiltersTest+Model[].OrderBy(x => x.Name).ThenByDescending(x => x.Age)");
        }
        ...
        public async Task DataGridEnumLocalization()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterEnumLocalizationTest.Item>>();
            ...
            IElement SelectElement() => comp.Find("div.pro-select.filter-input");
            await SelectElement().MouseDownAsync(new MouseEventArgs());

            var items = comp.FindAll("div.pro-list-item").ToArray();
        ...
        public async Task DataGridValidatorFormBinding()
        {
            ...
            var form = comp.FindComponent<ProForm>().Instance;
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridValidatorTest.Item>>().Instance;
        ...
        public async Task TestCurrentPageParameterTwoWayBinding()
        {
            ...
            var dataGridComponent = comp.FindComponent<ProDataGrid<int>>();
            ...
            await comp.WaitForAssertionAsync(() => comp.Find(".pro-table-body .pro-table-row .pro-table-cell").TextContent.Should().Be("1"));
            ...
            await comp.WaitForAssertionAsync(() => comp.Find(".pro-table-body .pro-table-row .pro-table-cell").TextContent.Should().Be("2"));

            // Assert user input correctly updates the CurrentPage parameter value by clicking the "Next Page" button in the pager.
            await comp.FindAll(".pro-table-pagination-actions .pro-button-root")[2].ClickAsync();
            await comp.WaitForAssertionAsync(() => dataGrid.CurrentPage.Should().Be(2));
            await comp.WaitForAssertionAsync(() => comp.Find(".pro-table-body .pro-table-row .pro-table-cell").TextContent.Should().Be("3"));
        }
        ...
        public async Task DataGridUniqueRowKey()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<string>>();
            ...
            await comp.InvokeAsync(() => dataGrid.Instance.SetSortAsync(sortByColumnName, SortDirection.Ascending, x => x));
            before = dataGrid.FindComponent<ProInput<string>>();
            await comp.InvokeAsync(() => dataGrid.Instance.SetSortAsync(sortByColumnName, SortDirection.Descending, x => x));
            after = dataGrid.FindComponent<ProInput<string>>();
        ...
        public async Task DataGrid_TwoWayBind_SelectedItem_SelectedItems()
        {
            ...
            var comp = Context.Render<ProDataGrid<int>>(parameters =>
            {
        ...
        public async Task DataGridSelectedItemEvents()
        {
            ...
            // find first pro-table-row and second pro-table-cell
            var firstRow = dataGrid.FindAll(".pro-table-row")[1];
        ...
        public async Task DataGridHeaderToggleHierarchy()
        {
            ...
            var headerElement = comp.Find("th.pro-header-togglehierarchy");
            headerElement.Should().NotBeNull("Header should have pro-header-togglehierarchy class when EnableHeaderToggle is true");
            headerCell.Instance.IncludeHierarchyToggle.Should().BeTrue();

            // Check that the HierarchyToggle button exists in the header
            var toggleButton = headerElement.QuerySelector(".pro-hierarchy-toggle-button");
            ...
            toggleButton = headerElement.QuerySelector(".pro-hierarchy-toggle-button");
            await toggleButton.ClickAsync();
        ...
        public async Task DataGridHeaderToggleIcon(bool rightToLeft)
        {
            ...
            var toggleButton = headerElement.QuerySelector(".pro-hierarchy-toggle-button");
            var icon = toggleButton.QuerySelector(".pro-icon-root");
            ...
            icon = headerElement.QuerySelector(".pro-hierarchy-toggle-button .pro-icon-root");
        ...
        public void SelectColumn_RowCheckbox_ShouldBeDisabled_WhenDisabledFuncReturnsTrue()
        {
            ...
            var checkbox = comp.Find("td.pro-table-cell .pro-checkbox input");
        ...
        public void SelectColumn_HeaderCheckbox_ShouldNotRender_WhenMultiSelectionIsFalse()
        {
            ...
            var headerCheckbox = comp.FindAll("th.pro-table-cell .pro-checkbox input");
        ...
        public void SelectColumn_HeaderCheckbox_ShouldRender_WhenMultiSelectionIsTrue()
        {
            ...
            var headerCheckbox = comp.Find("th.pro-table-cell .pro-checkbox input");
        ...
        public void DataGridRowDetailInitiallyExpandedObservableMultiple()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHierarchyInitiallyExpandedItemsTest.Model>>();
        ...
        public async Task DataGridRowDetailInitiallyExpandedServerMultiple()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridServerHierarchyTest.Model>>();
        ...
        public async Task DataGridShouldAllowUnsortedAscDescOnly()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridAllowUnsortedTest.Item>>();
            ...
            dataGrid = comp.FindComponent<ProDataGrid<DataGridAllowUnsortedTest.Item>>();
        ...
        public async Task DataGrid_HierarchyVisibilityToggled_SingleRowToggle()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHierarchyVisibilityToggledTest.Model>>();
        ...
        public async Task DataGrid_HierarchyColumn_HierarchyVisibilityToggled_SingleRowToggle()
        {
            ...
            await comp.Find("tbody tr button.pro-icon-button").ClickAsync(new MouseEventArgs());
        ...
        {
            var comp = Context.Render<DataGridHierarchyColumnVisibilityToggledTest>();
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHierarchyColumnVisibilityToggledTest.Model>>();
            var testComponent = comp.Instance;
        ...
        public async Task DataGrid_HierarchyColumn_HierarchyVisibilityToggled_RemovingColumnClearsCachedCallback()
        {
            ...
            comp.FindAll("tbody tr button.pro-icon-button").Should().BeEmpty();
        ...
        public async Task DataGridFilterIcons()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterIconsTest.Model>>();
        ...
        public async Task DataGridFilterTemplateUsesContextFilterIcon()
        {
            ...
            ProIconButton CustomFilterButton() =>
                comp.FindComponents<ProIconButton>()
        ...
        public async Task DataGrid_SelectedItems_ShouldUpdateWhenSingleItemRemoved()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSelectionCleanupTest.Model>>();
            var testComponent = comp.Instance;
            ...
            await comp.WaitForAssertionAsync(() =>
                dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(3));
        }
        ...
        public async Task DataGrid_SelectedItems_ShouldUpdateWhenMultipleItemsRemoved()
        {
            ...
            await comp.WaitForAssertionAsync(() =>
                dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(2));
        }
        ...
        public async Task DataGrid_SelectedItems_ShouldClearWhenCollectionCleared()
        {
            ...
            await comp.WaitForAssertionAsync(() => dataGrid.Instance.GetState(x => x.SelectedItems).Count.Should().Be(0));
            await comp.WaitForAssertionAsync(() =>
                dataGrid.FindAll(".pro-table-body .pro-table-row").Count.Should().Be(0));
        }
        ...
        public async Task DataGrid_SelectedItem_ShouldUpdateWhenItemRemoved()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHierarchyCleanupTest.Model>>();
            var testComponent = comp.Instance;
        ...
        public async Task DataGrid_SelectedItems_ShouldUpdateWhenItemRemovedFromList()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridSelectionCleanupListTest.Model>>();
            var testComponent = comp.Instance;
        ...
        public async Task DataGrid_OpenHierarchies_ShouldClearWhenExpandedItemRemovedFromList()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridHierarchyCleanupListTest.Model>>();
            var testComponent = comp.Instance;
        ...
        public async Task DataGridFilterDefinitionsPreloadTest()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridFilterDefinitionsPreloadTest.Model>>();
        ...
        public async Task DataGridFilterDefinitionsPreloadColumnFilterRowTest()
        {
            ...
            var dataGrid = comp.FindComponent<ProDataGrid<DataGridPreloadFilterRowTest.Model>>();
