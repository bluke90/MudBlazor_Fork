...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class DialogTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProDialogProvider>();
        ...
        public async Task Simple()
        {
            ...
            comp.Find("div.pro-dialog-container").Should().NotBe(null);
            comp.Find("p.pro-typography").TrimmedText().Should().Be("Wabalabadubdub!");
            // close by click outside the dialog
            comp.Find("div.pro-overlay").Click();
            comp.Markup.Trim().Should().BeEmpty();
            ...
            await comp.InvokeAsync(async () => dialogReference = await service.ShowAsync<DialogOkCancel>());
            await comp.InvokeAsync(async () => dialogReference = await service.ShowAsync<DialogOkCancel>());
            var cont = comp.FindAll("div.pro-dialog-container");
            cont.Count.Should().Be(2);
            await comp.InvokeAsync(() => comp.Instance.DismissAll());
            cont = comp.FindAll("div.pro-dialog-container");
        ...
        public async Task InlineDialog()
        {
            ...
            comp1.FindComponents<ProButton>().Count.Should().Be(1);
            // open the dialog
            ...
            comp.Find("p.pro-typography").TrimmedText().Should().Be("Wabalabadubdub!");
            comp.Find("div.pro-dialog").GetAttribute("class").Should().Contain("pro-dialog-width-full");
            // close by click on ok button
        ...
        /// <summary>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/4098
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/8746
        /// </summary>
        [Test]
        public async Task InlineDialogShowMethod()
        {
            ...
            await comp1.WaitForAssertionAsync(() => comp.Find("div.pro-dialog-container").Should().NotBe(null));
            ...
            // close by click on ok button
            comp.Find(".pro-message-box button").Click();
        ...
        /// </summary>
        /// <remarks>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/11789
        /// </remarks>
        [Test]
        public void InlineDialog_OpenCancelOpen()
        {
            ...
            comp.FindAll(".pro-dialog-content").Should().BeEmpty();
            ...
            comp.Find(".pro-dialog-content").InnerHtml.Trim().Should().NotBeEmpty();

            // Act : Cancel by click outside

            comp.Find("div.pro-overlay-dialog").Click();
        ...
        {
            var provider = Context.Render<ProDialogProvider>();
            provider.Markup.Trim().Should().BeEmpty();
            var service = Context.Services.GetRequiredService<IDialogService>();
            service.Should().NotBe(null);
            // displaying the component with the inline dialog only renders the open button
            var comp = Context.Render<TestNestedInlineDialog>();
            comp.FindComponents<ProButton>().Count.Should().Be(1);
            // open the dialog
            comp.Find("button").Click();
            await comp.WaitForAssertionAsync(() =>
                provider.Find("div.pro-dialog-container").Should().NotBe(null)
            );
            provider.Find("p.pro-typography").TrimmedText().Should().Be("Scorpiany!");
            provider.FindComponents<ProText>().Count.Should().Be(2); //counts both the dialog header and the text in our test component
            ...
            provider.FindAll("p.pro-typography")[1].TrimmedText().Should().Be("Nested dialog!");
            provider.FindComponents<ProText>().Count.Should().Be(4); //now we have another ProText
        }
        ...
        public async Task InlineDialog_Should_UpdateIsVisibleOnClose()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-dialog-container").Count.Should().Be(1));
            await comp.InvokeAsync(() => comp.WaitForElement("div.pro-overlay").Click());
        ...
        public async Task InlineDialogShouldNotCloseAfterStateHasChanged()
        {
            ...
            comp1.Find("button").Click();
            // rate star
            comp.Find("span.pro-rating-item").FirstElementChild.Click();
            // check if is still opened
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-dialog-container").Should().NotBe(null), TimeSpan.FromSeconds(5));
        }
        ...
        public async Task DialogShouldUpdateTitleContent()
        {
            ...
            IDialogReference dialogReference = null;
            // open simple test dialog
            await comp.InvokeAsync(async () => dialogReference = await service.ShowAsync<DialogThatUpdatesItsTitle>());
            dialogReference.Should().NotBe(null);
            //comp.Find("div.pro-dialog-container").Should().NotBe(null);
            comp.Find("div.pro-dialog-content").TrimmedText().Should().Be("Body:");
            comp.Find("div.pro-dialog-title").TrimmedText().Should().Be("Title:");
            // click on ok button should set title and content
            comp.FindAll("button")[1].Click();
            comp.Find("div.pro-dialog-content").TrimmedText().Should().Be("Body: Test123");
            comp.Find("div.pro-dialog-title").TrimmedText().Should().Be("Title: Test123");
        }
        ...
        public async Task DialogShouldNotOverwriteParameters()
        {
            ...
            var textField = comp.FindComponent<ProInput<string>>().Instance;
        ...
        public async Task DialogKeyboardNavigation()
        {
            ...
            var dialogInstance1 = dialog1.ProDialog.GetDialogContainer();
            ...
            var dialogInstance2 = dialog2.ProDialog.GetDialogContainer();
            comp.Markup.Trim().Should().NotBeEmpty();
        ...
        public async Task DialogKeyboardEvents()
        {
            ...
            dialogReference.Should().NotBe(null);
            var dialog1 = ((DialogOkCancel)dialogReference.Dialog)!;
            var dialogInstance = dialog1.ProDialog.GetDialogContainer();
        ...
        public async Task DialogHandlesOnBackdropClickEvent()
        {
            ...
            await comp.InvokeAsync(async () => dialogReference = await service.ShowAsync<DialogWithOnBackdropClickEvent>());
            dialogReference.Should().NotBe(null);
            comp.Find("div.pro-dialog-title").TrimmedText().Should().Be("Title:");
            ...
            comp.Find("div.pro-dialog-title").TrimmedText().Should().Be("Title: Backdrop clicked");
        }

        /// <summary>
        /// Open Inline Dialog and the from the inline dialog another normal dialog
        /// while closing the inline dialog.
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/4871
        /// </summary>
        [Test]
        public async Task InlineDialogBug4871()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindComponent<ProMessageBox>());
            var messageBox = comp.FindComponent<ProMessageBox>();
        ...
        public async Task DialogToggleFullscreenOptions()
        {
            ...
            await comp.InvokeAsync(async () => dialogReference = await service.ShowAsync<DialogToggleFullscreen>());
            dialogReference.Should().NotBe(null);

            comp.Find("div.pro-dialog").GetAttribute("class").Should().Be("pro-dialog pro-dialog-width-sm");
            comp.Find("button").Click();
            comp.Find("div.pro-dialog").GetAttribute("class").Should().Be("pro-dialog pro-dialog-fullscreen");
            comp.Find("button").Click();
            comp.Find("div.pro-dialog").GetAttribute("class").Should().Be("pro-dialog pro-dialog-width-sm");
        }
        ...
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/10180
        /// </summary>
        [Test]
        ...
        public async Task InlineAsyncDialogShouldHonorClass()
        {
            ...
            comp.Find("button").Click();
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-dialog").ClassList.Should().Contain("test-class"));
            comp.Find("div.pro-dialog-content").ClassList.Should().NotContain("test-class");
            comp.Find("div.pro-dialog-content").ClassList.Should().Contain("content-class");
            // check if tag is ok
            var dialogInstance = comp.FindComponent<ProDialog>().Instance;
        ...
        public async Task AsyncDialogShouldHonorClass()
        {
            ...
            var dialogReference = await dialogReferenceLazy.Value;
            dialogReference.Should().NotBe(null);
            comp.Find("div.pro-dialog").ClassList.Should().Contain("test-class");
            comp.Find("div.pro-dialog-content").ClassList.Should().NotContain("test-class");
            comp.Find("div.pro-dialog-content").ClassList.Should().Contain("content-class");
        }
        ...
        public async Task ShowGeneric_ShouldProvideDefaultOptions_WhenOverloadIsCalled()
        {
            ...
            // Act
            await provider.InvokeAsync(async () => await service.ShowAsync<DialogOkCancel>("Custom title"));
            var dialogInstance = provider.FindComponent<ProDialogContainer>();
        ...
        public async Task ShowGeneric_ShouldProvideCorrectOptions_WhenOverloadIsCalled()
        {
            ...
            // Act
            await provider.InvokeAsync(async () => await service.ShowAsync<DialogOkCancel>("Custom title", new DialogOptions { CloseButton = true }));
            var dialogInstance = provider.FindComponent<ProDialogContainer>();
        ...
        public async Task Show_ShouldRenderComponent()
        {
            ...
            // Act
            await provider.InvokeAsync(async () => await service.ShowAsync(typeof(DialogOkCancel)));
        ...
        public async Task Show_ShouldProvideDefaultOptions_WhenOverloadIsCalled()
        {
            ...
            // Act
            await provider.InvokeAsync(async () => await service.ShowAsync(typeof(DialogOkCancel), "Custom title"));
            var dialogInstance = provider.FindComponent<ProDialogContainer>();
        ...
        public async Task Show_ShouldProvideCorrectOptions_WhenOverloadIsCalled()
        {
            ...
            // Act
            await provider.InvokeAsync(async () => await service.ShowAsync(typeof(DialogOkCancel), "Custom title", new DialogOptions { CloseButton = true }));
            var dialogInstance = provider.FindComponent<ProDialogContainer>();
        ...
        public async Task Show_ShouldPassDialogParametersToDialog()
        {
            ...
            await provider.InvokeAsync(async () =>
                await service.ShowAsync(typeof(DialogWithActionsClass), "Custom title", new DialogParameters<DialogWithActionsClass> { { x => x.ActionsClass, "custom-class" } }));
        ...
        public async Task ShowAsync_FromNonUiThreadShouldAddInstance()
        {
            // Arrange
            var service = Context.Services.GetRequiredService<IDialogService>();
            _ = Context.Render<ProDialogProvider>();
            var invoked = false;
        ...
        [TestCase("", false, "pro-dialog-content")]
        [TestCase("", true, "pro-dialog-content pro-dialog-no-side-padding")]
        [TestCase("my-class", false, "pro-dialog-content my-class")]
        [TestCase("my-class", true, "pro-dialog-content pro-dialog-no-side-padding my-class")]
        public async Task DialogWithContentClassValueShouldRenderExpectedClassname(string contentClass, bool disablePadding, string expectedClassname)
        {
            ...
            comp.Find("div.pro-dialog-content").GetAttribute("class").Should().Be(expectedClassname);
        }

        [TestCase("", "pro-dialog-actions")]
        [TestCase("my-class", "pro-dialog-actions my-class")]
        public async Task DialogWithActionsClassValueShouldRenderExpectedClassname(string actionsClass, string expectedClassname)
        {
            ...
            comp.Find("div.pro-dialog-actions").GetAttribute("class").Should().Be(expectedClassname);
        }

        [TestCase("", "pro-dialog-title")]
        [TestCase("my-title-class my-second-class", "pro-dialog-title my-title-class my-second-class")]
        public async Task DialogWithTitleClassValueShouldRenderExpectedClassname(string titleClass, string expectedClassname)
        {
            ...
            comp.Find("div.pro-dialog-title").GetAttribute("class").Should().Be(expectedClassname);
        }
        ...
        public async Task DialogWithTitleShouldLinkDialogToTitleForAssistiveTechnologies()
        {
            ...
            var title = comp.Find("div.pro-dialog-title");
        ...
        public async Task DialogWithoutHeaderShouldNotRenderAriaLabelledBy()
        {
            ...
            comp.FindAll("div.pro-dialog-title").Should().BeEmpty();
        }
        ...
        public async Task DialogWithNestedDialogOptionShouldNotReset()
        {
            ...
            var closeButton = () => comp.Find("button.pro-button-close");
            ...
            var messageBox = () => comp.Find("div.pro-message-box");

            // close message box by clicking on yes button.
            messageBox().Should().NotBeNull();
            comp.FindAll(".pro-dialog-actions button")[1].Click();
        ...
        public async Task DuplicateDialog()
        {
            ...
            comp.FindComponents<ProDialog>().Count.Should().Be(1);
        }
        ...
        public async Task Dialog_TitleContent_And_ProgressBar_ShouldUpdate()
        {
            ...
            var dialog = comp.Find("div.pro-dialog");

            dialog.Should().NotBeNull();
            dialog.TextContent.Trim().Should().Be("Initial state"); // Initial title
            comp.FindComponent<ProProgressLinear>().Instance.Value.Should().Be(0); // Initial progress value - 0

            // Wait for mid-progress (simulate that loop is progressing)
            await Task.Delay(1000);
            //comp.Render();

            dialog = comp.Find("div.pro-dialog");
            dialog.TextContent.Should().Contain("Progress"); //change from "Initial state" to "Progress"

            var progressComponent = comp.FindComponent<ProProgressLinear>();
            ...
            comp.Markup.Trim().Should().NotContain("pro-dialog");
        }
        ...
        public async Task HandleBackgroundClickAsync_Should_Call_RefocusDialogAsync_When_BackdropClick_Disabled()
        {
            ...
            comp.Find("div.pro-dialog-container").Should().NotBeNull(); // Dialog is open
            comp.Find("div.pro-overlay").Click(); // Simulate a click on the backdrop

            //Assert
            comp.Find("div.pro-dialog-container").Should().NotBeNull(); // Dialog should still be open
        ...
        public async Task HandleBackgroundClickAsync_Should_Call_OnBackdropClick_And_RefocusDialog_When_Delegate_Defined()
        {
            ...
            // Act
            await dialogComponent.FindComponent<ProButton>().Find("button").ClickAsync(new MouseEventArgs()); // Open the dialog
            ...
            await comp.Find("div.pro-overlay").ClickAsync(new MouseEventArgs()); // Simulate a click on the backdrop

            // Assert
            comp.Find("div.pro-dialog-container").Should().NotBeNull(); // Dialog should still be open (not closed)
        ...
        /// <summary>
        /// Test that DefaultFocus property on ProDialogProvider is properly cascaded to dialogs
        /// </summary>
        [Test]
        public async Task DialogProvider_DefaultFocus_ShouldCascadeToDialogs()
        {
            ...
            var comp = Context.Render<ProDialogProvider>(parameters => parameters
            ...
            dialogReference.Should().NotBeNull();
            comp.Find("div.pro-dialog-container").Should().NotBeNull();
        ...
        /// <summary>
        /// Test that ProDialog respects explicit DefaultFocus parameter over global setting
        /// </summary>
        [Test]
        public async Task Dialog_ExplicitDefaultFocus_ShouldOverrideGlobalSetting()
        {
            ...
            {
                [nameof(ProDialog.DefaultFocus)] = DefaultFocus.FirstChild
            };
            IDialogReference dialogReference = null;
        ...
        public async Task CloseButton_ShouldHavePreventDefaultOnMouseDownAttribute()
        {
            ...
            // Assert
            var closeBtn = comp.Find(".pro-button-close");
