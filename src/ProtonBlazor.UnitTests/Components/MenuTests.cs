...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class MenuTests : BunitTest
    {
        ...
        {
            // https://github.com/ProtonBlazor/ProtonBlazor/issues/4063

            var comp = Context.Render<MenuTest1>();
            var menu = comp.FindComponent<ProMenu>();

            await comp.FindAll("button.pro-button-root")[0].ClickAsync();
            comp.FindAll("div.pro-menu-item").Count.Should().Be(2);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync();
            ...
            await comp.FindAll("a.pro-menu-item")[1].ClickAsync();
        ...
        public async Task OpenMenu_ClickSecondItem_CheckClosed()
        {
            ...
            comp.FindAll("div.pro-menu-item").Count.Should().Be(2);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("a.pro-menu-item")[0].ClickAsync();
            await comp.WaitForAssertionAsync(() => { comp.FindAll("div.pro-popover-open").Count.Should().Be(0); });
        }
        ...
        public async Task OpenMenu_ClickClassItem_CheckClass()
        {
            ...
            comp.FindAll("div.pro-menu-item").Count.Should().Be(2);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            comp.FindAll("div.pro-menu-item.test-class").Count.Should().Be(1);
        }
        ...
        public async Task OpenMenu_CheckClass()
        {
            var comp = Context.Render<MenuTest1>();
            await comp.FindAll("button.pro-button-root")[0].ClickAsync();
            comp.Find("div.pro-popover").ClassList.Should().Contain("menu-popover-class");
        }
        ...
        public async Task Menu_ModelessOverlay_IgnoresActivatorRootForAutoCloseHitTesting()
        {
            ...
            await comp.Find("button.pro-button-root").ClickAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-popover-open").Count.Should().Be(1));

            var menuRoot = comp.Find("div.pro-menu");
        ...
        {
            var comp = Context.Render<MenuTest1>();
            var menu = comp.FindComponent<ProMenu>().Instance;
        ...
        public async Task MouseOver_PointerLeave_ShouldClose()
        {
            ...
            await comp.Find("div.pro-menu").PointerEnterAsync();
            await comp.WaitForAssertionAsync(() => comp.Markup.Should().Contain("pro-popover-open"));

            // Close it again and wait for that to happen.
            await comp.Find("div.pro-menu").PointerLeaveAsync();
        ...
        public async Task MouseOver_Hover_ShouldOpenMenu()
        {
            ...
            IElement Menu() => comp.Find(".pro-menu");
        ...
        {
            var hoverDelay = ProGlobal.MenuDefaults.HoverDelay;
            var comp = Context.Render<MenuTestMouseOver>();
            var menu = comp.FindComponent<ProMenu>().Instance;
        ...
        public void ActivatorContent_Disabled_CheckDisabled()
        {
            ...
            var activator = comp.Find("div.pro-menu-activator");
            activator.ClassList.Should().Contain("pro-disabled");
        ...
        public async Task Default_Disabled_CheckDisabled()
        {
            ...
            var button = comp.Find("button.pro-button-root");
        ...
        public async Task ToggleEventArgs()
        {
            ...
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            await comp.InvokeAsync(() => menu.Instance.ToggleMenuAsync(new MouseEventArgs()));
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
        ...
        public async Task Menu_LeftAndRightClick_CheckClosed()
        {
            ...
            await comp.FindAll("button.pro-button-root")[0].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            comp.FindAll("div.pro-menu-item").Count.Should().Be(1);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            await comp.FindAll("button.pro-button-root")[0].ClickAsync(new MouseEventArgs() { Button = 2 });
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            //Standart button menu -- right click
            await comp.FindAll("button.pro-button-root")[1].ClickAsync(new MouseEventArgs() { Button = 2 });
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            comp.FindAll("div.pro-menu-item").Count.Should().Be(1);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            await comp.FindAll("button.pro-button-root")[1].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            //Icon button menu -- left click
            await comp.FindAll("button.pro-button-root")[2].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            comp.FindAll("div.pro-menu-item").Count.Should().Be(1);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            await comp.FindAll("button.pro-button-root")[2].ClickAsync(new MouseEventArgs() { Button = 2 });
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            //Icon button menu -- right click
            await comp.FindAll("button.pro-button-root")[3].ClickAsync(new MouseEventArgs() { Button = 2 });
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            comp.FindAll("div.pro-menu-item").Count.Should().Be(1);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            await comp.FindAll("button.pro-button-root")[3].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            //Activator content menu -- left click
            await comp.FindAll("button.pro-button-root")[4].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            comp.FindAll("div.pro-menu-item").Count.Should().Be(1);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            await comp.FindAll("button.pro-button-root")[4].ClickAsync(new MouseEventArgs() { Button = 2 });
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            ...
            var rightClickMenus = comp.FindAll("div.pro-menu");
            ...
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            await comp.FindAll("button.pro-button-root")[5].ClickAsync();
        ...
        public async Task MenuItem_Should_RenderIcons()
        {
            ...
            await comp.Find(".pro-menu-button-activator").ClickAsync();
            await comp.WaitForElementAsync("div.pro-popover-open");

            comp.FindAll(".pro-menu-list div.pro-menu-item svg.pro-svg-icon.pro-menu-item-icon.pro-icon-size-medium").Count.Should().Be(3);
        }
        ...
        public async Task MenuItem_Should_RenderIconColors()
        {
            ...
            comp.FindAll("div.pro-menu-item").Count.Should().Be(3);
            var items = comp.FindAll("div.pro-menu-item");

            items[0].QuerySelector("svg").ClassList.Should().NotContainMatch("pro-*-text");
            items[1].QuerySelector("svg").ClassList.Should().Contain("pro-secondary-text");
            items[2].QuerySelector("svg").ClassList.Should().Contain("pro-tertiary-text");
        }

        /// <summary>
        /// https://github.com/ProtonBlazor/ProtonBlazor/issues/6645
        /// </summary>
        [Test]
        public async Task OnClickErrorContentCaughtException()
        {
            var comp = Context.Render<MenuErrorContenCaughtException>();
            await comp.FindAll("button.pro-button-root")[0].ClickAsync(new MouseEventArgs());
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            comp.FindAll("div.pro-menu-item").Count.Should().Be(1);
            await comp.FindAll("div.pro-menu-item")[0].ClickAsync(new MouseEventArgs());
            var mudAlert = comp.FindComponent<ProAlert>();
            var text = mudAlert.Find("div.pro-alert-message");
        ...
        public async Task OpenMenu_CloseMenuOnClick_CheckStillOpen()
        {
            ...
            comp.FindAll("div.pro-menu-item").Count.Should().Be(2);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(2);
            await comp.FindAll("div.pro-menu-item")[1].ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
        }
        ...
        public async Task ItemsWithHrefShouldRenderAsAnchor()
        {
            ...
            await comp.FindAll("button.pro-button-root")[0].ClickAsync();
            comp.FindAll("div.pro-menu-item").Count.Should().Be(1);
            comp.FindAll("a.pro-menu-item").Count.Should().Be(3);
            comp.FindAll("a.pro-menu-item")[0].Attributes["href"].TextContent.Should().Be("https://www.test.com/1");
            comp.FindAll("a.pro-menu-item")[1].Attributes["href"].TextContent.Should().Be("https://www.test.com/2");
            await comp.FindAll("a.pro-menu-item")[2].ClickAsync(); // disabled
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1);
            await comp.FindAll("a.pro-menu-item")[1].ClickAsync(); // enabled
            await comp.WaitForAssertionAsync(() =>
            {
                comp.FindAll("div.pro-popover-open").Count.Should().Be(0);
            });
        ...
        public async Task OpenMenuAsync_Should_Set_FixedPosition()
        {
            ...
            var menuComponent = comp.FindComponent<ProMenu>();
            ...
            var popover = comp.Find("div.pro-popover");

            // Assert
            popover.ClassList.Should().Contain("pro-popover-anchor-top-left");
            popover.ClassList.Should().Contain("pro-popover-position-override");
        ...
        public void ContextMenu_Should_NotHaveButton_And_NotBeVisible()
        {
            ...
            // Assert
            comp.FindAll("button.pro-button-root").Count.Should().Be(0);
            menuComponent.Find("div.pro-menu").ClassList.Should().Contain("pro-menu-button-hidden");
        }
        ...
        public void ContextMenu_WithLabel_Should_HaveButton_And_BeVisible()
        {
            ...
            menuComponent.Find("div.pro-menu").ClassList.Should().NotContain("pro-menu-button-hidden");
        }
        ...
        public async Task Open_TwoWayBinding()
        {
            ...
            comp.FindAll("div.pro-popover-open").Count.Should().Be(0, "No popovers should be visible.");
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                ...
                comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "One popover should be visible after opening.");
            });
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                ...
                comp.Instance.Open.Should().BeFalse();
                comp.FindAll("div.pro-popover-open").Count.Should().Be(0, "Popover should disappear after closing.");
            });
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                ...
                comp.Instance.Open.Should().BeTrue();
                comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Popover should reappear after reopening.");
            });
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                ...
                comp.Instance.Open.Should().BeTrue();
                comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Popover count should remain the same.");
            });
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                ...
                comp.Instance.Open.Should().BeFalse();
                comp.FindAll("div.pro-popover-open").Count.Should().Be(0, "Popover should no longer be visible.");
            });
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                menu.Instance.GetState(x => x.Open).Should().BeTrue("Clicking the button again should open the menu.");
                comp.Instance.Open.Should().BeTrue();
                comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Popover should appear again.");
            });
        }
        ...
        public async Task ActivatorClass()
        {
            ...
            comp.FindAll(".pro-menu")[0].FirstElementChild.ClassName.Should().Contain("pro-menu-button-activator");

            comp.FindAll(".pro-menu")[1].FirstElementChild.ClassName.Should().Contain("pro-menu-icon-button-activator");

            comp.FindAll(".pro-menu")[2].FirstElementChild.ClassName.Should().Contain("pro-menu-activator");

            await comp.FindAll(".pro-menu")[3].FirstElementChild.ClickAsync();

            comp.Find(".pro-popover-open .pro-menu-list .pro-menu-item.pro-menu-sub-menu-activator").Should().NotBeNull();
        }
        ...
        public void ShouldRenderLabelOrChildContent()
        {
            ...
            var childContent = comp.FindAll(".pro-menu-item")[0].InnerHtml;
            var label = comp.FindAll(".pro-menu-item")[1].InnerHtml;
            childContent.Should().BeEquivalentTo(label);

            // ChildContent should override Label.
            comp.FindAll(".pro-menu-item")[2].InnerHtml.Should().Contain("ContentText");
            comp.FindAll(".pro-menu-item")[2].InnerHtml.Should().NotContain("LabelText");
        }
        ...
        public async Task OpenNestedMenu()
        {
            ...
            await comp.Find("div.pro-menu-item:contains('1.3')").ClickAsync();

            // Ensure both the main menu and the nested menu are open
            comp.FindAll("div.pro-popover-open").Count.Should().Be(2);
        }
        ...
        public async Task ClickingMenuItem_ClosesNestedMenu()
        {
            ...
            await comp.Find("div.pro-menu-item:contains('2.2')").ClickAsync();
        ...
        public async Task MenuContext_Should_ToggleMenu_Via_ToggleMenu()
        {
            ...
            var comp = Context.Render<ProMenu>(parameters => parameters
        ...
        public async Task Menu_ButtonActivator_WithContext()
        {
            ...
            // The ProButton inside the ActivatorContent should be rendered
            var button = comp.Find("button.pro-button-root");
        ...
        public async Task Menu_PointerEvents_ShowHide_WithDebounce()
        {
            ...
            await comp.Find("button:contains('1')").ClickAsync();
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Main menu should be open");

            // 1. Test SHOW debounce behavior
            // Trigger pointer enter on submenu item
            var menuItem = comp.Find("div.pro-menu:contains('1.3')");
            ...
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Submenu should not open immediately");

            // After the hover delay, submenu should become visible
            await Task.Delay(hoverDelay + 50);
            comp.FindAll("div.pro-popover-open").Count.Should().Be(2, "Submenu should open after hover delay");
            ...
            comp.FindAll("div.pro-popover-open").Count.Should().Be(2, "Submenu should remain open immediately after pointer leave");

            // Wait less than the delay
            await Task.Delay(hoverDelay / 2);
            comp.FindAll("div.pro-popover-open").Count.Should().Be(2, "Submenu should still be open before hide delay completes");

            // After the full delay, submenu should close
            await Task.Delay(hoverDelay + 50);
            comp.FindAll("div.pro-popover-open").Count.Should().Be(1, "Submenu should close after full hide delay (2x hover delay)");
        }
        ...
        public async Task Menu_PointerEvents_MultipleLevels()
        {
            ...
            var menuItem1 = comp.Find("div.pro-menu:contains('1.3')");
            menuItem1.PointerEnterAsync(new PointerEventArgs()).CatchAndLog();
            await Task.Delay(hoverDelay + 100);
            comp.FindAll("div.pro-popover-open").Count.Should().Be(2, "First level submenu should be open");

            // Open second level submenu
            var menuItem2 = comp.Find("div.pro-menu:contains('2.1')");
            menuItem2.PointerEnterAsync(new PointerEventArgs()).CatchAndLog();
            await Task.Delay(hoverDelay + 100);
            comp.FindAll("div.pro-popover-open").Count.Should().Be(3, "Second level submenu should be open");
        ...
        public async Task Menu_ArrowDown_FocusSecondItem()
        {
            ...
            await comp.Find(".pro-menu-button-activator").ClickAsync(new MouseEventArgs());
        ...
        public async Task Menu_ArrowUp_FocusLastItem()
        {
            ...
            var allFocusableItems = comp.FindAll(".pro-menu-item[tabindex='0']");
        ...
        public async Task Menu_ArrowRight_OpensNestedMenu()
        {
            ...
            comp.FindAll(".pro-popover-open").Count.Should().BeGreaterThan(1);
        }
        ...
        public async Task Menu_ArrowRight_NoFurtherAction()
        {
            ...
            comp.FindAll(".pro-popover-open").Count.Should().Be(1);
        }
        ...
        public async Task Menu_ArrowLeft_ClosesNestedMenu()
        {
            ...
            var openBefore = comp.FindAll(".pro-popover-open");
            ...
            var openAfter = comp.FindAll(".pro-popover-open");
        ...
        public async Task Menu_Enter_ClosesMenuOnLinkItem()
        {
            ...
            comp.FindAll(".pro-popover-open").Should().BeEmpty();
        }
        ...
        public async Task Menu_DisabledItem_IsFocusableButNotInvokable()
        {
            ...
            var disabledItem = comp.Find(".pro-menu-item.pro-disabled");
        ...
        public async Task Menu_DisabledItem_HasCorrectAccessibilityAttributes()
        {
            ...
            disabledItem.GetAttribute("aria-disabled").Should().Be("true");
            disabledItem.GetAttribute("class").Should().Contain("pro-disabled");
        ...
        public async Task TrackKeyboardInteraction_WhenArrowDown_FocusesFirstItem()
        {
            ...
            var focusedIndex = (int)typeof(ProMenu)
        ...
        public async Task TrackKeyboardInteraction_WhenArrowUp_FocusesLastItem()
        {
            ...
            var menuItems = (IReadOnlyList<object>)typeof(ProMenu)
        ...
        {
            var menu = Context.Render<ProMenu>();
        ...
        {
            var menu = Context.Render<ProMenu>(p =>
            {
        ...
        public async Task NestedMenu_SubMenuArrow_PointsRightInLtr()
        {
            var comp = Context.Render<MenuWithNestingTest>();
            await comp.Find("button:contains('1')").ClickAsync();
            var icon = comp.Find(".pro-menu-submenu-icon");
