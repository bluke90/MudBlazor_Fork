...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class ChartTests : BunitTest
    {
        ...
        public async Task PieChartSelection()
        {
            ...
            await comp.FindAll("path.pro-chart-serie")[0].ClickAsync();
            comp.Find("h6").InnerHtml.Trim().Should().Be("Selected portion of the chart: 0");
            await comp.FindAll("path.pro-chart-serie")[3].ClickAsync();
        ...
        public async Task LineChartSelection()
        {
            ...
            comp.Find("h6").InnerHtml.Trim().Should().Be("Selected portion of the chart: -1");
            // now click something and see that the selected index changes:
            await comp.FindAll("path.pro-chart-line")[0].ClickAsync();
            comp.Find("h6").InnerHtml.Trim().Should().Be("Selected portion of the chart: 0");
            await comp.FindAll("path.pro-chart-line")[1].ClickAsync();
            comp.Find("h6").InnerHtml.Trim().Should().Be("Selected portion of the chart: 1");
        }
        ...
        public async Task BarChartSelection()
        {
            ...
            //check tooltip
            comp.FindAll("path.pro-chart-bar")[0].MouseOver();
            comp.Find("tspan").InnerHtml.Trim().Should().Be("40");

            // now click something and see that the selected index changes:
            await comp.FindAll("path.pro-chart-bar")[0].ClickAsync();
            comp.Find("h6").InnerHtml.Trim().Should().Be("Selected portion of the chart: 0");

            comp.FindAll("path.pro-chart-bar")[10].MouseOver();
            comp.Find("tspan").InnerHtml.Trim().Should().Be("24");

            await comp.FindAll("path.pro-chart-bar")[10].ClickAsync();
            comp.Find("h6").InnerHtml.Trim().Should().Be("Selected portion of the chart: 1");
        }
        ...
        public async Task ChartYAxisFormat(ChartType chartType)
        {
            ...
            var yaxis = comp.FindAll("g.pro-charts-yaxis");
            ...
            yaxis = comp.FindAll("g.pro-charts-yaxis");
            yaxis.Should().NotBeNull();
        ...
        public void HeatMap_ShouldBuildLegendsCorrectly()
        {
            ...
            var legends = comp.FindAll(".pro-chart-heatmap-legend");
        ...
        public void HeatMap_ShouldFormatValueForDisplayCorrectly()
        {
            ...
            var formattedValues = comp.FindAll(".pro-chart-cell");
        ...
        public void HeatMap_ShouldHandleEmptyAndNullData()
        {
            ...
            var cells = comp.FindAll(".pro-chart-cell");
        ...
        public void HeatMap_ShouldRenderAxisLabelsInCorrectPosition(Enum position)
        {
            ...
            var axisLabels = comp.FindAll("g text.pro-charts-xaxis, g text.pro-charts-yaxis");
        ...
        public void HeatMap_ShouldCalculateDynamicFontSize()
        {
            ...
            var cellText = comp.Find(".pro-chart-cell text");
        ...
        public void HeatMap_ShouldGenerateCorrectColorPaletteForDifferentInputs()
        {
            ...
            var singleColorComp = Context.Render<ProChart<double>>(parameters => parameters
                .Add(p => p.ChartType, ChartType.HeatMap)
            ...
            var multiColorComp = Context.Render<ProChart<double>>(parameters => parameters
                .Add(p => p.ChartType, ChartType.HeatMap)
        ...
        public void HeatMap_ShouldFormatValuesCorrectly(double? input, string expected)
        {
            ...
            var cellTexts = comp.FindAll(".pro-chart-cell text");
        ...
        public void HeatMap_ShouldHandleCustomHeatMapCellOverrides()
        {
            ...
            {
                builder.OpenComponent<ProHeatMapCell<double>>(0);
                builder.AddAttribute(1, "Row", 0);
                builder.AddAttribute(2, "Column", 0);
                builder.AddAttribute(3, "Value", 10.05);
                builder.AddAttribute(6, "ProColor", new ProColor("#FF5733"));
            ...
            var customContent = comp.Find(".pro-chart-cell div");
            customContent.TextContent.Trim().Should().Be("Custom Content");

            // Verify that the custom cell has the correct color
            var customCell = comp.Find(".pro-chart-cell rect");
            customCell.GetAttribute("fill").Should().Contain(new ProColor("#FF5733").ToString(ProColorOutputFormats.RGBA));
        ...
        [Test]
        public void ProHeatMapCell_ShouldThrowExceptionIfNotInMudChart()
        {
            // Attempt to render ProHeatMapCell outside of ProChart
            var exception = Assert.Throws<InvalidOperationException>(() =>
                Context.Render<ProHeatMapCell<double>>(parameters => parameters
                    .Add(p => p.Row, 0)
                    .Add(p => p.Column, 0)
                )
            );
            ...
            exception.Message.Should().Contain("ProHeatMapCell must be used inside a ProChart component.");
        }
        ...
        public async Task HeatmapChart_CanHideSeries()
        {
            ...
            comp.FindAll(".pro-chart-cell").Count.Should().Be(chartSeries.Where(x => x.Visible).Sum(x => x.Data.Count), "should equal count of visible cells");
        ...
        public void RadarChart_FillOpacity_Should_RenderInvariant_InDifferentCultures()
        {
            ...
            try
            {
                ...
                var noNbComp = Context.Render<ProChart<double>>(parameters => parameters
                ...
                var noNbOpacity = noNbComp.Find("path.pro-chart-serie").GetAttribute("fill-opacity");

                CultureInfo.CurrentCulture = CultureInfo.InvariantCulture;
                CultureInfo.CurrentUICulture = CultureInfo.InvariantCulture;

                var invariantComp = Context.Render<ProChart<double>>(parameters => parameters
                    .Add(p => p.ChartType, ChartType.Radar)
                    .Add(p => p.ChartSeries, new List<ChartSeries<double>>
                    {
                        new() { Name = "Series 1", Data = new([10, 20, 30]) }
                ...
                var invariantOpacity = invariantComp.Find("path.pro-chart-serie").GetAttribute("fill-opacity");
        ...
        public void BarChart_LongValues_ShouldNotRoundDown()
        {
            ...
            var comp = Context.Render<ProChart<long>>(parameters => parameters
            ...
            var yAxisLabels = comp.FindAll(".pro-charts-yaxis text");
        ...
        public void LineChart_LongValues_ShouldNotRoundDown()
        {
            ...
            var circles = comp.FindAll("circle.pro-chart-point");
        ...
        public void StackedBarChart_LongValues_ShouldNotRoundDown()
        {
            ...
            var barPaths = comp.FindAll("path.pro-chart-bar");
