...
namespace ProtonBlazor.UnitTests.Charts
{
    public class DonutChartTests : BunitTest
    {
        ...
        public void DonutChartEmptyData()
        {
            ...
            comp.Markup.Should().Contain("pro-chart-donut");
        }
        ...
        public void DonutChartRendersWithIntData()
        {
            ...
            comp.Markup.Should().Contain("class=\"pro-chart-donut pro-ltr\"");
            comp.Markup.Should().Contain("class=\"pro-chart-serie\"");
        ...
        public async Task DonutChart_CanHideSeries()
        {
            ...
            comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(0, "Area A path should be hidden");
            comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(1, "Area B path should remain visible");
            ...
            comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Area A path should be visible again");
            ...
            comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(0, "Area C path should be hidden");
            comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Area A path should still be visible");
            comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(1, "Area B path should still be visible");
            comp.FindAll($"path.pro-chart-serie{series4}").Count.Should().Be(1, "Area D path should still be visible");
            ...
            comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(1, "Area C path should be visible again");
        }
    }
}
