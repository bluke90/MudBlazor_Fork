...
public class ChartOptionsTests
{
    ...
    public void SankeyChartOptions_Defaults_AreExpected()
    {
        ...
        options.HighlightColor.Should().Be("var(--pro-palette-text-primary)");
    ...
    public void RadarChartOptions_Defaults_AreExpected()
    {
        ...
        options.GridLineColor.Should().Be("var(--pro-palette-divider)");
        ...
        options.AxisLineColor.Should().Be("var(--pro-palette-lines-inputs)");
