...
namespace ProtonBlazor.UnitTests.Charts
{
    public class StackedBarChartTests : BunitTest
    {
        ...
        public void StackedBarChart_DefaultRender_ShouldNotThrow()
        {
            ...
            comp.Markup.Should().Contain("pro-chart");
        }
        ...
        public void StackedBarChart_EmptyData_ShouldRenderAxesAndLegend()
        {
            ...
            comp.Markup.Should().Contain("pro-chart");
            comp.Markup.Should().Contain("class=\"pro-charts-xaxis\""); // X-axis should still render
            comp.Markup.Should().Contain("class=\"pro-charts-yaxis\""); // Y-axis should still render
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(0); // No bars
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(0); // No legend items
        }
        ...
        public void StackedBarChart_SingleSeries_ShouldRenderCorrectly()
        {
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(3); // 3 bars for 3 data points
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(1); // 1 legend item
            comp.Find("div.pro-chart-legend-item").TextContent.Should().Contain("Series 1");

            var xAxisTexts = comp.FindAll("g.pro-charts-xaxis text");
        ...
        public void StackedBarChart_MultipleSeries_ShouldRenderCorrectly()
        {
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(4);
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(2);
            var legendItems = comp.FindAll("div.pro-chart-legend-item");
        ...
        public void StackedBarChart_SeriesWithVaryingDataPoints_ShouldRenderCorrectly()
        {
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(5);
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(2);
        ...
        public async Task StackedBarChart_Dynamic_AddSeries_ShouldUpdateChart()
        {
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(2);
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(1);
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(4); // 2 from Series 1 + 2 from Series 2
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(2);
            comp.FindAll("div.pro-chart-legend-item")[1].TextContent.Should().Contain("Series 2");
        }
        ...
        public async Task StackedBarChart_Dynamic_RemoveSeries_ShouldUpdateChart()
        {
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(2); // Only Series 1's bars
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(1);
            comp.Find("div.pro-chart-legend-item").TextContent.Should().Contain("Series 1");
        }
        ...
        public async Task StackedBarChart_Dynamic_ChangeSeriesData_ShouldUpdateChart()
        {
            ...
            var initialPaths = comp.FindAll("path.pro-chart-bar");
            ...
            var updatedPaths = comp.FindAll("path.pro-chart-bar");
        ...
        public async Task StackedBarChart_Dynamic_ChangeLabels_ShouldUpdateChart()
        {
            ...
            var initialLabels = comp.FindAll("g.pro-charts-xaxis text").Select(x => x.TextContent).ToArray();
            ...
            var updatedLabels = comp.FindAll("g.pro-charts-xaxis text").Select(x => x.TextContent).ToArray();
        ...
        public void StackedBarChart_ChartOptions_ShowLegendFalse_ShouldNotRenderLegend()
        {
            ...
            comp.FindAll("div.pro-chart-legend").Should().BeEmpty();
            comp.FindAll("div.pro-chart-legend-item").Should().BeEmpty();
        }
        ...
        public void StackedBarChart_LegendPosition_ShouldApplyCorrectClass(Position position)
        {
            ...
            var chartElement = comp.Find(".pro-chart");
            var expectedClass = $"pro-chart-legend-{position.ToStringFast(true)}";
        ...
        public void StackedBarChart_ChartOptions_ChartPalette_ShouldApplyColors()
        {
            ...
            var bars = comp.FindAll("path.pro-chart-bar");
        ...
        public void StackedBarChart_WidthAndHeight_ShouldApplyToSvg(string width, string height)
        {
            ...
            var svgElement = comp.Find("svg.pro-chart-bar");
        ...
        public async Task StackedBarChart_RightToLeft_True_ShouldAdjustLegendPositionStartEnd()
        {
            ...
            var chartElement = comp.Find(".pro-chart");
            chartElement.ClassList.Should().Contain("pro-chart-legend-right");
            ...
            chartElement = comp.Find(".pro-chart");
            chartElement.ClassList.Should().Contain("pro-chart-legend-left");
        }
        ...
        public void StackedBarChart_DataEdge_AllZeroValues_ShouldRenderCorrectly()
        {
            ...
            var yAxisLabels = comp.FindAll("g.pro-charts-yaxis text").Select(e => e.TextContent).ToList();
        ...
        public void StackedBarChart_DataEdge_SingleDataPointInSeries_ShouldRender()
        {
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(2); // 2 series * 1 data point
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(2);
            var xAxisTexts = comp.FindAll("g.pro-charts-xaxis text");
        ...
        public void StackedBarChart_DataEdge_SingleSeriesSingleDataPoint_ShouldRender()
        {
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(1); // 1 series * 1 data point
            comp.FindAll("div.pro-chart-legend-item").Count.Should().Be(1);
            comp.Find("div.pro-chart-legend-item").TextContent.Should().Contain("Solo Series");
            var xAxisTexts = comp.FindAll("g.pro-charts-xaxis text");
            xAxisTexts.Should().HaveCount(1);
        ...
        public async Task StackedBarChart_Tooltip_ShowToolTipsTrue_ShouldRenderTooltipComponent()
        {
            ...
            var bar = comp.Find("path.pro-chart-bar");
        ...
        public async Task StackedBarChart_Selection_LegendClick_ShouldUpdateSelectedIndexAndFireEvent()
        {
            ...
            legendItems = comp.FindAll("div.pro-chart-legend-item");
        ...
        public async Task StackedBarChart_Options_YAxisTicks_And_MaxNumYAxisTicks_ShouldControlYAxisGrid()
        {
            ...
            var yAxisLabels1 = comp.FindAll("g.pro-charts-yaxis text").Select(e => e.TextContent).ToList();
            ...
            var yAxisLabels2 = comp.FindAll("g.pro-charts-yaxis text").Select(e => e.TextContent).ToList();
        ...
        public async Task StackedBarChart_Options_YAxisSuggestedMax_ShouldInfluenceScale()
        {
            ...
            yAxisLabels = comp.FindAll("g.pro-charts-yaxis text").Select(e => e.TextContent).ToList();
        ...
        public void StackedBarChart_Options_AxisVisibility_False_ShouldWork()
        {
            ...
            comp.FindAll("g.pro-charts-gridlines-yaxis").Should().BeEmpty();
            comp.FindAll("g.pro-charts-gridlines-xaxis-lines").Should().BeEmpty();
        }
        ...
        public void StackedBarChart_Options_AxisVisibility_True_ShouldWork()
        {
            ...
            comp.FindAll("g.pro-charts-gridlines-yaxis").Should().NotBeEmpty();
            comp.FindAll("g.pro-charts-gridlines-xaxis-lines").Should().NotBeEmpty();
        }
        ...
        public async Task BarChartExampleData()
        {
            ...
            comp.Markup.Should().Contain("class=\"pro-charts-xaxis\"");
            comp.Markup.Should().Contain("class=\"pro-charts-yaxis\"");
            comp.Markup.Should().Contain("pro-chart-legend-item");

            // find legend
            var legend = comp.FindComponent<Legend<double>>();
            const string LEGEND_CSS_SELECTOR = "div.pro-chart-legend-item";
            ...
            comp.FindAll("path.pro-chart-bar").Count.Should().Be(3 * 9, because: "3 series with 9 data points each");
        ...
        public async Task StackedBarChart_CanHideSeries()
        {
            ...
            comp.FindAll($"path.pro-chart-bar{series1}").Count.Should().Be(chartSeries[0].Data.Values.Count, "Series 1 should have its bar segments visible initially");
            comp.FindAll($"path.pro-chart-bar{series2}").Count.Should().Be(chartSeries[1].Data.Values.Count, "Series 2 should have its bar segments visible initially");
            comp.FindAll($"path.pro-chart-bar{series3}").Count.Should().Be(0, "Series 3 should have no bar segments visible initially");
            ...
            comp.FindAll($"path.pro-chart-bar{series1}").Count.Should().Be(0, "Series 1 bar segments should be hidden");
            ...
            comp.FindAll($"path.pro-chart-bar{series1}").Count.Should().Be(chartSeries[0].Data.Values.Count, "Series 1 bar segments should be visible again");
            ...
            comp.FindAll($"path.pro-chart-bar{series2}").Count.Should().Be(0, "Series 2 bar segments should be hidden");
            comp.FindAll($"path.pro-chart-bar{series1}").Count.Should().Be(chartSeries[0].Data.Values.Count, "Series 1 bar segments should remain visible");
            ...
            comp.FindAll($"path.pro-chart-bar{series3}").Count.Should().Be(chartSeries[2].Data.Values.Count, "Series 3 bar segments should be visible");
        }
    }
}
