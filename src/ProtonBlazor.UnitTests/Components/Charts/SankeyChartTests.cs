...
namespace ProtonBlazor.UnitTests.Charts
{
    public class SankeyChartTests : BunitTest
    {
        ...
        public void ChartRendersCorrectly()
        {
            ...
            // Parent
            sankey.Markup.Should().Contain("pro-chart");
        ...
        private IRenderedComponent<ProChart<double>> RenderSankey(List<SankeyEdge<double>> edges, SankeyChartOptions options = null)
        {
            var result = Context.Render<ProChart<double>>(parameters => parameters
