...
public class RadarChartTests : BunitTest
{
    ...
    public void RadarChart_BasicRendering_NoData()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(0);
        comp.FindAll("path.pro-chart-axis-line").Count.Should().Be(0); // No labels, no data, so no axes.
    }
    ...
    public async Task RadarChart_Should_UpdateSelectedPointIndex_OnDataMarkerClick()
    {
        ...
        var dataMarkers = comp.FindAll("circle.pro-chart-series-point");
        ...
        dataMarkers = comp.FindAll("circle.pro-chart-series-point");
    ...
    public void RadarChart_BasicRendering_WithData_InferAxesFromData()
    {
        ...
        comp.FindAll("path.pro-chart-axis-line").Count.Should().Be(1);
    }
    ...
    public void RadarChart_BasicRendering_WithData_AndLabels()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(4);
        comp.FindAll("path.pro-chart-axis-line").Count.Should().Be(1);
    }
    ...
    public void RadarChart_Option_ShowGridLines_And_GridLevels()
    {
        ...
        comp.FindAll("path.pro-chart-grid-line").Count.Should().Be(3); // 3 levels
    }
    ...
    public void RadarChart_Option_ShowGridLines_False()
    {
        ...
        comp.FindAll("path.pro-chart-grid-line").Count.Should().Be(0);
    }
    ...
    public void RadarChart_Option_ShowAxisLabels_True()
    {
        ...
        comp.FindAll("text.pro-chart-axis-label").Count.Should().Be(3);
        comp.FindAll("text.pro-chart-axis-label").Any(t => t.TextContent == "Axis1").Should().BeTrue();
    }
    ...
    public void RadarChart_Option_ShowAxisLabels_False()
    {
        ...
        comp.FindAll("text.pro-chart-axis-label").Count.Should().Be(0);
    }
    ...
    public void RadarChart_Option_ShowDataPoints_True()
    {
        ...
        comp.FindAll("circle.pro-chart-series-point").Count.Should().Be(seriesData.Length);
    }
    ...
    public void RadarChart_Option_ShowDataPoints_False()
    {
        ...
        comp.FindAll("circle.pro-chart-series-point").Count.Should().Be(0);
    }
    ...
    public void RadarChart_Option_AngleOffset()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(3);
        comp.Find("path.pro-chart-serie").GetAttribute("d").Should().NotBeNullOrWhiteSpace();
    }
    ...
    public async Task RadarChart_CanHideSeries()
    {
        ...
        comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Series 1 path should initially be visible");
        comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(1, "Series 2 path should initially be visible");
        comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(0, "Series 3 path should initially be hidden");
        ...
        comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(0, "Series 1 path should be hidden after unchecking");
        ...
        comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Series 1 path should be visible again after re-checking");
        ...
        comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(0, "Series 2 path should be hidden");
        comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Series 1 path should still be visible"); // Ensure other series not affected
        ...
        comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(1, "Series 3 path should be visible after checking");
    }
    ...
    public void RadarChart_Should_ApplyCustomPaletteToSeries()
    {
        ...
        var seriesPaths = comp.FindAll("path.pro-chart-serie");
    ...
    public void RadarChart_Should_RespectLegendPosition(Position position)
    {
        ...
        var div = comp.Find("div.pro-chart");
        div.Should().NotBeNull();

        var expectedClass = position switch
        {
            Position.Top => "pro-chart-legend-top",
            Position.Bottom => "pro-chart-legend-bottom",
            Position.Start => "pro-chart-legend-left",
            Position.End => "pro-chart-legend-right",
            _ => string.Empty
        };
    ...
    public void RadarChart_Should_RenderGracefully_WhenChartOptionsIsNull()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().BeGreaterThan(0);
    }
    ...
    public void RadarChart_Should_ApplyGridLineColorAndWidth()
    {
        ...
        var gridLines = comp.FindAll("path.pro-chart-grid-line");
    ...
    public void RadarChart_Should_ApplyAxisLineColorAndWidth()
    {
        ...
        var axisLines = comp.FindAll("path.pro-chart-axis-line");
    ...
    public void RadarChart_Should_ApplyDataPointRadius()
    {
        ...
        var dataPoints = comp.FindAll("circle.pro-chart-series-point");
    ...
    public void RadarChart_Should_ApplyAngleOffset_WithValue(double angleOffset)
    {
        ...
        var seriesPath = comp.Find("path.pro-chart-serie");
    ...
    public void RadarChart_Should_RenderAxisValues_WhenShowAxisValuesIsTrue()
    {
        ...
        comp.FindAll("text.pro-chart-axis-value").Count.Should().BeGreaterThan(0);
    }
    ...
    public void RadarChart_Should_NotRenderAxisValues_WhenShowAxisValuesIsFalse()
    {
        ...
        comp.FindAll("text.pro-chart-axis-value").Count.Should().Be(0);
    }
    ...
    public void RadarChart_Should_RenderCorrectNumberOfAxisLines_BasedOnLabels_GroupByDataSet()
    {
        ...
        comp.FindAll("path.pro-chart-axis-line").Count.Should().Be(3);
        comp.FindAll("text.pro-chart-axis-label").Count.Should().Be(chartLabels.Length);
    }
    ...
    public void RadarChart_Should_RenderCorrectNumberOfAxisLines_BasedOnLabels_GroupByLabel()
    {
        ...
        comp.FindAll("path.pro-chart-axis-line").Count.Should().Be(2);
        comp.FindAll("text.pro-chart-axis-label").Count.Should().Be(chartSeries.Count);
        comp.FindAll("circle.pro-chart-series-point").Count.Should().Be(chartSeries.Sum(x => x.Data.Count));
    }
    ...
    public void RadarChart_Should_RenderAxisLabels_WithLongNamesAndSpecialChars()
    {
        ...
        var renderedLabels = comp.FindAll("text.pro-chart-axis-label");
    ...
    public void RadarChart_Should_HandleMismatchedLabels_LessThanData_GroupByDataSet()
    {
        ...
        var renderedAxisLines = comp.FindAll("path.pro-chart-axis-line");
    ...
    public async Task RadarChart_Should_ReRender_WhenChartSeriesIsUpdated()
    {
        ...
        seriesPaths = comp.FindAll("path.pro-chart-serie");
    ...
    public async Task RadarChart_Should_ReRender_WhenChartLabelsAreUpdated()
    {
        ...
        var axisLabels = comp.FindAll("text.pro-chart-axis-label");
        ...
        axisLabels = comp.FindAll("text.pro-chart-axis-label");
    ...
    public async Task RadarChart_Should_ReRender_WhenChartOptionsAreUpdated()
    {
        ...
        comp.FindAll("path.pro-chart-grid-line").Count.Should().Be(2);
        var initialSeriesPathD = comp.Find("path.pro-chart-serie").GetAttribute("d");
        ...
        comp.FindAll("path.pro-chart-grid-line").Count.Should().Be(0, "Grid lines should be hidden after option update.");

        var updatedSeriesPathD = comp.Find("path.pro-chart-serie").GetAttribute("d");
        ...
        comp.FindAll("path.pro-chart-grid-line").Count.Should().Be(5, "Grid lines should update to new count when shown.");
    }
    ...
    public void RadarChart_Should_RenderPathsPerSeries_WhenAggregationIsGroupByDataSet()
    {
        ...
        var axisLinePath = comp.Find("path.pro-chart-axis-line");
    ...
    public void RadarChart_Should_RenderPathsPerLabel_WhenAggregationIsGroupByLabel()
    {
        ...
        var renderedSeriesPaths = comp.FindAll("path.pro-chart-serie");
        renderedSeriesPaths.Count.Should().Be(originalChartLabels.Length);

        var renderedAxisLabels = comp.FindAll("text.pro-chart-axis-label");
    ...
    public void RadarChart_Scaling_SmallValues_GridLevels1()
    {
        ...
        var axisValues = comp.FindAll("text.pro-chart-axis-value");
