...
namespace ProtonBlazor.UnitTests.Charts
{
    public class PieChartTests : BunitTest
    {
        ...
        public void PieChartEmptyData()
        {
            ...
            comp.Markup.Should().Contain("pro-chart-pie");
        ...
        public async Task PieChartExampleData(double[] data)
        {
            ...
            comp.Markup.Should().Contain("class=\"pro-chart-pie pro-ltr\"");
        ...
        public async Task PieChart_CanHideSeries()
        {
            ...
            comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(0, "Slice 1 path should be hidden");
            comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(1, "Slice 2 path should remain visible"); // Check other slices
            ...
            comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Slice 1 path should be visible again");
            ...
            comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(0, "Slice 3 path should be hidden");
            comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Slice 1 path should still be visible");
            comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(1, "Slice 2 path should still be visible");
            comp.FindAll($"path.pro-chart-serie{series4}").Count.Should().Be(1, "Slice 4 path should still be visible");
            ...
            comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(1, "Slice 3 path should be visible again");
        }
    }
}
