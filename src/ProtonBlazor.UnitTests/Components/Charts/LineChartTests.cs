...
namespace ProtonBlazor.UnitTests.Charts
{
    public class LineChartTests : BunitTest
    {
        ...
        public async Task LineChartExampleData(InterpolationOption opt)
        {
            ...
            {
                var path = comp.Find("path.pro-chart-line");
            ...
            {
                var path = comp.FindAll("path.pro-chart-line").Skip(1).First();
                var d = path.GetAttribute("d");
            ...
            if (comp.Instance.CanHideSeries)
            {
                ...
                comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(1, "Series 1 path expected to be visible");
                comp.FindAll($"path.pro-chart-line{series2}").Count.Should().Be(1, "Series 2 path expected to be visible");
                comp.FindAll($"path.pro-chart-line{series3}").Count.Should().Be(0, "Series 3 path expected to be hidden");

                // Hide Series 1
                await seriesCheckboxes[0].ChangeAsync(false);

                seriesCheckboxes = comp.FindAll(".pro-checkbox-input");
                ...
                comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(0, "Series 1 path hidden");
                comp.FindAll($"path.pro-chart-line{series2}").Count.Should().Be(1, "Series 2 path still visible");
                comp.FindAll($"path.pro-chart-line{series3}").Count.Should().Be(0, "Series 3 path still hidden");
                ...
                comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(1, "Series 1 path visible again");
                ...
                comp.FindAll($"path.pro-chart-line{series3}").Count.Should().Be(1, "Series 3 path visible");
                comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(1, "Series 1 path still visible (after Series 3 shown)");
                comp.FindAll($"path.pro-chart-line{series2}").Count.Should().Be(1, "Series 2 path still visible (after Series 3 shown)");
                ...
                comp.FindAll($"path.pro-chart-line{series3}").Count.Should().Be(0, "Series 3 path hidden again");
