...
namespace ProtonBlazor.UnitTests.Charts
{
    public class TimeSeriesChartTests : BunitTest
    {
        ...
        public void TimeSeriesChartBasicExample()
        {
            ...
            // check the line path
            comp.Markup.Should().ContainEquivalentOf("<path class=\"pro-chart-serie pro-chart-line\" blazor:onclick=\"15\" fill=\"none\" stroke=\"#2979FF\" stroke-opacity=\"1\" stroke-width=\"3\" d=\"M 38 320 L 248.6667 320 L 459.3333 320 L 670 320\"></path>");

            // check the axis
            comp.Markup.Should().ContainEquivalentOf("<g class=\"pro-charts-gridlines-yaxis\"><path stroke=\"#e0e0e0\" stroke-width=\"0.3\" d=\"M 38 320 L 670 320\"></path></g></g>");
        ...
        public void TimeSeriesChartRendersWithIntData()
        {
            ...
            var comp = Context.Render<ProChart<int>>(parameters => parameters
                .Add(p => p.ChartType, ChartType.Timeseries)
                .Add(p => p.ChartSeries, [
                    new ()
                    {
        ...
        public void TimeSeriesChartMatchBounds()
        {
            ...
            comp.Markup.Should().ContainEquivalentOf("<svg class=\"pro-chart-line pro-ltr\" width=\"100%\" height=\"400px\" viewBox=\"0 0 1000 400\"");
        }
        ...
        public void TimeSeriesChartEmptyData()
        {
            ...
            comp.Markup.Should().Contain("pro-chart-line pro-ltr");
        }
        ...
        public async Task TimeSeriesChart_CanHideSeries()
        {
            ...
            comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(1, "Temperature series path should initially be visible");
            comp.FindAll($"path.pro-chart-line{series2}").Count.Should().Be(1, "Humidity series path should initially be visible");
            comp.FindAll($"path.pro-chart-line{series3}").Count.Should().Be(0, "Pressure series path should initially be hidden");
            ...
            comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(0, "Temperature series path should be hidden");
            ...
            comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(1, "Temperature series path should be visible again");
            ...
            comp.FindAll($"path.pro-chart-line{series2}").Count.Should().Be(0, "Humidity series path should be hidden");
            comp.FindAll($"path.pro-chart-line{series1}").Count.Should().Be(1, "Temperature series path should remain visible");
            ...
            comp.FindAll($"path.pro-chart-line{series3}").Count.Should().Be(1, "Pressure series path should be visible");
        }
    }
}
