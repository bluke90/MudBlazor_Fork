...
namespace ProtonBlazor.UnitTests.Charts
{
    public class ScatterPlotChartTests : BunitTest
    {
        ...
        public void ScatterPlotRendersAxesAndLegend()
        {
            ...
            comp.Markup.Should().Contain("pro-chart-scatter");
        ...
        public void ScatterPlotShowsCorrectXAxisLabels()
        {
            ...
            var xAxis = comp.Find(".pro-charts-xaxis");
        ...
        public void ScatterPlotShowsCorrectYAxisLabels()
        {
            ...
            var yAxis = comp.Find(".pro-charts-yaxis");
        ...
        public async Task ScatterPlotCanHideAndShowSeries()
        {
            ...
            var checkboxes = comp.FindAll(".pro-checkbox-input");
            ...
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(8);

            // Hide Series 1
            await checkboxes[0].ChangeAsync(false);
            series[0].Visible.Should().BeFalse();
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(4, because: "only Series 2 remains");

            // Show Series 1 again
            checkboxes = comp.FindAll(".pro-checkbox-input");
        ...
        public void ScatterPlotHandlesNegativeCoordinates()
        {
            ...
            comp.Markup.Should().Contain("pro-chart-scatter");
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(6);

            comp.Find(".pro-charts-xaxis").InnerHtml.Should().Contain("-");
            comp.Find(".pro-charts-yaxis").InnerHtml.Should().Contain("-");
        }
        ...
        public void ScatterPlotMultipleSeriesRenderAllPoints()
        {
            ...
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(10);
        ...
        public async Task ScatterPlotUpdateSeriesRebuildsChart()
        {
            ...
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(2);
        ...
        public void ScatterPlotInitiallyHiddenSeriesNotRendered()
        {
            ...
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(4);
        }
        ...
        public void ScatterPlotXAxisFormatApplied()
        {
            ...
            var xAxisHtml = comp.Find(".pro-charts-xaxis").InnerHtml;
        ...
        public void ScatterPlotLineSeriesRendersPathNotCircles()
        {
            ...
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(6, because: "line series produces no scatter circles");

            // The line series produces an SVG path
            comp.FindAll("path.pro-chart-line").Count.Should().Be(1, because: "regression series renders as a line path");
        }
        ...
        public void ScatterPlotLineSeriesUsesCorrectPaletteColor()
        {
            ...
            var linePath = comp.Find("path.pro-chart-line");
        ...
        public void ScatterPlotLineSeriesParticipatesInAxisScaling()
        {
            ...
            comp.Find(".pro-charts-xaxis").InnerHtml.Should().Contain(">80<");
        }
        ...
        public void ScatterPlotShowDataLabelsRendersTextElements()
        {
            ...
            var labels = comp.FindAll("text.pro-chart-data-label");
        ...
        public void ScatterPlotShowDataLabelsContainsXAndYValues()
        {
            ...
            var label = comp.Find("text.pro-chart-data-label");
        ...
        public void ScatterPlotShowDataLabelsFalseRendersNoTextElements()
        {
            ...
            comp.FindAll("text.pro-chart-data-label").Count.Should().Be(0);
        }
        ...
        public void ScatterPlotShowDataLabelsWorksWithoutShowToolTips()
        {
            ...
            comp.FindAll("text.pro-chart-data-label").Count.Should().Be(2,
        ...
        public void ScatterPlotYAxisTicksControlsGridInterval()
        {
            ...
            var yAxis = comp.Find(".pro-charts-yaxis").InnerHtml;
        ...
        public void ScatterPlotYAxisSuggestedMaxExtendsAxisWhenDataIsBelow()
        {
            ...
            comp.Find(".pro-charts-yaxis").InnerHtml.Should().Contain(">60<");
        }
        ...
        public void ScatterPlotYAxisSuggestedMaxIgnoredWhenDataExceedsIt()
        {
            ...
            comp.Find(".pro-charts-yaxis").InnerHtml.Should().Contain(">80<");
        }
        ...
        public void ScatterPlotYAxisRequireZeroPointIncludesZeroWhenDataIsAllPositive()
        {
            ...
            comp.Find(".pro-charts-yaxis").InnerHtml.Should().Contain(">0<");
        }
        ...
        public void ScatterPlotMaxNumYAxisTicksThinsOutGridWhenExceeded()
        {
            ...
            var yAxisHtml = comp.Find(".pro-charts-yaxis").InnerHtml;
        ...
        public void ScatterPlotXAxisTicksControlsGridInterval()
        {
            ...
            var xAxis = comp.Find(".pro-charts-xaxis").InnerHtml;
        ...
        public async Task ScatterPlotTooltipAppearsOnHover()
        {
            ...
            var hoverCircle = comp.FindAll("circle.pro-chart-point").Last();
        ...
        public async Task ScatterPlotTooltipDisappearsOnMouseOut()
        {
            ...
            await comp.FindAll("circle.pro-chart-point").Last().MouseOverAsync();
            comp.FindAll("g.svg-tooltip").Count.Should().Be(1);

            await comp.FindAll("circle.pro-chart-point").Last().MouseOutAsync();
        ...
        public void ScatterPlotNoTooltipWhenShowToolTipsFalse()
        {
            ...
            comp.FindAll("circle.pro-chart-point").Count.Should().Be(1);
        }
        ...
        public void ScatterPlotDefaultSeriesTypeIsPoints()
        {
            ...
            comp.FindAll("path.pro-chart-line").Count.Should().Be(0);
