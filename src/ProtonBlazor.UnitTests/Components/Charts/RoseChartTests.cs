...
public class RoseChartTests : BunitTest
{
    ...
    public void RoseChart_BasicRendering_NoData()
    {
        ...
        comp.FindAll("path.pro-chart-series").Count.Should().Be(0); // No data, no series paths
    }
    ...
    public void RoseChart_BasicRendering_WithData()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(3);
    }
    ...
    public void RoseChart_Option_AngleOffset()
    {
        ...
        var path = comp.Find("path.pro-chart-serie");
    ...
    public void RoseChart_Option_ScaleFactor()
    {
        ...
        var pathDataSmall = compSmall.Find("path.pro-chart-serie").GetAttribute("d");
        ...
        var pathDataLarge = compLarge.Find("path.pro-chart-serie").GetAttribute("d");
    ...
    public void RoseChart_Option_ShowChartLabels_True()
    {
        ...
        comp.FindAll("text.pro-chart-label-value").Count.Should().Be(2);
        comp.FindAll("text.pro-chart-label-value tspan").Count(ts => ts.TextContent == "10").Should().Be(1);
    }
    ...
    public void RoseChart_Option_ShowChartLabels_False()
    {
        ...
        comp.FindAll("text.pro-chart-label").Count.Should().Be(0);
    }
    ...
    public void RoseChart_Option_ShowAsPercentage()
    {
        ...
        comp.FindAll("text.pro-chart-label-value tspan").Count(ts => ts.TextContent == "25%").Should().Be(1);
        comp.FindAll("text.pro-chart-label-value tspan").Count(ts => ts.TextContent == "75%").Should().Be(1);
    }
    ...
    public void RoseChart_Data_EmptySeries()
    {
        ...
        comp.FindAll("path.pro-chart-series").Count.Should().Be(0);
    }
    ...
    public async Task RoseChart_Interaction_SelectedIndex()
    {
        ...
        await comp.FindAll("path.pro-chart-serie").First().ClickAsync();
        selectedIndex.Should().Be(0);

        // Click on the third path segment (index 2)
        await comp.FindAll("path.pro-chart-serie").Last().ClickAsync();
    ...
    public async Task RoseChart_CanHideSeries()
    {
        ...
        var comp = Context.Render<ProChart<double>>(parameters => parameters
        ...
        var seriesCheckboxes = comp.FindAll(".pro-checkbox-input");
        ...
        for (var i = 0; i < chartLabels.Length; i++)
        {
            ...
            comp.FindAll($"path.pro-chart-serie{series[i]}").Count.Should().Be(1, $"{chartLabels[i]} path should be initially visible");
        }

        // Hide "Petal 1"
        await seriesCheckboxes[0].ChangeAsync(false);
        seriesCheckboxes = comp.FindAll(".pro-checkbox-input"); // Re-find
        seriesCheckboxes[0].IsChecked().Should().BeFalse("Petal 1 checkbox should be unchecked after hiding");
        comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(0, "Petal 1 path should be hidden");
        comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(1, "Petal 2 path should remain visible");
        ...
        comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Petal 1 path should be visible again");
        ...
        comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(0, "Petal 3 path should be hidden");
        comp.FindAll($"path.pro-chart-serie{series1}").Count.Should().Be(1, "Petal 1 path should still be visible");
        comp.FindAll($"path.pro-chart-serie{series2}").Count.Should().Be(1, "Petal 2 path should still be visible");
        comp.FindAll($"path.pro-chart-serie{series4}").Count.Should().Be(1, "Petal 4 path should still be visible");
        ...
        comp.FindAll($"path.pro-chart-serie{series3}").Count.Should().Be(1, "Petal 3 path should be visible again");
    }
    ...
    public void RoseChart_ChartLabels_NotSet()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(2); // Petals should render

        var valueLabels = comp.FindAll("text.pro-chart-label-value tspan");
        ...
        var legendItems = comp.FindAll(".pro-chart-legend-item");
    ...
    public void RoseChart_ChartLabels_MoreLabelsThanData()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(2);

        var valueLabels = comp.FindAll("text.pro-chart-label-value");
    ...
    public void RoseChart_CustomGraphics_ShouldRenderCustomSvg()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(3); // 3 petals
    ...
    public void RoseChart_Dimensions_ShouldRenderWithDefaults()
    {
        ...
        var chartDiv = comp.Find("div.pro-chart");
    ...
    public void RoseChart_MatchBoundsToSize_False_ShouldRespectExplicitDimensions()
    {
        ...
        var chartDiv = comp.Find("svg.pro-chart-rose");
        chartDiv.Should().NotBeNull();
    ...
    private IRenderedComponent<ProChart<double>> RenderRoseChartWithLegend(Position legendPosition, bool rtl = false)
    {
        return Context.Render<ProChart<double>>(parameters => parameters
            .Add(p => p.ChartType, ChartType.Rose)
            .Add(p => p.ChartSeries, new List<ChartSeries<double>> { new() { Name = "Series1", Data = new double[] { 10, 20, 30 } } })
    ...
    public void RoseChart_LegendPosition_Top_ShouldRenderLegendAtTop()
    {
        ...
        comp.Find("div.pro-chart").ClassList.Should().Contain("pro-chart-legend-top");
    }
    ...
    public void RoseChart_LegendPosition_Left_ShouldRenderLegendAtLeft()
    {
        ...
        comp.Find("div.pro-chart").ClassList.Should().Contain("pro-chart-legend-left");
    }
    ...
    public void RoseChart_LegendPosition_Right_ShouldRenderLegendAtRight()
    {
        ...
        comp.Find("div.pro-chart").ClassList.Should().Contain("pro-chart-legend-right");
    }
    ...
    public void RoseChart_LegendPosition_Bottom_ShouldRenderLegendAtBottom()
    {
        ...
        comp.Find("div.pro-chart").ClassList.Should().Contain("pro-chart-legend-bottom");
    }
    ...
    public async Task RoseChart_CanHideSeries_WithAggregationByDataSet_ShouldHideCorrectSeriesPetal()
    {
        ...
        var legendCheckboxes = comp.FindAll(".pro-checkbox-input");
        ...
        var checkboxSetA = legendItemSetA.QuerySelector(".pro-checkbox-input");
        ...
        var checkboxSetB = legendItemSetB.QuerySelector(".pro-checkbox-input");
        checkboxSetB.Should().NotBeNull();
        checkboxSetB.IsChecked().Should().BeTrue();

        var petals = comp.FindAll("path.pro-chart-serie");
        petals.Count.Should().Be(2, "Should be one petal per ChartSeries with GroupByDataSet");

        comp.FindAll($"path.pro-chart-serie[stroke='{_baseChartPalette[0]}']").Count.Should().Be(1, "Petal for Set A with correct color should exist.");
        comp.FindAll($"path.pro-chart-serie[stroke='{_baseChartPalette[1]}']").Count.Should().Be(1, "Petal for Set B with correct color should exist.");

        // Hide "Set A"
        await checkboxSetA.ChangeAsync(false);

        legendCheckboxes = comp.FindAll(".pro-checkbox-input"); // Re-query after change
        ...
        comp.FindAll($"path.pro-chart-serie[stroke='{_baseChartPalette[0]}']").Count.Should().Be(0, "Petal for Set A should be hidden.");
        comp.FindAll($"path.pro-chart-serie[stroke='{_baseChartPalette[1]}']").Count.Should().Be(1, "Petal for Set B should still be visible.");
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(1); // Only Set B's petal remains

        // Show "Set A" Again
        await checkboxSetA.ChangeAsync(true);

        legendCheckboxes = comp.FindAll(".pro-checkbox-input"); // Re-query
        legendCheckboxes[0].IsChecked().Should().BeTrue("Checkbox for Set A should be checked again");

        comp.FindAll($"path.pro-chart-serie[stroke='{_baseChartPalette[0]}']").Count.Should().Be(1, "Petal for Set A should be visible again.");
        comp.FindAll($"path.pro-chart-serie[stroke='{_baseChartPalette[1]}']").Count.Should().Be(1, "Petal for Set B should still be visible.");
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(2); // Both petals visible again
    }
    ...
    public void RoseChart_AggregationOption_GroupByDataSet_ShouldAggregateDataAndRenderPetalsPerSeries()
    {
        ...
        // Assertions
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(3, "Should render one petal per series");
        ...
        var petalPaths = comp.FindAll("path.pro-chart-serie").Select(p => p.GetAttribute("d")).ToList();
        var valueLabelElements = comp.FindAll("text.pro-chart-label-value").ToList();
    ...
    public void RoseChart_AggregationOption_GroupByLabel_ShouldAggregateDataAndRenderPetalsPerLabel()
    {
        ...
        // Assertions
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(2, "Should render one petal per label");
    ...
    public async Task RoseChart_Tooltips_ShouldPositionTooltipWithCustomLogic_When_TooltipPositionFuncIsProvided()
    {
        ...
        var firstPetal = comp.Find("path.pro-chart-serie");
    ...
    public void RoseChart_Option_ShowValues_True_And_ShowAsPercentage_False_ShouldDisplayActualValues()
    {
        ...
        comp.FindAll("path.pro-chart-serie").Count.Should().Be(3, "Should render three petals");

        var chartLabelElements = comp.FindAll(".pro-chart-labels");
        ...
        {
            var value = labelElement.QuerySelector(".pro-chart-label-value");
