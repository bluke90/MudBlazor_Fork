...
#nullable enable
    ...
    public class DatePickerTests : BunitTest
    {
        ...
        public void Default()
        {
            var comp = Context.Render<ProDatePicker>();
        ...
        {
            var comp = Context.Render<ProDatePicker>(p => p
        ...
        public async Task DatePicker_Should_Clear()
        {
            ...
            await comp.Find(".pro-input-clear-button").ClickAsync(); //clear the input
        ...
        public void Check_Initial_Date_Format()
        {
            ...
            var comp = Context.Render<ProDatePicker>(parameters => parameters
                .Add(p => p.Culture, CultureInfo.InvariantCulture)
                .Add(p => p.DateFormat, "dd/MM/yyyy")
                .Add(p => p.Date, date)
            );
        ...
        public async Task Check_DateTime_MaxValue()
        {
            ...
            comp.FindAll("button.pro-picker-calendar-day").First(x => x.TrimmedText().Equals("31")).ToMarkup().Should().Contain("pro-selected");
            comp.Find("button.pro-button-date .pro-button-label").InnerHtml.Should().Be("Fri, 31 Dec");
            comp.Find("button.pro-button-year .pro-button-label").InnerHtml.Should().Be("9999");
        }
        ...
        public async Task Open_ClickCalendarHeader_Click4thMonth_Click23rdDay_CheckDate()
        {
            ...
            // should show months
            comp.FindAll("div.pro-picker-month-container").Count.Should().Be(1);
            await comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-month-container > button.pro-picker-month")[3].ClickAsync();
            await comp.SelectDateAsync("23");
        ...
        public async Task DatePickerStaticWithPickerActionsDayClick()
        {
            ...
            var picker = comp.FindComponent<ProDatePicker>();

            picker.Markup.Should().Contain("pro-selected"); //confirm selected date is shown
        ...
        public async Task DatePickerBinding()
        {
            ...
            comp.FindAll("div.pro-picker-open").Count.Should().Be(0);
            await comp.Find(".pro-input-adornment button").ClickAsync();
            comp.FindAll("div.pro-picker-open").Count.Should().Be(1);

            var picker = comp.FindComponent<ProDatePicker>();

            comp.Markup.Should().Contain("pro-selected");
            ...
            await comp.Find(".pro-button").ClickAsync();
        ...
        public async Task Open_ClickYear_ClickCurrentYear_Click2ndMonth_Click1_CheckDate()
        {
            ...
            await comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-year-container > div.pro-picker-year").First(x => x.TrimmedText().Contains("2022")).ClickAsync();
            comp.FindAll("div.pro-picker-month-container").Count.Should().Be(1);
            await comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-month-container > button.pro-picker-month")[1].ClickAsync();
            comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-calendar-header").Count.Should().Be(1);
        ...
        public async Task Open_FixYear_Click2ndMonth_Click3_CheckDate()
        {
            ...
            await comp.Find("div.pro-picker-datepicker-toolbar > button.pro-button-year").ClickAsync();
            comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-year-container").Count.Should().Be(0);
            await comp.Find("div.pro-picker-calendar-container > .pro-picker-calendar-header > .pro-picker-calendar-header-switch > .pro-button-month").ClickAsync();
            comp.FindAll("div.pro-picker-month-container").Count.Should().Be(1);
            await comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-month-container > button.pro-picker-month")[1].ClickAsync();
            comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-calendar-header").Count.Should().Be(1);
        ...
        public async Task Open_FixMonth_ClickYear_Click3_CheckDate()
        {
            var comp = await OpenPicker(parameters => parameters
                .Add(x => x.FixMonth, 1));
            comp.FindAll("div.pro-picker-calendar-container > .pro-picker-calendar-header > .pro-picker-calendar-header-switch > .pro-button-month").Count.Should().Be(0);
            await comp.Find("div.pro-picker-datepicker-toolbar > button.pro-button-year").ClickAsync();
            comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-year-container").Count.Should().Be(1);
            await comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-year-container > div.pro-picker-year").First(x => x.TrimmedText().Contains("2022")).ClickAsync();
            comp.FindAll("div.pro-picker-month-container").Count.Should().Be(0);
            comp.FindAll("div.pro-picker-calendar-container > div.pro-picker-calendar-header").Count.Should().Be(1);
            await comp.SelectDateAsync("3");
        ...
        public async Task PersianCalendarDefault()
        {
            ...
            comp.Find("button.pro-button-year").TrimmedText().Equals("1403");
            comp.Find("button.pro-button-month").TrimmedText().Should().Contain("1403");
            comp.Find("button.pro-button-date").TrimmedText().Should().BeNullOrEmpty();
        }
        ...
        public async Task PersianCalendarFixedDay()
        {
            ...
            comp.FindAll("button.pro-picker-month").Count.Should().Be(0);
            await comp.Find("input").ClickAsync();
            comp.FindAll("button.pro-picker-month").Count.Should().Be(12);
            await comp.FindAll("button.pro-picker-month")[0].ClickAsync();
        ...
        public async Task IsDateDisabledFunc_DisablesCalendarMonthButtons()
        {
            ...
            comp.Instance.IsDateDisabledFunc.Should().Be(isDisabledFunc);
            comp.FindAll("button.pro-picker-month").Select(button => ((IHtmlButtonElement)button).IsDisabled)
                .Should().OnlyContain(disabled => disabled);

            // None should be selected
            comp.FindAll("button.pro-picker-month > .pro-typography").Select(
                text => ((IHtmlElement)text).ClassList.Any(cls => cls == "pro-picker-month-select" || cls == "pro-primary-text"))
        ...
        public async Task DisableCalendarMonthButtonsWhenFixDayOutOfRange()
        {
            ...
            comp
                .FindAll("button.pro-picker-month")
        ...
        [Test]
        //pro-button-root added for graying out and making buttons not clickable if month is disabled
        public async Task MonthButtons_ButtonRootClassPresent()
        {
            var comp = await OpenPicker(parameters => parameters.Add(x => x.FixDay, 1));
            var monthsCount = 12;

            comp.FindAll("button.pro-picker-month").Select(button =>
                button.ClassName?.Contains("pro-button-root"))
        ...
        public async Task CheckAutoCloseDatePickerTest()
        {
            ...
            await comp.InvokeAsync(() => datePicker.Instance.ClearAsync());
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-popover").Count.Should().Be(0));
        }
        ...
        {
            var dateComp = Context.Render<ProDatePicker>(p =>
            p.Add(x => x.PickerVariant, PickerVariant.Dialog));

            //open picker
            await dateComp.Find(".pro-picker input").ClickAsync();

            //navigate to month selection
            if (navigateToMonthSelection)
            {
                await dateComp.Find(".pro-picker button.pro-picker-calendar-header-transition").ClickAsync();
            }

            var buttons = dateComp.FindAll(".pro-picker button");
            //expected values
        ...
        public async Task DatePicker_Editable()
        {
            ...
            var datePickerComponent = comp.FindComponent<ProDatePicker>();
        ...
        public async Task DatePicker_KeyboardNavigation()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-picker-open").Count.Should().Be(0));
        ...
        public async Task DatePicker_KeyboardNavigation_FixYear_CannotBeChanged()
        {
            ...
            var datePicker = datePickerComponent.Instance;
            await comp.InvokeAsync(() => keyInterceptorService.OnKeyDown(datePicker.ElementId, new KeyboardEventArgs() { Key = "Enter", Type = "keydown", }));
            comp.WaitForAssertion(() => comp.FindAll("div.pro-picker-open").Count.Should().Be(1));
            ...
            await comp.InvokeAsync(() => keyInterceptorService.OnKeyDown(datePicker.ElementId, new KeyboardEventArgs() { Key = "Enter", Type = "keydown", }));
            await comp.InvokeAsync(() => keyInterceptorService.OnKeyDown(datePicker.ElementId, new KeyboardEventArgs() { Key = "Enter", Type = "keydown", }));
            comp.WaitForAssertion(() => comp.FindAll("div.pro-picker-open").Count.Should().Be(0));
            datePicker.Date.Should().Be(startDate);
        }
        ...
        public async Task DatePicker_CheckIfMonthsAreDisabled()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("button.pro-picker-month").Any(x => x.IsDisabled()).Should().Be(true));

            await comp.FindAll("button.pro-picker-month").First(x => x.IsDisabled()).ClickAsync();

            var months = comp.FindAll("button.pro-picker-month");
        ...
        {
            var comp = Context.Render<ProDatePicker>(parameters =>
        ...
        public async Task DatePicker_CustomTimerProvider()
        {
            ...
            comp.FindAll("div.pro-picker-open").Count.Should().Be(1);
            comp.Find(".pro-button-outlined").InnerHtml.Should().Contain("4");
            comp.Find(".pro-button-month").InnerHtml.Should().Contain("April");
            comp.Find(".pro-button-year").InnerHtml.Should().Contain("2003");
        }
        ...
        public async Task DatePickerWithFixYearAndFixMonth()
        {
            ...
            comp.Find(".pro-button-year").GetInnerText().Should().Be("2022");
            comp.Find(".pro-picker-calendar-header-transition").GetInnerText().Should().Be("October 2022");
        }
        ...
        public async Task DatePickerToolbar_DisplaysSelectedDate()
        {
            ...
            comp.FindAll("button.pro-picker-calendar-day").First(x => x.TrimmedText().Equals("10")).ToMarkup().Should().Contain("pro-selected");
            comp.Find("button.pro-button-date .pro-button-label").InnerHtml.Should().Be("Fri, 10 Jan");
            comp.Find("button.pro-button-year .pro-button-label").InnerHtml.Should().Be("2025");

            //navigate to previous month
            await comp.Find(".pro-picker-nav-button-prev").ClickAsync();
            ...
            //select new month
            await comp.Find("button.pro-button-month").ClickAsync();
            await comp.FindAll("button.pro-picker-month").First(x => x.TrimmedText().Equals("May")).ClickAsync();
            ...
            await comp.Find("button.pro-button-month").ClickAsync();
            await comp.Find("button.pro-picker-calendar-header-transition").ClickAsync();
            await comp.FindAll("div.pro-picker-year").First(x => x.TrimmedText().Equals("2022")).ClickAsync();
        ...
        public async Task DatePicker_HighlightSelectedMonthOnly()
        {
            ...
            await comp.FindAll("button.pro-picker-month").First(x => x.TrimmedText().Equals("Mar")).ClickAsync();
            await comp.Find("button.pro-button-month").ClickAsync();
            ...
            //change year
            await comp.Find(".pro-picker-calendar-header-switch button[aria-label^='Previous year']").ClickAsync();
            await comp.Find(".pro-picker-calendar-header-switch button[aria-label^='Previous year']").ClickAsync();
            ...
            await comp.Find(".pro-picker-calendar-header-switch button[aria-label^='Next year']").ClickAsync();
            await comp.Find(".pro-picker-calendar-header-switch button[aria-label^='Next year']").ClickAsync();
        ...
        public async Task DatePicker_HighlightSelectedYearOnly()
        {
            ...
            //select new year
            await comp.FindAll("div.pro-picker-year").First(x => x.TrimmedText().Equals("2020")).ClickAsync();
            await comp.Find("button.pro-picker-calendar-header-transition").ClickAsync();
        ...
        public async Task DatePicker_JumpToYear()
        {
            ...
            //Jump to 2025
            await comp.Find("button.pro-button-year").ClickAsync();
        ...
        public async Task DatePicker_FixYear_Past()
        {
            ...
            await comp.Find("button.pro-button-month").ClickAsync();
            var pickerHeader = comp.Find(".pro-picker-calendar-header-switch");
        ...
        public async Task DatePicker_FixYear_Future()
        {
            ...
            var datePickerComponent = component.FindComponent<ProDatePicker>();
            ...
            var dayButtons = component.FindAll(".pro-button-root.pro-icon-button.pro-ripple.pro-ripple-icon.pro-picker-calendar-day.pro-day");
            ...
            {
                prevMonthDay.ClassList.Contains("pro-hidden").Should().BeTrue("Previous month days should be hidden");
            }

            foreach (var currMonthDay in currMonthDays)
            {
                currMonthDay.ClassList.Contains("pro-hidden").Should().BeFalse("Current month days should be visible");
            }

            foreach (var nextMonthDay in nextMonthDays)
            {
                nextMonthDay.ClassList.Contains("pro-hidden").Should().BeTrue("Next month days should be hidden");
            }
        }
        ...
        public async Task DatePicker_NavigationButtons_ShouldNotThrowExceptionAtMaxDate()
        {
            ...
            comp.Find("button.pro-button-year").InnerHtml.Should().Contain("9999");
            comp.Find(".pro-button-month").InnerHtml.Should().Contain("Dec");

            // Click next month button - should not throw exception
            var nextMonthButton = comp.Find(".pro-picker-nav-button-next");
        ...
        public async Task DatePicker_NavigationButtons_ShouldNotThrowExceptionAtMinDate()
        {
            ...
            comp.Find("button.pro-button-year").InnerHtml.Should().Contain("1");

            // Click previous month button - should not throw exception
            var prevMonthButton = comp.Find(".pro-picker-nav-button-prev");
        ...
        public async Task DatePicker_YearNavigationButtons_ShouldNotThrowExceptionAtMaxYear()
        {
            ...
            comp.Find("button.pro-picker-calendar-header-transition").InnerHtml.Should().Contain("9999");
        ...
        public async Task DatePicker_YearNavigationButtons_ShouldNotThrowExceptionAtMinYear()
        {
            ...
            // Navigate to month view
            comp.Find("button.pro-picker-calendar-header-transition").InnerHtml.Should().Contain("1");
