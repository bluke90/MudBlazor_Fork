...
#nullable enable
    ...
    public class RatingTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProRating>();
            // select elements needed for the test
            IReadOnlyList<IElement> RatingItemsSpans() => comp.FindAll("span.pro-rating-item");
            IReadOnlyList<IElement> Inputs() => comp.FindAll("input[type=\"radio\"].pro-rating-input");
            // check initial state
        ...
        {
            var comp = Context.Render<ProRating>(parameters => parameters
        ...
        public async Task RatingTestIconColors()
        {
            ...
            // Select elements needed for the test
            IReadOnlyList<IElement> SvgColors() => comp.FindAll("svg.pro-icon-root");
            IReadOnlyList<IElement> RatingItemsSpans() => comp.FindAll("span.pro-rating-item");

            // Check initial state
            SvgColors()[0].ClassName.Should().Contain("pro-primary-text");
            SvgColors()[1].ClassName.Should().Contain("pro-primary-text");
            SvgColors()[2].ClassName.Should().Contain("pro-tertiary-text");
            SvgColors()[3].ClassName.Should().Contain("pro-tertiary-text");
            SvgColors()[4].ClassName.Should().Contain("pro-tertiary-text");
            ...
            SvgColors()[0].ClassName.Should().Contain("pro-primary-text");
            SvgColors()[1].ClassName.Should().Contain("pro-tertiary-text");
            SvgColors()[2].ClassName.Should().Contain("pro-tertiary-text");
            SvgColors()[3].ClassName.Should().Contain("pro-tertiary-text");
            SvgColors()[4].ClassName.Should().Contain("pro-tertiary-text");
            ...
            SvgColors()[0].ClassName.Should().Contain("pro-primary-text");
            SvgColors()[1].ClassName.Should().Contain("pro-primary-text");
            SvgColors()[2].ClassName.Should().Contain("pro-primary-text");
            SvgColors()[3].ClassName.Should().Contain("pro-tertiary-text");
            SvgColors()[4].ClassName.Should().Contain("pro-tertiary-text");
            RatingItemsSpans()[2].ClassName.Should().Contain("pro-rating-item-active");
            ...
            SvgColors()[3].ClassName.Should().Contain("pro-tertiary-text");
            SvgColors()[4].ClassName.Should().Contain("pro-tertiary-text");
            RatingItemsSpans()[1].ClassName.Should().Contain("pro-rating-item-active");
        ...
        public async Task Rating_KeyboardNavigation()
        {
            var comp = Context.Render<ProRating>(parameters => parameters
                .Add(p => p.MaxValue, 12));
            var item = comp.FindComponent<ProRatingItem>();
            // print the generated html
