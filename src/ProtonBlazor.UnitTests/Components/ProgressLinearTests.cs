...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class ProgressLinearTests : BunitTest
    {
        ...
        {
            var linear = new ProProgressLinear();
        ...
        {
            var comp = Context.Render<ProProgressLinear>(x =>
            {
                x.Add(y => y.Min, min);
                x.Add(y => y.Max, max);
        ...
        public void DefaultStructure(bool isVertical)
        {
            ...
            barContainer.ClassList.Should().Contain("pro-progress-linear-bars");
            barContainer.ChildElementCount.Should().Be(1);

            var barElement = barContainer.Children[0];
            barElement.ClassList.Should().Contain("pro-progress-linear-bar");
        ...
        public void IndeterminateStructure()
        {
            ...
            firstBarElement.ClassList.Should().Contain("pro-progress-linear-bar");
        ...
        public void BufferStructure(bool isVertical)
        {
            ...
            var secondBarElement = barContainer.Children[1];
            secondBarElement.ClassList.Should().Contain("pro-progress-linear-bar");
            ...
            thirdBarElement.ClassList.Should().Contain("pro-progress-linear-bar", "last");
        ...
        public void IndeterminateWithChildContent()
        {
            ...
            contentContainer.ClassList.Should().Contain("pro-progress-linear-content");
        ...
        public void RtlFlipClassOnlyOnHorizontalBars(bool isVertical)
        {
            ...
            var container = comp.Find(".pro-progress-linear");
            container.ClassList.Should().NotContain("pro-flip-x-rtl");

            var barContainer = comp.Find(".pro-progress-linear-bars");
            if (isVertical)
            {
                barContainer.ClassList.Should().NotContain("pro-flip-x-rtl");
            }
            else
            {
                barContainer.ClassList.Should().Contain("pro-flip-x-rtl");
            }

            var contentContainer = comp.Find(".pro-progress-linear-content");
            contentContainer.ClassList.Should().NotContain("pro-flip-x-rtl");
            contentContainer.TextContent.Should().Be("my content");
        }
        ...
        {
            var comp = Context.Render<ProProgressLinear>(x => x.Add(y => y.Rounded, rounded));

            var container = comp.Find(".pro-progress-linear");

            if (rounded)
            {
                container.ClassList.Should().Contain("pro-progress-linear-rounded");
            }
            else
            {
                container.ClassList.Should().NotContain("pro-progress-linear-rounded");
            }
        }
        ...
        {
            var comp = Context.Render<ProProgressLinear>(x => x.Add(y => y.Striped, striped));

            var container = comp.Find(".pro-progress-linear");

            if (striped)
            {
                container.ClassList.Should().Contain("pro-progress-linear-striped");
            }
            else
            {
                container.ClassList.Should().NotContain("pro-progress-linear-striped");
            }
        }
        ...
        {
            var comp = Context.Render<ProProgressLinear>(x => x.Add(y => y.Indeterminate, indeterminate));

            var container = comp.Find(".pro-progress-linear");

            if (indeterminate)
            {
                container.ClassList.Should().Contain("pro-progress-indeterminate");
            }
            else
            {
                container.ClassList.Should().NotContain("pro-progress-indeterminate");
            }
        }
        ...
        public void TestClassesForBuffer(bool buffer, bool indeterminate)
        {
            ...
            {
                container.ClassList.Should().Contain("pro-progress-linear-buffer");
            }
            else
            {
                container.ClassList.Should().NotContain("pro-progress-linear-buffer");
            }
        }
        ...
        {
            var comp = Context.Render<ProProgressLinear>(x => x.Add(y => y.Size, size));

            var container = comp.Find(".pro-progress-linear");

            container.ClassList.Should().Contain($"pro-progress-linear-{expectedString}");
        }
        ...
        {
            var comp = Context.Render<ProProgressLinear>(x => x.Add(y => y.Color, color));

            var container = comp.Find(".pro-progress-linear");

            container.ClassList.Should().Contain($"pro-progress-linear-color-{expectedString}");
        }
        ...
        {
            var comp = Context.Render<ProProgressLinear>(x => x.Add(y => y.Vertical, vertical));
