...
namespace ProtonBlazor.UnitTests.Components
{
    ...
    public class SelectTests : BunitTest
    {
        ...
        {
            var comp = Context.Render<ProSelect<string>>();
        ...
        public async Task SelectTest1()
        {
            ...
            var select = comp.FindComponent<ProSelect<string>>();
            IElement Menu() => comp.Find("div.pro-popover");
            IElement Input() => comp.Find("div.pro-input-control");
            // check popover class
            Menu().ClassList.Should().Contain("select-popover-class");
            // check initial state
            select.Instance.ReadValue.Should().BeNullOrEmpty();
            await comp.WaitForAssertionAsync(() => Menu().ClassList.Should().NotContain("pro-popover-open"));
            // click and check if it has toggled the menu
            await Input().MouseDownAsync();
            await comp.WaitForAssertionAsync(() => Menu().ClassList.Should().Contain("pro-popover-open"));
            // now click an item and see the value change
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            IReadOnlyList<IElement> Items() => comp.FindAll("div.pro-list-item");
        ...
        public async Task Select_ModelessOverlay_IgnoresActivatorRootForAutoCloseHitTesting()
        {
            ...
            await comp.Find("div.pro-input-control").MouseDownAsync();
        ...
        public async Task SelectTestCustomToString()
        {
            ...
            var select = comp.FindComponent<ProSelect<SelectCustomToStringTest.Pizza>>();
            var menu = comp.Find("div.pro-popover");
            ...
            // click and check if it has toggled the menu
            await Input().MouseDownAsync();
            menu.ClassList.Should().Contain("pro-popover-open");
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
        ...
        public async Task MultiSelectTest1()
        {
            ...
            await comp.WaitForAssertionAsync(() =>
                comp.Find("div.pro-popover").ClassList.Should().NotContain("pro-popover-open"));
            await comp.Find("div.pro-input-control").MouseDownAsync();
            await comp.WaitForAssertionAsync(() =>
                comp.Find("div.pro-popover").ClassList.Should().Contain("pro-popover-open"));
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            await comp.FindAll("div.pro-list-item")[1].ClickAsync();
            await comp.WaitForAssertionAsync(() =>
                comp.Find("div.pro-popover").ClassList.Should().Contain("pro-popover-open"));
            await comp.WaitForAssertionAsync(() => select.Instance.ReadText.Should().Be("2"));
            await comp.FindAll("div.pro-list-item")[0].ClickAsync();
            await comp.WaitForAssertionAsync(() => select.Instance.ReadText.Should().Be("2, 1"));
            await comp.FindAll("div.pro-list-item")[2].ClickAsync();
            ...
            await comp.WaitForAssertionAsync(() =>
                comp.FindAll("div.pro-list-item path")[1].Attributes["d"].Value.Should().Be(@unchecked));
            await comp.WaitForAssertionAsync(() =>
                comp.FindAll("div.pro-list-item path")[3].Attributes["d"].Value.Should().Be(@checked));
            await comp.WaitForAssertionAsync(() =>
                comp.FindAll("div.pro-list-item path")[5].Attributes["d"].Value.Should().Be(@checked));
            await select.SetParametersAndRenderAsync(parameter => parameter.Add(x => x.SelectedValues, new HashSet<string>() { "1", "2" }));
            await comp.WaitForAssertionAsync(() =>
                comp.FindAll("div.pro-list-item path")[1].Attributes["d"].Value.Should().Be(@checked));
            await comp.WaitForAssertionAsync(() =>
                comp.FindAll("div.pro-list-item path")[3].Attributes["d"].Value.Should().Be(@checked));
            await comp.WaitForAssertionAsync(() =>
                comp.FindAll("div.pro-list-item path")[5].Attributes["d"].Value.Should().Be(@unchecked));
        }
        ...
        public async Task MultiSelectWithValueContainZero()
        {
            ...
            var listItems = comp.FindAll(".pro-list-item");
        ...
        public async Task SelectWithEnum()
        {
            ...
            // select elements needed for the test
            var select = comp.FindComponent<ProSelect<MyEnum>>();
            var input = comp.Find("div.pro-input-control");
        ...
        public async Task MultiSelectWithEnum()
        {
            ...
            // select elements needed for the test
            var select = comp.FindComponent<ProSelect<MultiSelectWithEnumTest.MyEnum>>();
            var input = comp.Find("div.pro-input-control");
            ...
            comp.FindAll("div.pro-list-item path:not(:first-child)").Should().AllSatisfy(item =>
            ...
            await comp.WaitForAssertionAsync(() =>
            {
                ...
                comp.FindAll("div.pro-list-item path:not(:first-child)")[0].Attributes["d"]!.Value.Should().Be(@checked);
                // Remaining items should be unchecked
                comp.FindAll("div.pro-list-item:not(:first-child) path:not(:first-child)").Should().AllSatisfy(item =>
                    item.Attributes["d"]!.Value.Should().Be(@unchecked)
                );
            });
        }
        ...
        public async Task MultiSelect_ChildlessEnumItems_ShouldUpdateCheckboxImmediately()
        {
            ...
            var select = comp.FindComponent<ProSelect<MultiSelectChildlessEnumToStringFuncTest.Pizza>>();

            await comp.Find("div.pro-input-control").MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().Be(4));
        ...
        public async Task MultiSelect_SelectAll_ShouldUpdateChildlessItemCheckboxesImmediately()
        {
            ...
            await comp.Find("div.pro-input-control").MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().Be(5));
        ...
        /// <summary>
        /// Initially we have a value of 17 which is not in the list. So we render it as text via ProInput
        /// </summary>
        [Test]
        public async Task SelectUnrepresentableValue()
        {
            ...
            var items = comp.FindAll("div.pro-list-item").ToArray();
            await items[1].ClickAsync();
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-input-slot").TextContent.Trim().Should().Be("Two"));
            select.Instance.ReadValue.Should().Be(2);
        ...
        public async Task SelectUnrepresentableValueTest2()
        {
            ...
            comp.FindComponent<ProInput<string>>().Instance.ReadValue.Should().Be(null);
            comp.FindComponent<ProInput<string>>().Instance.InputType.Should().Be(InputType.Hidden);
            await input.MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            var items = comp.FindAll("div.pro-list-item").ToArray();
            await items[1].ClickAsync();
            ...
            select.Instance.ReadText.Should().Be("2");
            comp.FindComponent<ProInput<string>>().Instance.ReadValue.Should().Be("2");
            comp.FindComponent<ProInput<string>>().Instance.InputType.Should().Be(InputType.Text); // because list item has no render fragment, so we show it as text
        }

        /// <summary>
        /// When the select has a null value, the text should be displayed, and the pro-shrink class should be applied.
        /// </summary>
        [Test]
        public async Task SelectNullValue()
        {
            ...
            select.Find("div.pro-input-slot").TextContent.Should().Be("None");
            select.Markup.Should().Contain("pro-shrink");

            // Open menu and select a non-null value
            await comp.Find("div.pro-input-control").MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            await comp.FindAll("div.pro-list-item").ToArray()[1].ClickAsync(); // Select "One" (value = 1)

            // Verify non-null value
            await comp.WaitForAssertionAsync(() => select.Instance.ReadValue.Should().Be(1));
            select.Find("div.pro-input-slot").TextContent.Should().Be("One");
            select.Markup.Should().Contain("pro-shrink");

            // Open menu again and select null value
            await comp.Find("div.pro-input-control").MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            await comp.FindAll("div.pro-list-item").ToArray()[0].ClickAsync(); // Select "None" (value = null)
        ...
        public async Task SelectWithoutItemPresenters()
        {
            ...
            comp.Find("div.pro-input-slot").Attributes["style"].Value.Should().Contain("display:none");
            ...
            await items[1].ClickAsync();
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ClassList.Should().NotContain("pro-popover-open"));
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-input-slot").Attributes["style"].Value.Should().Contain("display:none"));
            select.Instance.ReadValue.Should().Be(2);
            select.Instance.ReadText.Should().Be("2");
        }
        ...
        public async Task Select_Should_FireTextChangedWithNewValue()
        {
            ...
            await input.MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            items = comp.FindAll("div.pro-list-item");
        ...
        public async Task SingleSelect_Should_FireTextChangedBeforeSelectedValuesChanged()
        {
            ...
            await input.MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            items = comp.FindAll("div.pro-list-item").ToArray();
        ...
        public async Task MulitSelect_Should_FireTextChangedBeforeSelectedValuesChanged()
        {
            ...
            var selectElement = comp.Find("div.pro-input-control");
        ...
        public async Task Disabled_SelectItem_Should_Be_Respected()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item-disabled").Count.Should().Be(1));
            await comp.FindAll("div.pro-list-item-disabled")[0].ClickAsync();
        ...
        public async Task MultiSelect_SelectAll2()
        {
            ...
            var selectAllItem = comp.FindComponent<ProListItem<string>>();
            ...
            var items = comp.FindComponents<ProSelectItem<string>>().Where(x => x.Instance.HideContent == false).ToArray();

            items.Should().HaveCount(7);
            foreach (var item in items)
            {
                item.Instance.Selected.Should().BeTrue();
                item.FindComponent<ProListItem<string>>().Instance.Icon.Should().Be("<path d=\"M0 0h24v24H0z\" fill=\"none\"/><path d=\"M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z\"/>");
            }

            // Check shadow items
            var shadowItems = comp.FindComponents<ProSelectItem<string>>().Where(x => x.Instance.HideContent).ToArray();
            foreach (var item in shadowItems)
            {
                ...
                Assert.Throws<Bunit.Rendering.ComponentNotFoundException>(() => item.FindComponent<ProListItem<string>>());
            }
        }
        ...
        public async Task MultiSelect_SelectAll3()
        {
            ...
            var mudListItem = comp.FindComponent<ProListItem<string>>();
        ...
        public async Task SelectClearable()
        {
            ...
            comp.FindAll(".pro-input-clear-button").Should().BeEmpty();
            ...
            await comp.WaitForAssertionAsync(() =>
                comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            ...
            // Popover closes
            await comp.WaitForAssertionAsync(() =>
                comp.Find("div.pro-popover")
                    .ClassList.Should().NotContain("pro-popover-open"));

            // Value is set
            select.Instance.ReadValue.Should().Be("2");

            // Clear button appears
            comp.FindAll(".pro-input-clear-button").Should().ContainSingle();

            // Click clear button
            var clearButton = comp.Find(".pro-input-clear-button");
        ...
        public async Task TextField_Should_Validate_Data_Attribute_Fail()
        {
            ...
            var selectcomp = comp.FindComponent<ProSelect<string>>();
        ...
        {
            var comp = Context.Render<SelectRequiredTest>();
            var select = comp.FindComponent<ProSelect<string>>().Instance;
        ...
        /// <summary>
        /// Required ProSelect should show validation error on focus loss without a value selected.
        /// </summary>
        [Test]
        ...
        public async Task Select_Should_HilightSelectedValue()
        {
            ...
            comp.Find("div.pro-popover").ClassList.Should().Contain("select-popover-class");
            select.Instance.ReadValue.Should().BeNullOrEmpty();
            comp.Find("div.pro-popover").ClassList.Should().NotContain("pro-popover-open");
            // open the select
            await comp.Find("div.pro-input-control").MouseDownAsync();
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-selected-item").Count.Should().Be(0));
            // now click an item and see the value change
            await comp.FindAll("div.pro-list-item")[1].ClickAsync();
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ClassList.Should().NotContain("pro-popover-open"));
            await comp.WaitForAssertionAsync(() => select.Instance.ReadValue.Should().Be("2"));
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-selected-item").Count.Should().Be(1));
            comp.FindAll("div.pro-list-item")[1].ToMarkup().Should().Contain("pro-selected-item");
        ...
        public async Task Select_Should_HilightInitiallySelectedValue()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-selected-item").Count.Should().Be(1));
            comp.FindAll("div.pro-list-item")[0].ToMarkup().Should().Contain("pro-selected-item");
            await comp.Find("div.pro-input-control").MouseDownAsync();
            await comp.WaitForAssertionAsync(() => comp.Find("div.pro-popover").ClassList.Should().NotContain("pro-popover-open"));
        }
        ...
        public async Task Select_KeyboardNavigation_MultiSelect_Focus()
        {
            ...
            var select = comp.FindComponent<ProSelect<string>>();
            var mudSelectElement = comp.Find(".pro-select");
            await comp.Find("div.pro-input-control").MouseDownAsync();
            ...
            //check if we received focus event from the ProSelect.OnFocusOutAsync
        ...
        public async Task MultiSelectWithCustomComparer()
        {
            ...
            const string @checked =
                "M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z";
            var icons = comp.FindAll("div.pro-list-item path").ToArray();
        ...
        [Test(Description = "https://github.com/ProtonBlazor/ProtonBlazor/issues/13106")]
        ...
        {
            var comp = Context.Render<SelectTest1>();
            var sut = comp.FindComponent<ProSelect<string>>();
        ...
        public async Task MultiSelectWithRequiredValue()
        {
            ...
            var selectWithT = comp.FindComponent<ProSelect<MultiSelectTestRequiredValue.TestClass>>().Instance;
            ...
            var inputs = comp.FindAll("div.pro-input-control");
            ...
            comp.WaitForState(() => comp.FindAll("div.pro-list-item").Count == 5);
            items = comp.FindAll("div.pro-list-item").ToArray();
        ...
        public async Task MultiSelectClearAndReset()
        {
            ...
            inputs = comp.FindAll("div.pro-input-control");
            await inputs[0].MouseDownAsync();
            items = comp.FindAll("div.pro-list-item").ToArray();
            await items[1].ClickAsync();
            await inputs[0].MouseDownAsync();
            ...
            var select2 = comp.FindComponent<ProSelect<MultiSelectTestRequiredValue.TestClass>>().Instance;
        ...
        public async Task MultiSelectAttributesOrder()
        {
            ...
            var selectComponent = comp.FindComponent<ProSelect<string>>();
        ...
        {
            var comp = Context.Render<ProSelect<string>>(parameters
        ...
        {
            var comp = Context.Render<ProSelect<string>>(parameters => parameters
        ...
        {
            var comp = Context.Render<ProSelect<int>>(parameters => parameters
        ...
        public void Should_render_aria_label_for_adornment_if_provided(Adornment adornment)
        {
            ...
            comp.Find(".pro-input-adornment-icon").Attributes.GetNamedItem("aria-label")!.Value.Should().Be(ariaLabel);
        }
...
#nullable enable
        ...
        {
            var comp = Context.Render<ProSelect<string>>(p => p
        ...
        public async Task SelectPopoverFullWidth()
        {
            ...
            comp.Find(".restricted").ClassList.Should().Contain("pro-popover-open").And.Contain("pro-popover-relative-width");
            ...
            comp.Find(".expanded").ClassList.Should().Contain("pro-popover-open").And.NotContain("pro-popover-relative-width");
        }
        ...
        public async Task SelectFitContent()
        {
            ...
            var select = comp.Find(".pro-select");

            select.ClassList.Should().NotContain("pro-width-content");
            ...
            select.ClassList.Should().Contain("pro-width-content");

            var filler = comp.Find(".pro-select-filler");
        ...
        public async Task SelectMultiSelectFieldChanged()
        {
            ...
            await comp.WaitForAssertionAsync(() => comp.FindAll("div.pro-list-item").Count.Should().BeGreaterThan(0));
            await comp.Find(".pro-list-item").ClickAsync();
        ...
        public async Task SelectOpenTwoWay()
        {
            ...
            var selectComponentInsaInstance = comp.FindComponent<ProSelect<string>>().Instance;
        ...
        {
            var select = Context.Render<ProSelect<string>>();
        ...
        {
            var select = Context.Render<ProSelect<string>>(parameters =>
            {
        ...
        public async Task Select_ToStringFunc_ShouldTakePrecedenceOverChildContent()
        {
            ...
            var displaySlots = comp.FindAll("div.pro-input-slot");
            ...
            displaySlots = comp.FindAll("div.pro-input-slot");
        ...
        public async Task Select_FitContent_ShouldPrioritizeToStringFunc()
        {
            ...
            filler = comp.Find(".pro-select-filler");
        ...
        public async Task Select_CustomItemRenderFragment()
        {
            ...
            comp.Find(".pro-select-input").TextContent.Should().Contain("Initial Item 1");
            await comp.Find("#switch_values").ClickAsync();
            comp.Find(".pro-select-input").TextContent.Should().Contain("Item 1");
        }
        ...
        public async Task Select_MultiSelect_ShouldKeepSelectionStateIndependentOfActiveDescendant()
        {
            ...
            {
                var input = comp.Find("input");
                var alabama = comp.FindAll("div.pro-list-item").Single(item => item.TextContent.Contains("Alabama"));
                var alaska = comp.FindAll("div.pro-list-item").Single(item => item.TextContent.Contains("Alaska"));
