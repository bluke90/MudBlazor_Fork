# ProtonBlazor.Benchmarks

Performance benchmarking suite for ProtonBlazor's ParameterState framework using BenchmarkDotNet.

## Overview

This project contains comprehensive benchmarks to measure and optimize the performance of the `ParameterState` system in ProtonBlazor. The ParameterState framework is central to ProtonBlazor's rendering and parameter-binding system, used by hundreds of components throughout the library.
...
- [ProtonBlazor Contributing Guide](../../CONTRIBUTING.md)
