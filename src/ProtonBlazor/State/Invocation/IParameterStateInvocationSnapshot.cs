...
namespace ProtonBlazor.State.Invocation;
...
internal interface IParameterStateInvocationSnapshot
{
    ...
    /// <remarks>
    /// <para>
    /// This method is intended for internal use and is controlled by the <see cref="ProComponentBase"/> and <see cref="ParameterScopeContainer"/>.
