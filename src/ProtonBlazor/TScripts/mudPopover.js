...
window.mudpopoverHelper = {
    // set by the class ProPopover in initialize
    ...
    basePopoverZIndex: Number.parseInt(getComputedStyle(document.documentElement)
        .getPropertyValue('--pro-zindex-popover')) || 1200,

    baseTooltipZIndex: Number.parseInt(getComputedStyle(document.documentElement)
        .getPropertyValue('--pro-zindex-tooltip')) || 1600,

    // static set of replacement values
    flipClassReplacements: {
        'top': {
            'pro-popover-top-left': 'pro-popover-bottom-left',
            'pro-popover-top-center': 'pro-popover-bottom-center',
            'pro-popover-top-right': 'pro-popover-bottom-right',
            'pro-popover-anchor-bottom-center': 'pro-popover-anchor-top-center',
            'pro-popover-anchor-bottom-left': 'pro-popover-anchor-top-left',
            'pro-popover-anchor-bottom-right': 'pro-popover-anchor-top-right',
        },
        'left': {
            'pro-popover-top-left': 'pro-popover-top-right',
            'pro-popover-center-left': 'pro-popover-center-right',
            'pro-popover-bottom-left': 'pro-popover-bottom-right',
            'pro-popover-anchor-center-right': 'pro-popover-anchor-center-left',
            'pro-popover-anchor-bottom-right': 'pro-popover-anchor-bottom-left',
            'pro-popover-anchor-top-right': 'pro-popover-anchor-top-left',
        },
        'right': {
            'pro-popover-top-right': 'pro-popover-top-left',
            'pro-popover-center-right': 'pro-popover-center-left',
            'pro-popover-bottom-right': 'pro-popover-bottom-left',
            'pro-popover-anchor-center-left': 'pro-popover-anchor-center-right',
            'pro-popover-anchor-bottom-left': 'pro-popover-anchor-bottom-right',
            'pro-popover-anchor-top-left': 'pro-popover-anchor-top-right',
        },
        'bottom': {
            'pro-popover-bottom-left': 'pro-popover-top-left',
            'pro-popover-bottom-center': 'pro-popover-top-center',
            'pro-popover-bottom-right': 'pro-popover-top-right',
            'pro-popover-anchor-top-center': 'pro-popover-anchor-bottom-center',
            'pro-popover-anchor-top-left': 'pro-popover-anchor-bottom-left',
            'pro-popover-anchor-top-right': 'pro-popover-anchor-bottom-right',
        },
        'top-and-left': {
            'pro-popover-top-left': 'pro-popover-bottom-right',
            'pro-popover-anchor-bottom-right': 'pro-popover-anchor-top-left',
            'pro-popover-anchor-bottom-center': 'pro-popover-anchor-top-center',
            'pro-popover-anchor-bottom-left': 'pro-popover-anchor-top-right',
            'pro-popover-anchor-top-right': 'pro-popover-anchor-bottom-left',
            'pro-popover-anchor-top-center': 'pro-popover-anchor-bottom-center',
            'pro-popover-anchor-top-left': 'pro-popover-anchor-bottom-right',
        },
        'top-and-right': {
            'pro-popover-top-right': 'pro-popover-bottom-left',
            'pro-popover-anchor-bottom-left': 'pro-popover-anchor-top-right',
            'pro-popover-anchor-bottom-center': 'pro-popover-anchor-top-center',
            'pro-popover-anchor-bottom-right': 'pro-popover-anchor-top-left',
            'pro-popover-anchor-top-left': 'pro-popover-anchor-bottom-right',
        ...
        'bottom-and-left': {
            'pro-popover-bottom-left': 'pro-popover-top-right',
            'pro-popover-anchor-top-right': 'pro-popover-anchor-bottom-left',
            'pro-popover-anchor-top-center': 'pro-popover-anchor-bottom-center',
            'pro-popover-anchor-top-left': 'pro-popover-anchor-bottom-right',
            'pro-popover-anchor-bottom-right': 'pro-popover-anchor-top-left',
        ...
        'bottom-and-right': {
            'pro-popover-bottom-right': 'pro-popover-top-left',
            'pro-popover-anchor-top-left': 'pro-popover-anchor-bottom-right',
            'pro-popover-anchor-top-center': 'pro-popover-anchor-bottom-center',
            'pro-popover-anchor-top-right': 'pro-popover-anchor-bottom-left',
            'pro-popover-anchor-bottom-left': 'pro-popover-anchor-top-right',
    ...
    calculatePopoverPosition: function (list, boundingRect, selfRect) {
        let top = boundingRect.top;     // default for pro-popover-anchor-top-left
        let left = boundingRect.left;   // default for pro-popover-anchor-top-left

        const isPositionOverride = list.includes('pro-popover-position-override');

        let offsetX = 0;
        let offsetY = 0;
        // transform origin

        if (list.includes('pro-popover-top-left')) {
            offsetX = 0;
            offsetY = 0;
        } else if (list.includes('pro-popover-top-center')) {
            offsetX = -selfRect.width / 2;
            offsetY = 0;
        } else if (list.includes('pro-popover-top-right')) {
            offsetX = -selfRect.width;
            offsetY = 0;
        }

        else if (list.includes('pro-popover-center-left')) {
            offsetX = 0;
            offsetY = -selfRect.height / 2;
        } else if (list.includes('pro-popover-center-center')) {
            offsetX = -selfRect.width / 2;
            offsetY = -selfRect.height / 2;
        } else if (list.includes('pro-popover-center-right')) {
            offsetX = -selfRect.width;
            offsetY = -selfRect.height / 2;
        }

        else if (list.includes('pro-popover-bottom-left')) {
            offsetX = 0;
            offsetY = -selfRect.height;
        } else if (list.includes('pro-popover-bottom-center')) {
            offsetX = -selfRect.width / 2;
            offsetY = -selfRect.height;
        } else if (list.includes('pro-popover-bottom-right')) {
            offsetX = -selfRect.width;
            offsetY = -selfRect.height;
        }
        ...
        if (!isPositionOverride) {
            ...
            if (list.includes('pro-popover-anchor-top-left')) {
                left = boundingRect.left;
                top = boundingRect.top;
            } else if (list.includes('pro-popover-anchor-top-center')) {
                left = boundingRect.left + boundingRect.width / 2;
                top = boundingRect.top;
            } else if (list.includes('pro-popover-anchor-top-right')) {
                left = boundingRect.left + boundingRect.width;
                top = boundingRect.top;

            } else if (list.includes('pro-popover-anchor-center-left')) {
                left = boundingRect.left;
                top = boundingRect.top + boundingRect.height / 2;
            } else if (list.includes('pro-popover-anchor-center-center')) {
                left = boundingRect.left + boundingRect.width / 2;
                top = boundingRect.top + boundingRect.height / 2;
            } else if (list.includes('pro-popover-anchor-center-right')) {
                left = boundingRect.left + boundingRect.width;
                top = boundingRect.top + boundingRect.height / 2;

            } else if (list.includes('pro-popover-anchor-bottom-left')) {
                left = boundingRect.left;
                top = boundingRect.top + boundingRect.height;
            } else if (list.includes('pro-popover-anchor-bottom-center')) {
                left = boundingRect.left + boundingRect.width / 2;
                top = boundingRect.top + boundingRect.height;
            } else if (list.includes('pro-popover-anchor-bottom-right')) {
                left = boundingRect.left + boundingRect.width;
                top = boundingRect.top + boundingRect.height;
            }
        }
    ...
    placePopover: function (popoverNode, classSelector) {
        ...
        if (popoverNode?.parentNode) {
            ...
            if (!classList.contains('pro-popover-open')) return;
            ...
            const isPositionOverride = classList.contains('pro-popover-position-override');
            const isRelativeWidth = classList.contains('pro-popover-relative-width');
            const isAdaptiveWidth = classList.contains('pro-popover-adaptive-width');
            const isFlipOnOpen = classList.contains('pro-popover-overflow-flip-onopen');
            const isFlipAlways = classList.contains('pro-popover-overflow-flip-always');
            ...
            if (isFlipOnOpen || isFlipAlways) {
                ...
                // Adjust .pro-list children if they would run off screen even after flipping
                const firstChild = popoverContentNode.firstElementChild;
                // Check if firstChild exists, has a classList, and is a pro-list
                const isList = firstChild?.classList?.contains("pro-list");
                ...
                const appBarElements = document.getElementsByClassName("pro-appbar pro-appbar-fixed-top");
                let appBarOffset = 0;
                ...
                if (!selector) {
                    ...
                    // For pro-popover-top-left

                    if (classList.contains('pro-popover-top-left')) {
                    ...
                    // For pro-popover-top-center
                    else if (classList.contains('pro-popover-top-center')) {
                    ...
                    // For pro-popover-top-right
                    else if (classList.contains('pro-popover-top-right')) {
                        // Space available in current direction
                        const spaceBelow = window.innerHeight - anchorY - window.mudpopoverHelper.flipMargin;
                        const spaceLeft = anchorX - window.mudpopoverHelper.flipMargin;
                    ...
                    // For pro-popover-center-left
                    else if (classList.contains('pro-popover-center-left')) {
                    ...
                    // For pro-popover-center-right
                    else if (classList.contains('pro-popover-center-right')) {
                        // Space available in current vs opposite direction
                        const spaceLeft = anchorX - window.mudpopoverHelper.flipMargin;
                        const spaceRight = window.innerWidth - anchorX - window.mudpopoverHelper.flipMargin;
                    ...
                    // For pro-popover-bottom-left
                    else if (classList.contains('pro-popover-bottom-left')) {
                        // Space available in current direction
                        const spaceAbove = anchorY - window.mudpopoverHelper.flipMargin;
                        const spaceRight = window.innerWidth - anchorX - window.mudpopoverHelper.flipMargin;
                    ...
                    // For pro-popover-bottom-center
                    else if (classList.contains('pro-popover-bottom-center')) {
                        // Space available in current vs opposite direction
                        const spaceAbove = anchorY - window.mudpopoverHelper.flipMargin;
                        const spaceBelow = window.innerHeight - anchorY - window.mudpopoverHelper.flipMargin;
                    ...
                    // For pro-popover-bottom-right
                    else if (classList.contains('pro-popover-bottom-right')) {
                        // Space available in current direction
                        const spaceAbove = anchorY - window.mudpopoverHelper.flipMargin;
                        const spaceLeft = anchorX - window.mudpopoverHelper.flipMargin;
                ...
                if (isList) {
                    ...
                    if (checkHeight) {
                        ...
                        const isCentered = Array.from(classList).some(cls =>
                            cls.includes('pro-popover-anchor-center')
                        );
            ...
            else if (!classList.contains('pro-popover-fixed')) {
    ...
    updatePopoverOverlay: function (popoverContentNode) {
        ...
        if (!popoverContentNode || popoverContentNode.classList.contains("pro-tooltip")) {
            return;
        }
        ...
        if (provider && popoverContentNode.classList.contains("pro-popover")) {
            const overlay = provider.querySelector('.pro-overlay');
            // skip any overlay marked with pro-skip-overlay
            if (overlay && !overlay.classList.contains('pro-skip-overlay-positioning')) {
    ...
    updatePopoverZIndex: function (popoverContentNode, parentNode) {
        // find the first parent pro-popover if it exists (nested popovers)
        const parentPopover = parentNode.closest('.pro-popover');
        const popoverNode = document.getElementById('popover-' + popoverContentNode.id.substr(15));
        // get --pro-zindex-popover from root
        ...
        // normal nested position update parentPopover is a parent with .pro-popover so nested for sure
        if (parentPopover) {
        ...
        else if (parentNode?.classList?.contains("pro-tooltip-root")) {
        ...
        else if (parentNode?.classList?.contains("pro-appbar")) {
    ...
    popoverOverlayUpdates: function () {
        ...
        // Traverse children of target.parentNode that contain the class "pro-popover"
        for (const child of parentNode.children) {
            if (child?.classList?.contains("pro-popover-open")) {
        ...
        if (highestTickItem) {
            const isNested = highestTickItem.classList.contains('pro-popover-nested');
            if (!isNested) {
...
class ProPopover {
    ...
    callbackPopover(mutation) {
        ...
        if (mutation.type == 'attributes' && mutation.attributeName == 'class') {
            if (target.classList.contains('pro-popover-open')) {
            ...
            // and it needs to be repositioned and shown, note we don't use pro-popover-open here
    ...
    initialize(containerClass, flipMargin, overflowPadding) {
        ...
        // "pro-popover-provider" is the default name of containerClass.
        ...
        const observer = new MutationObserver((mutations) => {
            for (const mutation of mutations) {
                if (
                    ...
                    mutation.target.classList.contains('pro-popover')
                ) {
    ...
    connect(id) {
        ...
        // e.g. the filter popover for datagrid, this would be the inside of <td> where the mudpopover was placed
        // popoverNode.parentNode is it's immediate parent or the actual <td> element in the above example
        const _ = document.getElementById('popover-' + id);

        // this is the content node in the provider regardless of the RenderFragment that exists when the popover is active
        const popoverContentNode = document.getElementById('popovercontent-' + id);

        const startOpened = popoverContentNode.classList.contains('pro-popover-open');
    ...
    /**
     * Disposes all resources used by this ProPopover instance
    ...
    dispose() {
        try {
            ...
            console.error("Error disposing ProPopover:", error);
        }
    }
...
window.mudpopoverHelper.handleScroll = function (node = null) {
    ...
    if (node) {
        ...
        window.mudpopoverHelper.placePopoverByClassSelector('pro-popover-fixed');
        window.mudpopoverHelper.placePopoverByClassSelector('pro-popover-overflow-flip-always');
    }
    // queue a debounced check all
    window.mudpopoverHelper.debouncedResize();
};

window.mudPopover = new ProPopover();
