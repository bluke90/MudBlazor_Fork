...
class ProHotkeyListener {
    ...
    unregisterHotkey(hotkeyId) {
        if (this._hotkeys.has(hotkeyId)) {
            ...
            console.warn("[ProtonBlazor] ProHotkey: No matching hotkey found to unregister");
        }
    }
        ...
        for (const hotkey of this._hotkeys.values()) {
            ...
            if (allModifiersPressed && noExtraModifiersPressed) {
                ...
                try {
                    ...
                    console.error("[ProtonBlazor] ProHotkey: DotNet invocation failed", {
                        key: hotkey.key,
...
if (!window.mudHotkeyListener) {
    window.mudHotkeyListener = new ProHotkeyListener();
}
