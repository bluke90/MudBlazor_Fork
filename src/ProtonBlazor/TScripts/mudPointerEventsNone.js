...
class ProPointerEventsNone {
    ...
    listenForPointerEvents(dotNetReference, elementId, options) {
        ...
        if (options.enableLogging) {
            this.logger = (msg, ...args) => console.log("[ProtonBlazor | PointerEventsNone]", msg, ...args);
        } else {
            this.logger = () => { };
        }
...
window.mudPointerEventsNone = new ProPointerEventsNone();
