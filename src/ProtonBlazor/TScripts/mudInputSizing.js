...
/**
 * Auto-grow textarea sizing logic for the ProInput component.
...
window.mudInputSizing = {
    ...
    init: (elem, maxLines) => {
        ...
        elem.adjustSizingHeight = function (didReflow = false) {
            // Save scroll positions https://github.com/ProtonBlazor/ProtonBlazor/issues/8152.
            ...
            if (didReflow) {
                const previousTextAlign = elem._proInputSizingPreviousTextAlign;
                elem.style.textAlign = previousTextAlign !== undefined ? previousTextAlign : '';
                delete elem._proInputSizingPreviousTextAlign;
            }
            ...
            // Force another adjustment after the scrollbar is hidden to avoid an empty line https://github.com/ProtonBlazor/ProtonBlazor/pull/8385.
            if (!didReflow && initialOverflowY !== elem.style.overflowY && elem.style.overflowY === 'hidden') {
                elem._proInputSizingPreviousTextAlign = elem.style.textAlign;
