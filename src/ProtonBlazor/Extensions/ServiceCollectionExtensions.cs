...
namespace ProtonBlazor.Services
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddProtonBlazorDialog(this IServiceCollection services)
        {
        ...
        /// <param name="services">IServiceCollection</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorSnackbar(this IServiceCollection services)
        {
        ...
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorSnackbar(this IServiceCollection services, Action<SnackbarConfiguration> options)
        {
            services.AddProtonBlazorSnackbar();
        ...
        /// <param name="services">IServiceCollection</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorResizeListener(this IServiceCollection services)
        {
        ...
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorResizeListener(this IServiceCollection services, Action<ResizeOptions> options)
        {
            services.AddProtonBlazorResizeListener();
            services.Configure(options);
        ...
        /// <param name="services">IServiceCollection</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorResizeObserver(this IServiceCollection services)
        {
        ...
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorResizeObserver(this IServiceCollection services, Action<ResizeObserverOptions> options)
        {
            services.AddProtonBlazorResizeObserver();
            services.Configure(options);
        ...
        /// <param name="services">IServiceCollection</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorResizeObserverFactory(this IServiceCollection services)
        {
        ...
        /// <param name="options">Defines ResizeObserverOptions for this instance</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorResizeObserverFactory(this IServiceCollection services, Action<ResizeObserverOptions> options)
        {
            services.AddProtonBlazorResizeObserverFactory();
            services.Configure(options);
        ...
        /// <param name="services">IServiceCollection</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorKeyInterceptor(this IServiceCollection services)
        {
        ...
        /// <param name="services">IServiceCollection</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddProtonBlazorJsEvent(this IServiceCollection services)
        {
        ...
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        public static IServiceCollection AddProtonBlazorScrollManager(this IServiceCollection services)
        {
        ...
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        public static IServiceCollection AddProtonBlazorScrollListener(this IServiceCollection services)
        {
        ...
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        public static IServiceCollection AddProtonBlazorScrollSpy(this IServiceCollection services)
        {
        ...
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        public static IServiceCollection AddProtonBlazorJsApi(this IServiceCollection services)
        {
        ...
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        public static IServiceCollection AddProtonBlazorPointerEventsNoneService(this IServiceCollection services)
        {
        ...
        /// <summary>
        /// Adds common services required by ProtonBlazor components
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddMudServices(this IServiceCollection services)
        {
            return services
                .AddCommonServices()
                .AddProtonBlazorDialog()
                .AddProtonBlazorSnackbar()
                .AddProtonBlazorResizeListener()
                .AddProtonBlazorResizeObserver()
                .AddProtonBlazorResizeObserverFactory()
                .AddProtonBlazorKeyInterceptor()
                .AddProtonBlazorJsEvent()
                .AddProtonBlazorScrollManager()
                .AddProtonBlazorScrollListener()
                .AddProtonBlazorJsApi()
                .AddProtonBlazorScrollSpy()
                .AddMudPopoverService()
                .AddProtonBlazorPointerEventsNoneService()
                .AddMudLocalization();
        }
        ...
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        /// <param name="configuration">Defines options for all ProtonBlazor services.</param>
        /// <returns>Continues the IServiceCollection chain.</returns>
        public static IServiceCollection AddMudServices(this IServiceCollection services, Action<ProServicesConfiguration> configuration)
        {
            ArgumentNullException.ThrowIfNull(configuration);

            var options = new ProServicesConfiguration();
            configuration(options);

            return services
                .AddCommonServices()
                .AddProtonBlazorDialog()
                .AddProtonBlazorSnackbar(snackBarConfiguration =>
                {
                ...
                .AddProtonBlazorResizeListener(resizeOptions =>
                {
                ...
                .AddProtonBlazorResizeObserver(observerOptions =>
                {
                ...
                .AddProtonBlazorResizeObserverFactory(observerOptions =>
                {
                    observerOptions.EnableLogging = options.ResizeObserverOptions.EnableLogging;
                    observerOptions.ReportRate = options.ResizeObserverOptions.ReportRate;
                })
