...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// Specifies the name of the category in which to group the property of a ProtonBlazor component when displayed in the API documentation.
    /// </summary>
    /// <remarks>
    ...
    public class CategoryAttribute : Attribute
    {
        ...
        private static readonly Dictionary<string, int> _categoryOrder = new()
        {
            ...
            // "Miscellaneous" category. In classes inheriting from ProComponentBase it can be used only exceptionally -
    ...
    /// <summary>
    /// Possible categories of ProtonBlazor components properties.
    /// </summary>
    /// <remarks>
    ///     <b>General categories</b>
    ///     <para>
    ///       - <i>Data</i>       - Used e.g. in form fields, pickers, <see cref="ProRating"/>, <see cref="ProTable{T}"/>, <see cref="ProTreeView{T}"/>,
    ///                              <see cref="ProTreeViewItem{T}"/>, and <see cref="ProCarousel{TData}"/>. Containers have this group when their items can be defined
    ...
    ///       - <i>Common</i>     - Properties defined in <see cref="ProComponentBase"/>.
    ///     </para>
    ///     <para>
    ///     Note: The following properties belong to the "Behavior" group, not to the "Appearance" group:<br/>
    ///      - <see cref="ProIconButton.Icon"/> - because it describes meaning of the button, since ProIconButton doesn't have text,<br/>
    ///      - <see cref="ProBaseInput{T}.Label"/> - because it describes meaning of the field,<br/>
    ///      - <see cref="ProBaseInput{T}.AdornmentText"/> - because it can describe information important to a user, e.g. a numeric field unit such as kilograms.<br/>
    ...
    ///           For example, <see cref="ProTableBase.CommitEditIcon"/> could belong to the "Appearance" group, but belongs to the "Editing" group.</para>
    /// 
    ...
    public static class CategoryTypes
    {
        ...
        /// <summary>Used in <see cref="ProComponentBase"/>.</summary>
        public static class ComponentBase
        {
            public const string Common = "Common";
        }

        /// <summary>Used in: <see cref="ProBaseButton"/>, all components inheriting from it, and <see cref="ProToggleIconButton"/>.</summary>
        ...
        /// <summary>Used in <see cref="ProFormComponent{T, U}"/> and all components inheriting from it.</summary>
        ...
        /// <summary>Used in <see cref="ProChartBase{T, TOptions}"/> and all components inheriting from it.</summary>
