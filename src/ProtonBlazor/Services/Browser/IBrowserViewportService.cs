...
public interface IBrowserViewportService : IAsyncDisposable
{
    ...
    /// <param name="options">The resize options for the observer. When set to null, the global options provided during AddMudServices/AddProtonBlazorResizeListener will be used.
