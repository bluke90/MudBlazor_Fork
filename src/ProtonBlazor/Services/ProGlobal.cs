...
/// <summary>
/// <para>
/// Static properties that let you control the default behavior of some parts of ProtonBlazor.
/// </para>
/// <para>
/// <b>Warning:</b> This feature is under development and breaking changes to the API <b>will occur</b> between releases.
/// See <see href="https://protonblazor.com/customization/globals#usage">our website</see> for more info including our support policy.
/// </para>
/// </summary>
public static class ProGlobal
{
    /// <summary>
    /// Default settings for <see cref="ProMenu"/>.
    /// <br/>
    /// <b>Warning:</b> This feature is under development and breaking changes to the API <b>will occur</b> between releases.
    /// </summary>
    ...
    {
        /// <summary>
        /// The delay in milliseconds before a <see cref="ProMenu"/> is shown when hovered, or hidden after the cursor moves away.
        /// </summary>
        public static int HoverDelay { get; set; } = 300;
    }

    /// <summary>
    /// Default settings for <see cref="ProTooltip"/>.
    /// <br/>
    /// <b>Warning:</b> This feature is under development and breaking changes to the API <b>will occur</b> between releases.
    /// </summary>
    ...
    {
        /// <summary>
        /// The amount of time in milliseconds to wait from opening the <see cref="ProTooltip"/> before beginning to perform the transition.
        /// </summary>
        public static TimeSpan Delay { get; set; } = TimeSpan.Zero;

        /// <summary>
        /// The length of time that the opening transition for <see cref="ProTooltip"/> takes to complete.
        /// </summary>
        public static TimeSpan Duration { get; set; } = TimeSpan.FromMilliseconds(251);
    }

    /// <summary>
    /// The handler for unhandled ProtonBlazor component exceptions.
    /// </summary>
    /// <remarks>
