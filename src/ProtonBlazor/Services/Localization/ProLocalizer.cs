...
/// <summary>
/// Base localizer that applications can override to supply ProtonBlazor translations.
/// </summary>
/// <remarks>
/// Register a custom implementation with DI (for example,
/// <c>services.Add{scope}Transient&lt;ProLocalizer, CustomMudLocalizerImpl&gt;()</c> or
/// <c>services.TryAdd{scope}Transient&lt;ProLocalizer, CustomMudLocalizerImpl&gt;()</c>) to provide localized strings for components.
/// </remarks>
public class ProLocalizer
{
    /// <summary>
