...
internal class ProPopoverHolder : IMudPopoverHolder
{
    ...
    /// <inheritdoc />
    public ProRender? ElementReference { get; set; }

    /// <summary>
    /// Initializes a new instance of the <see cref="ProPopoverHolder"/> class.
    /// </summary>
    ...
    public ProPopoverHolder(Guid id, TimeProvider timeProvider)
    {
        Id = id;
    ...
    /// <returns>The updated <see cref="ProPopoverHolder"/> instance.</returns>
    public ProPopoverHolder SetClass(string @class)
    {
        Class = @class;
    ...
    /// <returns>The updated <see cref="ProPopoverHolder"/> instance.</returns>
    public ProPopoverHolder SetStyle(string style)
    {
        Style = style;
    ...
    /// <returns>The updated <see cref="ProPopoverHolder"/> instance.</returns>
    public ProPopoverHolder SetShowContent(bool showContent)
    {
    ...
    /// <returns>The updated <see cref="ProPopoverHolder"/> instance.</returns>
    public ProPopoverHolder SetTag(object? tag)
    {
        Tag = tag;
    ...
    /// <returns>The updated <see cref="ProPopoverHolder"/> instance.</returns>
    public ProPopoverHolder SetUserAttributes(Dictionary<string, object?> userAttributes)
    {
    ...
    /// <returns>The updated <see cref="ProPopoverHolder"/> instance.</returns>
    public ProPopoverHolder SetFragment(RenderFragment? renderFragment)
    {
