...
/// <summary>
/// Options that control how ProtonBlazor popovers are positioned, animated, and managed.
/// </summary>
/// <remarks>
/// Configure this when registering ProtonBlazor services to keep popover behavior consistent across selects, menus, tooltips, and other popover-based components.
/// </remarks>
public class PopoverOptions
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to check for the presence of a popover provider <see cref="ProPopoverProvider"/>.
    ...
    /// The default value is <c>pro-popover-provider</c>.
    /// </summary>
    public string ContainerClass { get; set; } = "pro-popover-provider";
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to throw an exception when a duplicate <see cref="ProPopoverProvider"/> is encountered.
    /// The default value is <c>true</c>.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>
    /// Only applies to components that use a <see cref="ProPopover"/> in conjunction with a <see cref="ProOverlay"/>
    /// to close the popover when a user clicks outside, such as <see cref="ProSelect{T}"/>.
