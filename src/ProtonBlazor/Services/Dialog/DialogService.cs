...
// License: MIT
// Copyright (c) 2020 Adapted by ProtonBlazor
...
{
    /// <summary>
    /// Service used to create, show, and close ProtonBlazor dialogs.
    /// </summary>
    /// <remarks>
    /// Register this service and include a <see cref="ProDialogProvider"/> in your layout so dialogs can render and respond to close requests.
    /// </remarks>
    /// <seealso cref="ProDialog"/>
    /// <seealso cref="ProDialogContainer"/>
    ...
    public class DialogService : IDialogService
    {
        ...
        /// See: https://github.com/ProtonBlazor/ProtonBlazor/issues/10659#issuecomment-2602911059
        /// </remarks>
        ...
        public async Task<bool?> ShowMessageBoxAsync(MessageBoxOptions messageBoxOptions, DialogOptions? options = null)
        {
            ...
            var reference = await ShowAsync<ProMessageBox>(title: messageBoxOptions.Title, parameters: parameters, options: options);
            ...
            DialogOptions options)
        {
            ...
            {
                builder.OpenComponent<ProDialogContainer>(0);
                builder.SetKey(dialogReference.Id);
                builder.AddComponentParameter(1, nameof(ProDialogContainer.Options), options);
                builder.AddComponentParameter(2, nameof(ProDialogContainer.Title), title);
                builder.AddComponentParameter(3, nameof(ProDialogContainer.Content), dialogContent);
                builder.AddComponentParameter(4, nameof(ProDialogContainer.Id), dialogReference.Id);
                builder.CloseComponent();
            });
