...
/// <see cref="ProFormComponent{T, U}.Converter"/>. When a converter implementing this interface is supplied to
...
public interface ICultureAwareConverter
{
    ...
    /// <see cref="ProFormComponent{T, U}.Converter"/>), the host component will supply this delegate automatically.
    ...
    /// When the converter is used as a component converter (via <see cref="ProFormComponent{T, U}.Converter"/>), the host component will
