...
namespace ProtonBlazor
{
    ...
    public abstract class ProFormComponent<T, U> : ProComponentBase, IFormComponent, IAsyncDisposable
    {
        ...
        #region ProForm Validation

        /// <summary>
        /// The list of problems with the current input value.
        /// </summary>
        /// <remarks>
        /// When using a <see cref="ProForm"/>, this property is updated when validation has been performed.  Use the <see cref="Validation"/> property to control what validations are performed.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// When using a <see cref="ProForm"/>, this property can be any of several kinds of functions:
        /// <para>
        ...
        /// </summary>
        /// <remarks>
        /// When using a <see cref="ProForm"/>, the input is validated via the function set in the <see cref="Validation"/> property.
        /// </remarks>
