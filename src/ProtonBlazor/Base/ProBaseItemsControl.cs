...
namespace ProtonBlazor
{
    ...
    /// </summary>
    /// <typeparam name="TChildComponent">The type of <see cref="ProComponentBase"/> managed by this component.</typeparam>
    public abstract class ProBaseItemsControl<TChildComponent> : ProComponentBase
