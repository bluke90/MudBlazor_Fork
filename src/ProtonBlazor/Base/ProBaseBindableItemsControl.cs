...
namespace ProtonBlazor
{
    ...
    /// </summary>
    /// <typeparam name="TChildComponent">The <see cref="ProComponentBase"/> managed within this component..</typeparam>
    /// <typeparam name="TData">The type of item managed by this component.</typeparam>
    public abstract class ProBaseBindableItemsControl<TChildComponent, TData> : ProBaseItemsControl<TChildComponent>
        where TChildComponent : ProComponentBase
    {
        /// <summary>
