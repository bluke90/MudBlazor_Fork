/**
 * Build script for ProtonBlazor JS and SCSS assets.
 *
 * Usage:
 *   bun run build.mjs
...
const jsOutputFile = path.join(scriptDirectory, "wwwroot/ProtonBlazor.min.js");
const scssInput = path.join(scriptDirectory, "Styles/ProtonBlazor.scss");
const scssInputDir = path.dirname(scssInput);
const scssOutput = path.join(scriptDirectory, "wwwroot/ProtonBlazor.min.css");
