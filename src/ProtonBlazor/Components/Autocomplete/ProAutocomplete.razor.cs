...
{
    /// <summary>
    /// A text input for searching and selecting from a list of options. Unlike <see cref="ProSelect{T}"/>, it doesn't require the complete item list upfront and supports asynchronous search for database queries.
    /// </summary>
    /// <typeparam name="T">The type of item to search.</typeparam>
    /// <seealso cref="ProSelect{T}"/>
    public partial class ProAutocomplete<T> : ProBaseInput<T>
    {
        /// <summary>
        ...
        protected string AutocompleteClassname =>
            new CssBuilder("pro-select")
                .AddClass("pro-autocomplete")
                .AddClass("pro-width-full", FullWidth)
                .AddClass("pro-autocomplete--with-progress", ShowProgressIndicator && IsLoading)
                .Build();
        ...
        protected string GetListItemClassname(bool isSelected) =>
            new CssBuilder()
                .AddClass("pro-selected-item pro-primary-text pro-primary-hover", isSelected)
        ...
        /// </summary>
        /// <remarks>
        /// The current value of <see cref="ProBaseInput{T}.Text"/> is included in this event.
        /// </remarks>
        [Parameter]
        ...
        protected override void OnAfterRender(bool firstRender)
        {
            if (_isClearing || _isProcessingValue)
            {
                ...
                //https://github.com/ProtonBlazor/ProtonBlazor/pull/6701
