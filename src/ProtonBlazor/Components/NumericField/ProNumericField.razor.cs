...
namespace ProtonBlazor
{
    ...
    public partial class ProNumericField<T> : ProDebouncedInput<T>
    {
        private T? _step;
        private T? _max;
        private T? _min;
        ...
        protected string Classname =>
            new CssBuilder("pro-input-input-control pro-input-number-control")
                .AddClass(HideSpinButtons ? "pro-input-nospin" : "pro-input-showspin")
                .AddClass(Class)
                .Build();
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                ...
                var options = new KeyInterceptorOptions("pro-input-slot", keyOptions.ToArray());
