...
namespace ProtonBlazor
{
    ...
    /// </summary>
    public partial class ProPagination : ProComponentBase
    {
        ...
        private string Classname =>
            new CssBuilder("pro-pagination")
                .AddClass($"pro-pagination-{Variant.ToStringFast(true)}")
                .AddClass($"pro-pagination-{Size.ToStringFast(true)}")
                .AddClass("pro-pagination-disable-elevation", !DropShadow)
                .AddClass("pro-pagination-rtl", RightToLeft)
                .AddClass(Class)
                .Build();

        private string ItemClassname =>
            new CssBuilder("pro-pagination-item")
                .AddClass("pro-pagination-item-rectangular", Rectangular)
                .Build();

        private string SelectedItemClassname =>
            new CssBuilder(ItemClassname)
                .AddClass("pro-pagination-item-selected")
                .Build();

        public ProPagination()
        {
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>. Controlled via the <see cref="ProRTLProvider"/>.
        /// </remarks>
