...
/// <summary>
/// Represents content at the top of a <see cref="ProDrawer"/>.
/// </summary>
/// <seealso cref="ProDrawer"/>
/// <seealso cref="ProDrawerContainer"/>
public partial class ProDrawerHeader
{
    protected string Classname =>
      new CssBuilder("pro-drawer-header")
          .AddClass($"pro-drawer-header-dense", Dense)
          .AddClass(Class)
          .Build();
