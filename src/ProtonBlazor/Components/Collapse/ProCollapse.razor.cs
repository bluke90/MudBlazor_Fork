...
namespace ProtonBlazor
{
    ...
    public partial class ProCollapse : ProComponentBase
    {
        ...
        protected string Classname => new CssBuilder("pro-collapse-container")
            .AddClass("pro-collapse-entering", _state == CollapseState.Entering)
            .AddClass("pro-collapse-entered", _state == CollapseState.Entered)
            .AddClass("pro-collapse-exiting", _state == CollapseState.Exiting)
