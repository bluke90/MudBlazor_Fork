...
/// </summary>
public partial class ProHotkey : ProComponentBase, IAsyncDisposable
{
    private readonly string _hotkeyId = Identifier.Create("hotkey");
    private bool _childContentIsVisible;
    private DotNetObjectReference<ProHotkey>? _dotNetObjectReference;
    ...
    [DynamicDependency(nameof(ProHotkeyProviderJsCallback))]
    public ProHotkey()
    {
    ...
    private async Task RegisterOrUpdateHotkeyAsync()
    {
        ...
        await JsRuntime.InvokeVoidAsyncWithErrorHandling("mudHotkeyListener.registerOrUpdateHotkey",
            ...
            nameof(ProHotkeyProviderJsCallback),
            _hotkeyId,
            Key.ToString(),
    ...
    [JSInvokable]
    public async Task ProHotkeyProviderJsCallback()
    {
