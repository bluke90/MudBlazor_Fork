...
using ProtonBlazor.Components.Highlighter; // Added for FragmentInfo
// Removed: using static ProtonBlazor.Components.Highlighter.Splitter; 
...
/// </summary>
public partial class ProHighlighter : ProComponentBase
{
