...
/// </summary>
public partial class ProSplitPanel : ProComponentBase, IAsyncDisposable
{
    private string Classname => new CssBuilder("pro-split-panel")
    ...
    private string ClassnameFirstPanel => new CssBuilder("child-panel")
        .AddClass($"pro-elevation-{Elevation}", Elevation != 0 && FirstPanel != null)
    ...
    private string ClassnameSecondPanel => new CssBuilder("child-panel")
        .AddClass($"pro-elevation-{Elevation}", Elevation != 0 && SecondPanel != null)
