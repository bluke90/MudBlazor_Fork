...
namespace ProtonBlazor
{
    ...
    /// </remarks>
    public partial class ProFocusTrap : IDisposable
    {
        ...
        {
            return _root.ProFocusFirstAsync(2, 4).AsTask();
        }

        private Task FocusLastAsync()
        {
            return _root.ProFocusLastAsync(2, 4).AsTask();
        }
        ...
        {
            return _root.ProRestoreFocusAsync().AsTask();
        }

        private Task SaveFocusAsync()
        {
            return _root.ProSaveFocusAsync().AsTask();
        }
