...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A deeper level of navigation links as part of a <see cref="ProNavMenu"/>.
    /// </summary>
    /// <seealso cref="ProNavLink"/>
    /// <seealso cref="ProNavMenu"/>
    public partial class ProNavGroup : ProComponentBase
    {
        ...
        protected string Classname =>
            new CssBuilder("pro-nav-group")
                .AddClass(Class)
                .AddClass("pro-nav-group-disabled", Disabled)
                .Build();

        protected string ButtonClassname =>
            new CssBuilder("pro-nav-link")
                .AddClass($"pro-ripple", Ripple)
                .AddClass("pro-expanded", _expandedState.Value)
                .AddClass(HeaderClass)
                .Build();

        protected string IconClassname =>
            new CssBuilder("pro-nav-link-icon")
                .AddClass("pro-nav-link-icon-default", IconColor == Color.Default)
                .Build();

        protected string ExpandIconClassname =>
            new CssBuilder("pro-nav-link-expand-icon")
                .AddClass("pro-transform", _expandedState.Value && !Disabled)
                .AddClass("pro-transform-disabled", _expandedState.Value && Disabled)
                .Build();
        ...
        /// </summary>
        /// <remarks>
        /// Typically contains <see cref="ProNavGroup"/> and <see cref="ProNavLink"/> components.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.NavMenu.Behavior)]
