...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A navigation link as part of a <see cref="ProNavMenu"/>.
    /// </summary>
    /// <seealso cref="ProNavGroup"/>
    /// <seealso cref="ProNavMenu"/>
    public partial class ProNavLink : ProComponentBase
    {
        protected string Classname =>
            new CssBuilder("pro-nav-item")
                .AddClass(Class)
                .Build();

        protected string LinkClassname =>
            new CssBuilder("pro-nav-link")
                .AddClass($"pro-nav-link-disabled", Disabled)
                .AddClass($"pro-ripple", Ripple && !Disabled)
                .Build();
