...
public interface IMudDialogInstance
{
    ...
    /// <summary>
    /// The unique HTML element ID of the dialog container (pro-dialog-container).
    /// </summary>
    ...
    /// <summary>
    /// The text displayed at the top of this dialog if <see cref="ProDialogContainer.TitleContent" /> is not set.
    /// </summary>
    string? Title { get; }
    ...
    /// <remarks>
    /// Use this method to change the title while a dialog is open, such as when the title reflects a value within this dialog.  Has no effect when <see cref="ProDialogContainer.TitleContent"/> is set.
    /// </remarks>
