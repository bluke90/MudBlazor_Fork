...
// Copyright (c) 2020 ProtonBlazor Contributors
...
namespace ProtonBlazor
{
    ...
    /// <seealso cref="ProtonBlazor.DialogService"/>
    /// <seealso cref="ProMessageBox" />
    public partial class ProDialog : ProComponentBase
    {
        ...
        protected string ContentClassname => new CssBuilder("pro-dialog-content")
            .AddClass("pro-dialog-no-side-padding", !Gutters)
            .AddClass(ContentClass)
            .Build();

        protected string ActionsClassname => new CssBuilder("pro-dialog-actions")
        ...
        /// </summary>
        /// <remarks>
        /// When <c>null</c>, the <see cref="ProDialogContainer.Title"/> will be used.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        [Obsolete("Prefer the ContentClass property with CSS https://github.com/ProtonBlazor/ProtonBlazor/issues/12047")]
        [Parameter]
        [Category(CategoryTypes.Dialog.Appearance)]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>, which will use the global default from <see cref="ProDialogProvider.DefaultFocus"/> if set, otherwise <see cref="DefaultFocus.Element"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Dialog.Behavior)]
...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                _reference = await DialogService.ShowAsync<ProDialog>(title, parameters, options ?? Options);
