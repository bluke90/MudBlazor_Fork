...
/// </summary>
public partial class ProText : ProComponentBase
{
    protected string Classname =>
        new CssBuilder("pro-typography")
            .AddClass($"pro-typography-{Typo.ToStringFast(true)}")
            .AddClass($"pro-{Color.ToStringFast(true)}-text", Color != Color.Default && Color != Color.Inherit)
            .AddClass("pro-typography-gutterbottom", GutterBottom)
            .AddClass($"pro-typography-align-{ConvertAlign(Align).ToStringFast(true)}", Align != Align.Inherit)
