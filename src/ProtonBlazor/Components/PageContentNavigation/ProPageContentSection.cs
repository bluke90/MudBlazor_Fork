...
{
    /// <summary>
    /// A section (nav link) inside the ProPageContentNavigation
    /// </summary>
    public class ProPageContentSection
    {
        private readonly List<ProPageContentSection> _children = new();

        public int LevelSortingValue { get; private set; }

        public ProPageContentSection? Parent { get; }
        ...
        public ProPageContentSection(string title, string id)
        ...
        public ProPageContentSection(string title, string id, int level, ProPageContentSection? parent)
        {
            Title = title;
            Id = id;
            Level = level;
