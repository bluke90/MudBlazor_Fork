...
namespace ProtonBlazor
{
    ...
    public partial class ProPageContentNavigation : IAsyncDisposable, IMudStateHasChanged
    {
        ...
        /// <summary>
        /// The displayed section within the ProPageContentNavigation
        /// </summary>
        public IEnumerable<ProPageContentSection> Sections => _sections.AsEnumerable();

        /// <summary>
        /// The currently active session. null if there is no section selected
        /// </summary>
        public ProPageContentSection? ActiveSection => _sections.FirstOrDefault(x => x.Active);
        ...
        private string GetNavLinkClass(ProPageContentSection section) =>
        ...
        public void AddSection(string sectionName, string sectionId, bool forceUpdate) => AddSection(new ProPageContentSection(sectionName, sectionId), forceUpdate);

        private readonly Dictionary<ProPageContentSection, ProPageContentSection> _parentMapper = new();
        ...
        /// <param name="forceUpdate">If true, StateHasChanged is called, forcing a re-render of the component</param>
        public void AddSection(ProPageContentSection section, bool forceUpdate)
        {
