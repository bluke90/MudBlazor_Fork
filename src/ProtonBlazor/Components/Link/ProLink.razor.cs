...
/// </summary>
public partial class ProLink : ProComponentBase
{
    protected string Classname =>
        new CssBuilder("pro-typography pro-link")
            .AddClass($"pro-{Color.ToStringFast(true)}-text")
            .AddClass($"pro-link-underline-{Underline.ToStringFast(true)}")
            .AddClass($"pro-typography-{Typo.ToStringFast(true)}", Typo != Typo.inherit)
            ...
            .AddClass("pro-link-disabled", Disabled)
            .AddClass(Class)
            .Build();

    protected string StartIconClassname =>
        new CssBuilder("pro-link-icon-start")
            .AddClass(IconClass)
            .Build();

    protected string EndIconClassname =>
        new CssBuilder("pro-link-icon-end")
            .AddClass(IconClass)
            .Build();
