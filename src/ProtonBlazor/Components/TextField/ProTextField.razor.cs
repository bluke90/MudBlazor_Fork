...
namespace ProtonBlazor
{
    ...
    public partial class ProTextField<T> : ProDebouncedInput<T>
    {
        private IMask? _mask;
        private ProMask? _maskReference;
        ...
        /// <summary>
        /// The reference to the underlying <see cref="ProInput{T}"/> component.
        /// </summary>
        public ProInput<string>? InputReference { get; private set; }
        ...
        public IMask? Mask
        {
            get => _maskReference?.Mask ?? _mask; // this might look strange, but it is absolutely necessary due to how ProMask works.
            set => _mask = value;
        }
        ...
        /// <summary>
        /// Clears the <see cref="ProBaseInput{T}.Text"/> and sets <see cref="ProBaseInput{T}.Value"/> to <c>default(T)</c>.
        /// </summary>
        ...
        /// <summary>
        /// Sets the <see cref="ProBaseInput{T}.Text"/> to the specified value.
        /// </summary>
        ...
        /// Note that this function doesn't support <see cref="ProMask"/>.
        /// </remarks>
