...
namespace ProtonBlazor
{
    ...
    /// <seealso cref="ProDropContainer{T}"/>
    /// <seealso cref="ProDynamicDropItem{T}"/>
    public partial class ProDropZone<T> : ProComponentBase, IDisposable where T : notnull
    {
        private bool _containerIsInitialized = false;
        private bool _canDrop = false;
        private bool _dragInProgress = false;
        private bool _disposedValue = false;
        private readonly string _id = ProtonBlazor.Identifier.Create();
        ...
        [CascadingParameter]
        protected ProDropContainer<T>? Container { get; set; }
        ...
        /// </summary>
        /// <remarks>
        /// When set, overrides the <see cref="ProDropContainer{T}.ItemRenderer"/>.
        /// </remarks>
        [Parameter]
        ...
        /// <summary>
        /// The function which determines whether an item is within this <see cref="ProDropZone{T}"/> .
        /// </summary>
        /// <remarks>
        /// When set, overrides the <see cref="ProDropContainer{T}.ItemsSelector"/> function.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DropZone.Items)]
        ...
        /// </summary>
        /// <remarks>
        /// When a drop zone is allowed, the <see cref="CanDropClass"/> is applied, otherwise <see cref="NoDropClass"/> is applied.  When set, overrides <see cref="ProDropContainer{T}.CanDrop"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// This class is applied when <see cref="CanDrop"/> returns <c>true</c> for an item.  Multiple classes must be separated by spaces.  When set, overrides <see cref="ProDropContainer{T}.CanDropClass"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DropZone.DropRules)]
        ...
        /// </summary>
        /// <remarks>
        /// This class is applied when <see cref="CanDrop"/> returns <c>false</c> for an item.  Multiple classes must be separated by spaces.  When set, overrides <see cref="ProDropContainer{T}.NoDropClass"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DropZone.DropRules)]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  The <see cref="CanDrop"/> function determines which classes are applied.  When set, overrides <see cref="ProDropContainer{T}.ApplyDropClassesOnDragStarted"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DropZone.DropRules)]
        ...
        /// </summary>
        /// <remarks>
        /// If no value is given, all items can be dragged by default.  When an item is disabled, the <see cref="DisabledClass"/> is applied.  When set, overrides <see cref="ProDropContainer{T}.ItemDisabled"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// This class is applied when <see cref="ItemDisabled"/> returns <c>true</c> for an item.  Multiple classes must be separated by spaces.  When set, overrides <see cref="ProDropContainer{T}.DisabledClass"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DropZone.Disabled)]
        ...
        /// </summary>
        /// <remarks>
        /// Multiple classes must be separated by spaces.  When set, overrides <see cref="ProDropContainer{T}.DraggingClass"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Multiple classes must be separated by spaces.  When set, overrides <see cref="ProDropContainer{T}.ItemDraggingClass"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DropZone.DraggingClass)]
        ...
        /// </summary>
        /// <remarks>
        /// When set, overrides <see cref="ProDropContainer{T}.ItemsClassSelector"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DropZone.Items)]
        ...
        protected string Classname =>
            new CssBuilder("pro-drop-zone")
                //.AddClass("pro-drop-zone-drag-block", Container?.TransactionInProgress() == true && Container.GetTransactionOrignZoneIdentiifer() != Identifier)
        ...
        protected string PlaceholderClassname =>
            new CssBuilder("border-2 pro-border-primary border-dashed pro-chip-text pro-chip-color-primary pa-4 pro-dropitem-placeholder")
        ...
        private void Container_TransactionEnded(object? sender, ProDragAndDropTransactionFinishedEventArgs<T> e)
        {
            _dragCounter = 0;
        ...
        private void Container_TransactionStarted(object? sender, ProDragAndDropItemTransaction<T> e)
        {
            if (GetApplyDropClassesOnDragStarted())
            {
        ...
        private void Container_TransactionIndexChanged(object? sender, ProDragAndDropIndexChangedEventArgs e)
        {
