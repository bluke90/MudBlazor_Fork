...
/// <summary>
/// The information related to a <see cref="ProDropZone{T}"/> drag-and-drop transaction.
/// </summary>
/// <typeparam name="T">The type of item being dragged and dropped.</typeparam>
public class ProDragAndDropItemTransaction<T>
{
    ...
    public ProDragAndDropItemTransaction(T? item, string identifier, int index, Func<Task> commitCallback, Func<Task> cancelCallback)
    {
        Item = item;
