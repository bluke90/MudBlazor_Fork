...
public partial class ProDynamicDropItem<T> : ProComponentBase where T : notnull
{
    ...
    /// <summary>
    /// At least one <see cref="ProDragHandle{T}"/> is registered for this item.
    ...
    /// This is suppressed when a <see cref="ProDragHandle{T}"/> is present so that only
    ...
    protected string Classname =>
        new CssBuilder("pro-drop-item")
            .AddClass("pro-drop-item-draggable", IsEffectivelyDraggable)
