...
{
    /// <summary>
    /// A choice displayed as part of a list within a <see cref="ProMenu"/> component.
    /// </summary>
    /// <seealso cref="ProMenu" />
    public partial class ProMenuItem : ProComponentBase
    {
        [Inject]
        ...
        protected string Classname =>
            new CssBuilder("pro-menu-item")
                .AddClass("pro-disabled", GetDisabled())
                .AddClass("pro-ripple", !GetDisabled())
                .AddClass("pro-list-item-clickable", !GetDisabled())
                .AddClass("pro-menu-item-dense", GetDense())
                .AddClass(Class)
                .Build();

        /// <summary>
        /// The <see cref="ProMenu"/> which contains this item.
        /// </summary>
        [CascadingParameter]
        public ProMenu? ParentMenu { get; set; }
        ...
        /// </summary>
        protected bool ActivatesSubMenu => Class?.Contains("pro-menu-sub-menu-activator") == true;
