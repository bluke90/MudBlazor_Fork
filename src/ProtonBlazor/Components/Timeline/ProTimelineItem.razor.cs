...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A chronological item displayed as part of a <see cref="ProTimeline"/>
    /// </summary>
    /// <seealso cref="ProTimeline"/>
    public partial class ProTimelineItem : ProComponentBase, IDisposable
    {
        protected string Classnames =>
            new CssBuilder("pro-timeline-item")
                .AddClass($"pro-timeline-item-{TimelineAlign.ToStringFast(true)}")
                .AddClass(Class)
                .Build();

        protected string DotClassnames =>
            new CssBuilder("pro-timeline-item-dot")
                .AddClass($"pro-timeline-dot-size-{Size.ToStringFast(true)}")
                .AddClass($"pro-elevation-{Elevation}")
                .Build();

        protected string DotInnerClassnames =>
            new CssBuilder("pro-timeline-item-dot-inner")
                .AddClass($"pro-timeline-dot-fill", Variant == Variant.Filled)
                .AddClass($"pro-timeline-dot-{Color.ToStringFast(true)}")
                .AddClass(DotClass)
                .Build();
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [CascadingParameter]
        protected internal ProBaseItemsControl<ProTimelineItem>? Parent { get; set; }
        ...
        /// </remarks>
        [Obsolete("Prefer the DotClass property with CSS https://github.com/ProtonBlazor/ProtonBlazor/issues/12047")]
        [Parameter]
        [Category(CategoryTypes.Timeline.Dot)]
        ...
        /// <summary>
        /// Overrides <see cref="ProTimeline.TimelineAlign"/> with a custom value.
        /// </summary>
        /// <remarks>
