...
namespace ProtonBlazor
{
    ...
    public partial class ProBreadcrumbs : ProComponentBase
    {
        private string Classname => new CssBuilder("pro-breadcrumbs")
            .AddClass("pro-typography-body1")
            .AddClass(Class)
            .Build();
        ...
        {
            return new CssBuilder("pro-breadcrumb-item")
