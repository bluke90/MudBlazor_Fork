...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A clickable item as part of a <see cref="ProRating"/>.
    /// </summary>
    /// <seealso cref="ProRating"/>
    public partial class ProRatingItem : ProComponentBase
    {
        /// <summary>
        /// The CSS classes applied to this component.
        /// </summary>
        protected string ClassName =>
            new CssBuilder("pro-rating-item")
                .AddClass("pro-ripple pro-ripple-icon", Ripple)
                .AddClass("yellow-text.text-darken-3", Color == Color.Default)
                .AddClass($"pro-{Color.ToStringFast(true)}-text", Color != Color.Default)
                .AddClass("pro-rating-item-active", Active)
                .AddClass("pro-disabled", Disabled)
                .AddClass("pro-readonly", ReadOnly)
                .AddClass(Class)
                .Build();

        /// <summary>
        /// The parent <see cref="ProRating"/> containing this item.
        /// </summary>
        [CascadingParameter]
        private ProRating? Rating { get; set; }

        /// <summary>
        /// The value for this item.
        /// </summary>
        /// <remarks>
        /// Defaults to the index of this item in the parent <see cref="ProRating"/>.  (e.g. The 3rd item has a value of <c>3</c>.)
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <see cref="Size.Medium"/>.  Can be overridden by <see cref="ProRating.Size"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <see cref="Color.Default"/>.  Can be overridden by <see cref="ProRating.Color"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>true</c>.  Can be overridden by <see cref="ProRating.Ripple"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// When clicked, the <see cref="ProRating.SelectedValue"/> is changed.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// When hovered, the <see cref="ProRating.HoveredValue"/> is changed.
        /// </remarks>
        [Parameter]
