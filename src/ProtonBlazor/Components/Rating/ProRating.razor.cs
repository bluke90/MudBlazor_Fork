...
namespace ProtonBlazor
{
    ...
    /// </summary>
    /// <seealso cref="ProRatingItem"/>
    public partial class ProRating : ProComponentBase
    {
        ...
        protected string ClassName =>
            new CssBuilder("pro-rating-root")
                .AddClass("pro-disabled", Disabled)
                .AddClass(Class)
                .Build();

        /// <summary>
        /// The CSS classes to apply to each <see cref="ProRatingItem"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The CSS styles to apply to each <see cref="ProRatingItem"/>.
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.
        /// </remarks>
        [Obsolete("Prefer the RatingItemsClass property with CSS https://github.com/ProtonBlazor/ProtonBlazor/issues/12047")]
        [Parameter]
        [Category(CategoryTypes.Rating.Appearance)]
        ...
        /// <summary>
        /// The number of <see cref="ProRatingItem"/> items to display.
        /// </summary>
        /// <remarks>
        /// Defaults to <c>5</c>.
        /// </remarks>
