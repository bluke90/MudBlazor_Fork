...
public class RadarChartOptions : DefaultRadialChartOptions, IRadialChartOptions, IHasDataPointOptions
{
    ...
    /// Default is "var(--pro-palette-divider)".
    /// </summary>
    public string GridLineColor { get; set; } = "var(--pro-palette-divider)";
    ...
    /// Default is "var(--pro-palette-lines-inputs)".
    /// </summary>
    public string AxisLineColor { get; set; } = "var(--pro-palette-lines-inputs)";
