...
namespace ProtonBlazor
{
    ...
    public partial class ProHeatMapCell<T> : ProComponentBase where T : struct, INumber<T>, IMinMaxValue<T>, IFormattable
    {
        ...
        [Parameter]
        [Category(CategoryTypes.Chart.Appearance)]
        public ProColor? ProColor { get; set; }
        ...
        /// <see cref="ProHeatMapCell{T}"/> in the <see cref="HeatMap{T}"/>."/> Only the last value set will be used.
        /// </summary>
        [Parameter]
        [Category(CategoryTypes.Chart.Behavior)]
        ...
        protected override void OnInitialized()
        {
            ...
            {
                throw new InvalidOperationException("ProHeatMapCell must be used inside a ProChart component.");
            }
        }
