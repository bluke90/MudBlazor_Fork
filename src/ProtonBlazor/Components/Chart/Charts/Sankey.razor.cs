...
namespace ProtonBlazor.Charts
{
    ...
    /// </summary>
    partial class Sankey<T> : ProChartBase<T, SankeyChartOptions>, IDisposable where T : struct, INumber<T>, IMinMaxValue<T>, IFormattable
    {
        [Inject]
        ...
        private string GetNextHexColorForNodeRect(SankeyNode node)
        {
            ...
            {
                return definition.Color.ToString(ProColorOutputFormats.HexA);
            }
