...
using ProtonBlazor.Interpolation;
...
partial class ScatterPlot<T> : ProAxisLineChartBase<T, ScatterPlotChartOptions> where T : struct, INumber<T>, IMinMaxValue<T>, IFormattable
{
    ...
    {
        Series = (ChartContainer != null && ChartReference is ProChart<T>)
