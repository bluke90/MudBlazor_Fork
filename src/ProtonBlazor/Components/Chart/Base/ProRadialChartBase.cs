...
public abstract class ProRadialChartBase<T, TOptions> : ProChartBase<T, TOptions>, IDisposable
    ...
    where TOptions : IRadialChartOptions
{
    ...
    private readonly DotNetObjectReference<ProRadialChartBase<T, TOptions>> _dotNetObjectReference;
