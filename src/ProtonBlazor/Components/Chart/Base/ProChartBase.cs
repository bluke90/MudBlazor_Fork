    ...
    where TOptions : IChartOptions
{
    ...
    /// </summary>
    protected string Classname => new CssBuilder("pro-chart")
        .AddClass($"pro-chart-legend-{ConvertLegendPosition(LegendPosition).ToStringFast(true)}")
        .AddClass("pro-chart-fill-bounds", MatchBoundsToSize)
        .AddClass(Class)
        .Build();
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ProChartBase{T, TOptions}"/> class.
    /// </summary>
    protected ProChartBase()
    {
