...
{
    /// <summary>
    /// Represents a set of text labels which describe data values in a <see cref="ProChart{T}"/>.
    /// </summary>
    public partial class Legend<T> : ProChartBase<T, IChartOptions> where T : struct, INumber<T>, IMinMaxValue<T>, IFormattable
    {
        /// <summary>
        /// The chart, if any, containing this component.
        /// </summary>
        [CascadingParameter]
        public ProChart<T>? ChartContainer { get; set; }
