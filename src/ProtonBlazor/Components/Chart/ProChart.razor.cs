...
/// </summary>
public partial class ProChart<T> where T : struct, INumber<T>, IMinMaxValue<T>, IFormattable
{
    [Inject]
    ...
    /// <summary>
    /// The pixel height used for the fallback wrapper div when <see cref="ProChartBase{T,TOptions}.Height"/>
