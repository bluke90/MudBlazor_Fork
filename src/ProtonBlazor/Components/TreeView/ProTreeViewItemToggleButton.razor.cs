...
/// <summary>
/// Toggles the expansion state of a <see cref="ProTreeViewItem{T}"/>.
/// </summary>
/// <seealso cref="ProTreeView{T}"/>
/// <seealso cref="ProTreeViewItem{T}"/>
public partial class ProTreeViewItemToggleButton : ProComponentBase
{
    ...
    protected string Classname =>
        new CssBuilder(Class)
            .AddClass("pro-treeview-item-expand-button")
            .AddClass("pro-treeview-item-arrow-expand", !Loading)
            .AddClass("pro-transform", _expandedState.Value && !Loading)
            .AddClass("pro-treeview-item-arrow-load", Loading)
            .Build();
