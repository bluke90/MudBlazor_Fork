...
public class MultiDimensionSwipeEventArgs
{
    ...
    public MultiDimensionSwipeEventArgs(PointerEventArgs touchEventArgs, IReadOnlyList<SwipeDirection> swipeDirections, IReadOnlyList<double?> swipeDeltas, ProSwipeArea sender)
    {
