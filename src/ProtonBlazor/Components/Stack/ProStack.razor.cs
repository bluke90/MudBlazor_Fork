...
/// </summary>
public partial class ProStack : ProComponentBase
{
    private string? Role =>
    ...
    protected string Classname =>
        new CssBuilder("d-flex")
            ...
            .AddClass($"flex-grow-{StretchItems?.ToStringFast(true)}", StretchItems is not null and not ProtonBlazor.StretchItems.None)
            .AddClass(Class)
            .Build();
    ...
    /// <summary>
    /// Defines the stretching behaviour of children along the main axis within a <see cref="ProStack"/> component.
    /// </summary>
    /// <remarks>
    /// Defaults to <c>null</c>.  
    /// </remarks>
