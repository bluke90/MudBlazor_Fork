...
namespace ProtonBlazor
{
    ...
    /// </summary>
    public partial class ProRTLProvider : ProComponentBase
    {
        public ProRTLProvider()
        {
        ...
        protected string Classname =>
            new CssBuilder("pro-rtl-provider")
                .AddClass("pro-application-layout-rtl", RightToLeft)
                .AddClass(Class)
                .Build();
