...
namespace ProtonBlazor
{
    ...
    public class ProDatePicker : ProBaseDatePicker
    {
        ...
        protected override string GetDayClasses(int month, DateTime day)
        {
            ...
            if (day == TimeProvider.GetLocalNow().Date)
                return b.AddClass("pro-current pro-button-outlined")
                        .AddClass(
                            $"pro-button-outlined-{Color.ToStringFast(true)} pro-{Color.ToStringFast(true)}-text")
                        .Build();
            return b.Build();
        }
