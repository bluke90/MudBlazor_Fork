...
namespace ProtonBlazor
{
    ...
    /// </summary>
    public partial class ProSkeleton : ProComponentBase
    {
        protected string Classname =>
            new CssBuilder("pro-skeleton")
                .AddClass($"pro-skeleton-{SkeletonType.ToStringFast(true)}")
                .AddClass($"pro-skeleton-{Animation.ToStringFast(true)}")
                .AddClass(Class)
                .Build();
