...
namespace ProtonBlazor
{
    ...
    /// </summary>
    public partial class ProPopover : ProPopoverBase
    {
        protected internal override string PopoverClass =>
            new CssBuilder("pro-popover")
                .AddClass($"pro-popover-fixed", Fixed)
                .AddClass($"pro-popover-open", Open)
                .AddClass($"pro-popover-{TransformOrigin.ToStringFast(true)}")
                .AddClass($"pro-popover-anchor-{AnchorOrigin.ToStringFast(true)}")
                .AddClass($"pro-popover-overflow-{GetOverflowBehavior().ToStringFast(true)}")
                .AddClass($"pro-popover-{RelativeWidth.ToStringFast(true)}-width", RelativeWidth != DropdownWidth.Ignore)
                .AddClass($"pro-paper", Paper)
                .AddClass($"pro-paper-square", Paper && Square)
                .AddClass($"pro-elevation-{Elevation}", Paper && DropShadow)
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  This property is set via the <see cref="ProRTLProvider"/>.
        /// </remarks>
        ...
        /// <summary>
        /// Displays content within a <see cref="ProPaper"/>.
        /// </summary>
        /// <remarks>
