...
namespace ProtonBlazor
{
    ...
    /// </summary>
    /// <seealso cref="ProProgressCircular"/>
    public partial class ProProgressLinear : ProComponentBase
    {
        ...
        protected string Classname =>
            new CssBuilder("pro-progress-linear")
                .AddClass("pro-progress-linear-rounded", Rounded)
                .AddClass($"pro-progress-linear-striped", Striped)
                .AddClass($"pro-progress-indeterminate", Indeterminate)
                .AddClass($"pro-progress-linear-buffer", Buffer && !Indeterminate)
                .AddClass($"pro-progress-linear-{Size.ToStringFast(true)}")
                .AddClass($"pro-progress-linear-color-{Color.ToStringFast(true)}")
                .AddClass("pro-progress-linear-background", ShowBackground)
        ...
        protected string BarsClassname =>
            new CssBuilder("pro-progress-linear-bars")
                .AddClass("pro-flip-x-rtl", !Vertical)
                .Build();
