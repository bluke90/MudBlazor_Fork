...
namespace ProtonBlazor
{
    ...
    /// </summary>
    /// <seealso cref="ProProgressLinear"/>
    public partial class ProProgressCircular : ProComponentBase
    {
        ...
        protected string Classname =>
            new CssBuilder("pro-progress-circular")
                .AddClass($"pro-{Color.ToStringFast(true)}-text")
                .AddClass($"pro-progress-{Size.ToStringFast(true)}")
                .AddClass("pro-progress-indeterminate", Indeterminate)
                .AddClass("pro-progress-static", !Indeterminate)
                .AddClass(Class)
                .Build();

        protected string SvgClassname =>
            new CssBuilder("pro-progress-circular-circle")
                .AddClass("pro-progress-indeterminate", Indeterminate)
                .AddClass("pro-progress-static", !Indeterminate)
                .AddClass("pro-progress-circular-circle-rounded", Rounded)
                .Build();
