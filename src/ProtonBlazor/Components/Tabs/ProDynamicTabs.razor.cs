...
namespace ProtonBlazor
{
    ...
    /// </summary>
    public partial class ProDynamicTabs : ProTabs
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter] public EventCallback<ProTabPanel> CloseTab { get; set; }
        ...
        /// Defaults to <c>""</c>.
        /// </remarks>
        [Obsolete("Prefer the AddIconClass property with CSS https://github.com/ProtonBlazor/ProtonBlazor/issues/12047")]
        [Parameter]
        [Category(CategoryTypes.Tabs.Appearance)]
        ...
        /// Defaults to <c>""</c>.
        /// </remarks>
        [Obsolete("Prefer the CloseIconClass property with CSS https://github.com/ProtonBlazor/ProtonBlazor/issues/12047")]
        [Parameter]
        [Category(CategoryTypes.Tabs.Appearance)]
        ...
        protected override string InternalClassName { get; } = "pro-dynamic-tabs";

        protected override async Task HandleTabKeyDownAsync(KeyboardEventArgs e, ProTabPanel panel)
        {
