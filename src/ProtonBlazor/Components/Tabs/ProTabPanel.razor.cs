...
/// <summary>
/// A tab as part of a <see cref="ProTabs"/> or <see cref="ProDynamicTabs"/> component.
/// </summary>
public partial class ProTabPanel : ProComponentBase
{
    ...
    internal string Classname =>
        new CssBuilder("pro-tab-panel")
            .AddClass("pro-tab-panel-hidden", !Visible)
            .AddClass(Class)
            .Build();
    ...
    [CascadingParameter]
    private ProTabs? Parent { get; set; }
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Color.Default" />. When set, overrides the <see cref="ProTabs.IconColor" /> property.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Tabs.Behavior)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <c>true</c>. Only applies within a <see cref="ProDynamicTabs"/> component.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Tabs.Behavior)]
    ...
    /// Useful for activating tabs manually via the <c>ActivatePanel</c> method of the <see cref="ProTabs"/> and 
    /// <see cref="ProDynamicTabs"/> components.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Tabs.Behavior)]
    ...
    /// as a <see cref="ProTooltip"/>, which wraps the content they refer to.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Tabs.Behavior)]
    ...
    /// <summary>
    /// Value to use when ordering tabs lexicographically, in place of <see cref="ProTabPanel.Text" />.
    /// </summary>
    /// <remarks>
    /// Defaults to <c>null</c>.
    /// </remarks>
