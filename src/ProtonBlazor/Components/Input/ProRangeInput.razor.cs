...
namespace ProtonBlazor
{
    ...
    public partial class ProRangeInput<T> : ProBaseInput<Range<T>>
    {
        ...
        /// </summary>
        public ProRangeInput()
        {
            Value = new Range<T>();
        }

        protected string Classname => ProInputCssHelper.GetClassname(this,
        ...
        {
            await _elementReferenceStart.ProBlurAsync();
            await _elementReferenceEnd.ProBlurAsync();
        }

        /// <summary>
        /// Selects the text in the starting input.
        /// </summary>
        public ValueTask SelectStartAsync() => _elementReferenceStart.ProSelectAsync();
        ...
        public ValueTask SelectRangeStartAsync(int pos1, int pos2) => _elementReferenceStart.ProSelectRangeAsync(pos1, pos2);
        ...
        /// </summary>
        public ValueTask SelectEndAsync() => _elementReferenceEnd.ProSelectAsync();
        ...
        /// <param name="pos1">The index of the first character to select.</param>
        /// <param name="pos2">The index of the last character to select.</param>
        public ValueTask SelectRangeEndAsync(int pos1, int pos2) => _elementReferenceEnd.ProSelectRangeAsync(pos1, pos2);
