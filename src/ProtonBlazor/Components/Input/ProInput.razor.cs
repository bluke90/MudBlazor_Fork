...
namespace ProtonBlazor
{
    ...
    public partial class ProInput<T> : ProBaseInput<T>
    {
        ...
        private readonly Lazy<DotNetObjectReference<ProInput<T>>> _dotNetReferenceLazy;

        [DynamicDependency(nameof(CallOnBlurredAsync))]
        public ProInput()
        {
            _dotNetReferenceLazy = new Lazy<DotNetObjectReference<ProInput<T>>>(DotNetObjectReference.Create(this));
        }

        protected string Classname =>
            new CssBuilder(
                    ProInputCssHelper.GetClassname(this,
                        () => HasNativeHtmlPlaceholder() ||
                              !string.IsNullOrEmpty(ReadText) ||
                              Adornment == Adornment.Start ||
                              !string.IsNullOrWhiteSpace(Placeholder) ||
                              ShrinkLabel))
                .AddClass($"pro-input-sizing-{Sizing.ToStringFast(true)}")
                .Build();

        protected string InputClassname => ProInputCssHelper.GetInputClassname(this);

        protected string AdornmentClassname => ProInputCssHelper.GetAdornmentClassname(this);

        protected string ClearButtonClassname =>
            new CssBuilder("pro-input-clear-button")
                .AddClass("me-n1", Adornment == Adornment.End && HideSpinButtons == false)
                .AddClass("pro-icon-button-edge-end", Adornment == Adornment.End && HideSpinButtons)
                .AddClass("me-6", Adornment != Adornment.End && HideSpinButtons == false)
                .AddClass("pro-icon-button-edge-margin-end", Adornment != Adornment.End && HideSpinButtons)
                .AddClass("pro-no-activator")
                .Build();
        ...
        /// </summary>
        /// <remarks>
        /// Only occurs when <see cref="InputType"/> is <see cref="InputType.Number"/>.  For numeric inputs, use the <see cref="ProNumericField{T}"/> component.
        /// </remarks>
        [Parameter]
        ...
        /// <summary>
        /// For <see cref="ProNumericField{T}"/>, hides the spin buttons.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <remarks>
        /// When clicked, the <see cref="ProBaseInput{T}.Text"/> and <see cref="ProBaseInput{T}.Value"/> properties are reset.
        /// </remarks>
        [Parameter]
        ...
        public override async ValueTask FocusAsync()
        {
            ...
            {
                Console.WriteLine($@"ProInput.FocusAsync: {e.Message}");
            }
        }
        ...
        {
            return ElementReference.ProBlurAsync();
        }

        /// <inheritdoc />
        public override ValueTask SelectAsync()
        {
            return ElementReference.ProSelectAsync();
        }

        /// <inheritdoc />
        public override ValueTask SelectRangeAsync(int pos1, int pos2)
        {
            return ElementReference.ProSelectRangeAsync(pos1, pos2);
        }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            ...
            if (firstRender)
            {
                ...
                await ElementReference.ProAttachBlurEventWithJS(_dotNetReferenceLazy.Value);
            }
        ...
        /// <summary>
        /// Set the <see cref="ProBaseInput{T}.Text"/> to the specified value.
        /// </summary>
    ...
    /// </summary>
    public class ProInputString : ProInput<string> { }
}
