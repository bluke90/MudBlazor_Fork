...
namespace ProtonBlazor
{
    ...
    public abstract class ProDebouncedInput<T> : ProBaseInput<T>
    {
        private DebounceDispatcher? _debouncer;

        protected ProDebouncedInput()
        {
        ...
        /// <summary>
        /// The number of milliseconds to wait before updating the <see cref="ProBaseInput{T}.Text"/> value.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// The value in <see cref="ProBaseInput{T}.Text"/> is included in this event.
        /// </remarks>
        [Parameter]
