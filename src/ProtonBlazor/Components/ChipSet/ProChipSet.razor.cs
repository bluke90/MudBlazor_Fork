...
/// <summary>
/// A collection of multiple <see cref="ProChip{T}"/> components that allows single or multi-selection.
/// </summary>
/// <typeparam name="T">The type of item managed by this component.</typeparam>
/// <seealso cref="ProChip{T}"/>
public partial class ProChipSet<T> : ProComponentBase, IDisposable
{
    public ProChipSet()
    {
    ...
    private readonly HashSet<ProChip<T>> _chips = new();
    ...
    protected string Classname => new CssBuilder("pro-chipset")
        .AddClass(Class)
        .Build();
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Variant.Filled"/>.  Can be overridden by setting <see cref="ProChip{T}.Variant"/>.
    /// </remarks>
    [Parameter]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Color.Default"/>.  Can be overridden by setting <see cref="ProChip{T}.Color"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Color.Inherit"/>.  Can be overridden by setting <see cref="ProChip{T}.SelectedColor"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Color.Inherit"/>.  Can be overridden by setting <see cref="ProChip{T}.IconColor"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Size.Medium"/>.  Can be overridden by setting <see cref="ProChip{T}.Size"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Icons.Material.Filled.Check"/>.  Can be overridden by setting <see cref="ProChip{T}.CheckedIcon"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <see cref="Icons.Material.Filled.Cancel"/>.  Can be overridden by setting <see cref="ProChip{T}.CloseIcon"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <c>true</c>.  Can be overridden by setting <see cref="ProChip{T}.Ripple"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <c>false</c>.  When <c>true</c>, the <see cref="LayoutProperties.DefaultBorderRadius"/> is used for chip edges.  Can be overridden by setting <see cref="ProChip{T}.Label"/>.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.Chip.Appearance)]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <c>false</c>.  When <c>true</c>, the all chips are visibly disabled and interaction is not allowed.  Overrides any value set for <see cref="ProChip{T}.Disabled"/>.
    /// </remarks>
    [Parameter]
    ...
    /// </summary>
    /// <remarks>
    /// Defaults to <c>false</c>.  When <c>true</c>, chips cannot be clicked even if <see cref="ProChip{T}.OnClick"/> is set.
    /// </remarks>
    [Parameter]
    [Category(CategoryTypes.ChipSet.Behavior)]
    ...
    /// </summary>
    [Parameter]
    public EventCallback<ProChip<T>> OnClose { get; set; }
    ...
    internal async Task AddAsync(ProChip<T> chip)
    {
        if (!_chips.Add(chip))
            return;
        var value = chip.GetValue();
    ...
    internal async Task RemoveAsync(ProChip<T> chip)
    {
    ...
    internal async Task OnChipSelectedChangedAsync(ProChip<T> chip, bool selected)
    {
        var value = chip.GetValue();
        if (!MultiSelection)
        {
    ...
    internal async Task OnChipDeletedAsync(ProChip<T> chip)
    {
