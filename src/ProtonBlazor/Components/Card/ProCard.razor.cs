...
namespace ProtonBlazor
{
    ...
    public partial class ProCard : ProComponentBase
    {
        protected string Classname => new CssBuilder("pro-card")
            .AddClass(Class)
            .Build();
        ...
        /// <summary>
        /// Adds visual padding to the content (<see cref="ProCardHeader"/>, <see cref="ProCardContent"/> or <see cref="ProCardActions"/>).
        /// </summary>
        /// <remarks>
