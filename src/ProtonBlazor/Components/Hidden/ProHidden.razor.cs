...
namespace ProtonBlazor
{
    ...
    /// </summary>
    /// <remarks>
    /// This component uses JavaScript to listen for browser window size changes.  If you want a solution using only CSS, you can use the <see href="https://protonblazor.com/features/display#class-reference">responsive display classes</see>.
    /// </remarks>
    public partial class ProHidden : ProComponentBase, IBrowserViewportObserver, IAsyncDisposable
    {
