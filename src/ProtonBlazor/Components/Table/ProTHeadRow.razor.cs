...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A header row displayed at the top of a <see cref="ProTable{T}"/> and each group.
    /// </summary>
    public partial class ProTHeadRow : ProComponentBase, IDisposable
    {
        ...
        /// <summary>
        /// The current state of the <see cref="ProTable{T}"/> containing this header.
        /// </summary>
        [CascadingParameter]
