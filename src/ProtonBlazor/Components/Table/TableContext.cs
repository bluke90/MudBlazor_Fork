...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// The current state of a <see cref="ProTable{T}"/>.
    /// </summary>
    /// <remarks>
    ...
    public abstract class TableContext
    {
        ...
        /// </summary>
        public ProTableBase? Table { get; set; }
        ...
        /// <summary>
        /// Whether the table containts a <see cref="ProTablePager"/>.
        /// </summary>
        ...
        public abstract void Add(ProTr row, object? item);
        ...
        /// <param name="item">The data associated with the row.</param>
        public abstract void Remove(ProTr row, object? item);
        ...
        /// </summary>
        public List<ProTHeadRow> HeaderRows { get; set; } = new();

        /// <summary>
        /// The footer rows within the table and its groups.
        /// </summary>
        public List<ProTFootRow> FooterRows { get; set; } = new();
        ...
        public abstract void ManagePreviousEditedRow(ProTr row);
    }
    ...
    public class TableContext<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T> : TableContext
    {
        ...
        public IEqualityComparer<T>? Comparer //when the comparer value is setup, update the collections with the new comparer
        {
            ...
            set
            {
                ...
                Rows = new Dictionary<T, ProTr>(Rows, _comparer);
            }
        }
        ...
        /// </summary>
        public Dictionary<T, ProTr> Rows { get; set; } = new();
#pragma warning restore CS8714 // The type cannot be used as type parameter in the generic type or method. Nullability of type argument doesn't match 'notnull' constraint.

        /// <summary>
        /// The current grouping rows.
        /// </summary>
        public List<ProTableGroupRow<T>> GroupRows { get; set; } = new();

        /// <summary>
        /// The current list of sort labels.
        /// </summary>
        public List<ProTableSortLabel<T>> SortLabels { get; set; } = new();
        ...
        /// <inheritdoc />
        public override void ManagePreviousEditedRow(ProTr row)
        {
            if (Table is null)
            {
                return;
        ...
        /// <inheritdoc />
        public override void Add(ProTr row, object? item)
        {
            var t = item.As<T>();
            if (t is null)
            {
        ...
        /// <inheritdoc />
        public override void Remove(ProTr row, object? item)
        {
            var t = item.As<T>();
            if (t is null)
            {
        ...
        /// </summary>
        public ProTableSortLabel<T>? CurrentSortLabel { get; protected set; }
        ...
        /// <returns></returns>
        public async Task SetSortFunc(ProTableSortLabel<T> label, bool overrideDirectionNone = false)
        {
        ...
        private void UpdateSortLabels(ProTableSortLabel<T> label)
        {
