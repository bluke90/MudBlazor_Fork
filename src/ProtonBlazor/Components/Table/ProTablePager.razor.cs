...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A component which changes pages and page size for a <see cref="ProTable{T}"/>.
    /// </summary>
    public partial class ProTablePager : ProComponentBase
    {
        protected string Classname =>
            new CssBuilder("pro-table-pagination-toolbar")
                .AddClass("pro-tablepager-left", !RightToLeft)
                .AddClass("pro-tablepager-right", RightToLeft)
                .AddClass(Class)
                .Build();

        protected string PaginationClassname =>
            new CssBuilder("pro-table-pagination-display")
                .AddClass("pro-tablepager-left", !RightToLeft)
                .AddClass("pro-tablepager-right", RightToLeft)
                .AddClass(Class)
                .Build();
        ...
        /// <summary>
        /// The current state of the <see cref="ProTable{T}"/> containing this pager.
        /// </summary>
        [CascadingParameter]
        ...
        /// <summary>
        /// The location of this pager relative to the parent <see cref="ProTable{T}"/>.
        /// </summary>
        /// <remarks>
        ...
        private string Info
        {
            get
            {
                ...
                {
                    return Localizer[LanguageResource.ProDataGridPager_InfoFormat, $"{firstItem:N0}", $"{lastItem:N0}", $"{filteredItemsCount:N0}"];
                }
        ...
        /// <summary>
        /// The <see cref="ProTable{T}"/> linked to this pager.
        /// </summary>
        public ProTableBase? Table => Context?.Table;
        ...
        protected override void OnParametersSet()
        {
            ...
            {
                RowsPerPageString = Localizer[LanguageResource.ProDataGridPager_RowsPerPage];
            }

            if (string.IsNullOrEmpty(AllItemsText))
            {
                AllItemsText = Localizer[LanguageResource.ProDataGridPager_AllItems];
            }
        }
    }
}
