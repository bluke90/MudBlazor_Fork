...
{
    // note: the ProTable code is split. Everything that has nothing to do with the type parameter of ProTable<T> is here in ProTableBase

    /// <summary>
    /// A base class for designing table components.
    /// </summary>
    public abstract class ProTableBase : ProComponentBase
    {
        ...
        protected string Classname =>
            new CssBuilder("pro-table")
                .AddClass("pro-xs-table", Breakpoint == Breakpoint.Xs)
                .AddClass("pro-sm-table", Breakpoint == Breakpoint.Sm)
                .AddClass("pro-md-table", Breakpoint == Breakpoint.Md)
                .AddClass("pro-lg-table", Breakpoint is Breakpoint.Lg or Breakpoint.Always)
                .AddClass("pro-xl-table", Breakpoint is Breakpoint.Xl or Breakpoint.Always)
                .AddClass("pro-xxl-table", Breakpoint is Breakpoint.Xxl or Breakpoint.Always)
                ...
                .AddClass("pro-table-sticky-footer", FixedFooter)
                .AddClass($"pro-elevation-{Elevation}", !Outlined)
                .AddClass(Class)
                .Build();

        protected string HeadClassname => new CssBuilder("pro-table-head")
            .AddClass(HeaderClass)
            .AddClass("pro-table-dense", Dense)
            .Build();

        protected string FootClassname => new CssBuilder("pro-table-foot")
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, rows beyond this number will overflow into separate pages.  Requires a <see cref="ProTablePager"/> in the <see cref="PagerContent"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>0</c> (the first page).  Requires a <see cref="ProTablePager"/> in the <see cref="PagerContent"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Pagination)]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  Becomes <c>true</c> before <c>ServerData</c> is called, then becomes <c>false</c>.  When <c>true</c>, either a <see cref="ProProgressLinear"/> is displayed or custom content if <c>LoadingContent</c> or <c>LoadingContentBody</c> is set.
        /// </remarks>
        [Parameter]
        ...
        /// <summary>
        /// The color of the <see cref="ProProgressLinear"/> while <see cref="Loading"/> is <c>true</c>.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <remarks>
        /// For basic headers, add <see cref="ProTh"/> components here to describe each column.  For more customized headers (such as multi-row headers), set <see cref="CustomHeader"/> to <c>true</c> and use <see cref="ProTHeadRow"/> components here instead.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Header)]
        ...
        /// </summary>
        /// <remarks>
        /// For basic footers, add <see cref="ProTd"/> components here to describe each column.  For more customized footers (such as multi-row footers), set <see cref="CustomFooter"/> to <c>true</c> and use <see cref="ProTFootRow"/> components here instead.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Footer)]
        ...
        /// </summary>
        /// <remarks>
        /// Add a <see cref="ProTablePager"/> here to navigate multiple pages of data.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Pagination)]
        ...
        /// </summary>
        /// <remarks>
        /// Multiple classes must be separated by spaces.  Some CSS classes will be overridden by <see cref="ProTd"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Rows)]
        ...
        /// </summary>
        /// <remarks>
        /// Some CSS styles will be overridden by <see cref="ProTd"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Rows)]
        ...
        /// </summary>
        /// <remarks>
        /// Typically used to interact with other components such as <see cref="ProTablePager"/>.
        /// </remarks>
        ...
        internal abstract Task FireRowClickEventAsync(MouseEventArgs args, ProTr mudTr, object? item);

        internal abstract Task FireRowMouseEnterEventAsync(PointerEventArgs args, ProTr mudTr, object? item);

        internal abstract Task FireRowMouseLeaveEventAsync(PointerEventArgs args, ProTr mudTr, object? item);
