...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A row of data within a <see cref="ProTable{T}"/>.
    /// </summary>
    public partial class ProTr : ProComponentBase, IDisposable
    {
        ...
        protected string Classname => new CssBuilder("pro-table-row")
            .AddClass(Class)
        ...
        /// <summary>
        /// The current state of the <see cref="ProTable{T}"/> containing this data row.
        /// </summary>
        [CascadingParameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  Managed automatically by the parent <see cref="ProTable{T}"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>true</c>.  Requires <see cref="Checkable"/> to be <c>true</c>. Managed automatically by the parent <see cref="ProTable{T}"/>.
        /// </remarks>
        [Parameter]
        ...
        /// <summary>
        /// Disables mouse events and sets the color to <c>--pro-palette-text-disabled</c>.
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>. Managed automatically by the parent <see cref="ProTable{T}"/>.
        /// </remarks>
        ...
        /// </remarks>
        [Parameter]
        public string DisabledClass { get; set; } = "pro-table-row-disabled";
        ...
        /// <param name="notify">When <c>true</c>, the table's <see cref="ProTable{T}.OnHeaderCheckboxClicked(bool)"/> event occurs.</param>
