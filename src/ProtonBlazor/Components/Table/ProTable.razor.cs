...
namespace ProtonBlazor
{
    ...
    // Note: the ProTable code is split. Everything depending on the type parameter T of ProTable<T> is here in ProTable<T>
    ...
    public partial class ProTable<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T> : ProTableBase, IDisposable
    {
        [Inject]
        ...
        /// </summary>
        /// <remarks>
        /// Use <see cref="ProTd"/> to define columns, and <c>context</c> to access item properties for each column.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Use <see cref="ProTr"/> and <see cref="ProTd"/> to define the child content, and <c>context</c> to access item properties.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Rows)]
        ...
        /// </summary>
        /// <remarks>
        /// Use <see cref="ProTd"/> to define columns, and <c>context</c> to access item properties for each column. Typically looks similar to rows in <see cref="RowTemplate"/> but with edit components.
        /// </remarks>        
        [Parameter]
        ...
        /// A disabled row ignores mouse events and uses <c>--pro-palette-text-disabled</c> as color.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>pro-table-row-disabled</c>
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Appearance)]
        public string DisabledRowClass { get; set; } = "pro-table-row-disabled";
        ...
        /// </summary>
        /// <remarks>
        /// No <see cref="ProTr"/> or <see cref="ProTd"/> is necessary.
        /// </remarks>
        [Parameter]
        ...
        /// You must supply valid table row/cell markup (for example <c>&lt;ProTr&gt;</c> and <c>&lt;ProTd&gt;</c>).
        ...
        internal override async Task FireRowClickEventAsync(MouseEventArgs args, ProTr mudTr, object? item)
        {
        ...
        internal override async Task FireRowMouseEnterEventAsync(PointerEventArgs args, ProTr mudTr, object? item)
        {
            var typedItem = default(T);
            try
            {
        ...
        internal override async Task FireRowMouseLeaveEventAsync(PointerEventArgs args, ProTr mudTr, object? item)
        {
            var typedItem = default(T);
            try
            {
        ...
        /// </summary>
        /// <remarks>
        /// Use <see cref="ProTd"/> to define the cells in the group header.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Grouping)]
        ...
        /// </summary>
        /// <remarks>
        /// Use <see cref="ProTd"/> to define the cells in the group footer.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Table.Grouping)]
