...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// A footer row displayed at the bottom of a <see cref="ProTable{T}"/> and each group.
    /// </summary>
    public partial class ProTFootRow : ProComponentBase, IDisposable
    {
        ...
        /// <summary>
        /// The current state of the <see cref="ProTable{T}"/> containing this footer.
        /// </summary>
        [CascadingParameter]
        ...
        /// <summary>
        /// Hides the extra column displayed when <see cref="ProTableBase.MultiSelection"/> is <c>true</c>.
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.
        /// </remarks>
        ...
        /// <summary>
        /// Hides the extra column displayed when <see cref="ProTableBase.Editable"/> is <c>true</c>.
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.
        /// </remarks>
