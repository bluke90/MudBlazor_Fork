...
namespace ProtonBlazor
{
    ...
    public partial class ProSlider<T> : ProComponentBase where T : struct, INumber<T>
    {
        ...
        protected string Classname =>
            new CssBuilder("pro-slider")
                .AddClass($"pro-slider-{Size.ToStringFast(true)}")
                .AddClass($"pro-slider-{Color.ToStringFast(true)}")
                .AddClass("pro-slider-vertical", Vertical)
                .AddClass(Class)
                .Build();
