...
namespace ProtonBlazor
{
    ...
    /// </summary>
    /// <remarks>
    /// You can use the <see cref="Icons"/> class and <see href="https://protonblazor.com/features/icons#icons">Icons Reference</see> for SVG paths, or a <see href="https://fontawesome.com/icons">Font Awesome CSS Class</see>.
    /// </remarks>
    /// <seealso cref="ProIconButton"/>
    public partial class ProIcon : ProComponentBase
    {
        protected string Classname =>
            new CssBuilder("pro-icon-root")
                .AddClass("pro-icon-default", Color == Color.Default && !Disabled)
                .AddClass("pro-svg-icon", !string.IsNullOrEmpty(Icon) && Icon.Trim().StartsWith("<"))
                .AddClass($"pro-{Color.ToStringFast(true)}-text", Color != Color.Default && Color != Color.Inherit && !Disabled)
                .AddClass($"pro-icon-size-{Size.ToStringFast(true)}")
                .AddClass(Class)
                .Build();
    ...
    internal sealed partial class IconSyntax
    {
