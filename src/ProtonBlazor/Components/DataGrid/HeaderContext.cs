...
{
    /// <summary>
    /// Represents the current state of a header in a <see cref="ProDataGrid{T}"/>.
    /// </summary>
    ...
    public class HeaderContext<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T>
    {
        ...
        /// </summary>
        /// <param name="dataGrid">The <see cref="ProDataGrid{T}"/> which contains the header.</param>
        public HeaderContext(ProDataGrid<T> dataGrid)
        {
            _dataGrid = dataGrid;
        ...
        /// <summary>
        /// Represents the behaviors allowed for a <see cref="ProDataGrid{T}"/> header.
        /// </summary>
