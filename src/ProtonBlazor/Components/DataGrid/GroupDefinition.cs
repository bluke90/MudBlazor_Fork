...
/// <summary>
/// Represents the grouping information for columns in a <see cref="ProDataGrid{T}"/>.
/// </summary>
...
public class GroupDefinition<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T>
{
    ...
    /// <summary>
    /// The <see cref="ProDataGrid{T}"/> which contains this group definition.
    /// </summary>
    public required ProDataGrid<T> DataGrid { get; init; }
