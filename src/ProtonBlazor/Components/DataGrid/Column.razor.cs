...
namespace ProtonBlazor
{
    ...
    /// <seealso cref="ProDataGrid{T}"/>
    public abstract partial class Column<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T> : ProComponentBase, IDisposable
    {
        ...
        /// </summary>
        [CascadingParameter]
        public ProDataGrid<T> DataGrid { get; set; } = null!;
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, this overrides the <see cref="ProDataGrid{T}.SortMode"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, this overrides the <see cref="ProDataGrid{T}.DragDropColumnReordering"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, this overrides the <see cref="ProDataGrid{T}.Filterable"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, this overrides the <see cref="ProDataGrid{T}.ShowFilterIcons"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, this overrides the <see cref="ProDataGrid{T}.Hideable"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, this overrides the <see cref="ProDataGrid{T}.ShowColumnOptions"/> property.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>, which falls back to <see cref="ProDataGrid{T}.SortIcon"/>.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.DataGrid.Appearance)]
        [Obsolete("Column-level sort icon customization is no longer supported. Configure ProDataGrid.SortIcon or use HeaderTemplate for full header customization.", true)]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When set, this overrides the <see cref="ProDataGrid{T}.Groupable"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <see cref="ProDataGrid{T}.Culture"/>.
        /// </remarks>
        [Parameter]
        ...
        /// <remarks>
        /// <para>
        /// When <see cref="ProDataGrid{T}.EditMode"/> is <see cref="DataGridEditMode.Form"/>, the built-in Save button
        /// automatically invokes <see cref="ProDataGrid{T}.CommittedItemChanges"/> — no extra handling is required.
        /// </para>
        /// <para>
        /// When <see cref="ProDataGrid{T}.EditMode"/> is <see cref="DataGridEditMode.Cell"/>, standard columns commit
        /// their value automatically on change. Custom controls inside an <see cref="EditTemplate"/> do not trigger
        /// <see cref="ProDataGrid{T}.CommittedItemChanges"/> automatically. Track changes directly in a value-changed
        /// handler instead:
        /// </para>
        /// <code>
        /// &lt;EditTemplate&gt;
        ///     &lt;ProDatePicker Date="@context.Item.Date"
