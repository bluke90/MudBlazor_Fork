...
namespace ProtonBlazor
{
    ...
    /// <summary>
    /// Represents the current state of a footer in a <see cref="ProDataGrid{T}"/>.
    /// </summary>
    ...
    public class FooterContext<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T>
    {
        ...
        /// </summary>
        /// <param name="dataGrid">The <see cref="ProDataGrid{T}"/> containing this footer.</param>
        public FooterContext(ProDataGrid<T> dataGrid)
        {
            _dataGrid = dataGrid;
        ...
        /// <summary>
        /// Represents the actions which can be performed on the footer of <see cref="ProDataGrid{T}"/> columns.
        /// </summary>
