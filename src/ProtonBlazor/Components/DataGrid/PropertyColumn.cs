...
{
    /// <summary>
    /// Represents a column in a <see cref="ProDataGrid{T}"/> associated with an object's property.
    /// </summary>
    ...
    public partial class PropertyColumn<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T, TProperty> : Column<T>
    {
        ...
        protected override void OnParametersSet()
        {
            ...
            {
                // Most likely this is a dynamic expression that people use as workaround https://try.protonblazor.com/snippet/cYGxuTmhyqAQeCVM
