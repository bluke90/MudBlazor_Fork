...
{
    /// <summary>
    /// Represents an additional column for a <see cref="ProDataGrid{T}"/> which isn't tied to data.
    /// </summary>
    ...
    public partial class TemplateColumn<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T> : Column<T>
    {
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  When set, this overrides the <see cref="ProDataGrid{T}.Filterable"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  When set, this overrides the <see cref="ProDataGrid{T}.SortMode"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  When set, this overrides the <see cref="ProDataGrid{T}.DragDropColumnReordering"/> property.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  When set, this overrides the <see cref="ProDataGrid{T}.ShowColumnOptions"/> property.
        /// </remarks>
        [Parameter]
