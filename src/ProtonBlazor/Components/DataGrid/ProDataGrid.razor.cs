...
namespace ProtonBlazor
{
    ...
    public partial class ProDataGrid<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] T> : ProComponentBase, IDisposable
    {
        private ProForm? _editForm;
        internal int? _rowsPerPage;
        private int _currentPage = 0;
        internal bool _groupInitialExpanded = true;
        internal ProVirtualize<IndexBag<T>>? _proVirtualize;
        ...
        private ProDropContainer<Column<T>>? _dropContainer;
        private ProDropContainer<Column<T>>? _columnsPanelDropContainer;
        ...
        protected string Classname =>
            new CssBuilder("pro-table")
                ...
                .AddClass("pro-lg-table", Breakpoint == Breakpoint.Lg || Breakpoint == Breakpoint.Always)
                .AddClass("pro-xl-table", Breakpoint == Breakpoint.Xl || Breakpoint == Breakpoint.Always)
        ...
        protected string TableClass =>
            new CssBuilder("pro-table-container")
                .AddClass("cursor-col-resize", when: IsResizing)
                .Build();

        protected string HeadClassname =>
            new CssBuilder("pro-table-head")
                .AddClass(HeaderClass)
                .AddClass("pro-table-dense", Dense)
                .Build();

        protected string FootClassname =>
            new CssBuilder("pro-table-foot")
                .AddClass(FooterClass).Build();

        protected string BodyClassname =>
            new CssBuilder("pro-table-body")
                .AddClass("pro-table-body-virtualized", Virtualize)
                .Build();
        ...
        internal SortDirection GetColumnSortDirection(string? columnName)
        {
            ...
            if (SortDefinitions.TryGetValue(columnName, out var sortDefinition))
            {
        ...
        private Task ItemUpdatedAsync(ProItemDropInfo<Column<T>> dropItem)
        {
        ...
        /// </summary>
        [Parameter]
        public RenderFragment<ProDataGrid<T>>? FilterTemplate { get; set; }
        ...
        /// </summary>
        /// <remarks>
        /// Multiple classes must be separated by spaces.  Note that some CSS settings are overridden by other styles, such as those from <see cref="ProTd"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Some CSS settings are overridden by other styles, such as those from <see cref="ProTd"/>.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// A <see cref="ProTablePager"/> is typically added here to break up rows into multiple pages.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>10</c>.  Applies when the <see cref="PagerContent"/> section contains a <see cref="ProTablePager"/>.  When this property changes, the <see cref="RowsPerPageChanged"/> event occurs.
        /// </remarks>
        [Parameter]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>0</c>.  Applies when the <see cref="PagerContent"/> section contains a <see cref="ProTablePager"/>.
        /// </remarks>
        [Parameter]
        ...
        /// <summary>
        /// Indicates if a <see cref="ProDataGridPager{T}"/> is present.
        /// </summary>
        ...
        internal async Task InvokeServerLoadFunc()
        {
            ...
            if (VirtualizeServerData != null)
            {
                if (_proVirtualize != null)
                {
                    // Cancel any prior request
                    CancelServerDataToken();
                    await _proVirtualize.RefreshDataAsync();
                }
                else
                {
                    Loading = true;
        ...
        /// </summary>
        /// <remarks>
        /// This method closes the filter panel shown by <see cref="ProDataGrid{T}"/>, such as the panel used by <see cref="DataGridFilterMode.Simple"/>.
        ...
        internal IEnumerable<T> Sort(IEnumerable<T> items)
        {
            ...
            {
                Debug.Assert(sortDefinition.SortFunc is not null);
        ...
        /// <summary>
        /// Navigates to a page when this grid has a <see cref="ProDataGridPager{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Sets the <see cref="RowsPerPage"/> when this grid contains a <see cref="ProDataGridPager{T}"/>.
        /// </summary>
        ...
        private Task ColumnOrderUpdated(ProItemDropInfo<Column<T>> dropItem)
        {
            Debug.Assert(dropItem.Item is not null);
        ...
        {
            var gridRect = await _gridElement.ProGetBoundingClientRectAsync();
