...
namespace ProtonBlazor
{
    ...
    /// </summary>
    public partial class ProInputControl : ProComponentBase
    {
        protected string Classname =>
            new CssBuilder("pro-input-control")
                .AddClass("pro-input-required", when: () => Required)
                .AddClass($"pro-input-control-margin-{Margin.ToStringFast(true)}", when: () => Margin != Margin.None)
                .AddClass("pro-input-control-full-width", FullWidth)
        ...
        protected string HelperContainer =>
            new CssBuilder("pro-input-control-helper-container")
                .AddClass("px-1", Variant == Variant.Filled)
                .AddClass("px-2", Variant == Variant.Outlined)
                .Build();

        protected string HelperClass =>
            new CssBuilder("pro-input-helper-text")
                .AddClass("pro-input-helper-onfocus", HelperTextOnFocus)
                .AddClass("pro-input-error", Error)
                .Build();
