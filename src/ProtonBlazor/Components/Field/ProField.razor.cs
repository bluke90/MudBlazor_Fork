...
{
    // TODO: Maybe can inherit from ProBaseInput?
    /// <summary>
    /// A component similar to <see cref="ProTextField{T}"/> which supports custom content.
    /// </summary>
    /// <seealso cref="ProTextField{T}"/>
    public partial class ProField : ProComponentBase
    {
        protected string Classname =>
            new CssBuilder("pro-input")
                ...
                // Without the pro-shrink class, the label will become a placeholder
                // Apply "pro-shrink" only if ShrinkLabel is false AND
                ...
                .AddClass("pro-input-error", Error && !string.IsNullOrEmpty(ErrorText))
        ...
        protected string InnerClassname =>
            new CssBuilder("pro-input-slot")
                ...
                .AddClass("pro-input-slot-nopadding", () => InnerPadding == false)
