...
namespace ProtonBlazor
{
    ...
    /// <seealso cref="ProCarouselItem" />
    public partial class ProCarousel<TData> : ProBaseBindableItemsControl<ProCarouselItem, TData>, IAsyncDisposable
    {
        ...
        protected string Classname => new CssBuilder("pro-carousel")
            .AddClass($"pro-carousel-{(BulletsColor ?? _currentColor).ToStringFast(true)}")
            .AddClass(Class)
            .Build();
        ...
        protected string NavigationButtonsClassName => new CssBuilder()
            ...
            .AddClass("pro-carousel-elements-rtl", RightToLeft)
        ...
        /// <summary>
        /// Displays a bullet for each <see cref="ProCarouselItem"/>.
        /// </summary>
        /// <remarks>
        /// Defaults to <c>true</c>.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>null</c>.  When <c>null</c> the <see cref="ProCarouselItem.Color"/> property is used.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.Carousel.Appearance)]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>false</c>.  When <c>true</c>, the <see cref="ProCarouselItem"/> items will be rotated after the delay specified in <see cref="AutoCycleTime" />.
        /// </remarks>
        ...
        /// <summary>
        /// The delay before displaying the next <see cref="ProCarouselItem"/> when <see cref="AutoCycle"/> is <c>true</c>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The icon displayed for the current <see cref="ProCarouselItem"/> when no <see cref="BulletTemplate"/> is set.
        /// </summary>
        [Parameter]
        [Category(CategoryTypes.Carousel.Appearance)]
        ...
        /// <summary>
        /// The icon displayed for unselected <see cref="ProCarouselItem"/>s when no <see cref="BulletTemplate"/> is set.
        /// </summary>
        [Parameter]
        [Category(CategoryTypes.Carousel.Appearance)]
        ...
        /// </summary>
        /// <remarks>
        /// Defaults to <c>true</c>.  When <c>true</c>, swipe gestures on touch devices can be used to change the current <see cref="ProCarouselItem"/>.
        /// </remarks>
        [Category(CategoryTypes.Carousel.Behavior)]
        [Parameter]
        ...
        /// <inheritdoc />
        public override void AddItem(ProCarouselItem item)
        {
            Items.Add(item);
        ...
        /// <summary>
        /// Changes the selected <see cref="ProCarouselItem"/> to the next one, or restarts at <c>0</c>.
        /// </summary>
