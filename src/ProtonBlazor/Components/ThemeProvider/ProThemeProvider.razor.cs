...
/// </summary>
/// <seealso cref="ProTheme"/>
partial class ProThemeProvider : ComponentBaseWithState, IAsyncDisposable
{
    private bool _disposed;
    private bool _observing;
    private const string Palette = "pro-palette";
    ...
    private readonly Lazy<DotNetObjectReference<ProThemeProvider>> _lazyDotNetRef;
    ...
    /// </summary>
    [Parameter]
    public ProTheme? Theme { get; set; }

    /// <summary>
    /// Uses the browser default scrollbar instead of the ProtonBlazor scrollbar. 
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Uses darker colors for all ProtonBlazor components.
    /// </summary>
    /// <remarks>
    /// Defaults to <c>false</c>.
    ...
    /// </summary>
    /// <remarks>
    /// Returns <see cref="ProTheme.PaletteDark"/> when <see cref="IsDarkMode"/> is <c>true</c>; otherwise, returns <see cref="ProTheme.PaletteLight"/>.
    ...
    public ProThemeProvider()
    {
        ...
        _lazyDotNetRef = new Lazy<DotNetObjectReference<ProThemeProvider>>(CreateDotNetObjectReference);
    }
    ...
    protected string BuildTheme()
    {
        ...
        themeStringBuilder.AppendLine("<style class='pro-theme-provider'>");
    ...
    protected static string BuildProtonBlazorScrollbar()
    {
    ...
    protected virtual void GenerateTheme(StringBuilder themeStringBuilder)
    {
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-primary-rgb: {palette.Primary.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-primary-hover: {palette.Primary.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        themeStringBuilder.AppendLine($"--{Palette}-secondary: {palette.Secondary};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-secondary-rgb: {palette.Secondary.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-secondary-hover: {palette.Secondary.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        themeStringBuilder.AppendLine($"--{Palette}-tertiary: {palette.Tertiary};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-tertiary-rgb: {palette.Tertiary.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-tertiary-hover: {palette.Tertiary.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        themeStringBuilder.AppendLine($"--{Palette}-info: {palette.Info};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-info-rgb: {palette.Info.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-info-hover: {palette.Info.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        themeStringBuilder.AppendLine($"--{Palette}-success: {palette.Success};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-success-rgb: {palette.Success.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-success-hover: {palette.Success.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        themeStringBuilder.AppendLine($"--{Palette}-warning: {palette.Warning};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-warning-rgb: {palette.Warning.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-warning-hover: {palette.Warning.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        themeStringBuilder.AppendLine($"--{Palette}-error: {palette.Error};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-error-rgb: {palette.Error.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-error-hover: {palette.Error.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        themeStringBuilder.AppendLine($"--{Palette}-dark: {palette.Dark};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-dark-rgb: {palette.Dark.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-dark-hover: {palette.Dark.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");

        themeStringBuilder.AppendLine($"--{Palette}-text-primary: {palette.TextPrimary};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-text-primary-rgb: {palette.TextPrimary.ToString(ProColorOutputFormats.ColorElements)};");
        themeStringBuilder.AppendLine($"--{Palette}-text-secondary: {palette.TextSecondary};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-text-secondary-rgb: {palette.TextSecondary.ToString(ProColorOutputFormats.ColorElements)};");
        themeStringBuilder.AppendLine($"--{Palette}-text-disabled: {palette.TextDisabled};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-text-disabled-rgb: {palette.TextDisabled.ToString(ProColorOutputFormats.ColorElements)};");

        themeStringBuilder.AppendLine($"--{Palette}-action-default: {palette.ActionDefault};");
        themeStringBuilder.AppendLine(
            $"--{Palette}-action-default-hover: {palette.ActionDefault.SetAlpha(palette.HoverOpacity).ToString(ProColorOutputFormats.RGBA)};");
        ...
        themeStringBuilder.AppendLine($"--{Palette}-surface-rgb: {palette.Surface.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine(
            $"--{Palette}-divider-rgb: {palette.Divider.ToString(ProColorOutputFormats.ColorElements)};");
        ...
        themeStringBuilder.AppendLine($"--pro-native-html-color-scheme: {(_isDarkModeState.Value ? "dark" : "light")};");
    }

    protected ProTheme GetTheme() => Theme ?? _originalMudTheme;
    ...
    private async Task OnObserveSystemDarkModeChangeChanged(ParameterChangedEventArgs<bool> arg)
    {
        ...
        // like <ProThemeProvider ObserveSystemDarkModeChange="false" />, the ChangeHandler of ParameterState will be invoked.
    ...
    private DotNetObjectReference<ProThemeProvider> CreateDotNetObjectReference() => DotNetObjectReference.Create(this);
