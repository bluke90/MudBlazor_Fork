...
namespace ProtonBlazor
{
    ...
    public partial class ProMessageBox : ProComponentBase
    {
        ...
        protected string Classname =>
            new CssBuilder("pro-message-box")
                .Build();

        public ProMessageBox()
        {
        ...
        [CascadingParameter]
        private ProDialogProvider? DialogProvider { get; set; }
        ...
        /// </summary>
        /// <remarks>
        /// Must be a <see cref="ProButton"/>.  When set, <see cref="CancelText"/> is ignored.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.MessageBox.Behavior)]
        ...
        /// </summary>
        /// <remarks>
        /// Must be a <see cref="ProButton"/>.  When set, <see cref="NoText"/> is ignored.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.MessageBox.Behavior)]
        ...
        /// </summary>
        /// <remarks>
        /// Must be a <see cref="ProButton"/>.  When set, <see cref="YesText"/> is ignored.
        /// </remarks>
        [Parameter]
        [Category(CategoryTypes.MessageBox.Behavior)]
        ...
        public async Task<bool?> ShowAsync(DialogOptions? options = null)
        {
            ...
            _reference = await DialogService.ShowAsync<ProMessageBox>(title: Title, parameters: parameters, options: options);
