...
/// </summary>
public partial class ProDivider : ProComponentBase
{
    protected string Classname =>
        new CssBuilder("pro-divider")
            .AddClass("pro-divider-absolute", Absolute)
            .AddClass("pro-divider-flexitem", FlexItem)
            .AddClass("pro-divider-light", Light)
            .AddClass("pro-divider-vertical", Vertical)
            .AddClass($"pro-divider-{DividerType.ToStringFast(true)}", DividerType != DividerType.FullWidth || (DividerType == DividerType.FullWidth && Vertical == false))
            .AddClass(Class)
            .Build();
