...
{
    /// <summary>
    /// Indicates how items in a <see cref="ProStack"/> are wrapped.
    /// </summary>
    [EnumExtensions]
    public enum Wrap
    {
        ...
        /// </summary>
        /// <remarks>
        /// When <see cref="ProStack.Row"/> is <c>true</c>, items are wrapped to fit into the width of the container.<br />
