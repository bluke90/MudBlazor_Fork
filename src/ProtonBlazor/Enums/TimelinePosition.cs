...
/// <summary>
/// Specifies how items are drawn in a <see cref="ProTimeline" />.
/// </summary>
[EnumExtensions]
public enum TimelinePosition
{
    ...
    /// </summary>
    /// <remarks>
    /// Only applies if <see cref="ProTimeline.TimelineOrientation"/> is <see cref="TimelineOrientation.Horizontal"/>.
    /// </remarks>
    [Description("top")]
    Top,
    ...
    /// </summary>
    /// <remarks>
    /// Only applies if <see cref="ProTimeline.TimelineOrientation"/> is <see cref="TimelineOrientation.Vertical"/>.
    /// </remarks>
    [Description("bottom")]
    Bottom,
    ...
    /// <summary>
    /// Dots are displayed at the start based on the Right-to-Left setting of the <see cref="ProRTLProvider"/>.
    /// </summary>
    /// <remarks>
    /// Only applies if <see cref="ProTimeline.TimelineOrientation"/> is <see cref="TimelineOrientation.Vertical"/>.<br />
    ...
    /// <summary>
    /// Dots are displayed at the end based on the Right-to-Left setting of the <see cref="ProRTLProvider"/>.
    /// </summary>
    /// <remarks>
    /// Only applies if <see cref="ProTimeline.TimelineOrientation"/> is <see cref="TimelineOrientation.Vertical"/>.<br />
