/**
 * Build script for ProtonBlazor.Docs SCSS assets.
 *
 * Usage:
 *   bun run build.mjs
...
const scssInput = path.join(scriptDirectory, "Styles/ProtonBlazorDocs.scss");
const scssOutput = path.join(scriptDirectory, "wwwroot/ProtonBlazorDocs.min.css");
