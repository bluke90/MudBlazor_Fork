...
namespace ProtonBlazor.Docs.Models
{
    ...
    {
        public static TeamMember[] GetTeam() =>
        [
            new TeamMember
            {
            ...
            new TeamMember
            {
                ...
                Bio = "Entrepreneur and Open Source contributor. Co-founder of ProtonBlazor. Creator of Numpy.NET and Python.Included. ",
                Team = Team.Core
            },
            new TeamMember
            {
        ...
        public static TeamMember[] GetHallOfFameTeam() =>
        [
            new TeamMember
            {
                Name = "Mike Surcouf",
