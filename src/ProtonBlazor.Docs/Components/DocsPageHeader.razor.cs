...
public sealed partial class DocsPageHeader
{
    ...
    /// </summary>
    /// <remarks>
    /// Should be the name of a component, such as <c>nameof(ProAlert)</c>.  When set, the
    ...
    /// </summary>
    public ProComponent Example { get; set; }
    ...
    /// </summary>
    private string GetTitle() => $"{Title} - ProtonBlazor";
    ...
    {
        return NavigationManager.Uri.Replace(NavigationManager.BaseUri, "https://protonblazor.com/");
    }
}
