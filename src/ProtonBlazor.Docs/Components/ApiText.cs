...
public sealed partial class ApiText : ComponentBase
{
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        // Convert XML documentation text, links, and HTML to ProtonBlazor equivalents
        XElement xml;
        try
        {
        ...
        while (reader.Read())
        {
            ...
            switch (reader.NodeType)
            {
                            ...
                            switch (reader.Name)
                            {
                                case "cref":
                                    ...
                                    if (linkType == "T") // Type
                                    {
                                        ...
                                        if (linkRef != null && (linkRef.StartsWith("Microsoft", StringComparison.OrdinalIgnoreCase) || linkRef.StartsWith("System", StringComparison.OrdinalIgnoreCase)))
                                        {
                                            ...
                                            builder.AddMudLink(sequence++, $"https://learn.microsoft.com/dotnet/api/{msLink}", className, Typo, "docs-link docs-code docs-code-primary", "_external", (linkSequence, linkBuilder) =>
                                            {
                                                ...
                                                {
                                                    tooltipBuilder.AddMudIcon(tooltipSequence++, "ProtonBlazor.Icons.Material.Filled.Link", Color.Default, Size.Small);
                                                });
                                            });
                                        }
                                        else
                                    ...
                                    else // Property, Method, Field, or Event
                                    {
                                        ...
                                        else if (linkRef.StartsWith("ProtonBlazor.Icons"))
                                        {
                                            builder.AddMudTooltip(sequence++, Placement.Top, linkRef.Replace("ProtonBlazor.", ""), (childSequence, childBuilder) =>
                                            {
                ...
                case XmlNodeType.Text:
                    // <ProText Typo="Typo.caption">{value}</ProText>
