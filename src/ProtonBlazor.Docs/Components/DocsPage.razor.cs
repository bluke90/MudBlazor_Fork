...
namespace ProtonBlazor.Docs.Components
{
    public partial class DocsPage : ComponentBase
    {
        ...
        private ProPageContentNavigation _contentNavigation;
        ...
        private Dictionary<DocsPageSection, ProPageContentSection> _sectionMapper = new();
        ...
        internal async Task AddSectionAsync(DocsSectionLink sectionLinkInfo, DocsPageSection section)
        {
            ...
            if (_contentNavigation != null)
            {
                while (_bufferedSections.Count > 0)
                {
                    ...
                    {
                        ProPageContentSection parentInfo = null;
                        ...
                        var info =
                            new ProPageContentSection(sectionLinkInfo.Title, sectionLinkInfo.Id, section.Level,
                                parentInfo);
