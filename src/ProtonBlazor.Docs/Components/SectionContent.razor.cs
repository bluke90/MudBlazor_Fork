...
public partial class SectionContent
{
    ...
    protected string InnerClassname =>
        new CssBuilder("docs-section-content-inner")
            ...
            .AddClass($"pro-width-full", Block && FullWidth)
    ...
    protected virtual async Task RunOnTryProtonBlazorAsync()
    {
        string firstFile;
        if (Codes == null)
        {
        ...
        // Data models
        if (codeFiles.Contains("ProtonBlazor.Examples.Data.Models"))
        {
        ...
        // var tryProtonBlazorLocation = "https://localhost:5001/";
        const string TryProtonBlazorLocation = "https://try.protonblazor.com/";
        var url = $"{TryProtonBlazorLocation}snippet/{codeFileEncoded}";
