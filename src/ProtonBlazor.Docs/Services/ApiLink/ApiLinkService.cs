...
#nullable enable
    public class ApiLinkService : IApiLinkService
    {
        ...
        private readonly IReadOnlyCollection<ApiLinkServiceEntry> _featuredEntries =
            [
                new ApiLinkServiceEntry
                {
                    ...
                    SubTitle = "Get started with ProtonBlazor fast and easy."
                },
                ...
                new ApiLinkServiceEntry
                {
                    ...
                    ComponentType = typeof(ProTable<T>),
                ...
                new ApiLinkServiceEntry
                {
                    ...
                    ComponentType = typeof(ProDialog),
                ...
                new ApiLinkServiceEntry
                {
                    ...
                    ComponentType = typeof(ProAppBar),
                ...
                new ApiLinkServiceEntry
                {
                    ...
                    ComponentType = typeof(ProNavMenu),
        ...
        private void RegisterAliases()
        {
            ...
            RegisterPage("Accordion", subtitle: "Go to Expansion Panels", componentType: typeof(ProExpansionPanels));
            RegisterPage("Backdrop", subtitle: "Go to Overlay", componentType: typeof(ProOverlay));
            RegisterPage("Box", subtitle: "Go to Paper", componentType: typeof(ProPaper));
            RegisterPage("Combo Box", subtitle: "Go to Select", componentType: typeof(ProSelect<T>));
            RegisterPage("Drag & Drop", subtitle: "Go to Drop Zone", componentType: typeof(ProDropZone<T>));
            RegisterPage("Dropdown", subtitle: "Go to Select", componentType: typeof(ProSelect<T>));
            RegisterPage("Expander", subtitle: "Go to Collapse", componentType: typeof(ProCollapse));
            RegisterPage("Harmonica", subtitle: "Go to Expansion Panels", componentType: typeof(ProExpansionPanels));
            RegisterPage("Horizontal Line", subtitle: "Go to Divider", componentType: typeof(ProDivider));
            RegisterPage("Notification", subtitle: "Go to Snackbar", componentType: typeof(ProSnackbarProvider));
            RegisterPage("Popup", subtitle: "Go to Popover", componentType: typeof(ProPopover));
            RegisterPage("Segmented Buttons", subtitle: "Go to Toggle Group", componentType: typeof(ProToggleGroup<T>));
            RegisterPage("Side Panel", subtitle: "Go to Drawer", componentType: typeof(ProDrawer));
            RegisterPage("Toast", subtitle: "Go to Snackbar", componentType: typeof(ProSnackbarProvider));
            RegisterPage("Typeahead", subtitle: "Go to Autocomplete", componentType: typeof(ProAutocomplete<T>));
            RegisterAliasKeyword("components/navmenu", "Navigation Menu");
            RegisterAliasKeyword("docs/overview", "Explore ProtonBlazor");
        ...
        /// </summary>
        private void Register(IEnumerable<ProComponent> items)
        {
