...
using ProtonBlazor.Docs.Pages.Consent.Prompt;
using ProtonBlazor.Docs.Services;
using ProtonBlazor.Docs.Services.Notifications;
using ProtonBlazor.Docs.Services.UserPreferences;
...
#pragma warning restore 0618
            ...
            services.AddCookieConsent(options =>
            {
                ...
                options.ConsentPromptVariant = new ProCookieConsentPromptVariant();
