...
public partial class Appbar : IDisposable
{
    ...
    private ProAutocomplete<ApiLinkServiceEntry>? _searchBarAutocomplete;
    private ProAutocomplete<ApiLinkServiceEntry>? _searchDialogAutocomplete;
    ...
    {
        return page == _activePage ? "pro-chip-text pro-chip-color-primary mx-1 px-3" : "mx-1 px-3";
    }
