...
{
    private const string ParameterStateAttributeFullName = "ProtonBlazor.State.ParameterStateAttribute";
    ...
    private sealed class AnalyzerState
    {
        ...
        private static bool IsComponentBaseWithStateExtensionsType(INamedTypeSymbol? typeSymbol)
        {
            ...
            // Check namespace: ProtonBlazor.Extensions
            return IsNamespaceMatch(typeSymbol.ContainingNamespace, "ProtonBlazor", "Extensions");
        }
