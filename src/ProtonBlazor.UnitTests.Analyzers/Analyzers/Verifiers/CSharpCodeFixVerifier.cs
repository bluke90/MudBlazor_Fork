...
namespace ProtonBlazor.UnitTests.Analyzers.Verifiers;
    ...
    where TCodeFix : CodeFixProvider, new()
{
    ...
    public class Test : CSharpCodeFixTest<TAnalyzer, TCodeFix, DefaultVerifier>
    {
        public Test()
        {
            ...
            // Keep the version in sync with the ProtonBlazor project
            ...
            TestState.AdditionalReferences.Add(MetadataReference.CreateFromFile(typeof(ProtonBlazor._Imports).Assembly.Location));
        }
    }
}
