...
using VerifyCS = CSharpAnalyzerVerifier<ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer>;
...
public class ParameterStateAnalyzerTests
{
    ...
    {
        var analyzer = new ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer();
    ...
    {
        // Assert MUD0010
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.ReadDescriptor.Id, Is.EqualTo("MUD0010"));
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.ReadDescriptor.DefaultSeverity, Is.EqualTo(DiagnosticSeverity.Warning));
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.ReadDescriptor.IsEnabledByDefault, Is.True);

        // Assert MUD0011
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.WriteDescriptor.Id, Is.EqualTo("MUD0011"));
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.WriteDescriptor.DefaultSeverity, Is.EqualTo(DiagnosticSeverity.Warning));
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.WriteDescriptor.IsEnabledByDefault, Is.True);

        // Assert MUD0012
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.ExternalAccessDescriptor.Id, Is.EqualTo("MUD0012"));
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.ExternalAccessDescriptor.DefaultSeverity, Is.EqualTo(DiagnosticSeverity.Warning));
        Assert.That(ProtonBlazorAnalyzer::ProtonBlazor.Analyzers.ParameterStateAnalyzer.ExternalAccessDescriptor.IsEnabledByDefault, Is.True);
    }
    ...
    public void ParameterUsageOptions_MustMatch()
    {
        ...
        AssertEnumsMatch(
            typeof(ProtonBlazor.State.ParameterUsageOptions),
            typeof(ProtonBlazorAnalyzer.ProtonBlazor.State.ParameterUsageOptions)
        );
    }
...
class MyComponent
{
    [ProtonBlazor.State.ParameterState(ParameterUsage = ParameterUsageOptions.All)]
    public int Counter { get; set; }
...
class MyComponent
{
    [ProtonBlazor.State.ParameterState(ParameterUsage = ParameterUsageOptions.Read)]
    public int Counter { get; set; }
...
class MyComponent
{
    [ProtonBlazor.State.ParameterState(ParameterUsage = ParameterUsageOptions.Write)]
    public int Counter { get; set; }
...
class MyComponent
{
    [ProtonBlazor.State.ParameterState(ParameterUsage = ParameterUsageOptions.None)]
    public int Counter { get; set; }
...
class TestClass
{
    ...
    {
        var builder = new ComponentParameterCollectionBuilder<ProProgressLinear>();
...
class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        var comp = Context.RenderComponent<ProProgressCircular>(x =>
        {
