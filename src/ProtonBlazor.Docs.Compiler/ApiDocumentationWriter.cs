...
public class ApiDocumentationWriter : StringWriter
{
    ...
    {
        WriteLine($"// Copyright (c) ProtonBlazor {DateTime.Now.Year}");
        WriteLine("// ProtonBlazor licenses this file to you under the MIT license.");
        WriteLine("// See the LICENSE file in the project root for more information.");
        WriteLine();
        WriteLine("//-----------------------------------------------------------------------");
        WriteLine("// Generated by ProtonBlazor.Docs.Compiler.ApiDocumentationWriter");
        ...
        WriteLine();
        WriteLine("namespace ProtonBlazor.Docs.Models;");
        WriteLine();
    }
    ...
    public void WriteClassStart()
    {
        ...
        WriteLine("/// </summary>");
        WriteLine($"[GeneratedCodeAttribute(\"ProtonBlazor.Docs.Compiler\", \"{typeof(ApiDocumentationWriter).Assembly.GetName().Version}\")]");
    ...
    public void WriteType(DocumentedType type)
    {
        ...
        WriteIsComponentIndented(type.Type.IsSubclassOf(typeof(ProComponentBase)));
    ...
    /// <summary>
    /// Serializes the specified ProGlobal settings.
    /// </summary>
    ...
    /// <summary>
    /// Writes whether the type inherits from <see cref="ProComponentBase"/>.
    /// </summary>
